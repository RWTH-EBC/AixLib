...
package Example
  ...
  model ReciprocatingCompressor_R744
    ...
    Modelica.Fluid.Sources.FixedBoundary Condenser_in(
      ...
      T(displayUnit="degC") = 373.15,
      nPorts=1,
      p=10000000)                     annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=180,
          origin={88,40})));
    Modelica.Thermal.HeatTransfer.Sources.FixedTemperature Ambient(T=298.15)
  ...
  end ReciprocatingCompressor_R744;
  ...
  model ReciprocatingCompressor_R32
    ...
    Modelica.Fluid.Sources.FixedBoundary Condenser_in(
      ...
      T(displayUnit="degC") = 373.15,
      nPorts=1,
      p=6293000)                      annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=180,
          origin={88,40})));
    Modelica.Thermal.HeatTransfer.Sources.FixedTemperature Ambient(T=298.15)
  ...
  model ReciprocatingCompressor_R134a
    "Compressor Model using fluid dependent correlation for effective valve areas"
    ...
    Modelica.Fluid.Sources.FixedBoundary Condenser_in(
      ...
      T(displayUnit="degC") = 373.15,
      nPorts=1,
      p=2924000)                      annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=180,
          origin={88,40})));
    Modelica.Thermal.HeatTransfer.Sources.FixedTemperature Ambient(T=298.15)
  ...
  equation
    ...
    annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
      ...
      experiment(
        ...
        Tolerance=1e-05,
        __Dymola_Algorithm="Dassl"));
  end ReciprocatingCompressor_R134a;
  ...
  model ReciprocatingCompressor_R410A
    ...
    Modelica.Fluid.Sources.FixedBoundary Condenser_in(
      ...
      nPorts=1,
      use_p=true,
      p=3000000)                      annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=180,
          origin={88,40})));
    Modelica.Thermal.HeatTransfer.Sources.FixedTemperature Ambient(T=298.15)
  ...
  model ReciprocatingCompressor_R290
    "Compressor Model using fluid dependent correlation for effective valve areas"
    ...
    Modelica.Fluid.Sources.FixedBoundary Condenser_in(
      ...
      nPorts=1,
      p=2500000,
      T(displayUnit="degC") = 333.15) annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=180,
          origin={88,40})));
    Modelica.Thermal.HeatTransfer.Sources.FixedTemperature Ambient(T=298.15)
  ...
  equation
    ...
    annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
      ...
      experiment(
        ...
        Tolerance=1e-05,
        __Dymola_Algorithm="Dassl"));
  end ReciprocatingCompressor_R290;
end Example;
