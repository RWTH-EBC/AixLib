within ;
model hierarchischeRegelung_erweiterteRegelung
  ...
  erweiterteRegelung_modularBoiler erweiterteRegelung_modularBoiler1
...
equation
  ...
  connect(PLR_ein, notAusschalter_modularBoiler.PLR_ein) annotation (Line(
    ...
    connect(T_outdoor, erweiterteRegelung_modularBoiler1.T_ein) annotation (Line(
        points={{-100,-24},{-50,-24},{-50,-6.4},{0,-6.4}}, color={0,0,127}));
  connect(notAusschalter_modularBoiler.PLR_set,
    erweiterteRegelung_modularBoiler1.PLR_ein) annotation (Line(points={{-40,39},
          {-24,39},{-24,38},{-6,38},{-6,-2.6},{0,-2.6}}, color={0,0,127}));
  connect(erweiterteRegelung_modularBoiler1.T_Vorlauf, T_set) annotation (Line(
        points={{20,-2.6},{86,-2.6},{86,-10},{100,-10}}, color={0,0,127}));
  connect(erweiterteRegelung_modularBoiler1.PLR_aus, PLR_set) annotation (Line(
        points={{20,-6},{68,-6},{68,74},{100,74}}, color={0,0,127}));
...
end hierarchischeRegelung_erweiterteRegelung;
