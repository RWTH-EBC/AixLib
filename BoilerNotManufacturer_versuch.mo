within ;
model BoilerNotManufacturer_versuch
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor internalCapacity(final C=C,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-18,-50})));
  AixLib.Fluid.BoilerCHP.BaseClasses.Controllers.StationaryBehaviour
                                              DemandCalc(
    TColdNom=TColdNom,
    QNom=QNom,
  ...
  AixLib.Fluid.BoilerCHP.BaseClasses.Controllers.ReturnInfluence
                                          HeatCalc(
    TColdNom=TColdNom,
    QNom=QNom,
    dTWaterNom=dTWaterNom,
...
TVolume=vol.T;
  ...
  annotation (uses(AixLib(version="1.0.0")));
end BoilerNotManufacturer_versuch;
