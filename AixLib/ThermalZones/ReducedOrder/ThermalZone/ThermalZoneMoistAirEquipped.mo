...
model ThermalZoneMoistAirEquipped
  ...
  extends ThermalZoneMoistAir(SumMoistFlow(nu=2));
  ...
  HighOrder.Components.MoistAir.VarMoistAirExchange airExc(final V=zoneParam.VAir)
    if
...
equation
  ...
  connect(ventHum, airExc.HumIn) annotation (Line(points={{-100,-70},{-80,-70},
         ...
         {0,0,127}));
  connect(airExc.MoistFlow, SumMoistFlow.u[2]) annotation (Line(points={{-5.68,
          -22.96},{0,-22.96},{0,-30},{16,-30}}, color={0,0,127}));
