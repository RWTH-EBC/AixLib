...
model ThermalZone
  ...
  EquivalentAirTemperature.VDI6007WithWindow eqAirTempWall(
    ...
    final TGro=zoneParam.TSoil) if (sum(zoneParam.AExt) + sum(zoneParam.AWin)) > 0 "Computes equivalent air temperature" annotation (Placement(transformation(extent={{-36,-2},{-16,18}})));
  ...
  EquivalentAirTemperature.VDI6007 eqAirTempRoof(
    ...
    final TGro=273.15) if zoneParam.ARoof > 0 "Computes equivalent air temperature for roof" annotation (Placement(transformation(extent={{-36,66},{-16,86}})));
...
protected
  Modelica.Blocks.Sources.Constant hConvRoof(final k=(zoneParam.hConvRoofOut + zoneParam.hRadRoof)*zoneParam.ARoof) "Outdoor coefficient of heat transfer for roof" annotation (Placement(transformation(extent={{4,-4},{-4,4}})));
  ...
  Modelica.Blocks.Sources.Constant hConvWall(final k=(zoneParam.hConvWallOut + zoneParam.hRadWall)*sum(zoneParam.AExt)) "Outdoor coefficient of heat transfer for walls" annotation (Placement(transformation(extent={{-4,-4},{4,4}}, rotation=90)));
  ...
  Modelica.Blocks.Sources.Constant hConvWin(final k=(zoneParam.hConvWinOut + zoneParam.hRadWall)*sum(zoneParam.AWin)) "Outdoor coefficient of heat transfer for windows" annotation (Placement(transformation(extent={{4,-4},{-4,4}}, rotation=90)));
