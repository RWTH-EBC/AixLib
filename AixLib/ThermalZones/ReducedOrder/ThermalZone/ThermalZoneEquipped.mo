...
model ThermalZoneEquipped
  ...
  EquivalentAirTemperature.VDI6007WithWindow eqAirTempWall(
    ...
    final aExt=zoneParam.aExt) "Computes equivalent air temperature"
    annotation (Placement(transformation(extent={{-36,-2},{-16,18}})));
  Modelica.Blocks.Sources.Constant constSunblind[zoneParam.nOrientations](
    each k=0)
...
protected
  ...
  Modelica.Blocks.Sources.Constant TSoil(
    final k=zoneParam.Tsoil) if zoneParam.AFloor > 0
...
equation
  ...
  connect(HDirTilWall.inc, corGDouPan.inc) annotation (Line(points={{-67.2,36.1},
          {-60,36.1},{-60,36},{-56,36},{-56,36.8},{-51.4,36.8}}, color={0,0,127}));
  ...
  connect(HDifTilWall.HGroDifTil, corGDouPan.HGroDifTil) annotation (Line(
        points={{-67.2,13.2},{-62,13.2},{-62,39.6},{-51.4,39.6}}, color={0,0,
          127}));
  ...
  connect(theConWall.fluid, preTemWall.port)
  ...
  connect(HDifTilWall.HSkyDifTil, corGDouPan.HSkyDifTil) annotation (Line(
        points={{-67.2,22.8},{-64,22.8},{-64,42.4},{-51.4,42.4}}, color={0,0,
          127}));
  ...
  connect(theConWall.solid, ROM.extWall) annotation (Line(points={{26,14},{34,
          14},{34,42},{37.8,42}},
                              color={191,0,0}));
  connect(constSunblind.y, eqAirTempWall.sunblind) annotation (Line(points={{-26,
  ...
  connect(weaBus.TDryBul, eqAirTempRoof.TDryBul) annotation (Line(
      points={{-100,34},{-94,34},{-86,34},{-86,76},{-48,76},{-48,70},{-38,70}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(eqAirTempRoof.TEqAir, preTemRoof.T) annotation (Line(points={{-15,76},
          {4,76},{24,76},{24,86},{37.8,86}},           color={0,0,127}));
  connect(HDirTilRoof.H, solRadRoof.u1) annotation (Line(points={{-67.2,86.5},{-64,
          86.5},{-64,90},{-59,90}}, color={0,0,127}));
  connect(HDifTilRoof.H, solRadRoof.u2) annotation (Line(points={{-67.2,63},{
          -64,63},{-64,84},{-59,84}},
                                  color={0,0,127}));
