...
partial model PartialThermalZone "Partial model for thermal zone models"
  ...
  RC.FourElements ROM(
    ...
    final hConExtHeat=zoneParam.hConExtHeat,
    final hConExtCool=zoneParam.hConExtCool,
    ...
    final hConIntHeat=zoneParam.hConIntHeat,
    final hConIntCool=zoneParam.hConIntCool,
