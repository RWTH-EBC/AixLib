within AixLib.ThermalZones.ReducedOrder.Windows.SolarGain;
...
protected
  ...
  parameter Modelica.SIunits.TransmissionCoefficient Q210=(1-rho_1Dir0-0.907*A0)
    *(1+(0.907*A0*rho_1Dir0/(1-rho_1Dir0^2)))*UWin/25;
  parameter Modelica.SIunits.TransmissionCoefficient Q220=(1-rho_1Dir0-0.907*A0)
    *(0.907*A0/(1-rho_1Dir0^2))*(1-UWin/7.7);
  parameter Modelica.SIunits.TransmissionCoefficient taue_Dir0=(A0*0.907)^2/
    (1-rho_1Dir0^2)
    "Reference vertical parallel transmission coefficient for direct radiation";
  parameter Modelica.SIunits.ReflectionCoefficient rho_1Dir0=rho_11Dir0+
    (((1-rho_11Dir0)*0.907)^2*rho_11Dir0)/(1-(rho_11Dir0*0.907)^2);
  ...
  tau_1DifCov^2)/XN2_DifCov "Energetic dregree of transmission for second pane";
...
equation
  for i in 1:n loop
    ...
    Q21_DifCle[i]=a_1DifCle[i]*(1+(tau_1DifCle[i]*rho_1DifCle[i]/XN2_DifCle[i]))
    *UWin/25;
