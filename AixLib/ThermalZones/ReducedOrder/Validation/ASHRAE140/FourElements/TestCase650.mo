...
model TestCase650 "Test case 650"
  ...
  AixLib.ThermalZones.ReducedOrder.Windows.SolarGain.CorrectionGDoublePane
    corGDoublePane(UWin=3.046492744695893, n=4)
  ...
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow
    ...
    alphaWinOut=16.37,
    n=4,
    wfWall={0.15094339622641512,0.2547169811320755,0.33962264150943394,
    0.2547169811320755},
...
equation
  ...
  connect(from_degC_coo.u,SouTSetC. y[1]) annotation (Line(points={{-5.2,-86},{
          -9.4,-86}},            color={0,0,127}));
...
<p>Test Case 650 of the ASHRAE 140-2007: Calculation of heating/cooling loads
for room version light excited by internal and external gains. </p>
