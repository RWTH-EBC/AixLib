...
equation
  ...
  connect(corGDoublePane.solarRadWinTrans[1], absCoeffA.u) annotation (Line(
        points={{27,79.6},{40,79.6},{40,80},{54,80},{54,62},{104,62},{104,6},{107.8,
          6}},                                                           color={
          0,0,127}));
...
<p>
  Test Case 600 of the ASHRAE 140-2007: Calculation of solar radiation
  on tilted surfaces and of heating/cooling loads for room version
  light excited by internal and external gains.
</p>
<h4>
  Boundary conditions
</h4>
