...
model TestCase950 "Test case 950"
  ...
  AixLib.ThermalZones.ReducedOrder.RC.OneElement thermalZoneOneElement(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0009058311925},
    CExt={9152069.64734},
    hRad=5.13,
    RWin=0.0133333333333,
    RExtRem=0.0186378908278,
    ...
    nPorts=2,
    AExt={9.600000000000001,16.200000000000003,21.6,48.0,16.200000000000003}) "Thermal zone" annotation (Placement(transformation(extent={{44,14},{92,50}})));
  AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0,
    wfWall={0.10304320094174112,0.1738854015891881,0.23184720211891743,0.3173387937609652,0.1738854015891881},
  ...
  Modelica.Blocks.Sources.Constant alphaWall(k=29.3*111.60000000000001)
    ...
    rotation=90,
    origin={30,0})));
  Modelica.Blocks.Sources.Constant alphaWin(k=21.0*12.0)
  ...
  Modelica.Blocks.Sources.CombiTimeTable SouTSetC(
    ...
    verboseRead=true,
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    table=[0,100; 25200,100; 25200.01,27; 64800,27; 64800.01,100; 86400,100],
...
equation
  ...
  connect(alphaWall.y, thermalConductorWall.Gc)
    annotation (Line(points={{30,4.4},{30,12},{31,12}},   color={0,0,127}));
  connect(alphaWin.y, thermalConductorWin.Gc)
    annotation (Line(points={{32,49.6},{32,42},{33,42}}, color={0,0,127}));
  ...
  connect(gain2.y,multiSum. u[1]) annotation (Line(points={{118.5,-90.5},{120,
          -90.5},{120,-92},{126,-92}},       color={0,0,127}));
  ...
  connect(from_degC_coo.u,SouTSetC. y[1]) annotation (Line(points={{-7.2,-86},{-10,
          -86},{-11.4,-86}},                 color={0,0,127}));
...
<p>Test Case 950 of the ASHRAE 140-2007: Calculation of heating/cooling loads for room version heavy excited by internal and external gains. </p>
