...
model TestCase900 "Test case 900"
  ...
  AixLib.ThermalZones.ReducedOrder.RC.OneElement thermalZoneOneElement(
    ...
    nPorts=2,
    AExt={9.600000000000001,16.200000000000003,21.6,48.0,16.200000000000003}) "Thermal zone"
...
equation
  ...
  connect(division.y, weaDat.HInfHor_in) annotation (Line(points={{-103.4,54},{-100,
          54},{-100,62},{-104,62},{-104,70},{-99,70}},     color={0,0,127}));
...
<p>
  Test Case 900 of the ASHRAE 140-2007: Calculation of solar radiation
  on tilted surfaces and of heating/cooling loads for room version
  heavy excited by internal and external gains.
</p>
<h4>
  Boundary conditions
</h4>
