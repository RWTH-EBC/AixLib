...
model TestCase900 "Test case 900"
...
equation
  ...
  connect(conHea.u_m, thermalZoneOneElement.TAir) annotation (Line(points={{22,
          -69.6},{22,-69.6},{22,-74},{101,-74},{101,48},{93,48}},
                                                                color={0,0,127}));
...
<p>Test Case 900 of the ASHRAE 140-2007: Calculation of solar radiation on
tilted surfaces and of heating/cooling loads for room version heavy excited by
internal and external gains. </p>
