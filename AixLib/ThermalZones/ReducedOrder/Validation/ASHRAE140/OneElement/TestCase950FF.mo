...
model TestCase950FF "Test case 950 free float"
...
equation
  ...
  connect(thermalZoneOneElement.TAir, to_degC.u) annotation (Line(points={{93,48},
...
<p>Test Case 950FF of the ASHRAE 140-2007: Calculation of free float indoor air
temperature for room version heavy excited by internal and external gains. </p>
