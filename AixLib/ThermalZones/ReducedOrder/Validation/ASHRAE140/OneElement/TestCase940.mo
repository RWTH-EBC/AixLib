...
equation
  ...
  connect(from_degC_hea.u,SouTSetH. y[1]) annotation (Line(points={{-7.2,-60},{-11.4,
          -60}},                   color={0,0,127}));
...
<p>
  Test Case 940 of the ASHRAE 140-2007: Calculation of heating/cooling
...
<ul>
  ...
  <li>daily profile for set temperatures of heating and constant
  cooling
  </li>
