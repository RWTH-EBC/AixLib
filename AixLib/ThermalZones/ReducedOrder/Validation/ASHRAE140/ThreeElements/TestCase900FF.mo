...
equation
  ...
  connect(ventilationIn.ports[1], thermalZoneThreeElements.ports[1])
    annotation (Line(points={{-34,-38},{-30,-38},{-30,-10},{82.2375,-10},{82.2375,
          14.05}}, color={0,127,255}));
  connect(ventilationOut.ports[1], thermalZoneThreeElements.ports[2])
    annotation (Line(points={{-34,-70},{-26,-70},{-26,-14},{83.7625,-14},{83.7625,
          14.05}}, color={0,127,255}));
...
<p>
  Test Case 900FF of the ASHRAE 140-2007: Calculation of free float
  indoor air temperature for room version heavy excited by internal and
  external gains.
</p>
<h4>
  Boundary conditions
