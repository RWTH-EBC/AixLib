...
model MultizoneMoistCo2AirExchange "Multizone model with ideal heater and cooler and AHU considering moisture and co2 balance"
...
<ul>
  ...
  Rename to MultizoneMoistCo2AirExchange</li>
  <li>
...
end MultizoneMoistCo2AirExchange;
