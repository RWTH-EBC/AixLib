...
<p>This model is used to weight outputs according to given split
  factors per input port.</p>
  <p>The model needs the dimensions of the splitted ports (for input and
