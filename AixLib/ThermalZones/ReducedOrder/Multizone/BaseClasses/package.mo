...
package BaseClasses "Package with base classes for multizone models"
  extends Modelica.Icons.BasesPackage;



  partial model PartialMultizoneSP "Partial model for multizone models with Swimming Pools"
  ...
  equation
    ...
    for i in 1:numZones loop
      ...
      if use_swimmingPools_MZ and zone[i].use_swimmingPools then
        ...
        connect(zone[i].MFlowFreshWater, MFlowFW[i]) annotation (Line(points={{82.1,
                61.3},{82.1,-12},{82,-12},{82,-84},{110,-84}},
                                               color={0,0,127}));
