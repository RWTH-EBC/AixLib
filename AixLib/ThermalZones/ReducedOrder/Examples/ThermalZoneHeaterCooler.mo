...
model ThermalZoneHeaterCooler
  "Illustrates the use of ThermalZone with internal heater and cooler"
  extends Modelica.Icons.Example;

  AixLib.ThermalZones.ReducedOrder.ThermalZone.ThermalZone thermalZone(
    redeclare AixLib.DataBase.ThermalZones.OfficePassiveHouse.OPH_1_OfficeHeaterCoolerWithThresholds zoneParam,
  ...
  Modelica.Blocks.Sources.Constant TsetCool(k=273.15 + 24)
...
equation
  ...
  connect(sine.y, gain1.u) annotation (Line(points={{73,0},{70,0},{70,-18},{67.2,
          -18}}, color={0,0,127}));
  connect(TsetHea.y, thermalZone.TSetHeat) annotation (Line(points={{-69,-36},{-16,
          -36},{-16,1.2},{-9.6,1.2}}, color={0,0,127}));
  connect(TsetCool.y, thermalZone.TSetCool) annotation (Line(points={{-69,-2},{-20,
          -2},{-20,4},{-9.6,4}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)),
        experiment(Tolerance=1e-6,StopTime=3.1536e+007,Interval=3600),
        __Dymola_Commands(file=
  "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/ThermalZoneHeaterCooler.mos"
        "Simulate and plot"),
...
<p>
  ...
  building build as passive house using an ideal heater and cooler. All boundary conditions are generic
