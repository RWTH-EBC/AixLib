...
model SimpleRoomTwoElementsNonConstantTGround
  ...
  extends AixLib.ThermalZones.ReducedOrder.Examples.SimpleRoomTwoElements(
    eqAirTemp(
      wfWall={0.15,0.35},
      wfGro=0.5,
...
Apart from that, it is identical to <a href=\"modelica://AixLib.ThermalZones.ReducedOrder.Examples.SimpleRoomTwoElements\">
AixLib.ThermalZones.ReducedOrder.Examples.SimpleRoomTwoElements</a>.
<h4>References</h4>
...
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1744\">IBPSA, #1744</a>.
  ...
  "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomTwoElementsNonConstantTGround.mos"
        "Simulate and plot"),
