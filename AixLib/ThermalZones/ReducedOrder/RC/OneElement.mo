...
<ul>
  <li>September 26, 2016, by Moritz Lauster:<br/>
    ...
    Deleted conditional statements of <code>splitFactor</code> and <code>splitFactorSolRad</code>.
  </li>
