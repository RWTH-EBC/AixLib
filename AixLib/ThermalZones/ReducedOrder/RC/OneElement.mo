...
protected
  ...
  Modelica.Blocks.Sources.Constant hConvExtWall_const(final k=ATotExt*hConvExt) "Coefficient of convective heat transfer for exterior walls"
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor resExtWallWin(final G=min(ATotExt, ATotWin)*hRad) if ATotExt > 0 and ATotWin > 0 "Resistor between exterior walls and windows" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={-146,10})));
