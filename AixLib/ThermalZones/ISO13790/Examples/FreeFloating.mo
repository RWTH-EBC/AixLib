within AixLib.ThermalZones.ISO13790.Examples;
 model FreeFloating "Illustrates the use of the 5R1C thermal zone in free-floating conditions"
   ...
   Zone5R1C.Zone zon5R1C(
     ...
     AFlo=16,
     VRoo=16*3,
     redeclare replaceable AixLib.ThermalZones.ISO13790.Data.Light buiMas,
     nOrientations=4,
 ...
 equation
   ...
   "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ISO13790/Examples/FreeFloating.mos"
         "Simulate and plot"),
   Documentation(info="<html>
 <p>
 This model illustrates the use of <a href=\"modelica://AixLib.ThermalZones.ISO13790.Zone5R1C.Zone\">
 AixLib.ThermalZones.ISO13790.Zone5R1C.Zone</a> in a free-floating case 
