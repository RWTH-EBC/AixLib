within AixLib.ThermalZones.ISO13790.Validation.BESTEST;
 model Case900
   extends AixLib.ThermalZones.ISO13790.Validation.BESTEST.Case600(
     zon5R1C(hInt=2.74,
  ...
  annotation(experiment(
   ...
   "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Case900.mos"
