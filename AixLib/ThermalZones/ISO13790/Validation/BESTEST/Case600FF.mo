...
model Case600FF "Basic test with light-weight construction and free floating temperature"
  ...
  AixLib.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    filNam=Modelica.Utilities.Files.loadResource("modelica://AixLib/Resources/weatherdata/DRYCOLD.mos"))
    "Weather data"
  ...
  AixLib.ThermalZones.ISO13790.Validation.BESTEST.Data.Case600FFResults annComBESTESTFF "Annual comparison BESTEST FF"
...
equation
 ...
 annotation(experiment(
  ...
  "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Case600FF.mos"
