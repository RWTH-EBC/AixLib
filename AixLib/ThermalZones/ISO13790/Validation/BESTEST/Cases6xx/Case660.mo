...
model Case660 "Case 600, but with low-emissivity windows with Argon gas"
  extends AixLib.ThermalZones.ISO13790.Validation.BESTEST.Cases6xx.Case600(zonHVAC(
      UWin=1.45,
      gFac=0.44,
      coeFac={1,-0.152,0.51,-0.526}));
 annotation (
  __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases6xx/Case660.mos"
        "Simulate and plot"),
        experiment(
      StopTime=3.1536e+07,
      Interval=3600,
