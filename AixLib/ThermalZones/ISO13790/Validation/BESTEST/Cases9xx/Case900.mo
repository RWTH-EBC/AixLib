...
model Case900 "Case 600, but with high thermal mass"
  extends AixLib.ThermalZones.ISO13790.Validation.BESTEST.Cases6xx.Case600(
      zonHVAC(redeclare replaceable
        AixLib.ThermalZones.ISO13790.Validation.BESTEST.Data.Case900Mass buiMas));
 ...
 annotation(experiment(
  ...
  "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases9xx/Case900.mos"
