within AixLib.ThermalZones.ISO13790.Validation.BESTEST;
 model Case900FF "Test with heavy-weight construction and free floating temperature"
   extends AixLib.ThermalZones.ISO13790.Validation.BESTEST.Case600FF(
     zon5R1C(
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=3.1536e+007),
   ...
   "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Case900FF.mos"
