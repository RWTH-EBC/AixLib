...
model ZoneHVAC "Thermal zone for HVAC based on 5R1C network"
  ...
  Fluid.MixingVolumes.MixingVolumeMoistAir vol(
    ...
    m_flow_nominal=VRoo*AixLib.Media.Air.dStp*3/3600,
    V=VRoo,
...
<p>
This models is identical to <a href=\"modelica://AixLib.ThermalZones.ISO13790.Zone5R1C.Zone\">
AixLib.ThermalZones.ISO13790.Zone5R1C.Zone</a>, except that a mixing volume is added
