...
model OFD_1Jan "OFD with TMC, TIR and TRY"
  ...
  Modelica.Blocks.Sources.CombiTimeTable TSet_const(
    ...
    table=[0,273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17,273.15
         + 17,273.15 + 17,273.15 + 17; 21600,273.15 + 17,273.15 + 17,273.15 +
        17,273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17; 21600,
        273.15 + 20,273.15 + 20,273.15 + 20,273.15 + 20,273.15 + 20,273.15 + 20,
        273.15 + 20,273.15 + 20; 82800,273.15 + 20,273.15 + 20,273.15 + 20,
        273.15 + 20,273.15 + 20,273.15 + 20,273.15 + 20,273.15 + 20; 82800,
        273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17,
        273.15 + 17,273.15 + 17; 86400,273.15 + 17,273.15 + 17,273.15 + 17,
        273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17,273.15 + 17])
    annotation (Placement(transformation(extent={{-197,-19},{-177,1}})));
  ...
  AixLib.BoundaryConditions.WeatherData.Old.WeatherTRY.Weather Weather(
    ...
    fileName=ModelicaServices.ExternalReferences.loadResource(
        "modelica://AixLib/Resources/weatherdata/file:///D:/Remote-User/yni/Projekte/Git/aixlib/AixLib/AixLib/Resources/weatherdata/Aachen_TRY2015_507755060854_Jahr_dymola.txt"),
    WeatherData(
      tableOnFile=true,
...
equation
  ...
  connect(TSet_const.y[1], groundFloor.TSet_GF[1]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-64.023},{-106.538,-64.023}},
        color={0,0,127}));
  connect(TSet_const.y[2], groundFloor.TSet_GF[2]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-63.279},{-106.538,-63.279}},
        color={0,0,127}));
  connect(TSet_const.y[3], groundFloor.TSet_GF[4]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-61.791},{-106.538,-61.791}},
        color={0,0,127}));
  connect(TSet_const.y[4], groundFloor.TSet_GF[5]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-61.047},{-106.538,-61.047}},
        color={0,0,127}));
  connect(TSet_const.y[5], upperFloor.TSet_UF[1]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-28.1238},{-105.308,-28.1238}},
        color={0,0,127}));
  connect(TSet_const.y[6], upperFloor.TSet_UF[2]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-27.2712},{-105.308,-27.2712}},
        color={0,0,127}));
  connect(TSet_const.y[7], upperFloor.TSet_UF[3]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-26.4187},{-105.308,-26.4187}},
        color={0,0,127}));
  connect(TSet_const.y[6], upperFloor.TSet_UF[4]) annotation (Line(points={{-176,-9},
          {-160,-9},{-160,-50},{-140,-50},{-140,-25.5663},{-105.308,-25.5663}},
        color={0,0,127}));
  connect(TSet_const.y[8], groundFloor.TSet_GF[3]) annotation (Line(points={{-176,-9},
