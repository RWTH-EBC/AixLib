...
<p>
  This model represents the shadow length on a vertical wall caused by
  a horizontal shield on it.
</p>
<p>
  <b><span style=\"color: #008000;\">Concept</span></b>
</p>
<ul>
  <li>The model calculates the wall solar azimuth and the zenith angles
  to determine if a shadow is present on the wall surface, then outputs
  it as a boolean value.
  </li>
  <li>When the shadow is present, the model calculates the shadow
  length.
  </li>
</ul>
<p>
...
<ul>
  <li>The wall is vertical (til = 90°), while the shield is horizontal.
  </li>
</ul>
<p>
...
<p>
  ...
  AixLib.ThermalZones.HighOrder.Components.Shadow.Examples.ShadowLengthTest</a>
</p>
</html>", revisions="<html>
<ul>
  <li>
