...
equation
  connect(twoStar_RadEx.radPort, radPort) annotation(Line(points = {{49.1, 60}, {90, 60}}, pattern = LinePattern.Solid));
  ...
  connect(twoStar_RadEx.port_a, HeatTrans.port_b) annotation(Line(points = {{30.8, 60}, {20, 60}, {20, 2}, {10, 2}}, color = {191, 0, 0}));
  connect(twoStar_RadEx1.port_a, HeatTrans.port_a) annotation(Line(points = {{-32.8, 60}, {-20, 60}, {-20, 2}, {-10, 2}}, color = {191, 0, 0}));
  connect(twoStar_RadEx1.radPort, radPort1) annotation(Line(points = {{-51.1, 60}, {-90, 60}}, color = {95, 95, 95}, pattern = LinePattern.Solid));
