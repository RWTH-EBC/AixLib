...
equation
  ...
  connect(Wall_Ceiling.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{104,68},
          {104,58},{54,58},{54,-32},{33.8,-32},{33.8,-12.7}},                                                                                                       color={191,0,0}));
