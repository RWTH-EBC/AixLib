...
equation
  ...
  connect(Wall_Floor.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{96,
          -98.0002},{96,-74},{15.3,-74},{15.3,-69.8}},                                                                                                color={191,0,0}));
  ...
  connect(Wall_Livingroom.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{-10,34},
          {-10,24},{-48,24},{-48,-74},{15.3,-74},{15.3,-69.8}},                                                                                                          color={191,0,0}));
  connect(Wall_Corridor.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{56,16},
          {44,16},{44,-74},{15.3,-74},{15.3,-69.8}},                                                                                                       color={191,0,0}));
  connect(Wall_Bath.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{56,-40},
          {44,-40},{44,-74},{15.3,-74},{15.3,-69.8}},                                                                                                    color={191,0,0}));
  ...
  connect(outsideWall.solarRadWinTrans, Wall_Floor.solarRadWin) annotation (
      Line(points={{27,-79.5},{27,-74},{88,-74},{88,-86},{88.6667,-86},{88.6667,
          -97.8002}}, color={0,0,127}));
  ...
  connect(outsideWall.solarRadWinTrans, Wall_Livingroom.solarRadWin)
    annotation (Line(points={{27,-79.5},{27,-74},{44,-74},{44,20},{25.2,20},{
          25.2,33.2}}, color={0,0,127}));
