...
model Ow2IwL2IwS1Lf1At1Ro1
  ...
  AixLib.ThermalZones.HighOrder.Components.Walls.Wall Ceiling(
    ...
    withWindow=false,
    withDoor=false,
    ISOrientation=AixLib.ThermalZones.HighOrder.Components.Types.InsideSurfaceOrientation.ceiling) annotation (Placement(transformation(
        origin={28,60},
  ...
  AixLib.ThermalZones.HighOrder.Components.Walls.Wall floor(
    ...
    withWindow=false,
    withDoor=false,
    ISOrientation=AixLib.ThermalZones.HighOrder.Components.Types.InsideSurfaceOrientation.floor) if not use_UFH                           annotation (Placement(transformation(
        origin={-24,-60},
