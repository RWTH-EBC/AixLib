...
equation
  ...
  connect(floorRoom1.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{-60,-38},{-60,-28},{-30,-28},{-30,-19.8},{-31.3,-19.8}}, color={191,0,0}));
  ...
  connect(roof2.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{47,54},{47,40},{60,40},{60,-28},{-31.3,-28},{-31.3,-19.8}}, color={191,0,0}));
  ...
  connect(OW1.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{-71,-22},{-64,-22},{-64,-28},{-31.3,-28},{-31.3,-19.8}}, color={191,0,0}));
  ...
  connect(OW1.SolarRadiationPort, SolarRadiationPort_OW1) annotation (Line(
        points={{-80.2,-2.75},{-86,-2.75},{-86,-20},{-106,-20}}, color={255,128,
          0}));
  connect(OW2.thermStarComb_inside, thermStar_Demux.portConvRadComb) annotation (Line(points={{81,-16},{76,-16},{76,-28},{-31.3,-28},{-31.3,-19.8}}, color={191,0,0}));
