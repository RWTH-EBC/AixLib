...
partial model PartialRoom "Partial model with base component that are necessary for all HOM rooms"
  ...
  parameter Modelica.SIunits.Temperature T0_air=295.11 "Air"
    annotation (Dialog(tab="Initialization", group="Air volume of room", descriptionLabel=true));
  ...
  parameter Boolean use_infiltEN12831=true "Use model to exchange room air with outdoor air acc. to standard";
  parameter Real n50(unit="1/h") = 4 "Air exchange rate at 50 Pa pressure difference"
    annotation (Dialog(tab="Infiltration acc. to EN 12831 (building airtightness", enable=use_infiltEN12831));
