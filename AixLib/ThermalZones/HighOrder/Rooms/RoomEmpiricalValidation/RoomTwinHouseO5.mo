...
model RoomTwinHouseO5 "O5"
  ...
  Components.Sunblinds.SunblindTimeVariable sunblindTimeVariable(n=1, gsunblind
      ={1}) annotation (Placement(transformation(extent={{52,-80},{68,-64}})));
equation
  ...
  connect(IW1.thermStarComb_inside, thermStar_Demux.portConvRadComb)
    annotation (Line(points={{38,8},{40,8},{40,-46},{-7,-46},{-7,-8}}, color={
          191,0,0}));
  connect(SolarRadiationPort[3], sunblindTimeVariable.Rad_In[1]) annotation (
      Line(points={{-110,56},{-30,56},{-30,-71},{51,-71}}, color={255,128,0}));
  connect(sunblindTimeVariable.Rad_Out[1], wallSouth.SolarRadiationPort)
    annotation (Line(points={{69,-71},{82,-71},{82,-80},{-28.0833,-80},{
          -28.0833,-66.8}}, color={255,128,0}));
