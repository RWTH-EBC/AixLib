...
equation
  ...
  connect(IW.port_outside, airload.heatPort) annotation (Line(points={{29.9,24},
          {22,24},{22,-12},{18,-12}},
                                  color={191,0,0}));
  connect(IW1.port_outside, airload.heatPort) annotation (Line(points={{33.9,8},
          {22,8},{22,-12},{18,-12}},
                                 color={191,0,0}));
  ...
  connect(wallSouth.shortRadWin, solarRadInRoom.win_in[2]) annotation (Line(points={{21.2083,
          -53.3},{21.2083,-48},{-48,-48},{-48,36},{-46,36},{-46,35.75},{-45,
          35.75}},                                                                                                                                                      color={0,0,0}));
  ...
  connect(wallNorth.shortRadWin, solarRadInRoom.win_in[4]) annotation (Line(points={{28.2083,
          50.3},{28.2083,46},{-48,46},{-48,36.75},{-45,36.75}},                                                                                    color={0,0,0}));
  ...
  connect(solarRadInRoom.walls[2], wallSouth.shortRadWall) annotation (Line(points={{-23,
          41.75},{44,41.75},{44,-50},{-19.0417,-50},{-19.0417,-53}},                                                                                color={0,0,0}));
  ...
  connect(solarRadInRoom.walls[4], wallNorth.shortRadWall) annotation (Line(points={{-23,
          42.75},{-12.0417,42.75},{-12.0417,50}},                                                                                color={0,0,0}));
  connect(solarRadInRoom.floors[1], Floor.shortRadWall) annotation (Line(points={{-23,38},
          {-18,38},{-18,16},{-42,16},{-42,-70},{-54.0458,-70},{-54.0458,-75}},                                                                                 color={0,0,0}));
  connect(solarRadInRoom.ceilings[1], Ceiling.shortRadWall) annotation (Line(points={{-23,34},
          {-22,34},{-22,48},{-56.5333,48},{-56.5333,68}},                                                                                     color={0,0,0}));
