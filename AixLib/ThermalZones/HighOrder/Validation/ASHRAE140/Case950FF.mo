...
model Case950FF
  extends Case650FF(
    ...
    ReferenceHeatingLoadOrTempMax(table=[950,35.5,38.5]),
    ReferenceCoolingLoadOrTempMin(table=[950,-20.2,-18.6]),
    checkResultsAccordingToASHRAEHeatingOrTempMax(checkTime=21135600));
  annotation (
