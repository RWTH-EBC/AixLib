  ...
  <caption>
    ...
    <table>
      <caption>
        ...
        <p>
          The following FreeFloating models refer to test cases that do
          not include mechanical heating or cooling of the building.
        </p>
        <table>
          <caption>
            \"summary\" border=\"1\" cellspacing=\"0\" cellpadding=\"2\"
            ...
            <p>
              The simulated annual heating and cooling loads of <b>Case
              210, 250, 395, 430</b> cannot meet the statistical
              acceptance ranges given by ASHRAE140 (01.01.2021).<br/>
              However, cases that do not perform according to the
              reference values should not be considered erroneous. They
              shall be used as indication for debugging purposes
              instead.
            </p>
            <h4>
              References
