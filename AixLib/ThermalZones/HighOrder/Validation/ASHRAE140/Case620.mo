...
model Case620
  ...
  Rooms.ASHRAE140.EastWestFacingWindows Room(absInnerWallSurf=AixLib.ThermalZones.HighOrder.Components.Types.selectorCoefficients.abs06,
...
equation
  ...
  connect(integrator1.y, AnnualHeatingLoad)
    annotation (Line(points={{82.55,50},{100,50}},          color={0,0,127}));
  connect(integrator.y, AnnualCoolingLoad)
    annotation (Line(points={{82.55,32},{100,32}},          color={0,0,127}));
  connect(outsideTemp.port, Room.thermOutside) annotation (Line(points={{-59,46.5},
          {-39,46.5},{-39,57.59},{-9,57.59}}, color={191,0,0}));
  connect(Room.AirExchangePort, AirExchangeRate.y) annotation (Line(points={{-11.1,
          51.7475},{-21,51.7475},{-21,-43.5},{-26.35,-43.5}}, color={0,0,127}));
