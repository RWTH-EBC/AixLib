...
model TwinHouseO5
  ...
  Rooms.RoomEmpiricalValidation.RoomTwinHouseO5 roomTwinHouseN2(
  ...
  Modelica.Blocks.Sources.CombiTimeTable TempCellar(
    tableOnFile=true,
    tableName="TwinHouseO5",
    fileName=ModelicaServices.ExternalReferences.loadResource(
        "modelica://AixLib/Resources/weatherdata/TwinHouseO5.mat"),
    columns={4})
...
equation
  ...
  connect(TempAttic.y[1], add.u1) annotation (Line(points={{-75,34},{-68,34},{
          -68,43.2},{-63.4,43.2}},
                              color={0,0,127}));
  connect(TempAttic.y[2], add.u2) annotation (Line(points={{-75,34},{-68,34},{
          -68,34.8},{-63.4,34.8}},
                              color={0,0,127}));
  ...
  connect(Heat.y, sum1.u)
    annotation (Line(points={{-71,-90},{-66,-90}}, color={0,0,127}));
  ...
  connect(VentTemp.y[1], from_degC1.u) annotation (Line(points={{-79.2,-32},{
          -74,-32},{-74,-33},{-67,-33}}, color={0,0,127}));
