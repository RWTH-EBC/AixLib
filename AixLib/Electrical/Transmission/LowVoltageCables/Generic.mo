...
record Generic "Data record for a generic low voltage cable"
  ...
  parameter AixLib.Electrical.Types.CharacteristicResistance RCha(start=0)
    "Characteristic resistance of the cable";
  parameter AixLib.Electrical.Types.CharacteristicReactance XCha(start=0)
  ...
  redeclare function extends lineResistance
   ...
   input AixLib.Electrical.Transmission.LowVoltageCables.Generic cable
