within AixLib.Electrical.Transmission.BaseClasses;
partial model PartialBaseLine "Partial cable line dispersion model"
  ...
  parameter AixLib.Electrical.Types.Load modelMode=AixLib.Electrical.Types.Load.FixedZ_steady_state
    ...
    annotation(Evaluate=true, Dialog(tab="Model", group="Assumptions", enable = use_C), choices(choice=AixLib.Electrical.Types.Load.FixedZ_steady_state
        "Steady state", choice=AixLib.Electrical.Types.Load.FixedZ_dynamic "Dynamic"));
  ...
  replaceable parameter
    ...
    enable = mode == AixLib.Electrical.Types.CableMode.commercial),
...
AixLib.Electrical.Transmission.LowVoltageCables</a> and
...
properties can be found in <a href=\"modelica://AixLib.Electrical.Transmission.Functions\">
AixLib.Electrical.Transmission.Functions</a>.
</p>
<p>
The parameter <code>commercialCable</code> is assumed to be
<a href=\"modelica://AixLib.Electrical.Transmission.LowVoltageCables.Generic\">
AixLib.Electrical.Transmission.LowVoltageCables.Generic</a>.
The parameter is replaceable so it can be redeclared using a different type, for example
<a href=\"modelica://AixLib.Electrical.Transmission.MediumVoltageCables.Generic\">
AixLib.Electrical.Transmission.MediumVoltageCables.Generic</a>.<br/>
The example models
<a href=\"modelica://AixLib.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACLineMedium\">
AixLib.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACLineMedium</a> and
<a href=\"modelica://AixLib.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACSimpleGridMedium\">
AixLib.Electrical.AC.ThreePhasesBalanced.Lines.Examples.ACSimpleGridMedium</a>
