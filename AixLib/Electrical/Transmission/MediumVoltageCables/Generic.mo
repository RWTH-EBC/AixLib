...
record Generic "Data record for a generic medium voltage cable"
  ...
  extends AixLib.Electrical.Transmission.BaseClasses.BaseCable;
  parameter String size(start="")
    "AWG or kcmil code representing the conductor size";
  parameter AixLib.Electrical.Types.CharacteristicResistance Rdc(start=0)
  ...
  redeclare function extends lineResistance
    "Function that computes the resistance of a cable"
      input AixLib.Electrical.Transmission.MediumVoltageCables.Generic cable
      "Record that contains cable properties";
  algorithm
    R := l*cable.Rdc*AixLib.Electrical.Transmission.Functions.R_AC_correction(
...
<a href=\"modelica://AixLib.Electrical.Transmission.Functions.R_AC_correction\">
AixLib.Electrical.Transmission.Functions.R_AC_correction</a> for more details.
</p>
