within AixLib.Electrical.Transmission.Functions;
 function R_AC_correction
   ...
   input AixLib.Electrical.Transmission.Types.Material material
     "Material of the cable";
   output Real correction "Correction factor";
 algorithm
   if material == AixLib.Electrical.Transmission.Types.Material.Al then
     if size == "1/0" then
       correction := 1.0;
   ...
   elseif material == AixLib.Electrical.Transmission.Types.Material.Cu then
     if size == "1/0" then
       correction := 1.0;
     elseif size == "2/0" then
       correction := 1.001;
     ...
     assert(material <> AixLib.Electrical.Transmission.Types.Material.Al and
            material <> AixLib.Electrical.Transmission.Types.Material.Cu,
     "In function AixLib.Electrical.Transmission.Functions.R_AC_Correction,
