within AixLib.Electrical.Transmission.Functions;
 function selectCable_low "This function is used to automatically select the
   ...
   output AixLib.Electrical.Transmission.LowVoltageCables.Generic cable "Cable";
 protected
   parameter Real safety_factor = 1.2;
   Modelica.Units.SI.Current I_nominal
     "Nominal current flowing through the line";
   AixLib.Electrical.Transmission.LowVoltageCables.Cu10 cu10;
   AixLib.Electrical.Transmission.LowVoltageCables.Cu20 cu20;
   AixLib.Electrical.Transmission.LowVoltageCables.Cu25 cu25;
   AixLib.Electrical.Transmission.LowVoltageCables.Cu35 cu35;
   AixLib.Electrical.Transmission.LowVoltageCables.Cu50 cu50;
   AixLib.Electrical.Transmission.LowVoltageCables.Cu95 cu95;
   AixLib.Electrical.Transmission.LowVoltageCables.Cu100 cu100;
 algorithm
 
   assert(Transmission.Functions.selectVoltageLevel(V_nominal) == AixLib.Electrical.Types.VoltageLevel.Low,
   "In function AixLib.Electrical.Transmission.Functions.selectCable_low,
