within AixLib.Electrical.AC.ThreePhasesUnbalanced.Conversion.Examples;
 ...
 AixLib.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerStepDownDY</a> model.
 </p>
 </html>"),
 experiment(Tolerance=1e-6, StopTime=1.0),
 __Dymola_Commands(file=
  "modelica://AixLib/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Conversion/Examples/TransformerStepDownDY.mos"
         "Simulate and plot"), 
