...
__Dymola_Commands(file=
          "modelica://AixLib/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Lines/Examples/ACSimpleGridMedium.mos"
        "Simulate and plot"),
...
<span style=\" font-family:'Courier New,courier'; color:#ff0000;\">AixLib.Electrical.Transmission.Grids.TestGrid2NodesMedium</span>
<span style=\" font-family:'Courier New,courier';\"> grid,</span>
</p>
<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; -qt-user-state:8;\">
<span style=\" font-family:'Courier New,courier';\">      lines(</span>
<span style=\" font-family:'Courier New,courier'; color:#0000ff;\">redeclare </span>
<span style=\" font-family:'Courier New,courier'; color:#ff0000;\">AixLib.Electrical.Transmission.MediumVoltageCables.Generic</span>
</p>
<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; -qt-user-state:8;\">
...
<code>AixLib.Electrical.Transmission.MediumVoltageCables.Generic</code>. The lines are initialized
