within AixLib.Electrical.AC.OnePhase.Sensors.Examples;
 model GeneralizedSensor
   ...
   AixLib.Electrical.AC.OnePhase.Sensors.GeneralizedSensor sen
     "Sensor that measures V, I, and S"
     annotation (Placement(transformation(extent={{0,0},{20,20}})));
   AixLib.Electrical.AC.OnePhase.Loads.Capacitive loa(
   ...
   AixLib.Electrical.AC.OnePhase.Lines.TwoPortResistance res(R=0.05)
     "Line resistance"
 ...
 __Dymola_Commands(file=
           "modelica://AixLib/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Sensors/Examples/GeneralizedSensor.mos"
         "Simulate and plot"), 
