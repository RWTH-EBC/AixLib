within AixLib.Electrical.AC.OnePhase.Lines;
 ...
 protected
   replaceable TwoPortRL line(
     ...
     AixLib.Electrical.Transmission.BaseClasses.PartialTwoPortRLC(
       useHeatPort=true,
       M=M,
 ...
 AixLib.Electrical.AC.OnePhase.Lines.TwoPortRLC</a>
 ...
 <a href=\"modelica://AixLib.Electrical.AC.ThreePhasesBalanced.Lines.Line\">
 AixLib.Electrical.AC.ThreePhasesBalanced.Lines.Line</a>.
 </li>
 <li>
 November 8, 2016, by Michael Wetter:<br/>
 ...
 <span style=\" font-family:'Courier New,courier'; color:#ff0000;\"> AixLib.Electrical.Transmission.Functions.selectCable_low</span>
