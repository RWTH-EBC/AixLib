within AixLib.Electrical.AC.OnePhase.Loads;
model Capacitive "Model of a capacitive and resistive load"
  extends AixLib.Electrical.Interfaces.CapacitiveLoad(
...
<code>mode</code> and <code>use_pf_in</code>, see <a href=\"modelica://AixLib.Electrical.Interfaces.Load\">
AixLib.Electrical.Interfaces.Load</a> and
<a href=\"modelica://AixLib.Electrical.Interfaces.CapacitiveLoad\">
AixLib.Electrical.Interfaces.CapacitiveLoad</a> for more information.
</p>
