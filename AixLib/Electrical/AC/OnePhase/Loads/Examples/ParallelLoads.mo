...
model ParallelLoads
  ...
  AixLib.Electrical.AC.OnePhase.Loads.Inductive varRL(
    ...
    annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        origin={10,50})));
  AixLib.Electrical.AC.OnePhase.Sources.FixedVoltage source(f=60, V=120)
    "Voltage source"
  ...
  AixLib.Electrical.AC.OnePhase.Loads.Inductive RL(
    P_nominal=-1e3,
    linearized=false,
    V_nominal=120) "Constant inductor and resistor"
        ...
        extent={{-10,-10},{10,10}},
        origin={10,30})));
  AixLib.Electrical.AC.OnePhase.Loads.Capacitive varRC(mode=AixLib.Electrical.Types.Load.VariableZ_y_input,
      P_nominal=-1e3,
    linearized=false,
    V_nominal=120) "Variable conductor and resistor"        annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        origin={10,10})));
  AixLib.Electrical.AC.OnePhase.Loads.Capacitive RC(mode=AixLib.Electrical.Types.Load.FixedZ_steady_state,
      P_nominal=-1e3,
    linearized=false,
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://AixLib/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Loads/Examples/ParallelLoads.mos"
        "Simulate and plot"));
end ParallelLoads;
