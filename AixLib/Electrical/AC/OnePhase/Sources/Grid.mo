within AixLib.Electrical.AC.OnePhase.Sources;
model Grid "Electrical grid"

  replaceable AixLib.Electrical.AC.OnePhase.Interfaces.Terminal_p terminal
  ...
  AixLib.Electrical.AC.Interfaces.PowerOutput P
    "Power consumed from grid if positive, or fed to grid if negative"
    annotation (Placement(transformation(extent={{100,-10},{120,10}})));
  replaceable AixLib.Electrical.AC.OnePhase.Sources.FixedVoltage sou(
