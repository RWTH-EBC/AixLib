...
<p>Model for determining the cell temperature of a PV module mounted with the module backsite close to the ground, under operating conditions and under consideration of the wind velocity.</p>
<p><br/>
