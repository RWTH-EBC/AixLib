...
model PVModule5pNumerical
   "Numerical 5-p model for determining the I-V characteristics of a PV array after (DeSoto et al.,2006)"
...
// Other parameters and constants
 ...
 Modelica.SIunits.ElectricCurrent I_mp(start=I_mp0*0.5)
    "MPP current";

 Modelica.SIunits.Voltage V_mp(start=V_mp0*0.95)
    "MPP voltage";
 ...
 Modelica.SIunits.Power P_mod
  ...
  AixLib.Electrical.PVSystem.BaseClasses.PVModule5pNumericalPreCalc pVModule5pNumericalPreCalc(
  data = data)
  "Module that determines the main parameters under standard conditions";
...
<p>Numerical 5-p model for determining the I-V characteristics of a PV array (DeSoto et al.,2006).
...
<p><br/>  
<p>Approx. 0.3 percent more accurate than the analytical 5-p model, but exhibits initialization and convergence difficulties due to the iterative equations. Approx. 6 percent more accurate than the simple approach using the performance factor.</p>
<p><br/>   
