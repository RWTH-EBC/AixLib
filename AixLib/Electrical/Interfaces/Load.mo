...
model Load "Partial model for a generic load"
  ...
  parameter Modelica.Units.SI.Power P_nominal=0
    ...
    annotation (Dialog(group="Nominal conditions", enable=mode <> AixLib.Electrical.Types.Load.VariableZ_P_input));
  ...
  parameter Modelica.Units.SI.Voltage V_nominal(min=0, start=110)
    "Nominal voltage (V_nominal >= 0)" annotation (Evaluate=true, Dialog(group=
          "Nominal conditions", enable=(mode == AixLib.Electrical.Types.Load.FixedZ_dynamic
           or linearized)));
  parameter AixLib.Electrical.Types.InitMode initMode(
  min=AixLib.Electrical.Types.InitMode.zero_current,
  max=AixLib.Electrical.Types.InitMode.linearized) = AixLib.Electrical.Types.InitMode.linearized
...
<code>mode &lt;&gt; AixLib.Electrical.Types.Load.VariableZ_P_input</code>.
This avoids a warning during translation of
<a href=\"modelica://AixLib.Examples.ChillerPlant.DataCenterRenewables\">
AixLib.Examples.ChillerPlant.DataCenterRenewables</a>.
</li>
<li>
September 4, 2014, by Michael Wetter:<br/>
Changed the parameter from <code>linear</code> to <code>linearized</code>
because <code>AixLib.Fluid</code> also uses <code>linearized</code>.
...
AixLib.Electrical.Interfaces.Terminal</a>
...
<a href=\"modelica://AixLib.Electrical.Types.Load\">AixLib.Electrical.Types.Load</a>:
</p>
...
<!-- ************ -->
<tr>
<td>AixLib.Electrical.Types.Load.FixedZ_steady_state</td>
...
<!-- ************ -->
<tr>
<td>AixLib.Electrical.Types.Load.FixedZ_dynamic</td>
...
<!-- ************ -->
<tr>
<td>AixLib.Electrical.Types.Load.VariableZ_P_input</td>
...
<!-- ************ -->
<tr>
<td>AixLib.Electrical.Types.Load.VariableZ_y_input</td>
