...
equation
  ...
  connect(constantVoltage.terminal, RC_dyn.terminal_n) annotation (Line(
      ...
      smooth=Smooth.None));
  annotation (
    __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Electrical/DC/Lines/Examples/RCModel.mos"
        "Simulate and plot"),
...
two connectors (see <a href=\"modelica://AixLib.Electrical.DC.Lines.TwoPortRCLine\">
AixLib.Electrical.DC.Lines.TwoPortRCLine</a> for more details).
</p>
<p>
