within AixLib.Systems.HeatPumpSystems_old.BaseClasses;
partial model PartialHeatPumpSystem
  ...
  extends
    AixLib.Systems.HeatPumpSystems_old.BaseClasses.HeatPumpSystemParameters(
      cpCon=Medium_con.heatCapacity_cp(stateCon_default), cpEva=
        Medium_eva.heatCapacity_cp(stateEva_default));
