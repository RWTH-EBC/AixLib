...
model VentilationUnit "Example of the ventilation unit"
  ...
  Fluid.Sources.Boundary_pT SinkHeater(          redeclare package Medium =
        ...
        rotation=270,
        origin={42,-42})));
  AixLib.Systems.ModularAHU_old.VentilationUnit ventilationUnit(
    redeclare package Medium1 = Media.Air,
    redeclare package Medium2 = Media.Water,
    T_amb=293.15,
    m1_flow_nominal=1,
    m2_flow_nominal=1,
    cooler(redeclare AixLib.Systems.HydraulicModules_old.Admix
        ...
        dT_nom=10,
        Q_nom=10000)),
    heater(redeclare AixLib.Systems.HydraulicModules_old.Admix
        partialHydraulicModule(
        dIns=0.01,
        kIns=0.028,
        d=0.032,
