within AixLib.Systems.ModularAHU_old.Validation;
model AHU2_Cooler "Cooling register of ahu 2 in E.ON ERC testhall"
  ...
  AixLib.Systems.ModularAHU_old.Validation.MeasuredData.AHU2_Cooler_RampValve data
    "Measured data";
  ...
  RegisterModule registerModule(
    redeclare HydraulicModules_old.Admix hydraulicModule(
      tau=5,
      dIns=0.01,
      kIns=0.028,
      d=0.032,
      ...
      redeclare
        AixLib.Systems.HydraulicModules_old.BaseClasses.PumpInterface_PumpSpeedControlled
