...
model RegisterModule "AHU register module for heaters and coolers"
  ...
  replaceable
    AixLib.Systems.HydraulicModules_old.BaseClasses.PartialHydraulicModule
    hydraulicModule(
  ...
  AixLib.Fluid.HeatExchangers.DynamicHX dynamicHX(final m1_flow_nominal=
    ...
    annotation (Dialog(enable=true, group="Heat exchanger"), Placement(transformation(extent={{-20,28},
            {20,68}})));
  AixLib.Systems.ModularAHU_old.BaseClasses.RegisterBus registerBus annotation
    (Placement(transformation(extent={{-102,-12},{-78,10}}), iconTransformation(
          extent={{-112,-14},{-86,12}})));
