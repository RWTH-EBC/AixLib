...
equation
  for i in 1:n_consumers loop
    connect(distributor.flowPorts[i], simpleConsumer[i].port_a)
      annotation (Line(points={{-24,-24},{-46,-24},{-46,40},{-6,40}},  color={0,
            127,255}));
    connect(distributor.returnPorts[i], simpleConsumer[i].port_b)
      annotation (Line(points={{24.8,-24},{40,-24},{40,40},{14,40}}, color={0,
            127,255}));
  end for;
  connect(port_a, distributor.mainFlow) annotation (Line(points={{-100,0},{-60,
          0},{-60,-68},{-12.8,-68},{-12.8,-48}},
                                              color={0,127,255}));
  connect(distributor.mainReturn, port_b) annotation (Line(points={{12,-48},{12,
