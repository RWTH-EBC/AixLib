...
package MediumCon = AixLib.Media.Water "Medium heat sink";
 ...
 AixLib.Fluid.HeatPumps.HeatPump heatPump(
  ...
  Modelica.Blocks.Sources.BooleanExpression mode(y=true)
    annotation (Placement(transformation(extent={{84,88},{48,114}})));
...
equation
  ...
  connect(mode.y, sigBus.modeSet) annotation (Line(points={{46.2,101},{34,101},
          {34,102},{18,102},{18,101.085},{1.075,101.085}},
  ...
  connect(sigBus, heatSource.sigBus) annotation (Line(
      points={{1,101},{1,30},{60,30},{60,-35.7},{0.1,-35.7}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
