...
model ModularBoilerConsumerTest
...
equation
  ...
  connect(modularBoiler_simple.port_b, modularConsumer.port_a)
    annotation (Line(points={{26,0},{68,0}}, color={0,127,255}));
  connect(modularConsumer.port_b, modularBoiler_simple.port_a) annotation (Line(
