...
equation
  connect(bou.ports[1],
    ...
    annotation (Line(points={{-64,-13.6},{-40,-13.6},{-40,0},{-32,0}},
                                                                 color={0,127,255}));
  ...
  connect(modularBoiler_HierarchicalRegulation_wPump_wFeedback_wAdmix_.ports_b,
    ...
    annotation (Line(points={{32,0},{62,0}}, color={0,127,255}));
  ...
  connect(TCon1.y, modularBoiler_HierarchicalRegulation_wPump_wFeedback_wAdmix_.TCon[
    1]) annotation (Line(points={{-69,56},{-44,56},{-44,10},{-38,10},{-38,10.2},
          {-32,10.2}}, color={0,0,127}));
  connect(TCon2.y, modularBoiler_HierarchicalRegulation_wPump_wFeedback_wAdmix_.TCon[
    2]) annotation (Line(points={{-69,22},{-52,22},{-52,12},{-32,12},{-32,13.8}},
        color={0,0,127}));
  connect(TCon1.y, modularConsumer_multiport.T_Flow[1]) annotation (Line(points
        ={{-69,56},{-44,56},{-44,-32},{50,-32},{50,-7},{62,-7}}, color={0,0,127}));
  connect(TCon2.y, modularConsumer_multiport.T_Flow[2]) annotation (Line(points
        ={{-69,22},{-52,22},{-52,-32},{50,-32},{50,-5},{62,-5}}, color={0,0,127}));
  connect(TCon3.y, modularConsumer_multiport.T_Return[1]) annotation (Line(
        points={{9,-76},{58,-76},{58,-10},{62,-10}}, color={0,0,127}));
  connect(TCon3.y, modularConsumer_multiport.T_Return[2]) annotation (Line(
        points={{9,-76},{58,-76},{58,-8},{62,-8}}, color={0,0,127}));
annotation (
    experiment(
      StopTime=3600,
      Interval=60,
