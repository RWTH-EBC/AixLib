...
model ModularBoiler_wPump_wFeedback
  ...
  Modelica.Blocks.Sources.Constant
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        ...
        origin={-70,46})));
equation
  connect(bou.ports[1], modularBoiler_wPump_wFeedback.port_a) annotation (Line(
        points={{-72,2.4},{-50,2.4},{-50,-1},{-30,-1}}, color={0,127,255}));
  ...
  connect(const2.y, boilerControlBus.DeltaTWater) annotation (Line(points={{-59,
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(modularBoiler_wPump_wFeedback.port_b, bou.ports[2]) annotation (Line(
        points={{32,-1},{68,-1},{68,-72},{-54,-72},{-54,-2.4},{-72,-2.4}},
        color={0,127,255}));
