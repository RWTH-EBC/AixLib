...
equation
  ...
  connect(control_wPump.TCold, senTCold.T)
    annotation (Line(points={{-28,57.1429},{-60,57.1429},{-60,11}},
                                   color={0,0,127}));
  connect(heatGeneratorNoControl.TVolume, control_wPump.THot_Boiler)
    annotation (Line(points={{0,-11},{0,-20},{-50,-20},{-50,52.5714},{-28,
          52.5714}},
        color={0,0,127}));
  connect(senTHot.T, control_wPump.THot)
    annotation (Line(points={{60,11},{60,20},
          {-40,20},{-40,48},{-28,48}}, color={0,0,127}));
  connect(control_wPump.y, fan.y)
    annotation (Line(points={{-11.8,48},{-12,48},{
