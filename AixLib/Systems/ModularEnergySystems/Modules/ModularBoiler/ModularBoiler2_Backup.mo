...
equation
  ...
  connect(boilerControlBus.PLR, heatGeneratorNoControl.Qrel) annotation (Line(
      points={{0,100},{0,28},{-12,28},{-12,5.4}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(conPID2.u_s, dTWaterNom3.y)
    annotation (Line(points={{-184,-44},{-192,-44},{-192,-50},{-200,-50},{-200,
          -51},{-207.1,-51}},                          color={0,0,127}));
