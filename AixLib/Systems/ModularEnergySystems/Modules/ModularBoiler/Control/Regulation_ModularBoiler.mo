...
equation
  ...
  connect(lessThreshold.y,switch2. u2) annotation (Line(points={{-45.3,43},{
          -36.65,43},{-36.65,40},{-29.6,40}},
                                          color={255,0,255}));
  connect(PLRin,lessThreshold. u) annotation (Line(points={{-100,20},{-70,20},{
          -70,43},{-61.4,43}},
                             color={0,0,127}));
  connect(PLRin,switch2. u3) annotation (Line(points={{-100,20},{-36,20},{-36,
          33.6},{-29.6,33.6}},
                          color={0,0,127}));
  ...
  connect(PLRMea, lessThreshold1.u) annotation (Line(points={{-100,-60},{-45.6,
          -60}},                  color={0,0,127}));
  connect(lessThreshold1.y, switch1.u2) annotation (Line(points={{-27.2,-60},{
