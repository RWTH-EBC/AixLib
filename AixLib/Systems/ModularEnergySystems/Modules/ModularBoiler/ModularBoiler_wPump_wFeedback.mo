...
model ModularBoiler_wPump_wFeedback
  extends BaseClasses.Boiler_base(redeclare package
      Medium = Medium);

 replaceable package Medium = AixLib.Media.Water;

  Control.Control_wPump_wFeedback
...
equation
  connect(control_wPump_wFeedback.TCold, senTCold.T) annotation (Line(points={{-28,
          57.1429},{-60,57.1429},{-60,11}}, color={0,0,127}));
  connect(heatGeneratorNoControl.TVolume, control_wPump_wFeedback.THot_Boiler)
    annotation (Line(points={{2,-11},{2,-20},{-50,-20},{-50,52.5714},{-28,
          52.5714}},
        color={0,0,127}));
  connect(senTHot.T, control_wPump_wFeedback.THot) annotation (Line(points={{60,
          11},{60,20},{-42,20},{-42,48},{-28,48}}, color={0,0,127}));
  connect(control_wPump_wFeedback.y, fan.y) annotation (Line(points={{-11.8,48},
          {-12,48},{-12,38},{-36,38},{-36,12}}, color={0,0,127}));
  connect(control_wPump_wFeedback.PLR, heatGeneratorNoControl.PLR) annotation (
      Line(points={{-6.4,48},{-6.4,34},{-20,34},{-20,5.4},{-10,5.4}}, color={0,0,
          127}));
  connect(control_wPump_wFeedback.dTWater, heatGeneratorNoControl.dTWater)
    annotation (Line(points={{-1,48},{-1,28},{-16,28},{-16,9},{-10,9}}, color={0,
          0,127}));
  ...
  connect(boilerControlBus.PLR, control_wPump_wFeedback.PLR_in) annotation (
      Line(
  ...
  connect(control_wPump_wFeedback.y_valve, val.y) annotation (Line(points={{-17.2,
