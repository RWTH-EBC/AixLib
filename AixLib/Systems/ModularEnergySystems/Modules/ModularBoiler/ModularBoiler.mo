...
equation
  ...
  connect(controlBoilerNotManufacturer.DeltaTWater_b, heatGeneratorNoControl.dTWater)
    annotation (Line(points={{-63,37.2},{-10,37.2},{-10,9}},
                   color={0,0,127}));
  ...
  connect(senTCold.T, controlBoilerNotManufacturer.TCold) annotation (Line(
        points={{-80,11},{-80,30},{-92,30},{-92,42.6667},{-86,42.6667}},
                                                                  color={0,0,127}));
  connect(heatGeneratorNoControl.TVolume, controlBoilerNotManufacturer.THot)
    annotation (Line(points={{2,-11},{2,-16},{-66,-16},{-66,30},{-80,30},{-80,
          32},{-90,32},{-90,40.6667},{-86,40.6667}},
        color={0,0,127}));
  connect(boilerControlBus.DeltaTWater, controlBoilerNotManufacturer.DeltaTWater_a)
    annotation (Line(
      points={{-1.95,100.05},{-1.95,74},{-96,74},{-96,38.6667},{-86,38.6667}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(controlBoilerNotManufacturer.plr_b, heatGeneratorNoControl.PLR)
    annotation (Line(points={{-63,49.4667},{-16,49.4667},{-16,5.4},{-10,5.4}},
        color={0,0,127}));
