...
model ModularBoilerSingle
  ...
  // System Parameters
  parameter Boolean hasFeedback=false "circuit has Feedback"     annotation (choices(checkBox=true), Dialog(descriptionLabel=true, group="System setup"));
