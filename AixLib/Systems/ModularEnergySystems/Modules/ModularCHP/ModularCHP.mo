...
//   end if;
  ...
  connect(cHPControlBus.PLR, switch4.u3) annotation (Line(
      points={{0,102},{2,102},{2,88},{-54,88},{-54,59.8},{-29.8,59.8}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(cHPControlBus.PLR, pLRMin.u) annotation (Line(
      points={{0,102},{0,92},{-104,92},{-104,68},{-94,68}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(tHotCoolingWaterMax.y, greater.u2)
  ...
  connect(integrator1.y, cHPControlBus.ElectricEnergy) annotation (Line(points={{57,38},
          {80,38},{80,102},{0,102}},                color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(cHPNotManufacturer.THotEngine, cHPControlBus.TVolume) annotation (
      Line(points={{0,-11},{0,-28},{124,-28},{124,102},{0,102}},
        color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
