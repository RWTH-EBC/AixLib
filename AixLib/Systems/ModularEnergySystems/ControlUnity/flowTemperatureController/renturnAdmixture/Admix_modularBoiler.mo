...
model Admix_modularBoiler
  ...
  extends
    ControlUnity.flowTemperatureController.renturnAdmixture.PartialHydraulicModule_modularBoiler;
  ...
  AixLib.Fluid.FixedResistances.GenericPipe pipe1(
    ...
    final massDynamics=massDynamics) annotation (Dialog(enable=true, group="Pipes"),
      Placement(transformation(extent={{-78,28},{-62,12}})));
  AixLib.Fluid.FixedResistances.GenericPipe pipe2(
    ...
    final energyDynamics=energyDynamics,
    final massDynamics=massDynamics) annotation (Dialog(enable=true, group="Pipes"),
      Placement(transformation(extent={{-8,28},{8,12}})));
  AixLib.Fluid.FixedResistances.GenericPipe pipe3(
    ...
    final energyDynamics=energyDynamics,
    final massDynamics=massDynamics) annotation (Dialog(enable=true, group="Pipes"),
      Placement(transformation(extent={{60,28},{76,12}})));
  ...
  AixLib.Fluid.FixedResistances.GenericPipe pipe6(
    ...
    final massDynamics=massDynamics) annotation (Dialog(enable=true, group="Pipes"),
      Placement(transformation(
        ...
        rotation=90,
        origin={-30,-20})));
  AixLib.Fluid.MixingVolumes.MixingVolume junc456(
    redeclare package Medium = Medium,
    final massDynamics=massDynamics,
    T_start=T_start,
    nPorts=3,
  ...
  replaceable AixLib.Systems.HydraulicModules.BaseClasses.BasicPumpInterface PumpInterface(
    redeclare package Medium = Medium,
    final allowFlowReversal=allowFlowReversal,
    final m_flow_nominal=m_flow_nominal,
    T_start=T_start,
