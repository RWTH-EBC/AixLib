...
if PLRset >0 then
  ...
  connect(heatingCurve.TSet, PID.u_s)
    annotation (Line(points={{-47,0},{-26,0}}, color={0,0,127}));
  connect(TMea, PID.u_m) annotation (Line(points={{-12,-100},{-12,-12},{-14,-12}},
                                                                         color={0,0,127}));
  connect(PID.y, switch1.u1) annotation (Line(points={{-3,0},{36,0}}, color={0,0,127}));
