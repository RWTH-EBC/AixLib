...
model ModularBufferStorage
  ...
  parameter AixLib.DataBase.Storage.BufferStorageBaseDataDefinition data=
      ...
      dTank=dTank)                                "Data record for Storage" annotation(Dialog(enable= not advancedVolume, group="Control"));
...
<p>Model including <a href=\"AixLib.Fluid.Storage.BufferStorage\">BufferStorage</a> model and the needed ports. </p>
</html>"));
