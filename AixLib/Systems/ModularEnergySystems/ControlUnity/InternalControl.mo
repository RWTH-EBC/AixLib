...
model InternalControl "This model contains the internal controller"
 ...
 replaceable model TwoPositionController_top =
  ...
  parameter Integer k=k "Number of heat curcuits";
  parameter Modelica.SIunits.Temperature TBoiler=TBoiler
...
<p>Model that inclued the three different types of controller:</p>
<ul>
<li>two position control with and without buffer storage</li>
<li>flow temperature control with heat curve</li>
<li>flow temperature control with return admxiture</li>
</ul>
</html>"));
end InternalControl;
