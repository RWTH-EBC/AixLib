...
<p>Tester model for the modular CHP using a two position controller.</p>
</html>"));
  ...
  equation
    ...
    annotation (
      ...
      experiment(StopTime=5000),
      Documentation(info="<html>
<p>Tester model the modular CHP using a flow temperature control with heat curve.</p>
</html>"));
  ...
  equation
    ...
    connect(modularBufferStorage.TLayer, modularCHP.TLayers) annotation (Line(
          points={{5,-23},{-2,-23},{-2,12},{-15.9,12},{-15.9,7.1}}, color={0,0,
            127}));
    connect(internControl.y, cHPControlBus.internControl) annotation (Line(
          points={{-81,42},{-65.9,42},{-65.9,14.1}}, color={255,0,255}), Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    annotation (
      ...
      experiment(StopTime=5000),
      Documentation(info="<html>
<p>Tester model for the modular CHP using a two postion controller with buffer storage.</p>
</html>"));
