...
model hierarchicalControl_modularBoiler
 ...
 replaceable
    ControlUnity.twoPositionController.BaseClass.twoPositionControllerCal.TwoPositionController_layers
    twoPositionController_layers(
    n=n,
    layerCal=layerCal,
    TLayer_dif=TLayer_dif,
    Tlayerref=Tlayerref,
    bandwidth=bandwidth) if not use_advancedControl constrainedby
    ControlUnity.twoPositionController.BaseClass.partialTwoPositionController
    annotation (
    Placement(transformation(extent={{24,44},{44,64}})),
    choicesAllMatching=true,
    Dialog(enable=not use_advancedControl));
  Modelica.Blocks.Interfaces.RealInput TLayers[n] if not use_advancedControl
    ...
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={6,100})));
  ControlUnity.emergencySwitch_modularBoiler emergencySwitch_modularBoiler1 if not
    use_advancedControl
  ...
  ControlUnity.flowTemperatureController.flowTemperatureControl_heatingCurve flowTemperatureControl_heatingCurve if
    use_advancedControl
 ...
 ControlUnity.emergencySwitch_modularBoiler emergencySwitch_modularBoiler2 if
    use_advancedControl
...
connect(TMeaRet, flowTemperatureControl_heatingCurve.TMea) annotation (Line(
        points={{-10,-108},{-10,-76},{-11.2,-76}},color={0,0,127}));
    connect(Tin, emergencySwitch_modularBoiler2.TBoiler) annotation (Line(
          points={{-102,72},{-76,72},{-76,14},{-16,14},{-16,-32.2},{18,-32.2}},
          color={0,0,127}));
 ...
 connect(PLRin, emergencySwitch_modularBoiler1.PLR_ein) annotation (Line(
    ...
    connect(Tin, emergencySwitch_modularBoiler1.TBoiler) annotation (Line(
          points={{-102,72},{-30,72},{-30,49.8},{-18,49.8}}, color={0,0,127}));
