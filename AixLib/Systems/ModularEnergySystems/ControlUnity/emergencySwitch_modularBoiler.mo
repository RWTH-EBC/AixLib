...
<p>Emergency stop switch, that switches off the heat generator when a maximum temperatur is reached. This safety-related system stands above all other control units of the heat generator. </p>
<p>Important parameters </p>
<ul>
<li>TMax: Maximum temperature at which the heat generator is switched off if exceeded</li>
</ul>
</html>"));
