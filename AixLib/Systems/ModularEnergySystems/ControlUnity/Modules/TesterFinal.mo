...
package TesterFinal
  ...
  equation
    ...
    connect(realExpression.y, modularBoiler_AdmixNEW.TCon[1]) annotation (Line(points={{-32,
            46.4},{-32,40},{-24.8,40},{-24.8,38}},
                                            color={0,0,127}));
    ...
    connect(PLR.y, boilerControlBus.PLR) annotation (Line(points={{-103,48},{-86,48},{-86,44.05},{-67.95,
            44.05}}, color={0,0,127}), Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(isOn.y, boilerControlBus.isOn) annotation (Line(points={{-99.4,31},{-67.95,31},{-67.95,
            44.05}}, color={255,0,255}), Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(PLR1.y, boilerControlBus.PLREx) annotation (Line(points={{-95.4,62},{-82,
            62},{-82,60},{-67.95,60},{-67.95,44.05}},      color={0,0,127}),
        Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
    ...
    connect(vol1.ports[1], modularBoiler_AdmixNEW.port_a) annotation (Line(
          points={{-66.8667,-70},{-58,-70},{-58,-66},{-38,-66},{-38,28},{-34,28}},
          color={0,127,255}));
    connect(boundary_ph5.ports[1], vol.ports[3]) annotation (Line(points={{-64,12},
            {-2,12},{-2,22},{64.6667,22}}, color={0,127,255}));
    connect(modularBoiler_AdmixNEW.ports_b[2], vol1.ports[2]) annotation (Line(
          points={{-14,28},{-14,-70},{-65,-70}},      color={0,127,255}));
  ...
  model BoilerTesterTwoPositionController
    ...
    ModularBoilerTry                    modularBoilerTry(
      TColdNom=333.15,
      QNom=100000,
      simpleTwoPosition=true,
  ...
  equation
    ...
    connect(boilerControlBus, modularBoilerTry.boilerControlBus) annotation (
        Line(
    ...
    connect(PLR.y, boilerControlBus.PLR) annotation (Line(points={{-91.4,36},{-82,
        ...
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(vol.ports[2], modularBoilerTry.port_b) annotation (Line(points={{64,
            22},{26,22},{26,24},{-12,24}}, color={0,127,255}));
    connect(pipe.port_b, modularBoilerTry.port_a) annotation (Line(points={{38,
            -16},{30,-16},{30,6},{-42,6},{-42,24},{-32,24}}, color={0,127,255}));
    connect(bou.ports[1], modularBoilerTry.port_a) annotation (Line(points={{16,
            -22},{18,-22},{18,0},{-32,0},{-32,24}}, color={0,127,255}));
    ...
    connect(PLR1.y, boilerControlBus.PLREx) annotation (Line(points={{-87.4,26},
        ...
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(booleanExpression.y, boilerControlBus.internControl) annotation (
        Line(points={{-87,58},{-71.95,58},{-71.95,36.05}}, color={255,0,255}),
        Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(realExpression.y, boilerControlBus.DeltaTWater) annotation (Line(
          points={{-27,52},{-20,52},{-20,36.05},{-71.95,36.05}}, color={0,0,127}),
        Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
  ...
  model BoilerTesterAdmixtureNEW1
    "Test model for the controller model of the boiler"
  ...
  package Medium = AixLib.Media.Water
    ...
    ModularBoiler_Admix                       modularBoiler_AdmixNEW(
      ...
      TBoiler=348.15,
      severalHeatcurcuits=true,
      m_flow_nominalCon={0.7},
      dp_nominalCon(displayUnit="kPa") = {5000000},
      QNomCon={10000},
      TVar=false)
      annotation (Placement(transformation(extent={{-34,18},{-14,38}})));
    parameter Integer n=2 "Number of layers in the buffer storage";
  ...
  equation
    ...
    annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
          coordinateSystem(preserveAspectRatio=false)));
  end BoilerTesterAdmixtureNEW1;

  model BoilerTesterAdmixtureOutside
    "Test model for the controller model of the boiler"
    ...
    flowTemperatureController.renturnAdmixture.Admixture admixture(
      ...
      dp_nominalCon(displayUnit="kPa") = 10000,
      QNomCon=10000)
      annotation (Placement(transformation(extent={{-38,-48},{-18,-28}})));
    Modelica.Blocks.Sources.RealExpression realExpression(y=273.15 + 67)
  ...
  equation
    ...
    connect(realExpression.y, modularBoiler_Controller.TCon[1]) annotation (
        Line(points={{-29,52},{-22.8,52},{-22.8,34}}, color={0,0,127}));
    connect(admixtureBus, admixture.admixtureBus) annotation (Line(
        points={{-78,-24},{-52,-24},{-52,-14},{-28,-14},{-28,-28.5}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-3,6},{-3,6}},
        horizontalAlignment=TextAlignment.Right));
    connect(admixtureBus.Tsen_b1, modularBoiler_Controller.TMeaCon[1])
      annotation (Line(
        points={{-77.95,-23.95},{-80,-23.95},{-80,-8},{-6,-8},{-6,27.4},{-12,
            27.4}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        ...
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(modularBoiler_Controller.valPos[1], admixtureBus.valveSet)
      annotation (Line(points={{-12,30.8},{4,30.8},{4,-4},{-77.95,-4},{-77.95,
            -23.95}}, color={0,0,127}), Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(modularBoiler_Controller.port_b, admixture.port_a1) annotation (
        Line(points={{-12,24},{-6,24},{-6,-20},{-54,-20},{-54,-32},{-38,-32}},
          color={0,127,255}));
    connect(pipe.port_b, admixture.port_a2) annotation (Line(points={{38,-16},{
            28,-16},{28,-44},{-18,-44}}, color={0,127,255}));
    connect(admixture.port_b2, modularBoiler_Controller.port_a) annotation (
        Line(points={{-38,-44},{-52,-44},{-52,-42},{-54,-42},{-54,24},{-32,24}},
          color={0,127,255}));
    connect(admixture.port_b1, vol.ports[2]) annotation (Line(points={{-18,-32},
            {-10,-32},{-10,-34},{26,-34},{26,22},{64,22}}, color={0,127,255}));
    annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
          coordinateSystem(preserveAspectRatio=false)));
  end BoilerTesterAdmixtureOutside;

  model BoilerTesterAdmixtureNEWNoArray
    "Test model for the controller model of the boiler"
  ...
  package Medium = AixLib.Media.Water
    ...
    ModularBoiler_AdmixNoArray                modularBoiler_AdmixNoArray(
      nPorts=1,
      TColdNom=333.15,
      QNom=100000,
      n=1,
  ...
  equation
    ...
    connect(vol.heatPort,temperatureSensor. port)
      annotation (Line(points={{52,32},{52,2},{66,2}},     color={191,0,0}));
    connect(realExpression.y, modularBoiler_AdmixNoArray.TCon[1]) annotation (
        Line(points={{-32,46.4},{-32,40},{-24.8,40},{-24.8,38}}, color={0,0,127}));
    connect(modularBoiler_AdmixNoArray.ports_b[1], vol.ports[1]) annotation (
        Line(points={{-14,28},{24,28},{24,22},{59.3333,22}}, color={0,127,255}));
    connect(boilerControlBus, modularBoiler_AdmixNoArray.boilerControlBus)
      annotation (Line(
        points={{-68,44},{-50,44},{-50,37.8},{-30.4,37.8}},
        color={255,204,51},
        thickness=0.5), Text(
    ...
    connect(internControl.y, boilerControlBus.internControl) annotation (Line(
        ...
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(vol.ports[2], modularBoiler_AdmixNoArray.port_a) annotation (Line(
          points={{62,22},{60,22},{60,-16},{-34,-16},{-34,28}}, color={0,127,
            255}));
    connect(boundary_ph5.ports[1], vol.ports[3]) annotation (Line(points={{-64,12},
            {-2,12},{-2,22},{64.6667,22}}, color={0,127,255}));
    annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
          coordinateSystem(preserveAspectRatio=false)));
  end BoilerTesterAdmixtureNEWNoArray;
end TesterFinal;
