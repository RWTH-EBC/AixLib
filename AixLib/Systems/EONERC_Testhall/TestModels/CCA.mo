...
equation
  ...
  connect(controlCCA.distributeBus_CCA,cCA.ccaBus)  annotation (Line(
      points={{-99.8,-17.07},{-99.8,-16.4},{-82.22,-16.4}},
      color={255,204,51},
      thickness=0.5));
  connect(cCA.heat_port_CCA, eON_ERC_Testhall.intGainsConv_port) annotation (
      Line(points={{-71,-5.6},{-71,-0.5},{-17.68,-0.5}}, color={191,0,0}));
  connect(bound_sup.ports[1], cCA.port_a) annotation (Line(points={{-80,-50},{-74.74,
          -50},{-74.74,-26}}, color={0,127,255}));
  connect(bound_ret.ports[1], cCA.port_b) annotation (Line(points={{-64,-50},{-66.6,
          -50},{-66.6,-26}}, color={0,127,255}));
