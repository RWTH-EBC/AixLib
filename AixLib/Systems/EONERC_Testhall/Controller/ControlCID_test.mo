...
model ControlCID_test
  ...
  Modelica.Blocks.Sources.BooleanExpression booleanExpression1(y=true)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-90,-44})));
  Modelica.Blocks.Sources.Constant AirValveSet(k=1) annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={30,-50})));
equation
  ...
  connect(criticalDamping.y, distributeBus_CID.bus_cid.valveSet) annotation (
      Line(points={{5,24},{-22,24},{-22,-14.895},{-93.9,-14.895}}, color={0,0,
          127}));
  connect(AirValveSet.y, distributeBus_CID.control_cid.Office1_Air_Valve)
