...
package CPH
  model ControlCPH
    ...
    Subsystems.BaseClasses.Interfaces.HallHydraulicBus distributeBus_CPH
    ...
    Modelica.Blocks.Sources.Constant ThrottSet(k=0.665) annotation (Placement(
          ...
          rotation=0,
          origin={20,-60})));
    Subsystems.BaseClasses.Controls.HeatCurve heatCurve(x=-1.481, b=60)
  ...
  equation
    ...
    connect(heatCurve.T_sup, PID_Valve.u_s)
      annotation (Line(points={{59.9,64.1},{52,64.1},{52,68},{42,68}},
                                                   color={0,0,127}));
    connect(T_amb,heatCurve. T_amb)
      annotation (Line(points={{110,64},{98,64},{98,64},{84,64}},
                                                  color={0,0,127}));
    connect(heatCurve.T_sup, distributeBus_CPH.bus_cph_throttle.T_sup_set)
      annotation (Line(points={{59.9,64.1},{50,64.1},{50,-14.895},{-93.9,
            -14.895}},
          color={0,0,127}));
