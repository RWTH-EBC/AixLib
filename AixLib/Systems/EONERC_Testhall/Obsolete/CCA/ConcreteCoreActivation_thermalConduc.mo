within AixLib.Systems.EONERC_Testhall.Obsolete.CCA;
model ConcreteCoreActivation_thermalConduc
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heatCapacitor(C=C/
        nNodes, T(start=288.15)) annotation (Placement(
        transformation(
        extent={{-8,-8},{8,8}},
        rotation=270,
        origin={32,38})));
...
end ConcreteCoreActivation_thermalConduc;
