...
model ControlCPH
  .Testhall.BaseClass.DistributeBus distributeBus_CPH annotation (Placement(
...
equation
  ...
  connect(PID_cph_m_flow.u_m, distributeBus_CPH.bus_cph.m_flow) annotation (
      Line(points={{-38,52},{-38,-14.895},{-93.9,-14.895}},
                                                         color={0,0,127}));
