...
model Ashrae140Testcase900SP_flexquant_summer
...
equation
  ...
  connect(coolEnergyCalc.vFlow1, Bus.ahuBus.coolerBus.hydraulicBus.VFlowOutMea)
    annotation (Line(points={{65,71},{8,71},{8,40.05},{8.05,40.05}}, color={0,0,
          127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
...
end Ashrae140Testcase900SP_flexquant_summer;
