...
model Ashrae140_ideal_heaterTest
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(table=[0.0,0.0; 21600,
    ...
    annotation (Placement(transformation(extent={{148,-164},{128,-144}})));
equation
  ...
  connect(combiTimeTable.y[1], prescribedHeatFlow.Q_flow) annotation (Line(
        points={{127,-154},{127,-156},{118,-156}}, color={0,0,127}));
...
end Ashrae140_ideal_heaterTest;
