...
model Ashrae140Testcase900SP_flexquant_winter
...
equation
  ...
  connect(coolEnergyCalc.vFlow1, Bus.ahuBus.coolerBus.hydraulicBus.VFlowOutMea)
    annotation (Line(points={{65,71},{98,71},{98,26},{42,26},{42,40.05},{8.05,
  ...
  connect(hotEnergyCalc.vFlow1, Bus.ahuBus.heaterBus.hydraulicBus.VFlowOutMea)
    annotation (Line(points={{65,101},{65,60},{8.05,60},{8.05,40.05}}, color={0,
          0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
...
end Ashrae140Testcase900SP_flexquant_winter;
