...
model Ashrae140_ideal_heater_changeTcapa
  ...
  Modelica.Blocks.Sources.RealExpression realExpression16(y=CapaRC.thermCapExt[
        1].T)
  ...
  Modelica.Blocks.Interfaces.RealOutput T_Capacity "Value of Real output"
    annotation (Placement(transformation(extent={{258,-72},{278,-52}}),
        iconTransformation(extent={{284,-178},{304,-158}})));
  Modelica.Blocks.Sources.RealExpression realExpression17(y=CapaRC.port_a.Q_flow)
  ...
  Modelica.Blocks.Interfaces.RealOutput Qflow_capacitor "Value of Real output"
    annotation (Placement(transformation(extent={{160,-42},{180,-22}}),
        iconTransformation(extent={{270,-46},{290,-26}})));
  ThermalZones.ReducedOrder.RC.BaseClasses.ExteriorWall CapaRC(
    n=1,
    RExt={0},
    RExtRem=0,
    CExt={10000},
    T_start(displayUnit="K") = 290.65)
    annotation (Placement(transformation(extent={{48,-144},{68,-122}})));
equation
  ...
  connect(prescribedHeatFlow.port, CapaRC.port_b) annotation (Line(points={{98,
          -156},{74,-156},{74,-134},{68,-134}}, color={191,0,0}));
  connect(CapaRC.port_a, convection.solid) annotation (Line(points={{48,-134},{
          42,-134},{42,-112},{72,-112},{72,-106}}, color={191,0,0}));
...
end Ashrae140_ideal_heater_changeTcapa;
