...
model Ashrae140Testcase900SP_flexquant_test
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains1(
    ...
    "Table with profiles for internal gains 2018"
...
equation
  ...
  connect(internalGains1.y, thermalZone1.intGains) annotation (Line(points={{60,
  ...
  connect(QTabs_set1.y, ctrTabsQflow.QFlowSet_h)
    annotation (Line(points={{-161.3,2},{-110,2},{-110,-17.9},{-58.3,-17.9}}, color={0,0,127}));
  ...
  connect(coolEnergyCalc.vFlow1, Bus.ahuBus.coolerBus.hydraulicBus.VFlowOutMea)
    annotation (Line(points={{65,71},{8,71},{8,72},{6,72},{6,42},{8,42},{8,
          40.05},{8.05,40.05}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  ...
  connect(hotEnergyCalc.vFlow1, Bus.ahuBus.heaterBus.hydraulicBus.VFlowOutMea)
    annotation (Line(points={{65,101},{65,72},{8.05,72},{8.05,40.05}}, color={0,
          0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
