...
model Ashrae140Testcase900SPTest
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains3(
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    columns={2,3,4},
    tableOnFile=false,
    ...
    "Table with profiles for internal gains (old version, add 259200 to shift time)"
    annotation(Placement(transformation(extent={{-7,-7},{7,7}},
        rotation=0,
        origin={-65,-140})));
...
equation
  ...
  connect(step2.y, ctrTabsQflow.QFlowSet) annotation (Line(points={{-139,20},{
          -100,20},{-100,-17.9},{-58.3,-17.9}}, color={0,0,127}));
