...
model GeothermalFieldSimpleFlowControl
  ...
  Modelica.Blocks.Interfaces.RealInput mflow_gtf
    "Connector of setpoint input signal" annotation (Placement(transformation(
          extent={{-112,-28},{-94,-10}}), iconTransformation(extent={{-112,-28},
            {-94,-10}})));
...
equation
  ...
  connect(ctrGTFSimpleFlowCtrl.mflow_gtf, mflow_gtf) annotation (Line(points={{
          -64.3,-19.9},{-82.15,-19.9},{-82.15,-19},{-103,-19}}, color={0,0,127}));
