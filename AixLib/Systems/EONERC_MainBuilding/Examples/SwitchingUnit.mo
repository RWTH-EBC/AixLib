...
equation
  ...
  connect(switchingUnit.port_a3, vol.ports[1]) annotation (Line(points={{-12,
          -46},{-8,-46},{-8,-64},{2,-64}}, color={0,127,255}));
  connect(vol.ports[2], switchingUnit.port_b3) annotation (Line(points={{-2,-64},
