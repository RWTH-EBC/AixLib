...
model EONERC_Thermal_Zone "Test of ERC Thermal Zone"
  ...
  ThermalZones.ReducedOrder.ThermalZone.ThermalZone thermalZone1(
    ...
    annotation (Placement(transformation(extent={{150,-58},{206,0}})));
  ...
  ModularAHU.GenericAHU                genericAHU(
    ...
    humidifierRet(
      ...
      TLiqWat_in=288.15))
    annotation (Placement(transformation(extent={{-58,-104},{62,-38}})));
  ...
  BoundaryConditions.WeatherData.Bus        weaBus
    "Weather data bus"
    annotation (Placement(transformation(extent={{82,-20},{116,12}}),
    iconTransformation(extent={{-10,86},{10,106}})));
  BaseClasses.MainBus2ZoneMainBuilding                     mainBus annotation (
      Placement(transformation(extent={{-22,66},{24,124}}),
...
equation
  connect(weaDat.weaBus,thermalZone1. weaBus) annotation (Line(
      points={{56,26},{150,26},{150,-11.6}},
      color={255,204,51},
      thickness=0.5));
  connect(weaDat.weaBus,weaBus)  annotation (Line(
      points={{56,26},{99,26},{99,-4}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
  ...
  connect(boundaryOutsideAir.T_in,weaBus. TDryBul) annotation (Line(points={{-114,
          -108},{-180,-108},{-180,-4},{99,-4}},      color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(thermalZone1.TAir,mainBus. TRoom1Mea) annotation (Line(points={{208.8,
          -5.8},{208,-5.8},{208,95.145},{1.115,95.145}},       color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(boundaryOutsideAir.T_in,x_pTphi. T) annotation (Line(points={{-114,
          -108},{-156,-108},{-156,-84},{-146,-84}},                     color={
          0,0,127}));
  connect(x_pTphi.phi,weaBus. relHum) annotation (Line(points={{-146,-90},{-180,
          -90},{-180,-4},{99,-4}},                         color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(x_pTphi.p_in,weaBus. pAtm) annotation (Line(points={{-146,-78},{-180,
          -78},{-180,-4},{99,-4}},                         color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(x_pTphi.X,boundaryOutsideAir. X_in) annotation (Line(points={{-123,
          -84},{-120,-84},{-120,-100},{-114,-100}},
                                                  color={0,0,127}));
  connect(genericAHU.port_b1,thermalZone1. ports[1]) annotation (Line(points={{62.5455,
          -74},{182,-74},{182,-49.88},{171.42,-49.88}},         color={0,127,
          255}));
  connect(genericAHU.port_a2,thermalZone1. ports[2]) annotation (Line(points={{62.5455,
          -50},{118,-50},{118,-49.88},{184.58,-49.88}},       color={0,127,255}));
  connect(genericAHU.genericAHUBus,mainBus. ahu1Bus) annotation (Line(
      points={{2,-37.7},{2,95.145},{1.115,95.145}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
  ...
  connect(genericAHU.port_a1,boundaryOutsideAir. ports[1]) annotation (Line(
        points={{-58,-74},{-92,-74},{-92,-104}},                        color={
          0,127,255}));
