...
expandable connector TwoCircuitBus
  ...
  HydraulicModules.BaseClasses.HydraulicBus primBus "Primary hydraulic circuit";
  HydraulicModules.BaseClasses.HydraulicBus secBus "Secondary hydraulic circuit";
