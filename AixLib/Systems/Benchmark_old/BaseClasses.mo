...
package BaseClasses "Base class package"
  ...
  expandable connector HighTempSystemBus
    ...
    HydraulicModules_old.BaseClasses.HydraulicBus pumpBoilerBus
      "Hydraulic circuit of the boiler";
    HydraulicModules_old.BaseClasses.HydraulicBus pumpChpBus
      "Hydraulic circuit of the chp";
...
<li>February 6, 2016, by Peter Matthes:<br/>First implementation. </li>
  ...
  expandable connector TabsBus "Data bus for concrete cora activation"
    extends Modelica.Icons.SignalBus;
    import SI = Modelica.SIunits;
    HydraulicModules_old.BaseClasses.HydraulicBus admixBus
      "Hydraulic circuit of the boiler";
...
<li>February 6, 2016, by Peter Matthes:<br/>First implementation. </li>
  ...
  expandable connector MainBus
    ...
    extends Modelica.Icons.SignalBus;
    import SI = Modelica.SIunits;
    EONERC_MainBuilding_old.BaseClasses.HeatPumpSystemBus hpSystemBus
      "Heat pump system bus";
    EONERC_MainBuilding_old.BaseClasses.SwitchingUnitBus swuBus
      "Switching unit bus";
    HighTempSystemBus htsBus
      "High temoerature system bus";
    EONERC_MainBuilding_old.BaseClasses.TwoCircuitBus gtfBus
      "Geothermalfield bus";
    EONERC_MainBuilding_old.BaseClasses.TwoCircuitBus hxBus
    ...
    ModularAHU_old.BaseClasses.GenericAHUBus ahuBus "Bus for AHU";
    ModularAHU_old.BaseClasses.GenericAHUBus vu1Bus "Ventilation unit 1";
    ModularAHU_old.BaseClasses.GenericAHUBus vu2Bus "Ventilation unit 2";
    ModularAHU_old.BaseClasses.GenericAHUBus vu3Bus "Ventilation unit 3";
    ModularAHU_old.BaseClasses.GenericAHUBus vu4Bus "Ventilation unit 4";
    ModularAHU_old.BaseClasses.GenericAHUBus vu5Bus "Ventilation unit 5";
...
<li>February 6, 2016, by Peter Matthes:<br/>First implementation. </li>
  ...
  expandable connector TabsBus2 "Data bus for concrete cora activation"
    extends Modelica.Icons.SignalBus;
    import SI = Modelica.SIunits;
    HydraulicModules_old.BaseClasses.HydraulicBus pumpBus
      "Hydraulic circuit of concrete core activation";
    HydraulicModules_old.BaseClasses.HydraulicBus hotThrottleBus
      "Hydraulic circuit of hot supply";
    HydraulicModules_old.BaseClasses.HydraulicBus coldThrottleBus
      "Hydraulic circuit of cold supply";
    annotation (
      Icon(graphics,
           coordinateSystem(preserveAspectRatio=false)),
      Diagram(graphics,
