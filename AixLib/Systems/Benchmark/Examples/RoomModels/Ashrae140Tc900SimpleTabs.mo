...
model Ashrae140Tc900SimpleTabs
  "Ashrae140 Test Case 900 Set Point and Simple Tabs Controlled"
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    annotation(Placement(transformation(extent={{4,-9},{18,5}})));
  ...
  TabsSimple tabsSimple(
    ...
    thickness=0.05,
    cp=1000,
    alpha=20) annotation (Placement(transformation(extent={{8,-74},{60,-24}})));
...
equation
  ...
  connect(internalGains.y, thermalZone1.intGains) annotation (Line(points={{18.7,-2},
          {40,-2},{40,25.68},{51,25.68}},     color={0,0,127}));
  ...
  connect(tabsSimple.heatPort, thermalZone1.intGainsConv) annotation (Line(
        points={{34,-21.7273},{34,10.1364},{56.5,10.1364},{56.5,45.92}}, color=
          {191,0,0}));
  connect(tabsSimple.Q_flowTabs, Q_flowTabs) annotation (Line(points={{4.88,
          -51.2727},{-140,-51.2727},{-140,-50}}, color={0,0,127}));
  ...
  annotation (
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,-120},{140,
            180}})),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-140,-120},{
            140,180}})));
end Ashrae140Tc900SimpleTabs;
