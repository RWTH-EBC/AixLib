...
model SimpleRoomVolFlowCtrlwithSPControl_Ashrae
  ...
  Modelica.Blocks.Sources.Constant const(k=290.15)
    annotation (Placement(transformation(extent={{-168,136},{-148,156}})));
  Controller.CtrTabs2 ctrTabs2_1(
    ...
    ctrThrottleCold(
      ...
      rpm_pump=3500,
      reverseAction=true))
    annotation (Placement(transformation(extent={{-110,136},{-90,156}})));
...
equation
  ...
  connect(ventilationUnit1.port_b1, thermalZone1.ports[2]) annotation (Line(
        points={{-33.54,13},{35.23,13},{35.23,34.44},{34.875,34.44}}, color={0,
          127,255}));
  connect(ctrTabs2_1.tabsBus, tabs4_1.tabsBus) annotation (Line(
      points={{-90,146},{-30,146},{-30,-41.6364},{21.8,-41.6364}},
      color={255,204,51},
      thickness=0.5));
  connect(const.y, ctrTabs2_1.Tset)
    annotation (Line(points={{-147,146},{-112,146}}, color={0,0,127}));
  connect(const1.y, ctrVentilationUnitBasic.Tset) annotation (Line(points={{
          -151,104},{-130,104},{-130,108},{-110,108}}, color={0,0,127}));
  annotation (
...
end SimpleRoomVolFlowCtrlwithSPControl_Ashrae;
