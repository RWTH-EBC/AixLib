...
model Evaluation_CCCS
  ...
  AixLib.Systems.Benchmark.Model.Evaluation.CCCS.RBF RBF(i = 0.05, t = 1)  annotation (Placement(visible = true, transformation(origin={8,70},     extent = {{-10, -10}, {10, 10}}, rotation=0)));
  ...
  Modelica.Blocks.Math.MultiSum OperationalCosts(k={1,1,1},
                                                 nu=3)
...
equation
  ...
  connect(EmissionsCosts.Emission_Cost, OperationalCosts.u[1]) annotation (
    Line(points={{-52.7,50},{-34,50},{-34,36},{-24,36},{-24,34.8},{-20,34.8}},
                                                               color = {0, 0, 127}));
  connect(performanceReductionCosts1.PRC, OperationalCosts.u[2]) annotation (
    Line(points={{-59.2,11},{-46,11},{-46,12},{-34,12},{-34,32},{-20,32}},
                                                             color = {0, 0, 127}));
  ...
  connect(energyCosts.EnergyCost, OperationalCosts.u[3]) annotation (Line(
        points={{-52.96,80},{-20,80},{-20,29.2}},color={0,0,127}));
