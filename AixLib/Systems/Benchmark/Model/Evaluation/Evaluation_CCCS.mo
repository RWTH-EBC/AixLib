...
equation
  ...
  connect(bus_measure, bus_measure1) annotation(
    Line(points = {{-100, 0}, {-74, 0}, {-74, 12}, {-74, 12}}, color = {255, 204, 51}, thickness = 0.5));
  connect(energyCosts.EnergyCost, multiSum.u[1]) annotation(
    Line(points = {{-45, 84}, {-45, 84.2}, {-21, 84.2}, {-21, 54.4}, {-22, 54.4}, {-22, 26.4625}, {12, 26.4625}, {12, 29.15}}, color = {0, 0, 127}));
  connect(OperationalLifetimeReductionCosts.y, multiSum.u[4]) annotation(
    Line(points = {{-57, -34}, {-22, -34}, {-22, 26.85}, {11.5, 26.85}, {11.5, 22.85}, {12, 22.85}}, color = {0, 0, 127}));
  ...
  connect(EmissionsCosts.Emission_Cost, multiSum.u[2]) annotation(
    Line(points = {{-55, 54}, {-22, 54}, {-22, 27.05}, {12, 27.05}}, color = {0, 0, 127}));
  connect(multiSum.y, product1.u2) annotation(
    Line(points = {{25.02, 26}, {40, 26}, {40, 22}, {54, 22}}, color = {0, 0, 127}));
  ...
  connect(InvestmentCosts.y, OverallCost.u2) annotation(
    Line(points = {{-57, -80}, {10, -80}, {10, -6}, {78, -6}}, color = {0, 0, 127}));
