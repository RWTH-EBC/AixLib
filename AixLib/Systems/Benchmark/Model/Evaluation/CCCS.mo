...
public
  model LifespanReductionCosts
    "calculating costs of lifespan reduction due to wear as part of operating costs to evaluate the performance of a control strategy according to CCCS evaluation method"


    Real K_LDR_i;
    // costs due to lifespan reduction of component i
    Real K_LDR;
    // overall costs due to lifespan reduction of components
    parameter Real B=60000;
    // number of cycles until minimal lifespan is reached
    Real T;
    // Average lifespan in years
    parameter Real d_Op=365;
    //operating time in days; assumption: whole year
    parameter Real t_cycle=10800;
    // duration of one cycle (fully closed to fully opened) in seconds
    Real n;
