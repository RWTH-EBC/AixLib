...
model EnergyCosts "calculating the energy costs as part of the operational costs to evaluate the performance of a control strategy according to CCCS evaluation method"
  ...
  Modelica.Blocks.Sources.Constant NominalPowerOfDistrictHeating(k = NomPDisHeat)  annotation(
    Placement(visible = true, transformation(origin = {-152, 77}, extent = {{-10, -11}, {10, 11}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant NominalPowerOfDistrictCooling(k = NomPDisCool)  annotation(
...
equation
  ...
  connect(lrm[1].PRC, feedback1[1].u2) annotation(
      Line(points = {{0, 62}, {0, 62}, {0, 48}, {0, 48}}, color = {0, 0, 127}, thickness = 0.5));
  connect(bus_measure1.X_OpenplanOffice, lrm[5].X) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 72}, {-38, 72}, {-38, 72}, {-38, 72}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.X_Multipersonoffice, lrm[4].X) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 72}, {-38, 72}, {-38, 72}, {-38, 72}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.X_Conferenceroom, lrm[3].X) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 72}, {-40, 72}, {-40, 72}, {-38, 72}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.X_Workshop, lrm[2].X) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 72}, {-40, 72}, {-40, 72}, {-38, 72}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.X_Canteen, lrm[1].X) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 72}, {-38, 72}, {-38, 72}, {-38, 72}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.RoomTemp_Openplanoffice, lrm[5].T) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 88}, {-38, 88}, {-38, 88}, {-38, 88}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.RoomTemp_Multipersonoffice, lrm[4].T) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 88}, {-40, 88}, {-40, 88}, {-38, 88}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.RoomTemp_Conferenceroom, lrm[3].T) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 88}, {-38, 88}, {-38, 88}, {-38, 88}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.RoomTemp_Workshop, lrm[2].T) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 88}, {-38, 88}, {-38, 88}, {-38, 88}}, color = {255, 204, 51}, thickness = 0.5));
  connect(bus_measure1.RoomTemp_Canteen, lrm[1].T) annotation(
      Line(points = {{-100, -2}, {-56, -2}, {-56, 88}, {-38, 88}, {-38, 88}, {-38, 88}}, color = {255, 204, 51}, thickness = 0.5));
  ...
  connect(Tset.y, lrm[1].Tset) annotation(
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Text(lineColor = {0, 0, 255}, extent = {{-150, 110}, {150, 150}}, textString = ""), Text(extent = {{-38, -34}, {38, 34}}, textString = "PerformanceReductionCosts"), Text(extent = {{-100, 52}, {5, 92}}, textString = ""), Text(extent = {{-100, -92}, {5, -52}}, textString = "")}),
 ...
 T = t_cycle*B/(d_Op*24*3600);
  ...
  equation
    connect(Rate.y, product.u2) annotation(
      Line(points = {{-76, 40}, {-68, 40}, {-68, -72}, {24, -72}}, color = {0, 0, 127}));
    ...
    connect(discountingFactor1.y, product.u1) annotation(
      Line(points = {{0, -40}, {24, -40}, {24, -60}}, color = {0, 0, 127}));
    ...
    connect(Duration.y, discountingFactor1.duration) annotation(
      Line(points = {{-78, -44}, {-20, -44}, {-20, -44}, {-20, -44}}, color = {0, 0, 127}));
    connect(Rate.y, q.u2) annotation(
      Line(points = {{-76, 40}, {-60, 40}, {-60, 40}, {-60, 40}}, color = {0, 0, 127}));
