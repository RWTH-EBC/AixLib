...
model ReducedOrderModel_Connected
  ...
  AixLib.ThermalZones.ReducedOrder.RC.FourElements [5] thermalZoneFourElements(
   ...
   each  RFloor={1.5,0.1087,1.1429,0.0429},
    ...
    each nRoof=3,
    RRoof={{0.4444,0.06957,0.02941},{0.4444,0.06957,0.02941},{0.4444,0.06957,0.02941},
        {0.4444,0.06957,0.02941},{0.4444,0.06957,0.02941}},
    each RRoofRem=0,
    CRoof={{2472,368000,18000},{2472,368000,18000},{2472,368000,18000},{2472,368000,
        18000},{2472,368000,18000}})      "Thermal zone" annotation (Placement(transformation(extent={{44,-2},{92,34}})));
...
equation
 ...
 AixLib.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow</a>
  ...
  "modelica://AixLib/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomFourElements.mos"
        "Simulate and plot"));
end ReducedOrderModel_Connected;
