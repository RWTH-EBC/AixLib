 ...
 <li>Bundesregierung (Veranst.): Verordnung &uuml;ber energiesparenden W&auml;rmeschutz und energiesparende Anlagentechnik bei Geb&auml;uden. Berlin, 2009 </li>
  ...
  record ThermalZone_Record
    extends AixLib.DataBase.ThermalZones.ZoneBaseRecord(
      ...
      hConExt=2.5,
      nExt=4,
      RExt={0.0000555,0.00003174,0.0000533,0.00003267},
      RExtRem=0.000000001,
      CExt={810000000,111240000,2160000000,162000000},
      AInt=90,
      hConInt=2.5,
      nInt=2,
      ...
      hConFloor=2.5,
      nFloor=4,
      RFloor={0.0000167,0.0000012,0.0000127,0.0000005},
      RFloorRem=0.000000001,
      CFloor={75600,81750000,445000,10800000},
      ARoof=900,
      hConRoof=2.5,
      nRoof=4,
      RRoof={0.0000049,0.0000008,0.0000003,0.0000001},
      RRoofRem=0.000000001,
      CRoof={2220049,33100200,1620000,0.0009},
      nOrientationsRoof=1,
      tiltRoof={0},
      aziRoof={0},
      wfRoof={1},
