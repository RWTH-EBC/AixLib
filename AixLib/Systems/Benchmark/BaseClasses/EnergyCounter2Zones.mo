...
model EnergyCounter2Zones "Sums up all consumed energy"
  ...
  MainBus2ZoneMainBuilding mainBus annotation (Placement(transformation(extent=
            {{-118,-18},{-80,18}}), iconTransformation(extent={{-18,-42},{16,-6}})));
...
equation
  ...
  connect(integrator.y, mainBus.evaBus.WelHPMea) annotation (Line(points={{0.5,
  ...
  connect(add1.y, integrator3.u) annotation (Line(points={{-15.5,45},{-11,45}},
                                 color={0,0,127}));
  connect(add1.u1, mainBus.hxBus.primBus.pumpBus.power) annotation (Line(points
        ={{-27,48},{-98.905,48},{-98.905,0.09}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(add1.u2, mainBus.hxBus.secBus.pumpBus.power) annotation (Line(points=
  ...
  connect(integrator3.y, mainBus.evaBus.WelPumpsHXMea) annotation (Line(points=
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(integrator4.u, mainBus.swuBus.pumpBus.power) annotation (Line(points=
  ...
  connect(integrator7.u, mainBus.htsBus.fuelPowerBoilerMea) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(integrator7.y, mainBus.evaBus.QbrBoiMea) annotation (Line(points={{
          0.5,-35},{32,-35},{32,0.09},{-98.905,0.09}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  ...
  connect(sum1.u[1], mainBus.htsBus.pumpBoilerBus.pumpBus.power) annotation (
      Line(points={{-31,-17.5},{-98.905,-17.5},{-98.905,0.09}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
  ...
  connect(sum1.u[2], mainBus.htsBus.pumpChpBus.pumpBus.power) annotation (Line(
        points={{-31,-16.5},{-98.905,-16.5},{-98.905,0.09}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
  ...
  connect(sumWel.y, mainBus.evaBus.WelTotalMea) annotation (Line(points={{68.5,
  ...
  connect(add6.u1, mainBus.TRoom1Mea) annotation (Line(points={{83,82},{-16,82},
          {-16,84},{-98.905,84},{-98.905,0.09}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(add2.u1, mainBus.TRoom2Mea) annotation (Line(points={{83,64},{72,64},
          {72,100},{-98,100},{-98,0.09},{-98.905,0.09}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(integrator8.y, mainBus.evaBus.IseRoom1) annotation (Line(points={{
          120.5,79},{128,79},{128,98},{-98.905,98},{-98.905,0.09}}, color={0,0,
          127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
  ...
  connect(integrator11.y, mainBus.evaBus.IseRoom2) annotation (Line(points={{
          120.5,61},{134,61},{134,100},{-98.905,100},{-98.905,0.09}}, color={0,
          0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
