within AixLib.Systems.HydraulicModules_old.Example;
model ERC_ExperimentalHall_CoolingCircuit
  ...
  AixLib.Fluid.Sources.Boundary_pT bou1(
    ...
    p=200000) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-106,-86})));
  AixLib.Systems.HydraulicModules_old.Pump unmixed(
    redeclare
    ...
    length=2) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={6,4})));
  AixLib.Systems.HydraulicModules_old.ThrottlePump unmixedThrottle(
    redeclare
      AixLib.Systems.HydraulicModules_old.BaseClasses.PumpInterface_SpeedControlledNrpm
      PumpInterface(pump(redeclare
          AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos25slash1to6 per,
    ...
    pipe4(length=2)) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={74,4})));
  AixLib.Systems.HydraulicModules_old.Admix admix(
    redeclare
      AixLib.Systems.HydraulicModules_old.BaseClasses.PumpInterface_SpeedControlledNrpm
      PumpInterface(pump(redeclare
          AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos25slash1to6 per,
