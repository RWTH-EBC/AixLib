...
package Mode_based_ControlStrategy
  ...
  model Mode_based_Controller_V2
    ...
    AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Level.Version_2.FieldLevel_V2
      fieldLevel1 annotation (Placement(visible=true, transformation(
          origin={-40,-70},
          extent={{-10,-10},{10,10}},
          rotation=0)));
    Level.Version_2.ManagementLevel_Temp_V2 managementLevel_Temp_V2_1
      annotation (Placement(transformation(extent={{-50,40},{-30,60}})));
    Level.Version_2.AutomationLevel_V2 automationLevel_V2_1
  ...
  equation
    ...
    connect(automationLevel_V2_1.automationLevelBus, modeBasedControllerBus.AutomationLevelBus)
      annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(TAirOutside, automationLevel_V2_1.TAirOutside) annotation (Line(
          points={{108,-80},{80,-80},{80,-100},{-100,-100},{-100,20},{-24,20},{
            -24,9}},
          color={0,0,127}));
    ...
    connect(mainBus.gtfBus.primBus.TFwrdOutMea, automationLevel_V2_1.T_GEO)
      annotation (Line(
        points={{102.05,0.05},{102,0.05},{102,0},{100,0},{100,100},{-100,100},{-100,
            20},{-32,20},{-32,9}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.hpSystemBus.busThrottleCS.TFwrdOutMea, automationLevel_V2_1.T_CS)
      annotation (Line(
        points={{102.05,0.05},{100,0.05},{100,100},{-100,100},{-100,20},{-35.9,20},
            {-35.9,9.1}},
        color={255,204,51},
        thickness=0.5));
...
Controller")}),
  ...
  end Mode_based_Controller_V2;

  model Mode_Based_Controller_StateGraph
    Level.StateGraph.ManagamentLevel_StateGraph managamentLevel_StateGraph
      annotation (Placement(transformation(extent={{-60,40},{-40,60}})));
    Benchmark.BaseClasses.MainBus mainBus
      annotation (Placement(transformation(extent={{90,-10},{110,10}})));
    Level.Version_2.FieldLevel_V2 fieldLevel_V2_1
      annotation (Placement(transformation(extent={{-58,-40},{-42,-20}})));
    Level.StateGraph.AutomationLevel_StateGraph automationLevel_StateGraph
...
Level")}), Diagram(coordinateSystem(preserveAspectRatio=false)));
      ...
      model AutomationLevel_StateGraph
        ...
        Bus_Systems.AutomationLevelBus_V2 automationLevelBus_V2_1 annotation (
      ...
      equation
        ...
        connect(Combination_I.outPort[3], transition12.inPort) annotation (Line(
              points={{-19.5,-77.9167},{-16,-77.9167},{-16,-100},{100,-100},{
                100,7},{92.6,7}},
                      color={0,0,0}));
        ...
        connect(Combination_II.outPort[3], transition14.inPort) annotation (Line(
              points={{40.5,-77.9167},{50,-77.9167},{50,-100},{100,-100},{100,
                -30},{51,-30},{51,-24.6}},
                            color={0,0,0}));
        ...
        connect(transition29.inPort, Combination_II.outPort[6]) annotation (Line(
              points={{2.6,-89},{10,-89},{10,-100},{50,-100},{50,-78.4167},{
                40.5,-78.4167}},
              color={0,0,0}));
    ...
    package Version_2
      model AutomationLevel_V2
        ...
        Modelica.Blocks.Interfaces.RealInput T_GEO annotation (Placement(
              ...
              rotation=270,
              origin={80,110})));
        AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Bus_Systems.AutomationLevelBus_V2
          automationLevelBus
        ...
        PNlib.Components.TD T1(
          ...
          nOut=1,
          delay=600,
          firingCon=Superior_Mode[3].y == true and T_GEO >= 293.15)
                     annotation (Placement(transformation(
              extent={{-10,10},{10,-10}},
              rotation=180,
              origin={-186,46})));
        ...
        PNlib.Components.TD T2(
          ...
          nOut=1,
          delay=600,
          firingCon=Superior_Mode[1].y == true)
                     annotation (Placement(transformation(
              extent={{-10,10},{10,-10}},
              rotation=0,
              origin={-186,26})));
        PNlib.Components.TD T3(
          ...
          delay=600,
          firingCon=Superior_Mode[1].y == true)
          annotation (Placement(transformation(extent={{-196,-24},{-176,-4}})));
        ...
        PNlib.Components.TD T4(
          ...
          nOut=1,
          delay=600,
          firingCon=Superior_Mode[3].y == true and T_GEO < 285.15)
                     annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=180,
              origin={-186,-34})));
        ...
        PNlib.Components.TD T9(
          ...
          nOut=1,
          delay=600,
          firingCon=Superior_Mode[4].y == true and T_GEO >= 293.15)
                     annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=270,
              origin={-166,-44})));
        ...
        PNlib.Components.TD T13(
          ...
          nOut=1,
          delay=600,
          firingCon=Superior_Mode[2].y == true)
        ...
        PNlib.Components.TD T34(
          ...
          delay=600,
          firingCon=Superior_Mode[3].y == true and T_GEO < 285.15)
          annotation (Placement(transformation(extent={{-244,-24},{-224,-44}})));
      equation
        ...
        connect(managementLevelBus.Combination, Superior_Mode[4].u) annotation (Line(
            ...
            color={255,204,51},
            thickness=0.5));
        connect(Off.outTransition[1], T8.inPlaces[1]) annotation (Line(points={{-121.2,
                5.16667},{-110,5.16667},{-110,26},{-78.8,26}}, color={0,0,0}));
        connect(Off.outTransition[2], T13.inPlaces[1]) annotation (Line(points={{-121.2,
                5.5},{-110,5.5},{-110,-14},{-78.8,-14}}, color={0,0,0}));
        connect(Off.outTransition[3], T1.inPlaces[1]) annotation (Line(points={{-121.2,
                5.83333},{-110,5.83333},{-110,46},{-181.2,46}}, color={0,0,0}));
        connect(Off.outTransition[4], T4.inPlaces[1]) annotation (Line(points={{-121.2,
                6.16667},{-110,6.16667},{-110,-34},{-181.2,-34}}, color={0,0,0}));
        connect(Off.outTransition[6], T20.inPlaces[1]) annotation (Line(points={{-121.2,
                6.83333},{-110,6.83333},{-110,-34},{-94,-34},{-94,-39.2}}, color={0,0,
                0}));
        connect(Off.outTransition[5], T9.inPlaces[1]) annotation (Line(points={{-121.2,
                6.5},{-110,6.5},{-110,-34},{-166,-34},{-166,-39.2}}, color={0,0,0}));
        connect(Off.inTransition[1], T7.outPlaces[1]) annotation (Line(points={{-142.8,
                5.16667},{-146,5.16667},{-146,6},{-158,6},{-158,46},{-78.8,46}},
              color={0,0,0}));
        connect(T14.outPlaces[1], Off.inTransition[2]) annotation (Line(points={{-78.8,
                -34},{-158,-34},{-158,5.5},{-142.8,5.5}}, color={0,0,0}));
        connect(T2.outPlaces[1], Off.inTransition[3]) annotation (Line(points={{-181.2,
                26},{-158,26},{-158,6},{-150,6},{-150,5.83333},{-142.8,5.83333}},
              color={0,0,0}));
        connect(T3.outPlaces[1], Off.inTransition[4]) annotation (Line(points={{-181.2,
                -14},{-158,-14},{-158,6.16667},{-142.8,6.16667}}, color={0,0,0}));
        connect(T10.outPlaces[1], Off.inTransition[5]) annotation (Line(points={{-146,
                -39.2},{-146,-34},{-158,-34},{-158,6.5},{-142.8,6.5}}, color={0,0,0}));
        connect(T19.outPlaces[1], Off.inTransition[6]) annotation (Line(points={{-114,
                -39.2},{-114,-34},{-158,-34},{-158,6.83333},{-142.8,6.83333}}, color={
                0,0,0}));
        connect(T20.outPlaces[1], Combination_II.inTransition[1]) annotation (Line(
              points={{-94,-48.8},{-94,-73.2},{-100.833,-73.2}}, color={0,0,0}));
        connect(T24.outPlaces[1], Combination_II.inTransition[3]) annotation (Line(
              points={{-60,-56.8},{-60,-73.2},{-100.167,-73.2}}, color={0,0,0}));
        connect(T26.outPlaces[1], Combination_II.inTransition[2]) annotation (Line(
              points={{-60,70.8},{-60,76},{-10,76},{-10,-73.2},{-100.5,-73.2}}, color=
               {0,0,0}));
        connect(T17.outPlaces[1], Combination_II.inTransition[6]) annotation (Line(
              points={{-125.2,-74},{-99.1667,-74},{-99.1667,-73.2}}, color={0,0,0}));
        connect(T33.outPlaces[1], Combination_II.inTransition[5]) annotation (Line(
              points={{-238.8,-14},{-250,-14},{-250,-116},{-80,-116},{-80,-73.2},{-99.5,
                -73.2}}, color={0,0,0}));
        connect(T29.outPlaces[1], Combination_II.inTransition[4]) annotation (Line(
              points={{-200,72.8},{-200,76},{-250,76},{-250,-116},{-80,-116},{
                -80,-73.2},{-99.8333,-73.2}},
                                   color={0,0,0}));
        connect(Combination_II.outTransition[3], T23.inPlaces[1]) annotation (Line(
              points={{-100.167,-94.8},{-100.167,-104},{-40,-104},{-40,-56.8}}, color=
               {0,0,0}));
        connect(Combination_II.outTransition[2], T25.inPlaces[1]) annotation (Line(
              points={{-100.5,-94.8},{-100.5,-104},{-10,-104},{-10,76},{-40,76},{-40,70.8}},
              color={0,0,0}));
        connect(Combination_II.outTransition[1], T19.inPlaces[1]) annotation (Line(
              points={{-100.833,-94.8},{-100.833,-104},{-114,-104},{-114,-48.8}},
              color={0,0,0}));
        connect(Combination_II.outTransition[6], T18.inPlaces[1]) annotation (Line(
              points={{-99.1667,-94.8},{-99.1667,-96},{-100,-96},{-100,-104},{
                -114,-104},{-114,-92},{-125.2,-92}},
                                          color={0,0,0}));
        connect(Combination_II.outTransition[5], T34.inPlaces[1]) annotation (Line(
              points={{-99.5,-94.8},{-100,-94.8},{-100,-116},{-250,-116},{-250,-34},{-238.8,
                -34}}, color={0,0,0}));
        connect(Combination_II.outTransition[4], T30.inPlaces[1]) annotation (Line(
              points={{-99.8333,-94.8},{-99.8333,-116},{-250,-116},{-250,76},{
                -220,76},{-220,72.8}},
                              color={0,0,0}));
        connect(T8.outPlaces[1], Heating_I.inTransition[1]) annotation (Line(points={{
                -69.2,26},{-60,26},{-60,25.2},{-49.25,25.2}}, color={0,0,0}));
        connect(T16.outPlaces[1], Heating_I.inTransition[2]) annotation (Line(points={
                {-60,12.8},{-60,25.2},{-49.75,25.2}}, color={0,0,0}));
        connect(T25.outPlaces[1], Heating_I.inTransition[4]) annotation (Line(points={
                {-40,61.2},{-38,61.2},{-38,25.2},{-50.75,25.2}}, color={0,0,0}));
        connect(T22.outPlaces[1], Heating_I.inTransition[3]) annotation (Line(points={
                {-30.8,26},{-40,26},{-40,25.2},{-50.25,25.2}}, color={0,0,0}));
        connect(Heating_I.outTransition[1], T7.inPlaces[1]) annotation (Line(points={{
                -49.25,46.8},{-56,46.8},{-56,46},{-69.2,46}}, color={0,0,0}));
        connect(Heating_I.outTransition[2], T15.inPlaces[1]) annotation (Line(points={
                {-49.75,46.8},{-44,46.8},{-44,46},{-38,46},{-38,20},{-40,20},{-40,12.8}},
              color={0,0,0}));
        connect(Heating_I.outTransition[4], T26.inPlaces[1]) annotation (Line(points={
                {-50.75,46.8},{-52,46.8},{-52,48},{-62,48},{-62,61.2},{-60,61.2}},
              color={0,0,0}));
        connect(Heating_I.outTransition[3], T21.inPlaces[1]) annotation (Line(points={
                {-50.25,46.8},{-42,46.8},{-42,46},{-30.8,46}}, color={0,0,0}));
        connect(Heating_II.inTransition[2], T15.outPlaces[1]) annotation (Line(points=
               {{-50.25,-17.2},{-46,-17.2},{-46,-16},{-40,-16},{-40,3.2}}, color={0,0,
                0}));
        connect(Heating_II.inTransition[3], T11.outPlaces[1]) annotation (Line(points=
               {{-49.75,-17.2},{-44,-17.2},{-44,-18},{-30.8,-18},{-30.8,-14}}, color={
                0,0,0}));
        connect(T23.outPlaces[1], Heating_II.inTransition[4]) annotation (Line(points=
               {{-40,-47.2},{-40,-17.2},{-49.25,-17.2}}, color={0,0,0}));
        connect(Heating_II.outTransition[1], T14.inPlaces[1]) annotation (Line(points=
               {{-50.75,-38.8},{-54,-38.8},{-54,-38},{-69.2,-38},{-69.2,-34}}, color={
                0,0,0}));
        connect(Heating_II.outTransition[2], T16.inPlaces[1]) annotation (Line(points=
               {{-50.25,-38.8},{-54,-38.8},{-54,-38},{-64,-38},{-64,3.2},{-60,3.2}},
              color={0,0,0}));
        connect(Heating_II.outTransition[3], T12.inPlaces[1]) annotation (Line(points=
               {{-49.75,-38.8},{-42,-38.8},{-42,-38},{-30.8,-38},{-30.8,-34}}, color={
                0,0,0}));
        connect(Heating_II.outTransition[4], T24.inPlaces[1]) annotation (Line(points=
               {{-49.25,-38.8},{-49.25,-38},{-60,-38},{-60,-47.2}}, color={0,0,0}));
        connect(Combination_I.outTransition[6], T17.inPlaces[1]) annotation (Line(
              points={{-156.833,-73.2},{-134.8,-73.2},{-134.8,-74}}, color={0,0,0}));
        connect(Combination_I.outTransition[1], T10.inPlaces[1]) annotation (Line(
              points={{-155.167,-73.2},{-154,-73.2},{-154,-74},{-146,-74},{-146,
                -48.8}},
              color={0,0,0}));
        connect(Combination_I.outTransition[2], T22.inPlaces[1]) annotation (Line(
              points={{-155.5,-73.2},{-160,-73.2},{-160,-74},{-172,-74},{-172,-116},{-10,
                -116},{-10,26},{-21.2,26}}, color={0,0,0}));
        connect(Combination_I.outTransition[3], T11.inPlaces[1]) annotation (Line(
              points={{-155.833,-73.2},{-160,-73.2},{-160,-74},{-172,-74},{-172,
                -116},{-10,-116},{-10,-14},{-21.2,-14}},
                                                   color={0,0,0}));
        connect(Combination_I.outTransition[5], T27.inPlaces[1]) annotation (Line(
              points={{-156.5,-73.2},{-162,-73.2},{-162,-74},{-202,-74},{-202,-58.8}},
              color={0,0,0}));
        connect(Combination_I.outTransition[4], T31.inPlaces[1]) annotation (Line(
              points={{-156.167,-73.2},{-160,-73.2},{-160,-74},{-172,-74},{-172,
                -94},{-250,-94},{-250,48},{-238.8,48}},
                                                  color={0,0,0}));
        connect(Combination_I.inTransition[6], T18.outPlaces[1]) annotation (Line(
              points={{-156.833,-94.8},{-148,-94.8},{-148,-96},{-134.8,-96},{
                -134.8,-92}},
              color={0,0,0}));
        connect(T28.outPlaces[1], Combination_I.inTransition[5]) annotation (Line(
              points={{-222,-58.8},{-222,-78},{-220,-78},{-220,-94.8},{-156.5,-94.8}},
              color={0,0,0}));
        connect(T32.outPlaces[1], Combination_I.inTransition[4]) annotation (Line(
              points={{-238.8,28},{-250,28},{-250,-94},{-204,-94},{-204,-94.8},
                {-156.167,-94.8}},
                         color={0,0,0}));
        connect(Combination_I.inTransition[3], T12.outPlaces[1]) annotation (Line(
              points={{-155.833,-94.8},{-155.833,-116},{-10,-116},{-10,-34},{
                -21.2,-34}},
              color={0,0,0}));
        connect(Combination_I.inTransition[2], T21.outPlaces[1]) annotation (Line(
              points={{-155.5,-94.8},{-155.5,-106},{-156,-106},{-156,-116},{-10,-116},
                {-10,46},{-21.2,46}}, color={0,0,0}));
        connect(Cooling_II.outTransition[1], T3.inPlaces[1]) annotation (Line(points={
                {-209.25,-13.2},{-206,-13.2},{-206,-14},{-190.8,-14}}, color={0,0,0}));
        connect(Cooling_II.outTransition[2], T6.inPlaces[1]) annotation (Line(points={
                {-209.75,-13.2},{-212,-13.2},{-212,-14},{-222,-14},{-222,1.2},{-220,1.2}},
              color={0,0,0}));
        connect(Cooling_II.outTransition[3], T28.inPlaces[1]) annotation (Line(points=
               {{-210.25,-13.2},{-214,-13.2},{-214,-14},{-222,-14},{-222,-49.2}},
              color={0,0,0}));
        connect(Cooling_II.outTransition[4], T33.inPlaces[1]) annotation (Line(points=
               {{-210.75,-13.2},{-216,-13.2},{-216,-14},{-229.2,-14}}, color={0,0,0}));
        connect(T4.outPlaces[1], Cooling_II.inTransition[1]) annotation (Line(points={
                {-190.8,-34},{-200,-34},{-200,-34.8},{-209.25,-34.8}}, color={0,0,0}));
        connect(T5.outPlaces[1], Cooling_II.inTransition[2]) annotation (Line(points={
                {-200,1.2},{-200,-34.8},{-209.75,-34.8}}, color={0,0,0}));
        connect(T27.outPlaces[1], Cooling_II.inTransition[3]) annotation (Line(points=
               {{-202,-49.2},{-202,-34.8},{-210.25,-34.8}}, color={0,0,0}));
        connect(T34.outPlaces[1], Cooling_II.inTransition[4]) annotation (Line(points=
               {{-229.2,-34},{-210.75,-34},{-210.75,-34.8}}, color={0,0,0}));
        connect(Cooling_I.outTransition[1], T2.inPlaces[1]) annotation (Line(points={{
                -210.75,23.2},{-206,23.2},{-206,22},{-190.8,22},{-190.8,26}}, color={0,
                0,0}));
        connect(Cooling_I.outTransition[2], T5.inPlaces[1]) annotation (Line(points={{
                -210.25,23.2},{-206,23.2},{-206,22},{-198,22},{-198,10.8},{-200,10.8}},
              color={0,0,0}));
        connect(Cooling_I.outTransition[3], T32.inPlaces[1]) annotation (Line(points={
                {-209.75,23.2},{-216,23.2},{-216,26},{-229.2,26},{-229.2,28}}, color={
                0,0,0}));
        connect(Cooling_I.outTransition[4], T29.inPlaces[1]) annotation (Line(points={
                {-209.25,23.2},{-206,23.2},{-206,22},{-200,22},{-200,63.2}}, color={0,
                0,0}));
        connect(Cooling_I.inTransition[1], T1.outPlaces[1]) annotation (Line(points={{
                -210.75,44.8},{-206,44.8},{-206,44},{-190.8,44},{-190.8,46}}, color={0,
                0,0}));
        connect(T6.outPlaces[1], Cooling_I.inTransition[2]) annotation (Line(points={{
                -220,10.8},{-220,44.8},{-210.25,44.8}}, color={0,0,0}));
        connect(T31.outPlaces[1], Cooling_I.inTransition[3]) annotation (Line(points={
                {-229.2,48},{-209.75,48},{-209.75,44.8}}, color={0,0,0}));
        connect(T30.outPlaces[1], Cooling_I.inTransition[4]) annotation (Line(points={
                {-220,63.2},{-220,44.8},{-209.25,44.8}}, color={0,0,0}));
        connect(T13.outPlaces[1], Heating_II.inTransition[1]) annotation (Line(points=
               {{-69.2,-14},{-50.75,-14},{-50.75,-17.2}}, color={0,0,0}));
        connect(T9.outPlaces[1], Combination_I.inTransition[1]) annotation (Line(
              points={{-166,-48.8},{-166,-94.8},{-155.167,-94.8}}, color={0,0,0}));
        connect(Off.pd_t, integerToBoolean1[1].u) annotation (Line(points={{-132,16.6},
                {-130,16.6},{-130,90},{1.77636e-15,90},{1.77636e-15,-140.4}}, color={255,
                127,0}));
        connect(Combination_II.pd_t, integerToBoolean1[7].u) annotation (Line(points={
                {-89.4,-84},{0,-84},{0,-140.4}}, color={255,127,0}));
        connect(Combination_I.pd_t, integerToBoolean1[6].u) annotation (Line(points={{
                -166.6,-84},{-180,-84},{-180,-116},{0,-116},{0,-140.4}}, color={255,127,
                0}));
        connect(Heating_II.pd_t, integerToBoolean1[3].u) annotation (Line(points={{-39.4,
                -28},{-38,-28},{-38,0},{1.77636e-15,0},{1.77636e-15,-140.4}}, color={255,
                127,0}));
        connect(Heating_I.pd_t, integerToBoolean1[2].u) annotation (Line(points={{-60.6,
                36},{-60,36},{-60,60},{0,60},{0,-140.4}}, color={255,127,0}));
        connect(Cooling_I.pd_t, integerToBoolean1[4].u) annotation (Line(points={{-199.4,
                34},{-198,34},{-198,62},{-250,62},{-250,-116},{1.77636e-15,-116},{1.77636e-15,
                -140.4}}, color={255,127,0}));
        connect(Cooling_II.pd_t, integerToBoolean1[5].u) annotation (Line(points={{-220.6,
                -24},{-222,-24},{-222,0},{-250,0},{-250,-116},{1.77636e-15,-116},{1.77636e-15,
                -140.4}}, color={255,127,0}));
...
<p>(Off/Heating/Cooling 1-5 bestimmen die Aktors&auml;tze der VU/Tabs Module der R&auml;ume)</p>
      ...
      model FieldLevel_V2
        ...
        AixLib.Systems.Benchmark.BaseClasses.MainBus mainBus annotation (
            ...
            iconTransformation(
              ...
              extent={{-10,-10},{10,10}},
              rotation=0)));
        AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Controller.Controller_GTFSystem_V2
          controller_GTFSystem1 annotation (Placement(visible=true,
              transformation(
              origin={-80,90},
              extent={{-10,-10},{10,10}},
              rotation=0)));
        AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Controller.Controller_HPSystem_V2
          controller_HPSystem1 annotation (Placement(visible=true,
              transformation(
              origin={-80,10},
              extent={{-10,-10},{10,10}},
              rotation=0)));
        AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Controller.Controller_SwitchingUnit_V2
          controller_SwitchingUnit1(rpmPump=2000) annotation (Placement(visible
              =true, transformation(
              origin={-80,70},
              extent={{-10,-10},{10,10}},
              rotation=0)));
        AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Controller.Controller_HTSSystem_V2
        ...
        AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Controller.Controller_HX_V2
          controller_HX(TflowSet=293.15, rpmPumpPrim=130)
          annotation (Placement(transformation(extent={{-90,40},{-70,60}})));
        AixLib.Systems.Benchmark_fb.Mode_based_ControlStrategy.Controller.Controller_CentralAHU_V2
      ...
      connect(automationLevelBus.OpenplanOffice_Off, booleanPassThrough[20].u)
        ...
        connect(controller_CentralAHU.Heating_II, booleanPassThrough[3].y)
          annotation (Line(points={{-69.6,35.7143},{-34,35.7143},{-34,36},{2,36},
                {2,93.4}}, color={255,0,255}));
        connect(controller_CentralAHU.Cooling_I, booleanPassThrough[4].y)
          annotation (Line(points={{-69.6,29.8571},{-34,29.8571},{-34,30},{2,30},
                {2,93.4}}, color={255,0,255}));
        connect(controller_CentralAHU.Cooling_II, booleanPassThrough[5].y)
          annotation (Line(points={{-69.4,25.7143},{-34,25.7143},{-34,26},{2,26},
                {2,93.4}}, color={255,0,255}));
...
")}),            Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
 ...
 HTS\nSystem")}),
    ...
    end Controller_HTSSystem_V2;

    model Controller_GTFSystem_V2
 ...
 GTF\nSystem")}),
    ...
    end Controller_GTFSystem_V2;

    model Controller_HPSystem_V2
    ...
    equation
      ...
      connect(not1.y, heatPumpSystemBus1.busHP.onOff) annotation (Line(points={
              {-69,-28},{-60,-28},{-60,0},{8,0},{8,0.05},{100.05,0.05}}, color=
              {255,0,255}));
      connect(booleanExpression.y, ctrHP.allowOperation) annotation (Line(
            points={{-109,-60},{-100,-60},{-100,-58},{-30,-58}}, color={255,0,
              255}));
      connect(not1.y, switch1.u2) annotation (Line(points={{-69,-28},{-50,-28},
              {-50,-30},{-10,-30}}, color={255,0,255}));
      ...
      connect(switch1.y, heatPumpSystemBus1.busHP.N) annotation (Line(points={{
              ...
              127}));
      connect(or6.y, not1.u)
        annotation (Line(points={{-107,-28},{-92,-28}}, color={255,0,255}));
      connect(Off, or6.u2) annotation (Line(points={{70,-104},{64,-104},{64,-86},
              {-140,-86},{-140,-36},{-130,-36}}, color={255,0,255}));
      connect(Cooling_II, or6.u1) annotation (Line(points={{106,-32},{114,-32},
              {114,-106},{-148,-106},{-148,-28},{-130,-28}}, color={255,0,255}));
      annotation (
        Icon(coordinateSystem(preserveAspectRatio = false, initialScale = 0.1), graphics={  Rectangle(lineColor = {95, 95, 95}, fillColor = {215, 215, 215},
                fillPattern =                                                                                                                                              FillPattern.Solid,
 ...
 HP\nSystem")}),
    ...
    end Controller_HPSystem_V2;

    model Controller_HX_V2
...
Exchanger")}, coordinateSystem(initialScale = 0.1)));
    end Controller_HX_V2;

    model Controller_CentralAHU_V2
...
AHU")}),                               Diagram(coordinateSystem(preserveAspectRatio=
    ...
    end Controller_CentralAHU_V2;

    model Controller_SwitchingUnit_V2
    ...
    equation
      ...
      annotation (
        ...
        Diagram(coordinateSystem(preserveAspectRatio = false)));
    end Controller_SwitchingUnit_V2;
 ...
 Ventilation\nUnit")}),
    ...
    equation
      ...
      connect(PID_Cold.u_m, tabsBus21.pumpBus.TFwrdOutMea) annotation (Line(
            points={{-20,-14},{-20,-30},{100.05,-30},{100.05,0.05}}, color={0,0,
              127}));
      connect(booleanExpression.y, tabsBus21.pumpBus.pumpBus.onSet) annotation
        (Line(points={{99,96},{138,96},{138,32},{100.05,32},{100.05,0.05}},
            color={255,0,255}));
      connect(PID_Hot.y, pumpSwitchOff.u) annotation (Line(points={{-9,90},{16,
              90},{16,92},{64.4,92},{64.4,78}}, color={0,0,127}));
      connect(pumpSwitchOff.y, tabsBus21.hotThrottleBus.pumpBus.onSet)
        annotation (Line(points={{82.8,78},{94,78},{94,72},{100.05,72},{100.05,
              0.05}}, color={255,0,255}));
      connect(PID_Cold.y, pumpSwitchOff1.u) annotation (Line(points={{-9,-2},{
              -2,-2},{-2,-12},{10.4,-12},{10.4,-18}}, color={0,0,127}));
...
<li>February 6, 2016, by Peter Matthes:<br/>First implementation. </li>
    ...
    expandable connector AutomationLevelBus_V2
      "Data bus for Automation of mode-based control strategy"
      extends Modelica.Icons.SignalBus;
      import SI = Modelica.SIunits;
