within AixLib.Systems.Benchmark_fb.Model.Generation;
model Generation_v2
  ...
  Fluid.Storage.BufferStorage HotWater(
    ...
    data=AixLib.Systems.Benchmark_fb.Benchmark_DataBase.Benchmark_22000l(),
    TStart=343.15)
  ...
  Fluid.Storage.BufferStorage ColdWater(
    ...
    upToDownHC2=false,
    TStart=283.15,
    data=AixLib.Systems.Benchmark_fb.Benchmark_DataBase.Benchmark_46000l())
