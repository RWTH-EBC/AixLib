...
model FullModel_v4
  ...
  AixLib.Systems.Benchmark_fb.Model.Weather weather
  ...
  AixLib.Systems.Benchmark_fb.Model.InternalLoad.InternalLoads internalLoads
    annotation (Placement(transformation(extent={{-48,50},{-8,10}})));
  inner Modelica.Fluid.System system
    annotation (Placement(transformation(extent={{-100,80},{-80,100}})));
  AixLib.Systems.Benchmark_fb.Model.Evaluation.Evaluation evaluation
  ...
  AixLib.Systems.Benchmark_fb.Model.BusSystems.LogModel logModel
    annotation (Placement(transformation(extent={{100,-26},{120,-46}})));
  AixLib.Systems.Benchmark_fb.Model.BusSystems.Bus_measure Measure
    annotation (Placement(transformation(extent={{-120,0},{-80,40}})));
  AixLib.Systems.Benchmark_fb.Model.BusSystems.Bus_Control Control
