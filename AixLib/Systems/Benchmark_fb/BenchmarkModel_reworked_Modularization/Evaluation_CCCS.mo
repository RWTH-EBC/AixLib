...
model Evaluation_CCCS
  ...
  AixLib.Systems.Benchmark_fb.BenchmarkModel_reworked_Modularization.CCCS.RBF
    RBF(i=0.05, t=1) annotation (Placement(visible=true, transformation(
        origin={8,70},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  AixLib.Systems.Benchmark_fb.BenchmarkModel_reworked_Modularization.CCCS.PerformanceReductionCosts
