...
model Controller_VariablePowerCost
  ...
  AixLib.Systems.Benchmark_fb.ControlStrategies.Controller_Generation.Generation_VariablePowerCost
    generation_VariablePowerCost
    annotation (Placement(transformation(extent={{48,-10},{68,10}})));
  AixLib.Systems.Benchmark_fb.ControlStrategies.Controller_PumpsAndFans.Fan_VariablePowerCost
    fan_VariablePowerCost
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  AixLib.Systems.Benchmark_fb.ControlStrategies.Controller_PumpsAndFans.Pump_VariablePowerCost
