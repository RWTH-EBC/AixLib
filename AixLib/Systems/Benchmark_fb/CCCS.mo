...
equation
  ...
  connect(NominalPowerOfDistrictCooling.y, PowerConnection_DistrictCooling.u[2]) annotation (
    ...
    connect(mainBus.evaBus.QbrTotalMea, CostFactor_Fuel.u) annotation (Line(
        points={{-147.95,0.05},{-154,0.05},{-154,-80},{12,-80},{12,-76}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
    ...
    connect(mainBus.evaBus.WelTotalMea, CostFactorElectricity.u) annotation (
        Line(
        points={{-147.95,0.05},{-154,0.05},{-154,-36},{10,-36}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
...
Costs")}));
  ...
  equation
    ...
    connect(mainBus.evaBus.WelTotalMea, EmissionsFactorElectricity.u)
      annotation (Line(
        points={{-99.95,0.05},{-99.95,-34},{-40,-34}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.evaBus.QbrTotalMea, EmissionsFactorFuel.u) annotation (Line(
        points={{-99.95,0.05},{-100,0.05},{-100,-70},{-40,-70}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
...
Costs")}),
  ...
  parameter Real TSetWorkshop=288.15 "set room temperature for workshop [K]";
    ...
    Modelica.Blocks.Math.MultiProduct multiProduct[5](each nu=4) annotation (Placement(
          ...
          rotation=270,
          origin={0,-56})));
    BaseClasses.LRM_Temp lRM_Temp[5]
  ...
  equation
    ...
    connect(lRM_Temp[1].y, feedback1[1].u2)
      annotation (Line(points={{-7.2,82},{0,82},{0,48}},     color={0,0,127}));
...
Costs for
Strategy")}),                                          Diagram(coordinateSystem(
  ...
  model Evaluation_CCCS
    ...
    AixLib.Systems.Benchmark_fb.CCCS.BaseClasses.RBF RBF(i=0.05, t=1)
    ...
    AixLib.Systems.Benchmark_fb.CCCS.PerformanceReductionCosts
    ...
    CCCS.InvestmentCostsStrategy investmentCostsStrategy1 annotation (Placement(
    ...
    Benchmark.BaseClasses.MainBus mainBus
      annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
    InvestmentCostsComponents investmentCostsComponents
      annotation (Placement(transformation(extent={{-80,-100},{-60,-80}})));
  equation
    connect(investmentCostsStrategy1.kStrat, InvestmentCosts.u1) annotation (
      Line(points={{-59.8,-48},{-30,-48},{-30,-60},{-20,-60}},  color = {0, 0, 127}));
    ...
    connect(EmissionsCosts.Emission_Cost, OperationalCosts.u[1]) annotation (
      Line(points={{-59.6,58},{-34,58},{-34,34},{-24,34},{-24,35.15},{-20,35.15}},
                                                                 color = {0, 0, 127}));
    ...
    connect(energyCosts.EnergyCost, OperationalCosts.u[3]) annotation (Line(
          points={{-59.84,90},{-28,90},{-28,32},{-20,32},{-20,30.95}},
                                                   color={0,0,127}));
    ...
    connect(mainBus, lifespanReductionCosts.mainBus) annotation (Line(
        ...
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(investmentCostsComponents.y, InvestmentCosts.u2) annotation (Line(
          points={{-59.4,-90},{-30,-90},{-30,-72},{-20,-72}}, color={0,0,127}));
    annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Rectangle(
            extent={{-100,100},{100,-100}},
            fillColor={215,215,215},
  ...
  model LifespanReductionCosts_2
    ...
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleHS_rpmSet
      annotation (Placement(transformation(extent={{-88,112},{-74,126}})));
       parameter Real i_HP_ThrottleHS_rpmSet;
    Benchmark.BaseClasses.MainBus mainBus
      annotation (Placement(transformation(extent={{-112,-10},{-92,10}})));
    Modelica.Blocks.Routing.RealPassThrough HP_PumpHot_rpmSet
      annotation (Placement(transformation(extent={{-88,90},{-72,106}})));
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleRecool_rpmSet
      annotation (Placement(transformation(extent={{-88,68},{-72,84}})));
    Modelica.Blocks.Routing.RealPassThrough HP_PumpCold_rpmSet
      annotation (Placement(transformation(extent={{-88,46},{-72,62}})));
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleCS_rpmSet
      annotation (Placement(transformation(extent={{-88,24},{-72,40}})));
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleFreecool_rpmSet
      annotation (Placement(transformation(extent={{-88,2},{-72,18}})));
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleHS_valveSet
      annotation (Placement(transformation(extent={{-88,-20},{-72,-4}})));
    Modelica.Blocks.Routing.RealPassThrough HP_PumpCold_valveSet
      annotation (Placement(transformation(extent={{-88,-84},{-72,-68}})));
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleRecool_valveSet
      annotation (Placement(transformation(extent={{-88,-64},{-72,-48}})));
    Modelica.Blocks.Routing.RealPassThrough HP_PumpHot_valveSet
      annotation (Placement(transformation(extent={{-88,-42},{-72,-26}})));
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleFreecool_valveSet
      annotation (Placement(transformation(extent={{-88,-128},{-72,-112}})));
    Modelica.Blocks.Routing.RealPassThrough HP_ThrottleCS_valveSet
      annotation (Placement(transformation(extent={{-88,-106},{-72,-90}})));
  equation
    ...
    connect(mainBus.hpSystemBus.busThrottleHS.pumpBus.rpmSet,
      HP_ThrottleHS_rpmSet.u) annotation (Line(
        points={{-101.95,0.05},{-101.95,119},{-89.4,119}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busPumpHot.pumpBus.rpmSet, HP_PumpHot_rpmSet.u)
      annotation (Line(
        points={{-101.95,0.05},{-102,0.05},{-102,98},{-89.6,98}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busThrottleRecool.pumpBus.rpmSet,
      HP_ThrottleRecool_rpmSet.u) annotation (Line(
        points={{-101.95,0.05},{-101.95,76},{-89.6,76}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busPumpCold.pumpBus.rpmSet, HP_PumpCold_rpmSet.u)
      annotation (Line(
        points={{-101.95,0.05},{-101.95,54},{-89.6,54}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busThrottleCS.pumpBus.rpmSet,
      HP_ThrottleCS_rpmSet.u) annotation (Line(
        points={{-101.95,0.05},{-102,0.05},{-102,32},{-89.6,32}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-3,-6},{-3,-6}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busThrottleFreecool.pumpBus.rpmSet,
      HP_ThrottleFreecool_rpmSet.u) annotation (Line(
        points={{-101.95,0.05},{-101.95,10},{-89.6,10}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busThrottleHS.valveSet, HP_ThrottleHS_valveSet.u)
      annotation (Line(
        points={{-101.95,0.05},{-101.95,-12},{-89.6,-12}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busPumpHot.valveSet, HP_PumpHot_valveSet.u)
      annotation (Line(
        points={{-101.95,0.05},{-101.95,-34},{-89.6,-34}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busThrottleRecool.valveSet,
      HP_ThrottleRecool_valveSet.u) annotation (Line(
        points={{-101.95,0.05},{-102,0.05},{-102,-56},{-89.6,-56}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busPumpCold.valveSet, HP_PumpCold_valveSet.u)
      annotation (Line(
        points={{-101.95,0.05},{-102,0.05},{-102,-76},{-89.6,-76}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busThrottleCS.valveSet, HP_ThrottleCS_valveSet.u)
      annotation (Line(
        points={{-101.95,0.05},{-102,0.05},{-102,-98},{-89.6,-98}},
        color={255,204,51},
        thickness=0.5), Text(
        ...
        extent={{-6,3},{-6,3}},
        horizontalAlignment=TextAlignment.Right));
    connect(mainBus.hpSystemBus.busThrottleFreecool.valveSet,
      HP_ThrottleFreecool_valveSet.u) annotation (Line(
        points={{-101.95,0.05},{-101.95,2},{-102,2},{-102,-120},{-89.6,-120}},
        color={255,204,51},
        thickness=0.5), Text(
        string="%first",
        index=-1,
...
Costs_2")}),                                              Diagram(
  ...
  equation
    connect(InvestmentCostsComponents.y, y)
      annotation (Line(points={{7,0},{106,0}}, color={0,0,127}));
    annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Rectangle(
            extent={{-100,100},{100,-100}},
            lineColor={0,0,0},
            ...
            textString="Investment-
Costs for
Components")}), Diagram(coordinateSystem(preserveAspectRatio=false)));
  ...
  package BaseClasses
    model RBF
      ...
      Modelica.Blocks.Interfaces.RealOutput RBF annotation (
        Placement(visible = true, transformation(extent={{96,-66},{116,-46}},       rotation = 0), iconTransformation(extent={{96,-66},
                {116,-46}},                                                                                                                              rotation = 0)));
      AixLib.Systems.Benchmark_fb.CCCS.BaseClasses.discountingFactor
    ...
    model LRM_TempAndHum
      "performance reduction due to room temperature and humidity"
    ...
    equation
      ...
      connect(multiSum4.y, PRC) annotation (
        Line(points={{-2,-167.7},{-17.5,-167.7},{-17.5,-163.7},{-21,-163.7},{
              -21,-165.7},{-14,-165.7},{-14,-185.7},{-15,-185.7},{-15,-186},{2,
              -186}},                                                                                                                                                             color = {0, 0, 127}));
      ...
      connect(switch19.y, multiSum3.u[3]) annotation (Line(points={{231,-28},{
              238,-28},{238,20},{247.333,20},{247.333,12}},
                                                        color={0,0,127}));
      ...
      connect(switch1.y, multiSum4.u[1]) annotation (Line(points={{-175,-96},{
              -170,-96},{-170,-98},{-136,-98},{-136,-142},{2.66667,-142},{
              2.66667,-146}},  color={0,0,127}));
      connect(switch16.y, multiSum4.u[2]) annotation (Line(points={{21,-100},{
              20,-100},{20,-138},{-10,-138},{-10,-146},{-2,-146}},
                                                                 color={0,0,127}));
      connect(switch18.y, multiSum4.u[3]) annotation (Line(points={{251,-104},{
              251,-154},{-6.66667,-154},{-6.66667,-146}}, color={0,0,127}));
      ...
      annotation (
        ...
        Icon(coordinateSystem(extent = {{-400, -180}, {400, 180}}), graphics={
              Rectangle(
              extent={{-398,180},{402,-180}},
              lineColor={0,0,0},
              fillColor={215,215,215},
              fillPattern=FillPattern.Solid), Text(
              extent={{-154,48},{142,-32}},
              lineColor={0,0,0},
              fillColor={215,215,215},
              fillPattern=FillPattern.Solid,
              textString="LRM")}),
    ...
    block discountingFactor
      "u1 is the discounting factor, u2 is the duration in years"
...
Factor")}));
    ...
    equation
      ...
      connect(switch1.y, add1.u2)
        annotation (Line(points={{17,-34},{58,-34},{58,-6}},  color={0,0,127}));
      connect(switch12.y, add1.u1)
        annotation (Line(points={{17,32},{58,32},{58,6}},  color={0,0,127}));
