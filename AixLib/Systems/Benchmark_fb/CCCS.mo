...
package CCCS
  ...
  equation
    ...
    annotation (
      ...
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-150, -100}, {100, 100}}, initialScale = 0.1), graphics={  Text(lineColor = {0, 0, 255}, extent = {{-150, 110}, {150, 150}}, textString = ""), Text(lineColor = {0, 0, 255}, extent = {{-38, -34}, {38, 34}}, textString = ""), Text(extent = {{-100, -92}, {5, -52}}, textString = ""), Rectangle(fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-150, 100}, {100, -100}}), Text(lineColor = {95, 95, 95}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, extent = {{-118, 32}, {60, -34}}, textString = "Energy-
Costs")}));
  end EnergyCosts;
  ...
  equation
    ...
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -150}, {150, 150}}), graphics={  Rectangle(extent = {{-100, 150}, {150, -152}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                 FillPattern.Solid), Text(extent = {{-38, 36}, {90, -34}}, lineColor=
                {95,95,95},                                                                                                                                                                                                        fillColor=
                {215,215,215},
