...
Costs")}));
  ...
  equation
    ...
    connect(mainBus.evaBus.QbrTotalMea, EmissionsFactorFuel.u) annotation (
      ...
      Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(extent = {{-100, 100}, {100, -102}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                            FillPattern.Solid), Text(extent = {{-62, 26}, {54, -32}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "Emission-
Costs")}),
  ...
  equation
    connect(feedback1[6].y, multiProduct1[2].u[3]) annotation (
      Line(points={{-9,56},{-20,56},{-20,44},{0,44},{0,40},{0,40},{-3.73333,40}},         color = {0, 0, 127}, thickness = 0.5));
    connect(feedback1[5].y, multiProduct1[2].u[2]) annotation (
      Line(points={{-9,56},{-20,56},{-20,44},{0,44},{0,42},{0,42},{0,40}},                color = {0, 0, 127}, thickness = 0.5));
    connect(feedback1[4].y, multiProduct1[2].u[1]) annotation (
      Line(points={{-9,56},{-20,56},{-20,44},{0,44},{0,42},{0,40},{3.73333,40}},          color = {0, 0, 127}, thickness = 0.5));
    ...
    connect(multiProduct1[5].y, feedback2[5].u2) annotation (
      Line(points={{0,22.64},{0,22.64},{0,14},{0,14}},    color = {0, 0, 127}, thickness = 0.5));
    ...
    connect(lrm_co21[2].y, feedback1[6].u2) annotation (
      Line(points={{19.8,70},{0,70},{0,66},{0,66},{0,64},{0,64}},            color = {0, 0, 127}, thickness = 0.5));
    connect(lrm_voc1[2].y, feedback1[5].u2) annotation (
      Line(points={{0,77.4},{0,77.4},{0,64},{0,64}},      color = {0, 0, 127}, thickness = 0.5));
    connect(lRM_Temp[2].y, feedback1[4].u2) annotation (
      Line(points={{-19.2,70},{0,70},{0,66},{0,66},{0,64}},          color = {0, 0, 127}, thickness = 0.5));
    ...
    connect(mainBus.TRoom1Mea, lRM_Temp[1].T) annotation (
      Line(points={{-101.95,0.05},{-88,0.05},{-88,0},{-50,0},{-50,76.5},{-40,76.5},
            {-40,76.8}},                                                                                     color = {255, 204, 51}, thickness = 0.5));
    connect(mainBus.TRoom2Mea, lRM_Temp[2].T) annotation (
      Line(points={{-101.95,0.05},{-70,0.05},{-70,0},{-50,0},{-50,76.5},{-40,76.5},
            {-40,76.8}},                                                                                     color = {255, 204, 51}, thickness = 0.5));
    ...
    connect(mainBus.TRoom5Mea, lRM_Temp[5].T) annotation (
      Line(points={{-101.95,0.05},{-96,0.05},{-96,0},{-50,0},{-50,76.5},{-40,76.5},
            {-40,76.8}},                                                                                     color = {255, 204, 51}, thickness = 0.5));
    ...
    annotation (
      ...
      Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics={  Text(lineColor = {0, 0, 255}, extent = {{-150, 110}, {150, 150}}, textString = ""), Text(extent = {{-100, 52}, {5, 92}}, textString = ""), Text(extent = {{-100, -92}, {5, -52}}, textString = ""), Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Text(extent = {{-68, 36}, {62, -40}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "Performance-
Reduction-
Costs")}));
...
Costs")}),
  ...
  equation
    ...
    kStrat = K_Strat;
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                            FillPattern.Solid), Text(extent = {{-50, 32}, {52, -30}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "Investment-
Costs for
Strategy")}),
      Diagram(coordinateSystem(preserveAspectRatio = false)));
  ...
  equation
    connect(investmentCostsStrategy1.kStrat, InvestmentCosts.u1) annotation (
      Line(points={{-59.8,-50},{-30,-50},{-30,-60},{-20,-60}},        color = {0, 0, 127}));
    ...
    connect(performanceReductionCosts1.PRC, OperationalCosts.u[2]) annotation (
      Line(points={{-59.2,15},{-46,15},{-46,14},{-34,14},{-34,34},{-28,34},{-28,
            33.05},{-20,33.05}},                                                                                      color = {0, 0, 127}));
    ...
    connect(mainBus, lifespanReductionCosts_2_1.mainBus) annotation (Line(
        points={{-100,0},{-100,-16},{-84,-16},{-84,-14.4}},
        color={255,204,51},
        thickness=0.5));
    connect(lifespanReductionCosts_2_1.y, OperationalCosts.u[4]) annotation (
        Line(points={{-57.792,-15},{-34,-15},{-34,28},{-28,28},{-28,28.85},{-20,
            28.85}}, color={0,0,127}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                     FillPattern.Solid, lineColor = {0, 0, 0}), Text(extent = {{-72, 34}, {78, -30}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "CCCS")}),
      Diagram(coordinateSystem(preserveAspectRatio = false)));
  end Evaluation_CCCS;
  ...
  model LifespanReductionCosts_2
    ...
    AixLib.Systems.Benchmark.BaseClasses.MainBus mainBus annotation (
      Placement(visible = true, transformation(extent={{-110,-4},{-90,16}},       rotation = 0), iconTransformation(extent={{-110,-4},
              {-90,16}},                                                                                                                               rotation = 0)));
    ...
    AixLib.Systems.Benchmark_fb.CCCS.BaseClasses.lifespan_Reduction_Cost_Component
      lifespan_Reduction_Cost_Pumps[46](each cost_component=3000, each sim_time=4838400)
      annotation (Placement(visible=true, transformation(
          origin={90,50},
          extent={{-10,-10},{10,10}},
          rotation=0)));
  Modelica.Blocks.Math.MultiSum multiSum1(nu=97)
                                          annotation (
      Placement(visible = true, transformation(origin={122,0},   extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    AixLib.Systems.Benchmark_fb.CCCS.BaseClasses.lifespan_Reduction_Cost_Component
      lifespan_Reduction_Cost_Valves[51](each cost_component=1000, each sim_time=4838400)
      annotation (Placement(visible=true, transformation(
          origin={90,-50},
          extent={{-10,-10},{10,10}},
          rotation=0)));
    Modelica.Blocks.Routing.RealPassThrough gtf_sec_rpmSet
      annotation (Placement(transformation(extent={{-60,-46},{-46,-32}})));
    Modelica.Blocks.Routing.RealPassThrough gtf_prim_valveSet
      annotation (Placement(transformation(extent={{-60,-24},{-46,-10}})));
    Modelica.Blocks.Routing.RealPassThrough gtf_prim_rpmSet
      annotation (Placement(transformation(extent={{-60,-2},{-46,12}})));
    Modelica.Blocks.Routing.RealPassThrough hts_chp_valveSet
      annotation (Placement(transformation(extent={{-60,42},{-46,56}})));
    Modelica.Blocks.Routing.RealPassThrough hts_chp_rpmSet
      annotation (Placement(transformation(extent={{-60,64},{-46,78}})));
    Modelica.Blocks.Routing.RealPassThrough hts_boiler_valveSet
      annotation (Placement(transformation(extent={{-60,86},{-46,100}})));
    Modelica.Blocks.Routing.RealPassThrough hts_boiler_rpmSet
      annotation (Placement(transformation(extent={{-60,108},{-46,122}})));
    Modelica.Blocks.Routing.RealPassThrough gtf_sec_valveSet
      annotation (Placement(transformation(extent={{-60,-68},{-46,-54}})));
    Modelica.Blocks.Routing.RealPassThrough tabs_hotThrottle_rpmSet[5]
      annotation (Placement(transformation(extent={{-28,74},{-14,88}})));
    Modelica.Blocks.Routing.RealPassThrough tabs_pump_rpmSet[5]
      annotation (Placement(transformation(extent={{-28,120},{-14,134}})));
    Modelica.Blocks.Routing.RealPassThrough tabs_pump_valveSet[5]
      annotation (Placement(transformation(extent={{-28,96},{-14,110}})));
    Modelica.Blocks.Routing.RealPassThrough tabs_coldThrottle_valveSet[5]
      annotation (Placement(transformation(extent={{-28,6},{-14,20}})));
    Modelica.Blocks.Routing.RealPassThrough tabs_hotThrottle_valveSet[5]
      annotation (Placement(transformation(extent={{-28,52},{-14,66}})));
    Modelica.Blocks.Routing.RealPassThrough tabs_coldThrottle_rpmSet[5]
      annotation (Placement(transformation(extent={{-28,28},{-14,42}})));
    Modelica.Blocks.Routing.RealPassThrough vu_heater_rpmSet[5]
      annotation (Placement(transformation(extent={{-28,-78},{-14,-64}})));
    Modelica.Blocks.Routing.RealPassThrough vu_preheat_rpmSet[5]
      annotation (Placement(transformation(extent={{-28,-32},{-14,-18}})));
    Modelica.Blocks.Routing.RealPassThrough vu_preheat_valveSet[5]
      annotation (Placement(transformation(extent={{-28,-56},{-14,-42}})));
    Modelica.Blocks.Routing.RealPassThrough vu_cooler_valveSet[5]
      annotation (Placement(transformation(extent={{-28,-146},{-14,-132}})));
    Modelica.Blocks.Routing.RealPassThrough vu_heater_valveSet[5]
      annotation (Placement(transformation(extent={{-28,-100},{-14,-86}})));
    Modelica.Blocks.Routing.RealPassThrough vu_cooler_rpmSet[5]
      annotation (Placement(transformation(extent={{-28,-124},{-14,-110}})));
    Modelica.Blocks.Routing.RealPassThrough hx_sec_rpmSet
      annotation (Placement(transformation(extent={{2,64},{16,78}})));
    Modelica.Blocks.Routing.RealPassThrough hx_prim_valveSet
      annotation (Placement(transformation(extent={{2,86},{16,100}})));
    Modelica.Blocks.Routing.RealPassThrough hx_prim_rpmSet
      annotation (Placement(transformation(extent={{2,108},{16,122}})));
    Modelica.Blocks.Routing.RealPassThrough hx_sec_valveSet
      annotation (Placement(transformation(extent={{2,42},{16,56}})));
    Modelica.Blocks.Routing.RealPassThrough swu_Y3valveSet
      annotation (Placement(transformation(extent={{2,-44},{16,-30}})));
    Modelica.Blocks.Routing.RealPassThrough swu_Y2valveSet
      annotation (Placement(transformation(extent={{2,-22},{16,-8}})));
    Modelica.Blocks.Routing.RealPassThrough swu_pump_rpmSet
      annotation (Placement(transformation(extent={{2,0},{16,14}})));
    Modelica.Blocks.Routing.RealPassThrough swu_K1valveSet
      annotation (Placement(transformation(extent={{2,-66},{16,-52}})));
    Modelica.Blocks.Routing.RealPassThrough swu_K3valveSet
      annotation (Placement(transformation(extent={{2,-112},{16,-98}})));
    Modelica.Blocks.Routing.RealPassThrough swu_K2valveSet
      annotation (Placement(transformation(extent={{2,-90},{16,-76}})));
    Modelica.Blocks.Routing.RealPassThrough swu_K4valveSet
      annotation (Placement(transformation(extent={{2,-134},{16,-120}})));
    Modelica.Blocks.Routing.RealPassThrough ahu_heater_rpmSet
      annotation (Placement(transformation(extent={{34,76},{48,90}})));
    Modelica.Blocks.Routing.RealPassThrough ahu_preheater_valveSet
      annotation (Placement(transformation(extent={{34,98},{48,112}})));
    Modelica.Blocks.Routing.RealPassThrough ahu_preheater_rpmSet
      annotation (Placement(transformation(extent={{34,120},{48,134}})));
    Modelica.Blocks.Routing.RealPassThrough ahu_heater_valveSet
      annotation (Placement(transformation(extent={{34,54},{48,68}})));
    Modelica.Blocks.Routing.RealPassThrough ahu_cooler_rpmSet
      annotation (Placement(transformation(extent={{34,32},{48,46}})));
    Modelica.Blocks.Routing.RealPassThrough ahu_cooler_valveSet
      annotation (Placement(transformation(extent={{34,10},{48,24}})));
  equation
    ...
    connect(mainBus.hpSystemBus.busPumpHot.pumpBus.rpmSet, HP_PumpHot_rpmSet.u) annotation (
      Line(points={{-99.95,6.05},{-99.95,104},{-89.6,104}},
    ...
    connect(mainBus.htsBus.pumpBoilerBus.pumpBus.rpmSet, hts_boiler_rpmSet.u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,116},{-80,116},{-80,115},{-61.4,115}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.htsBus.pumpBoilerBus.valveSet, hts_boiler_valveSet.u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,93},{-61.4,93}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.htsBus.pumpChpBus.pumpBus.rpmSet, hts_chp_rpmSet.u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,71},{-61.4,71}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.htsBus.pumpChpBus.valveSet, hts_chp_valveSet.u) annotation (
        Line(
        points={{-99.95,6.05},{-99.95,49},{-61.4,49}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.gtfBus.primBus.pumpBus.rpmSet, gtf_prim_rpmSet.u) annotation (
       Line(
        points={{-99.95,6.05},{-100,6.05},{-100,5},{-61.4,5}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.gtfBus.secBus.pumpBus.rpmSet, gtf_sec_rpmSet.u) annotation (
        Line(
        points={{-99.95,6.05},{-99.95,-39},{-61.4,-39}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.gtfBus.primBus.valveSet, gtf_prim_valveSet.u) annotation (
        Line(
        points={{-99.95,6.05},{-99.95,-17},{-61.4,-17}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.gtfBus.secBus.valveSet, gtf_sec_valveSet.u) annotation (Line(
        points={{-99.95,6.05},{-99.95,-61},{-61.4,-61}},
        color={255,204,51},
        thickness=0.5));
    connect(HP_ThrottleHS_rpmSet.y, lifespan_Reduction_Cost_Pumps[1].u)
      annotation (Line(points={{-73.3,125},{-68,125},{-68,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(HP_PumpHot_rpmSet.y, lifespan_Reduction_Cost_Pumps[2].u) annotation (
        Line(points={{-71.2,104},{-68,104},{-68,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(HP_ThrottleRecool_rpmSet.y, lifespan_Reduction_Cost_Pumps[3].u)
      annotation (Line(points={{-71.2,82},{-68,82},{-68,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(HP_PumpCold_rpmSet.y, lifespan_Reduction_Cost_Pumps[4].u) annotation (
       Line(points={{-71.2,60},{-68,60},{-68,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(HP_ThrottleCS_rpmSet.y, lifespan_Reduction_Cost_Pumps[5].u)
      annotation (Line(points={{-71.2,38},{-68,38},{-68,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(HP_ThrottleFreecool_rpmSet.y, lifespan_Reduction_Cost_Pumps[6].u)
      annotation (Line(points={{-71.2,16},{-68,16},{-68,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(HP_ThrottleHS_valveSet.y, lifespan_Reduction_Cost_Valves[1].u)
      annotation (Line(points={{-71.2,-6},{-66,-6},{-66,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(HP_PumpHot_valveSet.y, lifespan_Reduction_Cost_Valves[2].u)
      annotation (Line(points={{-71.2,-28},{-66,-28},{-66,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
    connect(HP_ThrottleRecool_valveSet.y, lifespan_Reduction_Cost_Valves[3].u)
      annotation (Line(points={{-71.2,-50},{-66,-50},{-66,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
    connect(HP_PumpCold_valveSet.y, lifespan_Reduction_Cost_Valves[4].u)
      annotation (Line(points={{-71.2,-70},{-66,-70},{-66,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
    connect(HP_ThrottleCS_valveSet.y, lifespan_Reduction_Cost_Valves[5].u)
      annotation (Line(points={{-71.2,-92},{-66,-92},{-66,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
    connect(HP_ThrottleFreecool_valveSet.y, lifespan_Reduction_Cost_Valves[6].u)
      annotation (Line(points={{-71.2,-114},{-66,-114},{-66,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
    connect(hts_boiler_rpmSet.y, lifespan_Reduction_Cost_Pumps[7].u) annotation (
        Line(points={{-45.3,115},{-40,115},{-40,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(hts_chp_rpmSet.y, lifespan_Reduction_Cost_Pumps[8].u) annotation (
        Line(points={{-45.3,71},{-40,71},{-40,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(gtf_prim_rpmSet.y, lifespan_Reduction_Cost_Pumps[9].u) annotation (
        Line(points={{-45.3,5},{-40,5},{-40,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(gtf_sec_rpmSet.y, lifespan_Reduction_Cost_Pumps[10].u) annotation (
        Line(points={{-45.3,-39},{-40,-39},{-40,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(hts_boiler_valveSet.y, lifespan_Reduction_Cost_Valves[7].u)
      annotation (Line(points={{-45.3,93},{-42,93},{-42,94},{-40,94},{-40,-150},{72,
            -150},{72,-50},{79.6,-50}}, color={0,0,127}));
    connect(hts_chp_valveSet.y, lifespan_Reduction_Cost_Valves[8].u) annotation (
        Line(points={{-45.3,49},{-40,49},{-40,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(gtf_prim_valveSet.y, lifespan_Reduction_Cost_Valves[9].u) annotation (
       Line(points={{-45.3,-17},{-40,-17},{-40,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(gtf_sec_valveSet.y, lifespan_Reduction_Cost_Valves[10].u) annotation (
       Line(points={{-45.3,-61},{-40,-61},{-40,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
     connect(tabs_pump_rpmSet[1].y, lifespan_Reduction_Cost_Pumps[11].u)
      annotation (Line(points={{-13.3,127},{-6,127},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_hotThrottle_rpmSet[1].y, lifespan_Reduction_Cost_Pumps[12].u)
      annotation (Line(points={{-13.3,81},{-6,81},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_coldThrottle_rpmSet[1].y, lifespan_Reduction_Cost_Pumps[13].u)
      annotation (Line(points={{-13.3,35},{-10,35},{-10,36},{-6,36},{-6,156},{70,156},
            {70,50},{79.6,50}}, color={0,0,127}));

            connect(tabs_pump_rpmSet[2].y, lifespan_Reduction_Cost_Pumps[14].u)
      annotation (Line(points={{-13.3,127},{-6,127},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_hotThrottle_rpmSet[2].y, lifespan_Reduction_Cost_Pumps[15].u)
      annotation (Line(points={{-13.3,81},{-6,81},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_coldThrottle_rpmSet[2].y, lifespan_Reduction_Cost_Pumps[16].u)
      annotation (Line(points={{-13.3,35},{-10,35},{-10,36},{-6,36},{-6,156},{70,156},
            {70,50},{79.6,50}}, color={0,0,127}));

            connect(tabs_pump_rpmSet[3].y, lifespan_Reduction_Cost_Pumps[17].u)
      annotation (Line(points={{-13.3,127},{-6,127},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_hotThrottle_rpmSet[3].y, lifespan_Reduction_Cost_Pumps[18].u)
      annotation (Line(points={{-13.3,81},{-6,81},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_coldThrottle_rpmSet[3].y, lifespan_Reduction_Cost_Pumps[19].u)
      annotation (Line(points={{-13.3,35},{-10,35},{-10,36},{-6,36},{-6,156},{70,156},
            {70,50},{79.6,50}}, color={0,0,127}));

            connect(tabs_pump_rpmSet[4].y, lifespan_Reduction_Cost_Pumps[20].u)
      annotation (Line(points={{-13.3,127},{-6,127},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_hotThrottle_rpmSet[4].y, lifespan_Reduction_Cost_Pumps[21].u)
      annotation (Line(points={{-13.3,81},{-6,81},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_coldThrottle_rpmSet[4].y, lifespan_Reduction_Cost_Pumps[22].u)
      annotation (Line(points={{-13.3,35},{-10,35},{-10,36},{-6,36},{-6,156},{70,156},
            {70,50},{79.6,50}}, color={0,0,127}));

            connect(tabs_pump_rpmSet[5].y, lifespan_Reduction_Cost_Pumps[23].u)
      annotation (Line(points={{-13.3,127},{-6,127},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_hotThrottle_rpmSet[5].y, lifespan_Reduction_Cost_Pumps[24].u)
      annotation (Line(points={{-13.3,81},{-6,81},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(tabs_coldThrottle_rpmSet[5].y, lifespan_Reduction_Cost_Pumps[25].u)
      annotation (Line(points={{-13.3,35},{-10,35},{-10,36},{-6,36},{-6,156},{70,156},
            {70,50},{79.6,50}}, color={0,0,127}));
    connect(tabs_pump_valveSet[1].y, lifespan_Reduction_Cost_Valves[11].u)
      annotation (Line(points={{-13.3,103},{-6,103},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(tabs_hotThrottle_valveSet[1].y, lifespan_Reduction_Cost_Valves[12].u)
      annotation (Line(points={{-13.3,59},{-6,59},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));
    connect(tabs_coldThrottle_valveSet[1].y, lifespan_Reduction_Cost_Valves[13].u)
      annotation (Line(points={{-13.3,13},{-6,13},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));

            connect(tabs_pump_valveSet[2].y, lifespan_Reduction_Cost_Valves[14].u)
      annotation (Line(points={{-13.3,103},{-6,103},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(tabs_hotThrottle_valveSet[2].y, lifespan_Reduction_Cost_Valves[15].u)
      annotation (Line(points={{-13.3,59},{-6,59},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));
    connect(tabs_coldThrottle_valveSet[2].y, lifespan_Reduction_Cost_Valves[16].u)
      annotation (Line(points={{-13.3,13},{-6,13},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));

            connect(tabs_pump_valveSet[3].y, lifespan_Reduction_Cost_Valves[17].u)
      annotation (Line(points={{-13.3,103},{-6,103},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(tabs_hotThrottle_valveSet[3].y, lifespan_Reduction_Cost_Valves[18].u)
      annotation (Line(points={{-13.3,59},{-6,59},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));
    connect(tabs_coldThrottle_valveSet[3].y, lifespan_Reduction_Cost_Valves[19].u)
      annotation (Line(points={{-13.3,13},{-6,13},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));

            connect(tabs_pump_valveSet[4].y, lifespan_Reduction_Cost_Valves[20].u)
      annotation (Line(points={{-13.3,103},{-6,103},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(tabs_hotThrottle_valveSet[4].y, lifespan_Reduction_Cost_Valves[21].u)
      annotation (Line(points={{-13.3,59},{-6,59},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));
    connect(tabs_coldThrottle_valveSet[4].y, lifespan_Reduction_Cost_Valves[22].u)
      annotation (Line(points={{-13.3,13},{-6,13},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));

            connect(tabs_pump_valveSet[5].y, lifespan_Reduction_Cost_Valves[23].u)
      annotation (Line(points={{-13.3,103},{-6,103},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(tabs_hotThrottle_valveSet[5].y, lifespan_Reduction_Cost_Valves[24].u)
      annotation (Line(points={{-13.3,59},{-6,59},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));
    connect(tabs_coldThrottle_valveSet[5].y, lifespan_Reduction_Cost_Valves[25].u)
      annotation (Line(points={{-13.3,13},{-6,13},{-6,-150},{72,-150},{72,-50},{79.6,
            -50}}, color={0,0,127}));

    connect(vu_preheat_rpmSet[1].y, lifespan_Reduction_Cost_Pumps[26].u)
      annotation (Line(points={{-13.3,-25},{-6,-25},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
      connect(vu_heater_rpmSet[1].y, lifespan_Reduction_Cost_Pumps[27].u)
      annotation (Line(points={{-13.3,-71},{-6,-71},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_cooler_rpmSet[1].y, lifespan_Reduction_Cost_Pumps[28].u)
      annotation (Line(points={{-13.3,-117},{-6,-117},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));

            connect(vu_preheat_rpmSet[2].y, lifespan_Reduction_Cost_Pumps[29].u)
      annotation (Line(points={{-13.3,-25},{-6,-25},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_heater_rpmSet[2].y, lifespan_Reduction_Cost_Pumps[30].u)
      annotation (Line(points={{-13.3,-71},{-6,-71},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_cooler_rpmSet[2].y, lifespan_Reduction_Cost_Pumps[31].u)
      annotation (Line(points={{-13.3,-117},{-6,-117},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));

            connect(vu_preheat_rpmSet[3].y, lifespan_Reduction_Cost_Pumps[32].u)
      annotation (Line(points={{-13.3,-25},{-6,-25},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_heater_rpmSet[3].y, lifespan_Reduction_Cost_Pumps[33].u)
      annotation (Line(points={{-13.3,-71},{-6,-71},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_cooler_rpmSet[3].y, lifespan_Reduction_Cost_Pumps[34].u)
      annotation (Line(points={{-13.3,-117},{-6,-117},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
            connect(vu_preheat_rpmSet[4].y, lifespan_Reduction_Cost_Pumps[35].u)
      annotation (Line(points={{-13.3,-25},{-6,-25},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_heater_rpmSet[4].y, lifespan_Reduction_Cost_Pumps[36].u)
      annotation (Line(points={{-13.3,-71},{-6,-71},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_cooler_rpmSet[4].y, lifespan_Reduction_Cost_Pumps[37].u)
      annotation (Line(points={{-13.3,-117},{-6,-117},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
            connect(vu_preheat_rpmSet[5].y, lifespan_Reduction_Cost_Pumps[38].u)
      annotation (Line(points={{-13.3,-25},{-6,-25},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_heater_rpmSet[5].y, lifespan_Reduction_Cost_Pumps[39].u)
      annotation (Line(points={{-13.3,-71},{-6,-71},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));
    connect(vu_cooler_rpmSet[5].y, lifespan_Reduction_Cost_Pumps[40].u)
      annotation (Line(points={{-13.3,-117},{-6,-117},{-6,156},{70,156},{70,50},{79.6,
            50}}, color={0,0,127}));

    connect(vu_preheat_valveSet[1].y, lifespan_Reduction_Cost_Valves[26].u)
      annotation (Line(points={{-13.3,-49},{-6,-49},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_heater_valveSet[1].y, lifespan_Reduction_Cost_Valves[27].u)
      annotation (Line(points={{-13.3,-93},{-6,-93},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_cooler_valveSet[1].y, lifespan_Reduction_Cost_Valves[28].u)
      annotation (Line(points={{-13.3,-139},{-6,-139},{-6,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));

            connect(vu_preheat_valveSet[2].y, lifespan_Reduction_Cost_Valves[29].u)
      annotation (Line(points={{-13.3,-49},{-6,-49},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_heater_valveSet[2].y, lifespan_Reduction_Cost_Valves[30].u)
      annotation (Line(points={{-13.3,-93},{-6,-93},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_cooler_valveSet[2].y, lifespan_Reduction_Cost_Valves[31].u)
      annotation (Line(points={{-13.3,-139},{-6,-139},{-6,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
            connect(vu_preheat_valveSet[3].y, lifespan_Reduction_Cost_Valves[32].u)
      annotation (Line(points={{-13.3,-49},{-6,-49},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_heater_valveSet[3].y, lifespan_Reduction_Cost_Valves[33].u)
      annotation (Line(points={{-13.3,-93},{-6,-93},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_cooler_valveSet[3].y, lifespan_Reduction_Cost_Valves[34].u)
      annotation (Line(points={{-13.3,-139},{-6,-139},{-6,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
            connect(vu_preheat_valveSet[4].y, lifespan_Reduction_Cost_Valves[35].u)
      annotation (Line(points={{-13.3,-49},{-6,-49},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_heater_valveSet[4].y, lifespan_Reduction_Cost_Valves[36].u)
      annotation (Line(points={{-13.3,-93},{-6,-93},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_cooler_valveSet[4].y, lifespan_Reduction_Cost_Valves[37].u)
      annotation (Line(points={{-13.3,-139},{-6,-139},{-6,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));
            connect(vu_preheat_valveSet[5].y, lifespan_Reduction_Cost_Valves[38].u)
      annotation (Line(points={{-13.3,-49},{-6,-49},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_heater_valveSet[5].y, lifespan_Reduction_Cost_Valves[39].u)
      annotation (Line(points={{-13.3,-93},{-6,-93},{-6,-150},{72,-150},{72,-50},{
            79.6,-50}}, color={0,0,127}));
    connect(vu_cooler_valveSet[5].y, lifespan_Reduction_Cost_Valves[40].u)
      annotation (Line(points={{-13.3,-139},{-6,-139},{-6,-150},{72,-150},{72,-50},
            {79.6,-50}}, color={0,0,127}));

    connect(mainBus.hxBus.primBus.pumpBus.rpmSet, hx_prim_rpmSet.u) annotation (
        Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-6,156},{-6,115},{0.6,115}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.ahuBus.preheaterBus.hydraulicBus.pumpBus.rpmSet,
      ahu_preheater_rpmSet.u) annotation (Line(
        points={{-99.95,6.05},{-99.95,156},{24,156},{24,127},{32.6,127}},
        color={255,204,51},
        thickness=0.5));
    connect(ahu_preheater_rpmSet.y, lifespan_Reduction_Cost_Pumps[44].u)
      annotation (Line(points={{48.7,127},{70,127},{70,50},{79.6,50}}, color={0,0,
            127}));
    ...
    connect(ahu_preheater_valveSet.y, lifespan_Reduction_Cost_Valves[49].u)
      annotation (Line(points={{48.7,105},{60,105},{60,106},{72,106},{72,-50},{79.6,
            -50}}, color={0,0,127}));
    connect(ahu_heater_valveSet.y, lifespan_Reduction_Cost_Valves[50].u)
      annotation (Line(points={{48.7,61},{72,61},{72,-50},{79.6,-50}}, color={0,0,
            127}));
    connect(ahu_cooler_valveSet.y, lifespan_Reduction_Cost_Valves[51].u)
      annotation (Line(points={{48.7,17},{60,17},{60,18},{72,18},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(hx_prim_rpmSet.y, lifespan_Reduction_Cost_Pumps[41].u) annotation (
        Line(points={{16.7,115},{24,115},{24,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(hx_sec_rpmSet.y, lifespan_Reduction_Cost_Pumps[42].u) annotation (
        Line(points={{16.7,71},{24,71},{24,156},{70,156},{70,50},{79.6,50}},
          color={0,0,127}));
    connect(hx_prim_valveSet.y, lifespan_Reduction_Cost_Valves[41].u) annotation (
       Line(points={{16.7,93},{24,93},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(hx_sec_valveSet.y, lifespan_Reduction_Cost_Valves[42].u) annotation (
        Line(points={{16.7,49},{24,49},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(swu_pump_rpmSet.y, lifespan_Reduction_Cost_Pumps[43].u) annotation (
        Line(points={{16.7,7},{24,7},{24,156},{70,156},{70,50},{79.6,50}}, color={
            0,0,127}));
    connect(swu_Y2valveSet.y, lifespan_Reduction_Cost_Valves[43].u) annotation (
        Line(points={{16.7,-15},{24,-15},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(swu_Y3valveSet.y, lifespan_Reduction_Cost_Valves[44].u) annotation (
        Line(points={{16.7,-37},{24,-37},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(swu_K1valveSet.y, lifespan_Reduction_Cost_Valves[45].u) annotation (
        Line(points={{16.7,-59},{24,-59},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(swu_K2valveSet.y, lifespan_Reduction_Cost_Valves[46].u) annotation (
        Line(points={{16.7,-83},{24,-83},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(swu_K3valveSet.y, lifespan_Reduction_Cost_Valves[47].u) annotation (
        Line(points={{16.7,-105},{24,-105},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(swu_K4valveSet.y, lifespan_Reduction_Cost_Valves[48].u) annotation (
        Line(points={{16.7,-127},{24,-127},{24,-150},{72,-150},{72,-50},{79.6,-50}},
          color={0,0,127}));
    connect(lifespan_Reduction_Cost_Pumps.y, multiSum1.u[1:46]) annotation (Line(
          points={{100,50},{106,50},{106,0.43299},{112,0.43299}}, color={0,0,127}));
    connect(lifespan_Reduction_Cost_Valves.y, multiSum1.u[47:97]) annotation (
        Line(points={{100,-50},{106,-50},{106,-6.84783},{112,-6.84783},{112,-6.92784}},
          color={0,0,127}));

     connect(mainBus.tabs1Bus.pumpBus.pumpBus.rpmSet, tabs_pump_rpmSet[1].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,156},{-40,156},{-40,127},{-29.4,127}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs1Bus.pumpBus.valveSet, tabs_pump_valveSet[1].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,102},{-29.4,102},
            {-29.4,103}},
        color={255,204,51},
        thickness=0.5));
    ...
    connect(mainBus.tabs1Bus.hotThrottleBus.pumpBus.rpmSet,
      tabs_hotThrottle_rpmSet[1].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs1Bus.hotThrottleBus.valveSet, tabs_hotThrottle_valveSet[1].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,59},{-29.4,59}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs1Bus.coldThrottleBus.pumpBus.rpmSet,
      tabs_coldThrottle_rpmSet[1].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,35},{-29.4,35}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs1Bus.coldThrottleBus.valveSet, tabs_coldThrottle_valveSet[
      1].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,13},{-29.4,13}},
        color={255,204,51},
        thickness=0.5));
      ...
      annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs2Bus.pumpBus.valveSet, tabs_pump_valveSet[2].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,102},{-29.4,102},
            {-29.4,103}},
        color={255,204,51},
    ...
    connect(mainBus.tabs2Bus.hotThrottleBus.pumpBus.rpmSet,
      tabs_hotThrottle_rpmSet[2].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs2Bus.hotThrottleBus.valveSet, tabs_hotThrottle_valveSet[2].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,59},{-29.4,59}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs2Bus.coldThrottleBus.pumpBus.rpmSet,
      tabs_coldThrottle_rpmSet[2].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,35},{-29.4,35}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs2Bus.coldThrottleBus.valveSet, tabs_coldThrottle_valveSet[
      2].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,13},{-29.4,13}},
        color={255,204,51},
        thickness=0.5));

         connect(mainBus.tabs3Bus.pumpBus.pumpBus.rpmSet, tabs_pump_rpmSet[3].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,156},{-40,156},{-40,127},{-29.4,127}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs3Bus.pumpBus.valveSet, tabs_pump_valveSet[3].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,102},{-29.4,102},
            {-29.4,103}},
        color={255,204,51},
    ...
    connect(mainBus.tabs3Bus.hotThrottleBus.pumpBus.rpmSet,
      tabs_hotThrottle_rpmSet[3].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs3Bus.hotThrottleBus.valveSet, tabs_hotThrottle_valveSet[3].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,59},{-29.4,59}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs3Bus.coldThrottleBus.pumpBus.rpmSet,
      tabs_coldThrottle_rpmSet[3].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,35},{-29.4,35}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs3Bus.coldThrottleBus.valveSet, tabs_coldThrottle_valveSet[
      3].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,13},{-29.4,13}},
        color={255,204,51},
        thickness=0.5));

         connect(mainBus.tabs4Bus.pumpBus.pumpBus.rpmSet, tabs_pump_rpmSet[4].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,156},{-40,156},{-40,127},{-29.4,127}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs4Bus.pumpBus.valveSet, tabs_pump_valveSet[4].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,102},{-29.4,102},
            {-29.4,103}},
        color={255,204,51},
    ...
    connect(mainBus.tabs4Bus.hotThrottleBus.pumpBus.rpmSet,
      tabs_hotThrottle_rpmSet[4].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs4Bus.hotThrottleBus.valveSet, tabs_hotThrottle_valveSet[4].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,59},{-29.4,59}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs4Bus.coldThrottleBus.pumpBus.rpmSet,
      tabs_coldThrottle_rpmSet[4].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,35},{-29.4,35}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs4Bus.coldThrottleBus.valveSet, tabs_coldThrottle_valveSet[
      4].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,13},{-29.4,13}},
        color={255,204,51},
        thickness=0.5));

         connect(mainBus.tabs5Bus.pumpBus.pumpBus.rpmSet, tabs_pump_rpmSet[5].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,156},{-40,156},{-40,127},{-29.4,127}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs5Bus.pumpBus.valveSet, tabs_pump_valveSet[5].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,102},{-29.4,102},
            {-29.4,103}},
        color={255,204,51},
    ...
    connect(mainBus.tabs5Bus.hotThrottleBus.pumpBus.rpmSet,
      tabs_hotThrottle_rpmSet[5].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.tabs5Bus.hotThrottleBus.valveSet, tabs_hotThrottle_valveSet[5].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,59},{-29.4,59}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs5Bus.coldThrottleBus.pumpBus.rpmSet,
      tabs_coldThrottle_rpmSet[5].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,35},{-29.4,35}},
        color={255,204,51},
        thickness=0.5));

    connect(mainBus.tabs5Bus.coldThrottleBus.valveSet, tabs_coldThrottle_valveSet[
     5].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{-40,156},{-40,13},{-29.4,13}},
        color={255,204,51},
        thickness=0.5));

  connect(mainBus.vu1Bus.preheaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_preheat_rpmSet[1].u) annotation (Line(
    ...
    connect(mainBus.vu1Bus.preheaterBus.hydraulicBus.valveSet,
      vu_preheat_valveSet[1].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu1Bus.heaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_heater_rpmSet[1].u) annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-71},{-29.4,-71}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu1Bus.heaterBus.hydraulicBus.valveSet, vu_heater_valveSet[1].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-93},{-29.4,
            -93}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu1Bus.coolerBus.hydraulicBus.pumpBus.rpmSet,
      vu_cooler_rpmSet[1].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-117},{-29.4,
            -117}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu1Bus.coolerBus.hydraulicBus.valveSet, vu_cooler_valveSet[1].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-139},{-29.4,-139}},
        color={255,204,51},
        thickness=0.5));
    ...
    connect(mainBus.vu2Bus.preheaterBus.hydraulicBus.valveSet,
      vu_preheat_valveSet[2].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu2Bus.heaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_heater_rpmSet[2].u) annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-71},{-29.4,-71}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu2Bus.heaterBus.hydraulicBus.valveSet, vu_heater_valveSet[2].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-93},{-29.4,
            -93}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu2Bus.coolerBus.hydraulicBus.pumpBus.rpmSet,
      vu_cooler_rpmSet[2].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-117},{-29.4,
            -117}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu2Bus.coolerBus.hydraulicBus.valveSet, vu_cooler_valveSet[2].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-139},{-29.4,-139}},
        color={255,204,51},
        thickness=0.5));

        connect(mainBus.vu3Bus.preheaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_preheat_rpmSet[3].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-25},{-29.4,
            -25}},
        color={255,204,51},
        thickness=0.5));
    ...
    connect(mainBus.vu3Bus.preheaterBus.hydraulicBus.valveSet,
      vu_preheat_valveSet[3].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu3Bus.heaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_heater_rpmSet[3].u) annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-71},{-29.4,-71}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu3Bus.heaterBus.hydraulicBus.valveSet, vu_heater_valveSet[3].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-93},{-29.4,
            -93}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu3Bus.coolerBus.hydraulicBus.pumpBus.rpmSet,
      vu_cooler_rpmSet[3].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-117},{-29.4,
            -117}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu3Bus.coolerBus.hydraulicBus.valveSet, vu_cooler_valveSet[3].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-139},{-29.4,-139}},
        color={255,204,51},
        thickness=0.5));

        connect(mainBus.vu4Bus.preheaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_preheat_rpmSet[4].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-25},{-29.4,
            -25}},
        color={255,204,51},
        thickness=0.5));
    ...
    connect(mainBus.vu4Bus.preheaterBus.hydraulicBus.valveSet,
      vu_preheat_valveSet[4].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu4Bus.heaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_heater_rpmSet[4].u) annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-71},{-29.4,-71}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu4Bus.heaterBus.hydraulicBus.valveSet, vu_heater_valveSet[4].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-93},{-29.4,
            -93}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu4Bus.coolerBus.hydraulicBus.pumpBus.rpmSet,
      vu_cooler_rpmSet[4].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-117},{-29.4,
            -117}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu4Bus.coolerBus.hydraulicBus.valveSet, vu_cooler_valveSet[4].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-139},{-29.4,-139}},
        color={255,204,51},
        thickness=0.5));

        connect(mainBus.vu5Bus.preheaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_preheat_rpmSet[5].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-25},{-29.4,
            -25}},
        color={255,204,51},
        thickness=0.5));
    ...
    connect(mainBus.vu5Bus.preheaterBus.hydraulicBus.valveSet,
      vu_preheat_valveSet[5].u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu5Bus.heaterBus.hydraulicBus.pumpBus.rpmSet,
      vu_heater_rpmSet[5].u) annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-71},{-29.4,-71}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu5Bus.heaterBus.hydraulicBus.valveSet, vu_heater_valveSet[5].u)
      annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-93},{-29.4,
            -93}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu5Bus.coolerBus.hydraulicBus.pumpBus.rpmSet,
      vu_cooler_rpmSet[5].u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-40,-150},{-40,-117},{-29.4,
            -117}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.vu5Bus.coolerBus.hydraulicBus.valveSet, vu_cooler_valveSet[5].u)
      annotation (Line(
        points={{-99.95,6.05},{-99.95,-150},{-40,-150},{-40,-139},{-29.4,-139}},
        color={255,204,51},
        thickness=0.5));
    ...
    connect(mainBus.hxBus.secBus.valveSet, hx_sec_valveSet.u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.ahuBus.preheaterBus.hydraulicBus.valveSet,
      ahu_preheater_valveSet.u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{24,156},{24,105},{32.6,
            105}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.ahuBus.heaterBus.hydraulicBus.pumpBus.rpmSet,
      ahu_heater_rpmSet.u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,156},{24,156},{24,82},{32.6,82},
            {32.6,83}},
        color={255,204,51},
        thickness=0.5));
    ...
    connect(mainBus.swuBus.Y2valSet, swu_Y2valveSet.u) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.swuBus.Y3valSet, swu_Y3valveSet.u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-6,-150},{-6,-37},{0.6,
            -37}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.swuBus.K1valSet, swu_K1valveSet.u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-6,-150},{-6,-59},{0.6,
            -59}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.swuBus.K2valSet, swu_K2valveSet.u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-6,-150},{-6,-82},{0.6,
            -82},{0.6,-83}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.swuBus.K3valSet, swu_K3valveSet.u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-6,-150},{-6,-105},{0.6,
            -105}},
        color={255,204,51},
        thickness=0.5));
    connect(mainBus.swuBus.K4valSet, swu_K4valveSet.u) annotation (Line(
        points={{-99.95,6.05},{-100,6.05},{-100,-150},{-6,-150},{-6,-127},{0.6,
            -127}},
        color={255,204,51},
        thickness=0.5));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-150},{150,150}}),
                                                          graphics={  Rectangle(extent={{
                -100,150},{150,-152}},                                                                               lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                            FillPattern.Solid), Text(extent={{
                -38,36},{90,-34}},                                                                                                                                                                                                        lineColor=
                {0,0,0},                                                                                                                                                                                                        fillColor=
                {215,215,215},
...
Reduction
Costs")}),
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-150},{150,
              150}}), graphics={
          Text(
            extent={{-104,154},{-70,144}},
            lineColor={28,108,200},
            fontSize=12,
            textString="hpSystem"),
          Text(
            extent={{-70,142},{-36,132}},
            lineColor={28,108,200},
            fontSize=12,
            textString="htsSystem"),
          Text(
            extent={{-68,32},{-34,22}},
            lineColor={28,108,200},
            fontSize=14,
            textString="gtfSystem"),
          Text(
            extent={{-8,34},{26,24}},
            lineColor={28,108,200},
            fontSize=12,
            textString="swuSystem"),
          Text(
            extent={{-40,152},{-6,142}},
            lineColor={28,108,200},
            fontSize=11,
            textString="tabsSystems"),
          Text(
            extent={{22,152},{56,142}},
            lineColor={28,108,200},
            fontSize=11,
            textString="ahuSystem"),
          Text(
            extent={{-8,140},{26,130}},
            lineColor={28,108,200},
            fontSize=11,
  ...
  equation
    ...
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                            FillPattern.Solid), Text(extent = {{-64, 38}, {58, -34}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "Investment-
Costs for
Components")}),
      Diagram(coordinateSystem(preserveAspectRatio = false)));
  ...
  package BaseClasses
    ...
    equation
      ...
      annotation (
        Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
                fillPattern =                                                                                                                                                            FillPattern.Solid), Text(extent = {{-54, 28}, {56, -26}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
                fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "RBF")}),
        Diagram(coordinateSystem(preserveAspectRatio = false)));
    end RBF;
    ...
    equation
      ...
      annotation (
        ...
        Icon(coordinateSystem(extent = {{-400, -180}, {400, 180}}, initialScale = 0.1), graphics={  Rectangle(fillColor = {215, 215, 215},
                fillPattern =                                                                                                                            FillPattern.Solid, extent = {{-398, 180}, {402, -180}}), Text(fillColor = {215, 215, 215},
    ...
    equation
      ...
      annotation (
        Icon(graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
                fillPattern =                                                                                                             FillPattern.Solid), Text(extent = {{-56, 30}, {56, -30}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
                fillPattern =                                                                                                                                                                                                        FillPattern.Solid, textString = "Discounting
Factor")}));
    ...
    Modelica.Blocks.Interfaces.RealOutput y annotation (
      ...
      Benchmark.BaseClasses.MainBus mainBus1 annotation (
        Placement(visible = true, transformation(origin = {-102, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-102, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.Constant VOC_Concentration(k=150)
        "auxiliara constant - to be replaced with corresponding connection from mainBus"
        annotation (
      ...
      Modelica.Blocks.Logical.GreaterEqualThreshold greaterEqualThreshold1(
          threshold=22500) annotation (
        Placement(visible = true, transformation(origin = {-50, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Logical.LessThreshold lessThreshold1(threshold=22500)
        annotation (
    ...
    equation
      ...
      annotation (
        Icon(graphics={  Rectangle(fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-1, 3}, extent = {{-55, 21}, {55, -21}}, textString = "LRM_VOC")}));
    end LRM_VOC;
    ...
    Benchmark.BaseClasses.MainBus mainBus1 annotation (
      ...
      Modelica.Blocks.Interfaces.RealOutput y annotation (
        Placement(visible = true, transformation(origin = {102, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {102, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.Constant Concentration_CO2(k=400)
        "auxiliary constant - to be replaced by corresponding connection from mainBus"
        annotation (
    ...
    annotation (
        Icon(graphics={  Rectangle(fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-1, 1}, extent = {{-53, 21}, {53, -21}}, textString = "LRM_CO2")}));
    end LRM_CO2;
    ...
    equation
      ...
      connect(integrator1.y, feedback1.u1) annotation (
        Line(points={{61,60},{68,60},{68,12},{-86,12},{-86,-60},{-52,-60},{-52,
              -60},{-50,-60}},                                                                                   color = {0, 0, 127}));
      ...
      annotation (
        Icon(graphics={  Rectangle(fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {1, 2}, extent = {{-63, 30}, {63, -30}}, textString = "lifespan reduction cost one component")}, coordinateSystem(initialScale = 0.1)));
