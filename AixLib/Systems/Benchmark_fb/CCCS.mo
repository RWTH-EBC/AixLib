...
Strategy")}),
  ...
  model Evaluation_CCCS
    ...
    LifespanReductionCosts lifespanReductionCosts_2_1 annotation(
  ...
  equation
    ...
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -150}, {150, 150}}), graphics = {Rectangle(extent = {{-100, 150}, {150, -152}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid), Text(extent = {{-38, 36}, {90, -34}}, lineColor = {0, 0, 0}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid, textString = "Lifespan
Reduction
Costs")}),
