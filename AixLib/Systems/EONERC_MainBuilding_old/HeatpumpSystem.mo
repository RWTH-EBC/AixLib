...
model HeatpumpSystem "Heatpump system of the E.ON ERC main building"
  ...
  HydraulicModules_old.Pump pump_hot(
  ...
  HydraulicModules_old.Pump pump_cold(
    redeclare package Medium = Medium,
    allowFlowReversal=allowFlowReversal,
    m_flow_nominal=m_flow_nominal,
  ...
  HydraulicModules_old.Throttle throttle_recool(
    redeclare package Medium = Medium,
    allowFlowReversal=allowFlowReversal,
    m_flow_nominal=m_flow_nominal,
    T_start=T_start_hot,
    ...
    T_amb=T_amb) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-60,-100})));
  HydraulicModules_old.Throttle throttle_HS(
    redeclare package Medium = Medium,
    allowFlowReversal=allowFlowReversal,
    m_flow_nominal=m_flow_nominal,
    T_start=T_start_hot,
    ...
    T_amb=T_amb) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-120,0})));
  HydraulicModules_old.Throttle throttle_CS(
    redeclare package Medium = Medium,
    allowFlowReversal=allowFlowReversal,
    m_flow_nominal=m_flow_nominal,
    T_start=T_start_cold,
    ...
    T_amb=T_amb) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={160,0})));
  HydraulicModules_old.Throttle throttle_freecool(
    redeclare package Medium = Medium,
    allowFlowReversal=allowFlowReversal,
    m_flow_nominal=m_flow_nominal,
    T_start=T_start_cold,
