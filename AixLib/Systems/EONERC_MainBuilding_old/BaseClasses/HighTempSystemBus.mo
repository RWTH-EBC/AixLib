...
expandable connector HighTempSystemBus
  ...
  HydraulicModules_old.BaseClasses.HydraulicBus admixBus1
    "Hydraulic circuit of boiler 1";
  HydraulicModules_old.BaseClasses.HydraulicBus admixBus2
    "Hydraulic circuit of boiler 2";
  HydraulicModules_old.BaseClasses.HydraulicBus throttlePumpBus
    "Hydraulic circuit of chp";
