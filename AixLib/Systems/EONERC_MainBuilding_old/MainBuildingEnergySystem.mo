...
model MainBuildingEnergySystem
  ...
  HighTemperatureSystem highTemperatureSystem(
    ...
    m_flow_nominal=2) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-159,-83})));
  HydraulicModules_old.Admix admixHTC(
    redeclare
    ...
    Kv=63) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-170,70})));
  HydraulicModules_old.Controller.CtrMix ctrMixHTC(
    TflowSet=338.15,
    Td=0,
    Ti=150,
    k=0.05,
  ...
  HydraulicModules_old.SimpleConsumer consumerHTC(
    kA=20000,
    V=0.1,
    m_flow_nominal=1,
    redeclare package Medium = Medium,
  ...
  HydraulicModules_old.SimpleConsumer consumerLTC(
    kA=50000,
    V=5,
    m_flow_nominal=1,
    redeclare package Medium = Medium,
  ...
  HydraulicModules_old.SimpleConsumer consumerCold1(
    kA=312000/6,
    V=5,
    m_flow_nominal=1,
    redeclare package Medium = Medium,
    ...
    T_start=293.15) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={10,90})));
  HydraulicModules_old.Controller.CtrMix ctrMixLTC(
  ...
  HydraulicModules_old.Admix admixLTC(
    redeclare
      HydraulicModules_old.BaseClasses.PumpInterface_SpeedControlledNrpm
      PumpInterface(pump(redeclare
          AixLib.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2
    ...
    Kv=63) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-90,70})));
  HydraulicModules_old.Admix admixCold1(
    redeclare
      HydraulicModules_old.BaseClasses.PumpInterface_SpeedControlledNrpm
      PumpInterface(pump(redeclare
          AixLib.Fluid.Movers.Data.Pumps.Wilo.VeroLine80slash115dash2comma2slash2
  ...
  HydraulicModules_old.Controller.CtrMix ctrMixCold1(
    useExternalTset=false,
    TflowSet=289.15,
    k=0.05,
    Td=0,
  ...
  HydraulicModules_old.Admix admixCold2(
    redeclare
      HydraulicModules_old.BaseClasses.PumpInterface_SpeedControlledNrpm
      PumpInterface(pump(redeclare
    ...
    Kv=63) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={110,70})));
  HydraulicModules_old.SimpleConsumer consumerCold2(
    kA=1000,
    V=0.1,
    m_flow_nominal=1,
    redeclare package Medium = Medium,
  ...
  HydraulicModules_old.Controller.CtrMix ctrMixCold2(
    useExternalTset=false,
    TflowSet=285.15,
    k=0.05,
    Td=0,
