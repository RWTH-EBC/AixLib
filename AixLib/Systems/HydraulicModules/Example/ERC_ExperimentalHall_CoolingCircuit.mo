...
model ERC_ExperimentalHall_CoolingCircuit
  ...
  .AixLib.Systems.HydraulicModules.SimpleConsumer_old simpleConsumer(
    kA=2000,
    T_fixed=303.15,
    m_flow_nominal=1,
    redeclare package Medium = Medium,
  ...
  .AixLib.Systems.HydraulicModules.SimpleConsumer_old simpleConsumer1(
    kA=20000,
    T_fixed=303.15,
    m_flow_nominal=1,
    redeclare package Medium = Medium,
  ...
  .AixLib.Systems.HydraulicModules.SimpleConsumer_old simpleConsumer2(
    T_fixed=303.15,
    m_flow_nominal=1,
    redeclare package Medium = Medium,
    functionality="T_fixed",
