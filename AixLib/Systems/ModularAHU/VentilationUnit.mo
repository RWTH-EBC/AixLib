...
replaceable package Medium2 =
  ...
  ModularAHU.RegisterModule
    ...
    tau=tau,
    T_amb=T_amb)
    annotation (Dialog(enable=true, group="Cooler"),Placement(transformation(extent={{-72,-46},
            {-28,14}})));
  ModularAHU.RegisterModule
                 heater(
    redeclare package Medium1 = Medium1,
    ...
    tau=tau,
    T_amb=T_amb)
    annotation (Dialog(enable=true, group="Heater"),Placement(transformation(extent={{6,-46},
            {50,14}})));
