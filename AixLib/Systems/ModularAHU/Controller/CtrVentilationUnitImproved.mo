...
model CtrVentilationUnitImproved "Simple controller for Ventilation Unit"
...
equation
  ...
  connect(VFlow, PID_VflowSup.u_s) annotation (Line(
      ...
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(ctrCo.TMea, genericAHUBus.heaterBus.TAirOutMea) annotation (Line(
        points={{10,38},{56,38},{56,0.05},{100.05,0.05}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(ctrRh.TMea, genericAHUBus.heaterBus.TAirOutMea) annotation (Line(
        points={{10,-2},{54,-2},{54,0.05},{100.05,0.05}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
        ...
        Text(
          ...
          textString="Control")}), Diagram(coordinateSystem(preserveAspectRatio=
           false)));
end CtrVentilationUnitImproved;
