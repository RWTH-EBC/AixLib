...
block CtrRegBasic_adapted "Controller for heating and cooling registers"
  //Boolean choice;
...
equation
  ...
  connect(PID.y, registerBus.hydraulicBus.valveSet) annotation (Line(points={{
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(Tset1, registerBus.hydraulicBus.pumpBus.onSet) annotation (Line(
        points={{-120,60},{101.135,60},{101.135,0.13}}, color={255,0,255}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
