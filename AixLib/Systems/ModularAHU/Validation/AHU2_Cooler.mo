...
equation
  ...
  connect(gain.u, combiTimeTable.y[12]) annotation (Line(points={{-70.8,0},{-106,
  ...
  connect(gain.y, registerBus1.hydraulicBus.valSet) annotation (Line(points={{-61.6,
          0},{-37.95,0},{-37.95,10.05}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
