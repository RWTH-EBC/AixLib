...
equation
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent=  {{-80, 80}, {80, -80}}, fillColor=  {85, 170, 255}, fillPattern=  FillPattern.HorizontalCylinder, pattern=  LinePattern.Solid, lineColor=  {0, 0, 0}), Line(points=  {{-50, -56}, {-50, -34}}, color=  {0, 0, 0}, pattern=  LinePattern.Dash, smooth=  Smooth.None), Line(points=  {{-20, -56}, {-20, -34}}, color=  {0, 0, 0}, pattern=  LinePattern.Dash, smooth=  Smooth.None), Line(points=  {{12, -56}, {12, -34}}, color=  {0, 0, 0}, pattern=  LinePattern.Dash, smooth=  Smooth.None), Line(points=  {{46, -56}, {46, -34}}, color=  {0, 0, 0}, pattern=  LinePattern.Dash, smooth=  Smooth.None)}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Documentation(info = "<html>
