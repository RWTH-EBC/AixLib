...
model TempAndRad "Outdoor Temperature and solar irradiation"
  import AixLib;
  parameter AixLib.DataBase.Weather.WeatherBaseDataDefinition temperatureOT = AixLib.DataBase.Weather.WinterDay() "outdoor air tmeperature" annotation(choicesAllMatching = true);
