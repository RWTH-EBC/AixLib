...
model BoundaryMoistAir_phX "boundary for Moist Air, pressure, enthalpy, water fraction"
  ...
  parameter Modelica.SIunits.SpecificEnthalpy h = 1e4 "Fixed value of specific enthalpy as energy per mass dry air" annotation(Evaluate = true, Dialog(enable = not use_h_in));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {170, 255, 255}, fillPattern = FillPattern.Sphere, fillColor = {170, 213, 255}), Text(extent = {{-66, 14}, {76, -10}}, lineColor = {0, 0, 255}, textString = "p boundary")}), Documentation(info = "<html>
