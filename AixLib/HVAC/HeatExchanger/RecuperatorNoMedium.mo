...
model RecuperatorNoMedium "recuperator model with selectable flow arrangement"
  ...
  parameter Modelica.SIunits.Temperature T1out0 = 296.558 "Medium 1 inlet temperature at design point";
  parameter Modelica.SIunits.Temperature T2in0 = 273.15 + 26 "Medium 2 inlet temperature at design point";
  parameter Modelica.SIunits.Temperature T2out0 = 281.0248 "Medium 2 inlet temperature at design point";
  parameter Modelica.SIunits.MassFlowRate m_flow10 = 0.029949 "mass flow rate at design point";
  parameter Modelica.SIunits.MassFlowRate m_flow20 = 0.029954 "mass flow rate at design point";
  ...
  Modelica.Blocks.Interfaces.RealInput T1in(nominal = T1in0) "standard: colder medium" annotation(Placement(transformation(extent = {{120, 60}, {80, 100}})));
  ...
  Modelica.Blocks.Interfaces.RealInput T2in(nominal = T2in0) "standard: warmer medium" annotation(Placement(transformation(extent = {{20, 20}, {-20, -20}}, rotation = 180, origin = {-100, -80})));
