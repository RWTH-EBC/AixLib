...
model Test_RecuperatorNoMedium_counterflow_stopMassFlow
  ...
  Modelica.Blocks.Sources.Ramp T1in(duration = 1, offset = recuperatorNoMedium3.T1in0, startTime = 0.5, height = 0) annotation(Placement(transformation(extent = {{66, 10}, {46, 30}})));
  Modelica.Blocks.Sources.Ramp T2in(duration = 1, offset = recuperatorNoMedium3.T2in0, startTime = 2, height = 0) annotation(Placement(transformation(extent = {{-72, -30}, {-52, -10}})));
