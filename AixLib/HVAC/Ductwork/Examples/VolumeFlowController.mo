...
model VolumeFlowController "Example for Volume Flow Controller"
  ...
  Sources.BoundaryMoistAir_phX boundaryMoistAir_phX2(use_p_in = true, p = 99900) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, origin = {-62, 11})));
...
equation
  ...
  connect(boundaryMoistAir_phX2.p_in, add.y) annotation(Line(points = {{-74, 19}, {-92, 19}, {-92, -32}, {60, -32}, {60, -62}, {17, -62}}, color = {0, 0, 127}));
