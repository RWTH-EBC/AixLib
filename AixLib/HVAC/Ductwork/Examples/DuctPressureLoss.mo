...
model DuctPressureLoss "Example for Duct"
  ...
  Sources.BoundaryMoistAir_phX boundaryMoistAir_phX1(use_p_in = false, p = 100000) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {46, 20})));
  ...
  Sources.BoundaryMoistAir_phX boundaryMoistAir_phX2(use_p_in = true, p = 99900) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {-42, 20})));
  Anlagensimulation_WS1314.Ductwork.Duct duct annotation(Placement(transformation(extent = {{-12, 16}, {8, 24}})));
equation
  ...
  connect(boundaryMoistAir_phX2.p_in, add.y) annotation(Line(points = {{-54, 28}, {-92, 28}, {-92, -32}, {60, -32}, {60, -62}, {17, -62}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(boundaryMoistAir_phX2.portMoistAir_a, duct.portMoistAir_a) annotation(Line(points = {{-32, 20}, {-12, 20}}, color = {0, 127, 255}, smooth = Smooth.None));
  connect(duct.portMoistAir_b, boundaryMoistAir_phX1.portMoistAir_a) annotation(Line(points = {{8, 20}, {36, 20}}, color = {0, 127, 255}, smooth = Smooth.None));
