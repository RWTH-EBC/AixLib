...
model DuctPressureLoss "Example for Duct"
  ...
  Sources.BoundaryMoistAir_phX boundaryMoistAir_phX2(use_p_in = true, p = 99900) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, origin = {-42, 20})));
  Anlagensimulation_WS1314.Ductwork.Duct duct annotation(Placement(transformation(extent = {{-12, 16}, {8, 24}})));
equation
  connect(ramp.y, add.u1) annotation(Line(points = {{-31, -48}, {-24, -48}, {-24, -56}, {-6, -56}}, color = {0, 0, 127}));
  connect(ramp1.y, add.u2) annotation(Line(points = {{-31, -78}, {-23.5, -78}, {-23.5, -68}, {-6, -68}}, color = {0, 0, 127}));
