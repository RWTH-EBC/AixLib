...
partial model TwoPortMoistAirTransportFluidprops "Base class for tranport of Moist Air with all fluid properties"
  ...
  Modelica.SIunits.Pressure p_Saturation "Saturation Pressure of Steam at Sensor";
  ...
  Real X(min = 0) "mass fractions of water (liquid and steam) to dry air m_w/m_a in Sensor";
  Real X_Steam(min = 0) "mass fractions of steam to dry air m_w/m_a in Sensor";
  Real X_Water(min = 0) "mass fractions of liquid water to dry air m_w/m_a in Sensor";
  Real X_Saturation(min = 0) "saturation mass fractions of water to dry air m_w/m_a in Sensor";
  Modelica.SIunits.DynamicViscosity dynamicViscosity "dynamic viscosity of moist air";
protected
  parameter Modelica.SIunits.SpecificHeatCapacity cp_Water = baseParameters.cp_Water "Specific heat capacity of liquid water";
  ...
  parameter Modelica.SIunits.SpecificEnthalpy r_Steam = baseParameters.r_Steam "Specific enthalpy of vaporisation";
