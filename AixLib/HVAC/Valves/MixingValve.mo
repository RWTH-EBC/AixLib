...
model MixingValve
  import AixLib;
  extends AixLib.HVAC.Valves.BaseClasses.PartialTeeJunction;
  ...
  parameter Real leakageOpening(min=0,max=1)=1e-3
    ...
    //Valves                                                                 //
    ///////////////////////////////////////////////////////////////////////////
  AixLib.HVAC.Valves.SimpleValve simpleValve1(Kvs=Kvs)
    annotation (Placement(transformation(extent={{-70,-10},{-50,10}})));
  AixLib.HVAC.Valves.SimpleValve simpleValve2(Kvs=Kvs)
