...
//Radiators
  ...
  parameter AixLib.DataBase.Radiators.RadiatiorBaseDataDefinition
    Type_Radiator_Livingroom=
      AixLib.DataBase.Radiators.StandardOFD_EnEV2009.Livingroom() "Livingroom"
 ...
 Radiators.Radiator radiatorKitchen(RadiatorType=Type_Radiator_Kitchen)
  ...
  Pipes.StaticPipe toKiF(D=Diam_Sec, l=Length_toKi) "to kitchen, flow stream"
  ...
  Pipes.StaticPipe toKiR(D=Diam_Sec, l=Length_toKi) "to kitchen, return stream"
                                annotation (Placement(transformation(
          extent={{-72,-102},{-56,-90}})));
  ...
  Pipes.StaticPipe toCoF(D=Diam_Sec, l=Length_toCo) "to corridor , flow stream"
                                annotation (Placement(transformation(
        extent={{-8.5,4.5},{8.5,-4.5}},
        rotation=0,
        origin={45.5,40.5})));
  ...
  Pipes.StaticPipe thCoR2(D=Diam_Main, l=Length_thCo2)
    "through corridor 2, return stream" annotation (Placement(
        ...
        rotation=90,
        origin={-19,12.5})));
  Pipes.StaticPipe toHoF(D=Diam_Sec, l=Length_toHo) "to hobby , flow stream"
                             annotation (Placement(transformation(
        extent={{-6.5,4.5},{6.5,-4.5}},
        rotation=0,
        origin={23.5,80.5})));
  Pipes.StaticPipe toHoR(D=Diam_Sec, l=Length_toHo) "to hobby, return stream"
                              annotation (Placement(transformation(
        extent={{6.5,4.5},{-6.5,-4.5}},
        rotation=0,
        origin={20.5,66})));
