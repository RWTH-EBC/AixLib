...
model GroundFloor
  ...
  Modelica.Fluid.Interfaces.FluidPort_b
                    RETURN(redeclare package Medium = Medium)
...
equation
  connect(radiatorLiving.port_a, valveLiving.port_b) annotation(Line(points={{-95,4},
          {-79,4}},                                                                                    color = {255, 0, 0}, smooth = Smooth.None, thickness = 0.5));
  connect(valveWC.port_b, radiatorWC.port_a) annotation(Line(points={{50,-39},{83.68,
          -39},{83,-39.5}},                                                                                      color = {255, 0, 0}, smooth = Smooth.None, thickness = 0.5));
  connect(valveCorridor.port_b, radiatorCorridor.port_a) annotation(Line(points={{76,40},
          {86.6,40},{86,40.5}},                                                                                         color = {255, 0, 0}, smooth = Smooth.None, thickness = 0.5));
  connect(valveHobby.port_b, radiatorHobby.port_a) annotation(Line(points={{60,80.5},
          {78.64,80.5},{78,80}},                                                                                      color = {255, 0, 0}, smooth = Smooth.None, thickness = 0.5));
  ...
  connect(radiatorKitchen.port_a, valveKitchen.port_b) annotation(Line(points={{-89,
  ...
  connect(HydRes_RadWC.port_a, radiatorWC.port_b) annotation(Line(points={{67,-48.5},
          {127,-48.5},{127,-39.5},{100,-39.5}},                                                                                       color = {0, 128, 255}, smooth = Smooth.None, thickness = 0.5));
  ...
  connect(HydRes_RadLi.port_a, radiatorLiving.port_b) annotation(Line(points={{-116,
  ...
  connect(HydRes_RadCor.port_a, radiatorCorridor.port_b) annotation(Line(points={{84,27},
  ...
  connect(HydRes_RadHo.port_a, radiatorHobby.port_b) annotation(Line(points={{74,66},
  ...
  connect(radiatorWC.convPort, Con_WC) annotation(Line(points={{87.93,-33.04},{
          88,-33.04},{88,-33},{119,-33},{119,-50},{138.5,-50}},                                                                                              color = {191, 0, 0}, smooth = Smooth.None));
  ...
  connect(radiatorCorridor.convPort, Con_Corridor) annotation(Line(points={{90.35,
          46.2},{90,46.2},{90,46},{113,46},{113,25.5},{138.5,25.5}},                                                                                                   color = {191, 0, 0}, smooth = Smooth.None));
  connect(radiatorHobby.convPort, Con_Hobby) annotation(Line(points={{82.64,
          86.08},{82.64,91},{119,91},{119,73},{138,73}},                                                                                                    color = {191, 0, 0}, smooth = Smooth.None));
  connect(radiatorHobby.radPort, Rad_Hobby) annotation(Line(points = {{89.2, 86.24}, {89.2, 97}, {137, 97}}, color = {0, 0, 0}, smooth = Smooth.None));
  connect(radiatorLiving.radPort, Rad_Livingroom) annotation(Line(points={{-107.6,
          11.02},{-107.6,11},{-131,11},{-131,46},{-136,46},{-136,46.5},{-140,46.5}},                                                                                                    color = {0, 0, 0}, smooth = Smooth.None));
  ...
  connect(valveWC.T_setRoom, TSet_GF[4]) annotation(Line(points={{47.36,-31.16},
          {47.36,-7},{18,-7},{18,29},{-76,29},{-76,99},{-109,99}},                                                                                                    color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(__Dymola_Images(Parameters(source = "Images/OFD/GroundFloor_Hydraulics.png")), Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-130,
            -100},{130,100}},                                                                                                    grid = {1, 1}), graphics={  Rectangle(extent = {{1, 100}, {126, 63}}, pattern = LinePattern.None, lineColor = {0, 0, 0}, fillColor = {215, 215, 215},
            ...
            fillPattern =                                                                                                    FillPattern.Solid, textString = "WC/Storage"), Text(extent = {{-27, 56}, {80, 43}}, lineColor = {0, 0, 0}, fillColor = {0, 0, 0},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "Corridor"), Text(extent = {{-34, 100}, {73, 87}}, lineColor = {0, 0, 0}, fillColor = {0, 0, 0},
            fillPattern =                                                                                                    FillPattern.Solid, textString = "Hobby")}), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-130, -100}, {130, 100}}, grid = {1, 1}), graphics={  Rectangle(extent = {{-119, 92}, {123, -79}}, lineColor = {255, 0, 0}, fillColor = {135, 135, 135},
