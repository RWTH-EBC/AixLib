...
model GroundfloorBoiler
  ...
  Hydraulics.GroundFloor groundFloor(toWCF(dp(start = 100)), toWCR(dp(start = 100)), thCo2F(dp(start = 100)), thCoR2(dp(start = 100)), valveWC(dp(start = 1000)), valveLiving(dp(start = 1000)), valveHobby(dp(start = 1000)), toHoF(dp(start = 100)), toHoR(dp(start = 100)), thCo1F(dp(start = 100)), thCo1R(dp(start = 100)), toCoR(dp(start = 100)), toKiR(dp(start = 100)), thWCF(dp(start = 100)), thWCR(dp(start = 100)), toLiF(dp(start = 100)), toLiR(dp(start = 100)), valveKitchen(dp(start = 1000)), valveCorridor(dp(start = 1000)), thStR(dp(start = 100)),
    redeclare package Medium = Medium)                                                                                                     annotation(Placement(transformation(extent = {{94, 10}, {130, 38}})));
...
equation
 ...
 "), Rectangle(extent = {{-58, 42}, {-8, -30}}, lineColor = {255, 0, 0}, fillColor = {255, 255, 85},
            fillPattern =                                                                                          FillPattern.Solid), Text(extent = {{-48, 46}, {-18, 42}}, lineColor = {255, 0, 0}, fillColor = {0, 0, 255},
 ...
 ", fontSize = 11), Rectangle(extent = {{-6, 4}, {132, -64}}, lineColor = {255, 0, 0}, fillColor = {170, 255, 170},
            ...
            fillPattern =                                                                                                    FillPattern.Solid, fontSize = 11, textString = "Supply
 "), Text(extent = {{54, 96}, {84, 92}}, lineColor = {255, 0, 0}, fillColor = {0, 0, 255},
