...
class Acknowledgements "Acknowledgements"
  ...
  <b><span style=
  \"font-size: 12pt; color: #008000;\">Acknowledgements</span></b>
</p>
<p>
  The following people from RWTH Aachen University, E.ON Energy
  Research Center, Institute for Energy Efficient Buildings and Indoor
  Climate have directly contributed to the implementation of the AixLib
  library
</p>
<ul>
  <li>Michael Adolph
...
<p>
  We would like to thank the following people from other institutions
  that directly contributed to the AixLib library
</p>
<ul>
  <li>Thomas Beutlich
  </li>
