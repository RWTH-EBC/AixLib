...
block ReaderTMY3 "Reader for TMY3 weather data"
  ...
  Modelica.Blocks.Interfaces.RealInput HGloHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if (HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
  ...
  Modelica.Blocks.Interfaces.RealInput HDifHor_in(
    final quantity="RadiantEnergyFluenceRate",
    final unit="W/m2") if (HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor)
  ...
  Modelica.Blocks.Interfaces.RealInput HDirNor_in(final quantity="RadiantEnergyFluenceRate",
      final unit="W/m2") if
                          (HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor)
...
protected
  ...
  AixLib.BoundaryConditions.WeatherData.BaseClasses.ConvertRelativeHumidity
  ...
  SkyTemperature.BlackBody TBlaSkyCom(final calTSky=calTSky) if
       not (TBlaSkySou == AixLib.BoundaryConditions.Types.DataSource.Parameter or
            TBlaSkySou == AixLib.BoundaryConditions.Types.DataSource.Input)
...
equation
  ...
  if pAtmSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    pAtm_in_internal = pAtm;
  elseif pAtmSou == AixLib.BoundaryConditions.Types.DataSource.File then
  ...
  if ceiHeiSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    ceiHei_in_internal = ceiHei;
  elseif ceiHeiSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if totSkyCovSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    totSkyCov_in_internal = totSkyCov;
  elseif totSkyCovSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if opaSkyCovSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    opaSkyCov_in_internal = opaSkyCov;
  elseif opaSkyCovSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDewPoiSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    TDewPoi_in_internal = TDewPoi;
  elseif TDewPoiSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if TDryBulSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    TDryBul_in_internal = TDryBul;
  elseif TDryBulSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if TBlaSkySou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    TBlaSky_in_internal = TBlaSky;
  elseif TBlaSkySou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if relHumSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    relHum_in_internal = relHum;
  elseif relHumSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if winSpeSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    winSpe_in_internal = winSpe;
  elseif winSpeSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if winDirSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    winDir_in_internal = winDir;
  elseif winDirSou == AixLib.BoundaryConditions.Types.DataSource.Input then
  ...
  if HSou ==  AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
    connect(HGloHor_in, HGloHor_in_internal)
      "Get HGloHor using user input file";
  elseif HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
  ...
  if HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
     connect(HDifHor_in, HDifHor_in_internal)
      "Get HDifHor using user input file";
  elseif  HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor then
  ...
  if HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HGloHor or HSou == AixLib.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor then
  ...
  if HInfHorSou == AixLib.BoundaryConditions.Types.DataSource.Parameter then
    HInfHor_in_internal = HInfHor;
  elseif HInfHorSou == AixLib.BoundaryConditions.Types.DataSource.Input then
