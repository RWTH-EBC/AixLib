...
<ol>
  ...
  to
  <code>
    AixLib/Resources/weatherdata</code>
    (or
    to
    any
    directory
...
<p>
  ...
  set
  <code>
  computeWetBulbTemperature=false</code>.
</p><!-- ============================================== -->
<h4>
  Using
  constant
...
<ol>
  ...
  <li>
    ...
    <ul>
      ...
      (e.g.
      <code>
        USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos</code>),
        the
        units
        must
        be
        ...
        (e.g.
        <code>
        USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.epw</code>).
        The
        TMY3
        data
        used
        ...
        If
        <code>
        Resources/bin/ConvertWeatherData.jar</code>
        is
        used
        to
        convert
...
<p align=\"center\">
  <img alt=\"image\"
  src=\"modelica://AixLib/Resources/Images/BoundaryConditions/WeatherData/RadiationTimeShift.png\"
  border=\"1\">
</p>
<h4>
  References
...
<ul>
  ...
  Nouidui:<br/>
    ...
    is
    for
    <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/608\">
    #608</a>.
  </li>
  <li>
  April
  ...
  Wetter:<br/>
    ...
    is
    for
    <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/506\">
    Buildings,
    #506</a>.
  </li>
  <li>
  ...
  Lauster:<br/>
    ...
    is
    for
    <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/376\">
    #376</a>.
  </li>
  <li>
  January
  ...
  Wetter:<br/>
    ...
    is
    for
    <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/377\">
    #377</a>.
  </li>
  <li>
  September
  ...
  Fuchs:<br/>
    ...
    @tbeu
    at
    <a href=\"https://github.com/RWTH-EBC/AixLib/pull/107\">
    RWTH-EBC/AixLib#107</a>
  </li>
  <li>
  June
  6,
