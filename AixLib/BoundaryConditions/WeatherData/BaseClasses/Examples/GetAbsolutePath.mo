...
<ul>
  <li>November 18, 2016, by Michael Wetter:<br/>
    Removed tests that assumed that the regression test is run from the library root directory.<br/>
    This is for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/596\">#596</a>.
  </li>
  <li>October 9, 2013, by Michael Wetter:<br/>
    Removed incorrect call to <code>Modelica.Utilities.Files.exist</code>.
  </li>
  <li>May 9, 2013, by Michael Wetter:<br/>
