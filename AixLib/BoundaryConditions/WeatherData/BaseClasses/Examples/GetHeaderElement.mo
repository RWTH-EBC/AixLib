...
initial equation
  ...
  longitude = AixLib.BoundaryConditions.WeatherData.BaseClasses.getLongitudeTMY3(

    filNam=absFilNam);

  latitude = AixLib.BoundaryConditions.WeatherData.BaseClasses.getLatitudeTMY3(

    filNam=absFilNam);

  timeZone = AixLib.BoundaryConditions.WeatherData.BaseClasses.getTimeZoneTMY3(
...
<ul>
  <li>April 21, 2016, by Michael Wetter:<br/>
    Added call to <a href=\"modelica://AixLib.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath\">AixLib.BoundaryConditions.WeatherData.BaseClasses.getAbsolutePath</a> as this call has been removed from the function <a href=\"modelica://AixLib.BoundaryConditions.WeatherData.BaseClasses.getHeaderElementTMY3\">AixLib.BoundaryConditions.WeatherData.BaseClasses.getHeaderElementTMY3</a>. This is for <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/506\">Buildings, #506</a>.
  </li>
