...
model OneOffice
  ...
  AixLib.BoundaryConditions.InternalGains.Humans.HumanSensibleHeatTemperatureDependent human_SensibleHeat_VDI2078(roomArea=20) annotation (Placement(transformation(extent={{-10,38},{12,62}})));
  AixLib.BoundaryConditions.InternalGains.Machines.MachinesDIN18599 machines_SensibleHeat_DIN18599(nrPeople=2, areaSurfaceMachinesTotal=10) annotation (Placement(transformation(extent={{-10,-6},{14,24}})));
  AixLib.BoundaryConditions.InternalGains.Lights.LightsAreaSpecific lights(roomArea=20) annotation (Placement(transformation(extent={{-8,-46},{12,-22}})));
...
equation
  connect(RoomTemp.port, human_SensibleHeat_VDI2078.TRoom) annotation(Line(points={{-38,50},{-28,50},{-28,64},{-8.9,64},{-8.9,60.8}},            color = {191, 0, 0}));
  connect(Evolution_RoomTemp.y, RoomTemp.T) annotation(Line(points = {{-79, 50}, {-60, 50}}, color = {0, 0, 127}));
  connect(combiTimeTable.y[2], machines_SensibleHeat_DIN18599.uRel) annotation (Line(points={{-59,-10},{-20,-10},{-20,9},{-10,9}}, color={0,0,127}));
  connect(combiTimeTable.y[3], lights.uRel) annotation (Line(points={{-59,-10},{-20,-10},{-20,-34},{-8,-34}}, color={0,0,127}));
  ...
  connect(combiTimeTable.y[1], human_SensibleHeat_VDI2078.uRel) annotation (Line(points={{-59,-10},{-28,-10},{-28,50},{-10,50}}, color={0,0,127}));
