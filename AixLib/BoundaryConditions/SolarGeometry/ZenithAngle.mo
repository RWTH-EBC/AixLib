...
<p>
  This component computes the zenith angle, which is the angle between the earth surface normal and the sun beam. For a definition of the parameters, see the User's Guide <a href=\"modelica://AixLib.BoundaryConditions.UsersGuide\">AixLib.BoundaryConditions.UsersGuide</a>.
