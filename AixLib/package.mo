...
package AixLib
  ...
  conversion(from(
    ...
    version="0.8.3", script="modelica://AixLib/Resources/Scripts/ConvertAixLib_from_0.8.3_to_0.8.4.mos",
    version="0.9.1", script="modelica://AixLib/Resources/Scripts/ConvertAixLib_from_0.9.1_to_0.9.2.mos")),  Documentation(info = "<html>
