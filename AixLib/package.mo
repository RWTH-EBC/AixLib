...
package AixLib
  ...
  conversion(from(
    ...
    version="0.7.12", script="modelica://AixLib/Resources/Scripts/ConvertAixLib_from_0.7.12_to_0.8.0.mos"), from(
      version="0.8.0",
      to="Intermediate",
      change(
        item=convertElement(
            "AixLib.Systems.EONERC_MainBuilding.MainBuildingEnergySystem",
            "eonERCModeBasedControl.ctrHP.y1",
            "eonERCModeBasedControl.ctrHP.pumpsOn"),
        item=convertElement(
            "AixLib.Systems.EONERC_MainBuilding.Controller.EonERCModeControl.EonERCModeBasedControl",
            "ctrHP.y1",
            "ctrHP.pumpsOn"),
        item=convertElement(
            "AixLib.Systems.EONERC_MainBuilding.Controller.EonERCModeControl.CtrHP",
            "y1",
            "pumpsOn")))),                                                                                    Documentation(info = "<html>
