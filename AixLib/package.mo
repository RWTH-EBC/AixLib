...
package AixLib
  ...
  annotation(uses(Modelica(version="3.2.2"), Modelica_DeviceDrivers(version="1.4.4"), Modelica_Synchronous(version="0.92.1"), NcDataReader2(version="2.4.0")), version = "0.5.2", conversion(from(version="0.3.2",script="modelica://AixLib/Resources/Scripts/ConvertAixLib_from_0.3.2_to_0.4.mos",version="0.5.0",script="modelica://AixLib/Resources/Scripts/ConvertAixLib_from_0.5.0_to_0.5.1.mos")), Documentation(info = "<html>
