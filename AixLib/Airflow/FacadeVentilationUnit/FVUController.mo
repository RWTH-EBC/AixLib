...
equation
  connect(outdoorTemperature, add.u1) annotation (Line(points={{-100,30},{-78,
          30},{-78,-42.4},{-63.2,-42.4}}, color={0,0,127}));
  connect(roomTemperature, add.u2) annotation (Line(points={{-100,90},{-74,90},
          {-74,-40},{-68,-40},{-66,-40},{-66,-49.6},{-63.2,-49.6}}, color={0,0,
          127}));
  connect(outdoorTemperature, add1.u2) annotation (Line(points={{-100,30},{-88,
          30},{-78,30},{-78,-99.6},{-65.2,-99.6}}, color={0,0,127}));
  connect(roomTemperature, add1.u1) annotation (Line(points={{-100,90},{-88,90},
          {-74,90},{-74,-92.4},{-65.2,-92.4}}, color={0,0,127}));
  ...
  connect(setDeviationRecovery.y, heatRecoveryPossible.reference) annotation (
      Line(points={{-55.4,-72},{-52,-72},{-52,-84},{-42,-84}}, color={0,0,127}));
  connect(roomToBeCooled.y, and1.u1) annotation (Line(points={{-39,90},{-28,90},
          {-28,87},{-1.4,87}}, color={255,0,255}));
  connect(coldRecoveryPossible.y, and1.u2) annotation (Line(points={{-19,-60},{
          -6,-60},{-6,81.4},{-1.4,81.4}}, color={255,0,255}));
  connect(roomToBeCooled.y, useCoolingValve.u2) annotation (Line(points={{-39,
          90},{-28,90},{-28,100},{22,100},{22,86},{60.8,86}}, color={255,0,255}));
  connect(roomToBeCooled.y, and2.u1) annotation (Line(points={{-39,90},{-28,90},
          {-28,51},{-1.4,51}}, color={255,0,255}));
  connect(freeCoolingPossible.y, and2.u2) annotation (Line(points={{-19,-30},{-12,
          -30},{-12,45.4},{-1.4,45.4}}, color={255,0,255}));
  connect(roomToBeCooled.y, climatizationNeeded.u1) annotation (Line(points={{-39,
          90},{-28,90},{-28,13},{-1.4,13}}, color={255,0,255}));
  connect(roomToBeHeated.y, climatizationNeeded.u2) annotation (Line(points={{-39,
          60},{-30,60},{-30,7.4},{-1.4,7.4}}, color={255,0,255}));
  connect(heatRecoveryPossible.y, and3.u2) annotation (Line(points={{-19,-90},{
          -1.4,-90},{-1.4,-32.6}}, color={255,0,255}));
  connect(roomToBeHeated.y, and3.u1) annotation (Line(points={{-39,60},{-30,60},
          {-30,8},{-10,8},{-10,-27},{-1.4,-27}}, color={255,0,255}));
  connect(roomToBeHeated.y, useHeatingValve.u2) annotation (Line(points={{-39,
          60},{26,60},{26,54},{60.8,54}}, color={255,0,255}));
  connect(one.y, useHeatingValve.u1) annotation (Line(points={{14.6,70},{30,70},
          {30,58.8},{60.8,58.8}}, color={0,0,127}));
  connect(zero.y, useHeatingValve.u3) annotation (Line(points={{12.6,34},{34,34},
          {34,49.2},{60.8,49.2}}, color={0,0,127}));
  connect(roomToBeVentilated.y, useExFan.u2) annotation (Line(points={{-39,30},
          {-20,30},{-20,24},{18,24},{18,1.4},{58.6,1.4}}, color={255,0,255}));
  connect(useExFan.y, switch3.u2)
    annotation (Line(points={{74.7,7},{79.35,7},{84.8,7}}, color={255,0,255}));
  connect(exhaustFan.y, switch3.u1) annotation (Line(points={{52.6,38},{76,38},
          {76,11.8},{84.8,11.8}}, color={0,0,127}));
  connect(zero.y, switch3.u3) annotation (Line(points={{12.6,34},{24,34},{34,34},
          {34,-6},{80,-6},{80,2.2},{84.8,2.2}}, color={0,0,127}));
  connect(useExFan.y, not1.u) annotation (Line(points={{74.7,7},{80,7},{80,53},
          {85,53}}, color={255,0,255}));
  connect(timePassed.y, timer1.u) annotation (Line(points={{174.6,59},{184,59},
          {184,46},{128,46},{128,33},{132.6,33}}, color={255,0,255}));
  connect(not1.y, rSFlipFlop.S) annotation (Line(points={{96.5,53},{100,53},{
          100,52.8},{103.4,52.8}}, color={255,0,255}));
  connect(rSFlipFlop.Q, timer.u) annotation (Line(points={{121.8,52.8},{127.4,
          52.8},{127.4,53},{132.6,53}}, color={255,0,255}));
  connect(switch4.y, fanExhaustAirPower) annotation (Line(points={{126.6,0},{
          192,0},{192,30},{220,30}}, color={0,0,127}));
  connect(zero.y, useCoolingValve.u3) annotation (Line(points={{12.6,34},{24,34},
          {34,34},{34,81.2},{60.8,81.2}}, color={0,0,127}));
  connect(freeCoolingPossible.y, switch5.u2) annotation (Line(points={{-19,-30},
          {-12,-30},{-12,-14},{22,-14},{22,-26},{26.8,-26}}, color={255,0,255}));
  connect(zero.y, switch5.u1) annotation (Line(points={{12.6,34},{34,34},{34,-16},
          {24,-16},{24,-21.2},{26.8,-21.2}}, color={0,0,127}));
  ...
  connect(useCoolingValve.y, coolingValveOpening) annotation (Line(points={{
          74.6,86},{82,86},{82,104},{204,104},{204,90},{220,90}}, color={0,0,
          127}));
  connect(useHeatingValve.y, heatingValveOpening) annotation (Line(points={{
          74.6,54},{78,54},{78,80},{200,80},{200,60},{220,60}}, color={0,0,127}));
  connect(co2SeetConcentrationSource.y, roomToBeVentilated.u)
    annotation (Line(points={{-52.6,6},{-62,6},{-62,24}}, color={0,0,127}));
  connect(co2Concentration, roomToBeVentilated.reference) annotation (Line(
        points={{-100,-90},{-76,-90},{-76,36},{-62,36}}, color={0,0,127}));
  connect(climatizationNeeded.y, switch2.u2) annotation (Line(points={{14.7,13},
          {52,13},{52,-32},{114.8,-32}}, color={255,0,255}));
  connect(supplyFan.y, switch2.u1) annotation (Line(points={{96.6,-20},{110,-20},
          {110,-27.2},{114.8,-27.2}}, color={0,0,127}));
  connect(zero.y, switch2.u3) annotation (Line(points={{12.6,34},{34,34},{34,-6},
          {80,-6},{80,-36.8},{114.8,-36.8}}, color={0,0,127}));
  connect(switch2.y, switch1.u3) annotation (Line(points={{128.6,-32},{154,-32},
          {154,-31.8},{158.8,-31.8}}, color={0,0,127}));
  ...
  connect(and1.y, or3.u1) annotation (Line(points={{14.7,87},{20,87},{20,-43},{
          26.6,-43}}, color={255,0,255}));
  connect(and3.y, or3.u2) annotation (Line(points={{14.7,-27},{18,-27},{18,-48.6},
          {26.6,-48.6}}, color={255,0,255}));
  ...
  connect(zero.y, useHRC.u3) annotation (Line(points={{12.6,34},{34,34},{34,-6},
          {54,-6},{54,-47.8},{60.8,-47.8}}, color={0,0,127}));
  connect(useHRC.y, HRCDamperOpening) annotation (Line(points={{74.6,-43},{74,-43},
          {74,-44},{186,-44},{186,-60},{220,-60}}, color={0,0,127}));
  connect(add1.y, freeCoolingPossible.u) annotation (Line(points={{-51.4,-96},{
          -46,-96},{-46,-36},{-42,-36}}, color={0,0,127}));
  connect(timePassed1.y, pre1.u) annotation (Line(points={{174.6,39},{182,39},{
          182,22},{171.2,22}}, color={255,0,255}));
  connect(pre1.y, rSFlipFlop.R) annotation (Line(points={{157.4,22},{100,22},{
  ...
  connect(switch2.y, PexaLargerPsupa.u2) annotation (Line(points={{128.6,-32},{
          130,-32},{130,-14.6},{136.8,-14.6}}, color={0,0,127}));
  connect(timer.y, timePassed.u1) annotation (Line(points={{148.7,53},{154,53},
          {154,59},{160.8,59}}, color={0,0,127}));
  connect(twoHours.y, timePassed.u2) annotation (Line(points={{112.6,92},{134,
          92},{156,92},{156,53.4},{160.8,53.4}}, color={0,0,127}));
  connect(timer1.y, timePassed1.u1) annotation (Line(points={{148.7,33},{154,33},
          {154,39},{160.8,39}}, color={0,0,127}));
  connect(twentyMinutes.y, timePassed1.u2) annotation (Line(points={{112.6,72},
          {132,72},{150,72},{150,33.4},{160.8,33.4}}, color={0,0,127}));
  connect(exhaustFan.y, switch4.u1) annotation (Line(points={{52.6,38},{76,38},
          {76,26},{90,26},{90,18},{106,18},{106,4.8},{112.8,4.8}}, color={0,0,
          127}));
  connect(timePassed.y, switch4.u2) annotation (Line(points={{174.6,59},{184,59},
          {184,12},{108,12},{108,0},{112.8,0}}, color={255,0,255}));
  connect(switch3.y, switch4.u3) annotation (Line(points={{98.6,7},{104,7},{104,
          -4.8},{112.8,-4.8}}, color={0,0,127}));
  connect(and2.y, useExFan.u1) annotation (Line(points={{14.7,51},{24,51},{24,7},
          {58.6,7}}, color={255,0,255}));
  connect(greaterThreshold.y, switch7.u2) annotation (Line(points={{52.6,-80},{
          58,-80},{62.8,-80}}, color={255,0,255}));
  ...
  connect(switch4.y, greaterThreshold.u) annotation (Line(points={{126.6,0},{
          174,0},{182,0},{182,-68},{78,-68},{78,-60},{32,-60},{32,-80},{38.8,-80}},
        color={0,0,127}));
  connect(one.y, switch6.u3) annotation (Line(points={{14.6,70},{22,70},{30,70},
          {30,-12},{50,-12},{50,-56},{50,-58},{80,-58},{80,-64.8},{158.8,-64.8}},
        color={0,0,127}));
  connect(zero.y, switch6.u1) annotation (Line(points={{12.6,34},{34,34},{34,-6},
          {80,-6},{80,-48},{146,-48},{146,-55.2},{158.8,-55.2}}, color={0,0,127}));
