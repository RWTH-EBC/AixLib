...
<p>
  This model consists of three volumes that are connected among each other through three doors that all have the same geometry. All doors are closed, but they are not air-tight. Heat is added and removed from <code>volB</code> which induces a small air flow through the doors.
</p>
<p>
  This model uses <a href=\"modelica://AixLib.Media.Specialized.Air.PerfectGas\">Buildings.Media.Specialized.Air.PerfectGas</a> as the medium because <a href=\"modelica://AixLib.Media.Air\">Buildings.Media.Air</a> does not account for expansion if air the air is heated.
