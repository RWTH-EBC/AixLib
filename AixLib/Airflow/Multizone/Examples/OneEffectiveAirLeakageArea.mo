...
<p>
  This model consists of a model for an effective air leakage area that is connected to two air volumes. Air flows due to the addition of air to the volume <code>volA</code> and because heat is exchanged with <code>volB</code>.
