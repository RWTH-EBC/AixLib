...
<p>
  This model consists of two doors with the same geometry. For <i>t ≤ 1000</i> seconds, the door <code>dooOpeClo</code> is closed, and afterwards it is open. The door <code>dooOpe</code> is always open. Heat is added to the volume <code>volB</code>, which causes a density difference between <code>volA</code> and <code>volB</code>. This density difference induces a bi-directional airflow through both doors. Both doors have exactly the same bi-directional airflow rates.
