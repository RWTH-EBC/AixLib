...
<p>
  This model is similar than <a href=\"modelica://AixLib.Airflow.Multizone.Validation.ThreeRoomsContam\">AixLib.Airflow.Multizone.Validation.ThreeRoomsContam</a>. However, the initial temperatures are such that at the start of the simulation, the flow direction between the three rooms reverses direction.
</p>
<p>
  At the start of the simulation, the outdoor temperature is <i>15</i>°C, and the temperatures of the volumes are <i>20</i>°C at the top, <i>22</i>°C at the bottom west and <i>25</i>°C at the bottom east. Thus, initially there is a net flow circulation in the counter-clock direction. Because the volume on the east exchanges air with the outside, it cools down fast. Once it cooled down sufficiently, the flow direction between the three rooms reverses because the air in the bottom east is heaviest.
