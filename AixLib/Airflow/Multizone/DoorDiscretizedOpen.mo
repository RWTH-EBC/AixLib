...
<p>
  In this model, the door is always open. Use the model <a href=\"modelica://AixLib.Airflow.Multizone.DoorDiscretizedOperable\">Buildings.Airflow.Multizone.DoorDiscretizedOperable</a> for a door that can either be open or closed.
