...
<p>
  Set the parameter <code>use_HeatTransfer=true</code> to expose a <code>heatPort</code>. This <code>heatPort</code> can be used to add or subtract heat from the volume. This allows, for example, to use this model in conjunction with a model for heat transfer through walls to model a solar chimney that stores heat.
</p>
<p>
  For a steady-state model, use <a href=\"modelica://AixLib.Airflow.Multizone.MediumColumn\">AixLib.Airflow.Multizone.MediumColumn</a> instead of this model.
</p>
<p>
...
<ul>
  <li>
    <i>October 6, 2014</i> by Michael Wetter:<br/>
  ...
  <li>
    <i>July 31, 2011</i> by Michael Wetter:<br/>
    Changed model to use new base class <a href=\"modelica://AixLib.Fluid.Interfaces.LumpedVolumeDeclarations\">AixLib.Fluid.Interfaces.LumpedVolumeDeclarations</a>.
  </li>
  <li>
    <i>May 25, 2011</i> by Michael Wetter:<br/>
