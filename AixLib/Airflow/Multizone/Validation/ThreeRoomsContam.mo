...
model ThreeRoomsContam
  ...
  AixLib.Fluid.Sources.FixedBoundary volOut(
...
<p align=\"center\">
  <img src=\"modelica://AixLib/Resources/Images/Airflow/Multizone/Examples/3roomValidation.png\" border=\"1\" alt=\"Configuration" of="" the="" three="">
</p>
<p>
  This model has been used for a comparative model validation between CONTAM and the <code>Buildings</code> library. See Wetter (2006) for details of the validation.
</p>
<h4>
  References
</h4>
...
<ul>
  ...
  <li>June 26, 2014, by Michael Wetter:<br/>
