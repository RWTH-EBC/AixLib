...
<table border=\"1\" summary=\"Explanation" of="" the="">
  <tr>
    <th>
      Enumeration
    </th>
  ...
  <tr>
    ...
    <td>
      Use this setting to use the density from the volume that is connected to the top port.
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      Use this setting to use the density from the volume that is connected to the bottom port.
    </td>
  </tr>
  <tr>
    <td>
