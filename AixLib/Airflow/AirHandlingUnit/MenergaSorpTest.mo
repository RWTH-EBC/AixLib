...
model MenergaSorpTest "A modular model of the Menerga SorpSolair"
  ...
  Fluid.Sensors.TemperatureTwoPort T01_senTemSup(redeclare package Medium =
        ...
        T_start=T_init) "Temperature of supply air after SteamHumidifier"
  ...
  Fluid.Sensors.TemperatureTwoPort T02_senTemExh(redeclare package Medium =
        MediumAir, m_flow_nominal=5.1,
        T_start=T_init) "Temperature of the Exhaust Air"
    annotation (Placement(transformation(extent={{-598,292},{-578,312}})));
  Fluid.Sensors.TemperatureTwoPort sen_TFo(
    redeclare package Medium = MediumAir,
    m_flow_nominal=5.1,
    T_start=T_init) "Temperature of the exit air after recuperator"
  ...
  Fluid.Sensors.TemperatureTwoPort T04_senTemOut(redeclare package Medium =
        ...
        T_start=T_init) "Temperature of Outside Air"
  ...
  Fluid.Actuators.Valves.TwoWayEqualPercentage
    ...
    l=0.001,
    m_flow_nominal=5.1,
    dpValve_nominal=10) "damper at entry to supply air stream"
  ...
  Fluid.FixedResistances.PressureDrop resSupAir(
    redeclare package Medium = MediumAir,
    m_flow_nominal=5.1,
    dp_nominal=1025) "combined pressure loss of supply air side"
  ...
  Modelica.Blocks.Sources.RealExpression m_default(y=500) annotation (Placement(
        ...
        rotation=0,
        origin={-356,436})));
  Modelica.Blocks.Sources.RealExpression x_default(y=0.4) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-356,456})));
  Modelica.Blocks.Sources.RealExpression Y_default(y=0.8) annotation (Placement(
        ...
        rotation=0,
        origin={-356,476})));
  Modelica.Blocks.Sources.RealExpression T_default2(y=26 + 273.15)
                                                              annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={130,176})));
  Modelica.Blocks.Sources.RealExpression T_default3(y=0.4)    annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={126,156})));
  Modelica.Blocks.Sources.RealExpression L_default(y=15.2/3600*1100)
    annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={128,134})));
  Modelica.Blocks.Sources.RealExpression Y06_default(y=0.9) annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={52,0})));
  Modelica.Blocks.Sources.RealExpression T_default4(y=5)      annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-356,390})));
  Modelica.Blocks.Sources.RealExpression T_default5(y=64 + 273.15)
                                                              annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
  ...
  Modelica.Blocks.Sources.RealExpression T_default6(y=1)      annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={164,262})));
  Modelica.Blocks.Sources.BooleanExpression booleanExpression
    annotation (Placement(transformation(extent={{20,254},{40,274}})));
  ComponentsAHU.Absorber absorber(
    redeclare package Medium = MediumAir,
    m_flow_nominal=5,
    dp_abs=0) annotation (Placement(transformation(extent={{60,152},{40,172}})));
  ComponentsAHU.Absorber                                desorber(
    ...
    m_flow_nominal=1,
    redeclare package Medium = MediumAir,
    t_sol=337.15) annotation (Placement(transformation(extent={{60,290},{40,310}})));
equation
  ...
  connect(Y04.port_b, resExiAir.port_a) annotation (Line(points={{-60,300},{-28,
          300},{-28,318}},  color={162,29,33}));
  connect(Y08.port_b, resExiAir.port_a) annotation (Line(points={{-12,300},{-28,
          300},{-28,318}},  color={0,140,72}));
  ...
  connect(Y_default.y, busSensors.Y06_actual) annotation (Line(points={{-345,
      ...
      index=1,
      extent={{6,3},{6,3}}));
  connect(outsideAirFan.port_b, outMasFlo.port_a) annotation (Line(points={{106,
          26},{96,26},{96,28},{94,28},{94,40}}, color={0,127,255}));
  connect(outMasFlo.m_flow, busSensors.mFlowOut) annotation (Line(points={{105,
          50},{110,50},{110,232},{-212,232},{-212,330},{-303.9,330},{-303.9,
          369.9}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(T_default4.y, busSensors.mFlowAbs) annotation (Line(points={{-345,390},
          {-326,390},{-326,369.9},{-303.9,369.9}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(regMasFlo.m_flow, feedback.u2) annotation (Line(points={{154,311},{
          154,314},{128,314},{128,268}}, color={0,0,127}));
  connect(T_default6.y, feedback.u1) annotation (Line(points={{153,262},{148,
          262},{148,260},{136,260}}, color={0,0,127}));
  connect(outMasFlo.port_b, absorber.port_a)
    annotation (Line(points={{94,60},{94,162},{60,162}}, color={0,127,255}));
  connect(absorber.port_b, resSupAir.port_a) annotation (Line(points={{40,162},
          {-52,162},{-52,28},{-96,28}}, color={0,127,255}));
  connect(T_default2.y, absorber.Ts_in) annotation (Line(points={{119,176},{92,
          176},{92,170},{60.6,170}}, color={0,0,127}));
  connect(T_default3.y, absorber.x_in) annotation (Line(points={{115,156},{90,
          156},{90,166},{60.6,166}}, color={0,0,127}));
  connect(L_default.y, absorber.L_i) annotation (Line(points={{117,134},{90,134},
          {90,157},{60.6,157}}, color={0,0,127}));
  connect(absorber.Y06, busActors.openingY06) annotation (Line(points={{55.6,
          153.2},{-65.2,153.2},{-65.2,364.1},{-186.1,364.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(absorber.Pump, busActors.pumpN07) annotation (Line(points={{50,152},{
          -70,152},{-70,364.1},{-186.1,364.1}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(resRegAir.port_b, desorber.port_a)
    annotation (Line(points={{106,300},{60,300}}, color={0,127,255}));
  connect(desorber.port_b, Y08.port_a)
    annotation (Line(points={{40,300},{8,300}}, color={0,127,255}));
  connect(booleanExpression.y, desorber.Pump) annotation (Line(points={{41,264},
          {52,264},{52,290},{50,290}}, color={255,0,255}));
  connect(feedback.y, desorber.Y06) annotation (Line(points={{119,260},{55.6,
          260},{55.6,291.2}}, color={0,0,127}));
  connect(T_default5.y, desorber.Ts_in) annotation (Line(points={{77,318},{76,
          318},{76,308},{60.6,308}}, color={0,0,127}));
  connect(T_default3.y, desorber.x_in) annotation (Line(points={{115,156},{88,
          156},{88,304},{60.6,304}}, color={0,0,127}));
  connect(L_default.y, desorber.L_i) annotation (Line(points={{117,134},{90,134},
          {90,295},{60.6,295}}, color={0,0,127}));
