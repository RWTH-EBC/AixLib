...
model ComparisonOfAHUHumidifying
...
public
  ...
  Modelica.Blocks.Sources.Constant TempOutside(k=293)
    annotation (Placement(transformation(extent={{-100,60},{-88,72}})));
  Modelica.Blocks.Sources.Constant WaterLoadOutside(k=0.001)
...
equation
  ...
  connect(temAddInRoo.y, addToEtaTem.u1) annotation (Line(points={{85.3,87},{
          85.3,87.2},{75.4,87.2}}, color={0,0,127}));
  ...
  connect(WaterLoadOutside.y, absToRelHum.absHum) annotation (Line(points={{
          -87.4,44},{-82,44},{-82,7.6},{-77,7.6}}, color={0,0,127}));
  connect(TempOutside.y, ahu.T_outdoorAir) annotation (Line(points={{-87.4,66},
          {-82,66},{-82,60.8},{-60.36,60.8}}, color={0,0,127}));
  connect(TempOutside.y, absToRelHum.TDryBul) annotation (Line(points={{-87.4,
          66},{-82,66},{-82,2.2},{-77,2.2}}, color={0,0,127}));
  ...
  connect(addToEtaTem.y, ahu.T_extractAir) annotation (Line(points={{59.3,83},{
          52,83},{52,77.9},{20.48,77.9}}, color={0,0,127}));
  connect(addToEtaTem.y, modularAHU.T_eta) annotation (Line(points={{59.3,83},{
          52,83},{52,14.6},{16.875,14.6}}, color={0,0,127}));
  connect(phi_RoomExtractAir.y, ahu.phi_extractAir) annotation (Line(points={{
          87.4,40},{52,40},{52,73.4},{20.48,73.4}}, color={0,0,127}));
  connect(phi_RoomExtractAir.y, modularAHU.phi_eta) annotation (Line(points={{
          87.4,40},{52,40},{52,10.8},{16.875,10.8}}, color={0,0,127}));
  ...
  connect(phiSupMin.y, modularAHU.phi_supplyAir[1]) annotation (Line(points={{
          87.4,-4},{52,-4},{52,-18},{7.25,-18},{7.25,-13.14}}, color={0,0,127}));
  connect(phiSupMax.y, modularAHU.phi_supplyAir[2]) annotation (Line(points={{
          87.4,18},{52,18},{52,-18},{7.25,-18},{7.25,-12.38}}, color={0,0,127}));
...
end ComparisonOfAHUHumidifying;
