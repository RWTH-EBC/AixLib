within SimpleAHU.UnitTest.Test_SteamHumidifier;
model Test_SteamHumidifier
  ...
  SimpleAHU.Components.SteamHumidifier steamHumidifier(redeclare model
      PartialPressureDrop =
        SimpleAHU.Components.PressureDrop.PressureDropSimple)
