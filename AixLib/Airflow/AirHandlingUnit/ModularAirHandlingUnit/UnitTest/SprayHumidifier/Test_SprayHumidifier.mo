...
equation
  ...
  connect(sprayHumidifier.X_airOut, PID.u_m)
    annotation (Line(points={{1,-8},{44,-8},{44,2}}, color={0,0,127}));
  ...
  connect(PID.y, sprayHumidifier.m_flow_watIn) annotation (Line(points={{55,14},
          {58,14},{58,-82},{-16,-82},{-16,-21}}, color={0,0,127}));
