...
equation
  connect(senTem.port_b, bou1.ports[1]) annotation (Line(points={{82,-60},{90,
          -60}},              color={0,127,255}));
  connect(ramT.y, boundary.T_in) annotation (Line(points={{-69,12},{-62,12},{-62,
          -56},{-50,-56}}, color={0,0,127}));
  connect(ramXi.y, boundary.Xi_in[1]) annotation (Line(points={{-71,-20},{-62,-20},
          {-62,-64},{-50,-64}}, color={0,0,127}));
  connect(ramMasFlo.y, boundary.m_flow_in) annotation (Line(points={{-67,46},{-62,
          46},{-62,-52},{-50,-52}}, color={0,0,127}));
  ...
  connect(senMasFra.X, feedback1.u1)
  ...
  connect(ramMasFlo.y, steamHumidifier.m_flow_airIn) annotation (Line(points={{
          -67,46},{-42,46},{-42,-6},{-19,-6}}, color={0,0,127}));
  connect(ramT.y, steamHumidifier.T_airIn) annotation (Line(points={{-69,12},{
          -42,12},{-42,-9},{-19,-9}}, color={0,0,127}));
  connect(ramXi.y, steamHumidifier.X_airIn) annotation (Line(points={{-71,-20},
          {-42,-20},{-42,-12},{-19,-12}}, color={0,0,127}));
  connect(TSet.y, steamHumidifier.u) annotation (Line(points={{-75,-78},{-66,
          -78},{-66,-32},{-14,-32},{-14,-23.4}}, color={0,0,127}));
  connect(TSet.y, hum.u) annotation (Line(points={{-75,-78},{-18,-78},{-18,-54},
          {-11,-54}}, color={0,0,127}));
  connect(hum.powerEva, feedback2.u1) annotation (Line(points={{11,-50},{26,-50},
          {26,-6},{84,-6}}, color={0,0,127}));
  connect(steamHumidifier.Q, feedback2.u2) annotation (Line(points={{3,-22},{26,
          -22},{26,-14},{92,-14}}, color={0,0,127}));
  connect(steamHumidifier.T_airOut, feedback.u2) annotation (Line(points={{3,-9},
          {26,-9},{26,-42},{88,-42},{88,-36}}, color={0,0,127}));
  connect(steamHumidifier.X_airOut, feedback1.u2) annotation (Line(points={{3,
          -12},{26,-12},{26,-42},{58,-42},{58,-28}}, color={0,0,127}));
  connect(XSet.y, steamHumidifier1.X_set) annotation (Line(points={{-67,84},{
          -48,84},{-48,96},{0,96},{0,92.2}}, color={0,0,127}));
  connect(ramMasFlo.y, steamHumidifier1.m_flow_airIn) annotation (Line(points={
          {-67,46},{-42,46},{-42,90},{-11,90}}, color={0,0,127}));
  connect(ramT.y, steamHumidifier1.T_airIn) annotation (Line(points={{-69,12},{
          -42,12},{-42,86},{-11,86},{-11,87}}, color={0,0,127}));
  connect(ramXi.y, steamHumidifier1.X_airIn) annotation (Line(points={{-71,-20},
          {-42,-20},{-42,84},{-11,84}}, color={0,0,127}));
  connect(ramMasFlo.y, boundary1.m_flow_in)
    annotation (Line(points={{-67,46},{-32,46}}, color={0,0,127}));
  connect(ramT.y, boundary1.T_in) annotation (Line(points={{-69,12},{-42,12},{
          -42,42},{-32,42}}, color={0,0,127}));
  connect(ramXi.y, boundary1.Xi_in[1]) annotation (Line(points={{-71,-20},{-42,
          -20},{-42,34},{-32,34}}, color={0,0,127}));
  connect(boundary1.ports[1], hum1.port_a) annotation (Line(points={{-10,38},{0,
          38},{0,40},{8,40}}, color={0,127,255}));
  ...
  connect(senTem1.T, feedback3.u1)
    annotation (Line(points={{74,51},{74,66},{88,66}}, color={0,0,127}));
  connect(steamHumidifier1.T_airOut, feedback3.u2) annotation (Line(points={{11,
          87},{26,87},{26,52},{96,52},{96,58}}, color={0,0,127}));
  connect(senMasFra1.X, feedback4.u1)
    annotation (Line(points={{46,51},{46,78},{60,78}}, color={0,0,127}));
  connect(steamHumidifier1.X_airOut, feedback4.u2) annotation (Line(points={{11,
          84},{26,84},{26,64},{68,64},{68,70}}, color={0,0,127}));
  connect(hum1.Q_flow, feedback5.u1) annotation (Line(points={{29,48},{32,48},{
          32,92},{34,92}}, color={0,0,127}));
  connect(steamHumidifier1.Q, feedback5.u2) annotation (Line(points={{11,74},{
          44,74},{44,84},{42,84}}, color={0,0,127}));
