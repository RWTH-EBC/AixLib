...
equation
  ...
  connect(senCooRea.T_airOut, feedback.u2) annotation (Line(points={{5,-13},{30,
          -13},{30,-28},{56,-28},{56,-20}}, color={0,0,127}));
  connect(ramMasFlo.y, senCooRea1.m_flow_airIn) annotation (Line(points={{-67,46},
          {-48,46},{-48,86},{-11,86}}, color={0,0,127}));
  connect(ramT.y, senCooRea1.T_airIn) annotation (Line(points={{-69,12},{-48,12},
          {-48,83},{-11,83}}, color={0,0,127}));
  connect(ramXi.y, senCooRea1.X_airIn) annotation (Line(points={{-71,-20},{-48,-20},
          {-48,80},{-11,80}}, color={0,0,127}));
  connect(senCooRea1.Q, feedback1.u2) annotation (Line(points={{11,72},{22,72},
  ...
  connect(ramXi.y, boundary1.Xi_in[1]) annotation (Line(points={{-71,-20},{-62,-20},
          {-62,26},{-44,26}}, color={0,0,127}));
  connect(ramT.y, boundary1.T_in) annotation (Line(points={{-69,12},{-62,12},{-62,
          34},{-44,34}}, color={0,0,127}));
  connect(ramMasFlo.y, boundary1.m_flow_in) annotation (Line(points={{-67,46},{-62,
          46},{-62,38},{-44,38}}, color={0,0,127}));
  connect(boundary1.ports[1], cooFlu1.port_a) annotation (Line(points={{-22,30},
          {-12,30},{-12,40},{-4,40}}, color={0,127,255}));
  ...
  connect(cooFlu1.Q_flow, feedback1.u1) annotation (Line(points={{17,48},{30,48},
