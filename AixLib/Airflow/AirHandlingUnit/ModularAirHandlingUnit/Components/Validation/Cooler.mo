...
equation
  ...
  connect(senTem.T, feedback.u1)
    annotation (Line(points={{72,-49},{72,-30},{40,-30},{40,-12},{48,-12}},
                                                          color={0,0,127}));
  connect(CooRea.T_airOut, feedback.u2) annotation (Line(points={{5,-13},{30,-13},
  ...
  connect(CooRea.X_airOut, controlerCooler.Xout) annotation (Line(points={{5,
          -16},{14,-16},{14,6},{-38,6},{-38,34},{-29,34}}, color={0,0,127}));
  ...
  connect(CooRea.X_airOut, feedback1.u2) annotation (Line(points={{5,-16},{26,
          -16},{26,6},{54,6},{54,14}}, color={0,0,127}));
  connect(preOut.Q_flow, feedback2.u1) annotation (Line(points={{15,-52},{26,
          -52},{26,54},{44,54}}, color={0,0,127}));
  connect(CooRea.Q, feedback2.u2) annotation (Line(points={{5,-24},{26,-24},{26,
          36},{52,36},{52,46}}, color={0,0,127}));
