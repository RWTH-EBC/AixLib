...
<p>This model provides a idealized cooler. The model considers the convective heat transfer from the heat transfer surface in the air stream. Moreover the heat capacity of the heating surface and the housing of the heat exchanger is considered.</p>
<p>If the temperature of the cooling surface lies below the dew point, condensation is considered. </p>
<h4>Heat transfer model:</h4>
<p>The model assumes a heat transfer in a plane gap. Hence the convective heat transfer coefficient is calculated using the Nusselt-correlation for a plane gap as described in the VDI-Wärmeatlas 2013 (p.800, eq. 45).</p>
<p align=\"center\"><i>Nu<sub>m</sub> = 7.55 + (0.024 {Re Pr d<sub>h </sub> &frasl; l}<sup>1.14</sup>) &frasl; (1 + 0.0358 {Re Pr d<sub>h</sub> &frasl; l}<sup>0.64</sup> Pr<sup>0.17</sup>) </i></p>
</html>", revisions="<html>
<ul>
