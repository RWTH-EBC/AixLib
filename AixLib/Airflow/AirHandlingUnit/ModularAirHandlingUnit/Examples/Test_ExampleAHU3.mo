...
model Test_ExampleAHU3
  ...
  Modelica.Blocks.Sources.Constant X_set_Cooler(k=0.003)
...
equation
  ...
  connect(PID_T_setCoolingSurf.y, exampleAHU2.T_coolingSurf) annotation (Line(
        points={{-61.4,-60},{-22.3889,-60},{-22.3889,8}}, color={0,0,127}));
  ...
  connect(toTotAir.XiTotalAir, PID_T_setCoolingSurf.u_m) annotation (Line(
        points={{96.6,12},{108,12},{108,-104},{-68,-104},{-68,-67.2}}, color={0,
          0,127}));
  ...
  connect(exampleAHU2.T_airOutSup, x_pTphi.T) annotation (Line(points={{57.0556,
          23.5},{122,23.5},{122,-42},{62,-42},{62,-54},{53.2,-54}}, color={0,0,127}));
  connect(x_pTphi1.T, exampleAHU2.T_airOutSup) annotation (Line(points={{53.2,
          -86},{58,-86},{58,-72},{122,-72},{122,23.5},{57.0556,23.5}},
                                                                  color={0,0,127}));
  ...
  connect(PID_humidity_max.y, exampleAHU2.X_set_Cooler) annotation (Line(points=
         {{15.4,-86},{0.222222,-86},{0.222222,8}}, color={0,0,127}));
