...
equation
  ...
  connect(plateHeatExchangerFixedEfficiency.T_set, T_set_HRS) annotation (Line(
        points={{-62,21},{-62,26},{-90,26},{-90,-82},{-160,-82},{-160,-110}},
        color={0,0,127}));

  connect(cooler.X_set, X_set_Cooler) annotation (Line(points={{16,8},{16,42},{
          -86,42},{-86,-80},{14,-80},{14,-110}},                    color={0,0,127}));
  ...
  connect(sprayHumidifier.T_watIn, T_waterIn) annotation (Line(points={{39,-13},
          {39,-76},{68,-76},{68,-110}}, color={0,0,127}));
  ...
  connect(sprayHumidifier.X_set, X_set_Humidifier) annotation (Line(points={{42,
          9},{42,18},{26,18},{26,-80},{40,-80},{40,-110}}, color={0,0,127}));
