...
model ExampleAHU "Model of an examplary air handling unit"
  ...
  Components.SteamHumidifier steamHumidifier(
    cp_air=cp_air,
    cp_steam=cp_steam,
    cp_water=c_water,
    redeclare model PartialPressureDrop =
        Components.PressureDrop.PressureDropSimple (a=0.2, b=1.2))
  ...
  Modelica.Blocks.Interfaces.RealInput T_steamIn annotation (Placement(
        transformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
        ...
        rotation=90,
        origin={80,-100})));
  Modelica.Blocks.Interfaces.RealInput m_flow_steam "mass flow rate of steam"
  ...
  Modelica.Blocks.Interfaces.RealInput T_coolingSurf
    "temperature of cooling Surface" annotation (Placement(transformation(
        extent={{-20,-20},{20,20}},
        rotation=90,
...
equation
  if use_T_set then
    ...
    connect(T_set_cooler, cooler.T_set) annotation (Line(points={{-20,-110},{
            -20,-80},{-86,-80},{-86,34},{-40,34},{-40,20},{10,20},{10,8}},
                                                                color={0,0,127}));
    connect(T_set_reheater, reheater.T_set) annotation (Line(points={{130,-110},
            {130,-80},{92,-80},{92,20},{74,20},{74,8}},
                                                 color={0,0,127}));
  else
  ...
  connect(plateHeatExchangerFixedEfficiency.m_flow_airInOda, m_flow_airInOda)
    annotation (Line(points={{-73,18},{-86,18},{-86,80},{-200,80}}, color={0,0,
          127}));
  connect(plateHeatExchangerFixedEfficiency.T_airInOda, T_airInOda) annotation (
     Line(points={{-73,15},{-86,15},{-86,50},{-200,50}}, color={0,0,127}));
  connect(plateHeatExchangerFixedEfficiency.X_airInOda, X_airInOda) annotation (
     Line(points={{-73,12},{-86,12},{-86,20},{-200,20}}, color={0,0,127}));
  ...
  connect(cooler.m_flow_airOut, steamHumidifier.m_flow_airIn)
    annotation (Line(points={{21,6},{31,6}}, color={0,0,127}));
  connect(cooler.T_airOut, steamHumidifier.T_airIn) annotation (Line(points={{
          21,3},{26.5,3},{26.5,3},{31,3}}, color={0,0,127}));
  connect(cooler.X_airOut, steamHumidifier.X_airIn)
    annotation (Line(points={{21,0},{31,0}}, color={0,0,127}));
  connect(steamHumidifier.m_flow_airOut, reheater.m_flow_airIn)
    annotation (Line(points={{53,6},{63,6}}, color={0,0,127}));
  connect(steamHumidifier.T_airOut, reheater.T_airIn) annotation (Line(points={
          {53,3},{58.5,3},{58.5,3},{63,3}}, color={0,0,127}));
  connect(steamHumidifier.X_airOut, reheater.X_airIn)
    annotation (Line(points={{53,0},{63,0}}, color={0,0,127}));
  connect(reheater.m_flow_airOut, m_flow_airOutSup) annotation (Line(points={{
          85,6},{92,6},{92,-20},{190,-20}}, color={0,0,127}));
  connect(reheater.T_airOut, T_airOutSup) annotation (Line(points={{85,3},{92,3},
          {92,-50},{190,-50}}, color={0,0,127}));
  connect(reheater.X_airOut, X_airOutSup) annotation (Line(points={{85,0},{92,0},
          {92,-80},{190,-80}}, color={0,0,127}));
  connect(plateHeatExchangerFixedEfficiency.m_flow_airInEta, m_flow_airInEta)
    annotation (Line(points={{-51,18},{-40,18},{-40,80},{200,80}}, color={0,0,
          127}));
  connect(plateHeatExchangerFixedEfficiency.T_airInEta, T_airInEta) annotation (
     Line(points={{-51,15},{-40,15},{-40,50},{200,50}}, color={0,0,127}));
  connect(plateHeatExchangerFixedEfficiency.X_airInEta, X_airInEta) annotation (
     Line(points={{-51,12},{-40,12},{-40,20},{200,20}}, color={0,0,127}));
  connect(plateHeatExchangerFixedEfficiency.m_flow_airOutEta, m_flow_airOutEha)
    annotation (Line(points={{-73,8},{-86,8},{-86,-20},{-190,-20}}, color={0,0,
          127}));
  connect(plateHeatExchangerFixedEfficiency.T_airOutEta, T_airOutEha)
    annotation (Line(points={{-73,5},{-86,5},{-86,-50},{-190,-50}}, color={0,0,
          127}));
  connect(plateHeatExchangerFixedEfficiency.X_airOutEta, X_airOutEha)
    annotation (Line(points={{-73,2},{-86,2},{-86,-80},{-190,-80}}, color={0,0,
          127}));
  connect(steamHumidifier.T_steamIn, T_steamIn) annotation (Line(points={{39,
          -11.4},{39,-80},{90,-80},{90,-110}}, color={0,0,127}));
  connect(steamHumidifier.m_flow_steam, m_flow_steam) annotation (Line(points={{36,
          -11.4},{36,-80},{40,-80},{40,-110}},     color={0,0,127}));
  connect(cooler.T_coolingSurf, T_coolingSurf) annotation (Line(points={{5.1,
          -11.9},{5.1,-80},{-60,-80},{-60,-110}}, color={0,0,127}));
  connect(plateHeatExchangerFixedEfficiency.T_set, T_set_HRS) annotation (Line(
        points={{-62,21},{-62,34},{-86,34},{-86,-80},{-160,-80},{-160,-110}},
        color={0,0,127}));

  connect(cooler.X_set, X_set_Cooler) annotation (Line(points={{16,8},{16,20},{
          -24,20},{-24,34},{-86,34},{-86,-80},{14,-80},{14,-110}},  color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-180,
        ...
        Bitmap(
          ...
          fileName="modelica://SimpleAHU/Resources/ExampleAHU.png")}), Diagram(
