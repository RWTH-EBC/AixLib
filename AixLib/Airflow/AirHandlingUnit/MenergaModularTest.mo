...
model MenergaModularTest "A modular model of the Menerga SorpSolair"
  ...
  Modelica.Blocks.Sources.BooleanExpression booleanExpression
    annotation (Placement(transformation(extent={{-228,162},{-248,182}})));
equation
  ...
  connect(booleanExpression.y, recuperator.adiCoo) annotation (Line(points={{
          -249,172},{-260,172},{-260,172.6},{-309.72,172.6}}, color={255,0,255}));
