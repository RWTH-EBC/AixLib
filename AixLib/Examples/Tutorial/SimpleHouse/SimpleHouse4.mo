...
model SimpleHouse4 "Heating model"
  ...
  AixLib.Fluid.HeatExchangers.HeaterCooler_u heaWat(
    redeclare package Medium = MediumWater,
  ...
  AixLib.Fluid.Sources.Boundary_pT bouWat(
    redeclare package Medium = MediumWater,
    nPorts=1)
...
<li>
<a href=\"modelica://AixLib.Fluid.Movers.Preconfigured.FlowControlled_m_flow\">
AixLib.Fluid.Movers.Preconfigured.FlowControlled_m_flow</a>
</li>
<li>
...
src=\"modelica://AixLib/Resources/Images/Examples/Tutorial/SimpleHouse/result4.png\" width=\"1000\"/>
</p>
</html>"),
    __Dymola_Commands(file=
          "modelica://AixLib/Resources/Scripts/Dymola/Examples/Tutorial/SimpleHouse/SimpleHouse4.mos"
        "Simulate and plot"), 
