...
model SimpleHouse3 "Air model"
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor conRes(R=1/hWall/
      ...
      Placement(transformation(
        ...
        rotation=270,
        origin={110,20})));
  AixLib.Fluid.MixingVolumes.MixingVolume zon(
...
src=\"modelica://AixLib/Resources/Images/Examples/Tutorial/SimpleHouse/result3.png\" width=\"1000\"/>
</p>
</html>"),
    __Dymola_Commands(file=
          "modelica://AixLib/Resources/Scripts/Dymola/Examples/Tutorial/SimpleHouse/SimpleHouse3.mos"
        "Simulate and plot"));
end SimpleHouse3;
