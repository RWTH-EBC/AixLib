...
model SimpleHouse6 "Free cooling model"
  ...
  AixLib.Fluid.Actuators.Dampers.Exponential vavDam(
    ...
    "Damper" annotation (Placement(transformation(extent={{-10,10},{10,
            -10}}, origin={110,130})));
  AixLib.Fluid.Movers.Preconfigured.FlowControlled_dp fan(
    redeclare package Medium = MediumAir,
    show_T=true,
  ...
  AixLib.Fluid.HeatExchangers.ConstantEffectiveness hexRec(
  ...
  AixLib.Fluid.Sources.Boundary_pT bouAir(
    redeclare package Medium = MediumAir,
    use_T_in=true,
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort TFanIn(
    redeclare final package Medium = MediumAir,
    final m_flow_nominal=mAir_flow_nominal,
    tau=0) "Temperature at fan inlet"
    annotation (Placement(transformation(extent={{-40,120},{-20,140}})));
  AixLib.Fluid.Sensors.TemperatureTwoPort TFanOut(
    redeclare final package Medium = MediumAir,
    final m_flow_nominal=mAir_flow_nominal,
...
<li>
<a href=\"modelica://AixLib.Fluid.Movers.Preconfigured.FlowControlled_dp\">
AixLib.Fluid.Movers.Preconfigured.FlowControlled_dp</a>
</li>
<li>
...
src=\"modelica://AixLib/Resources/Images/Examples/Tutorial/SimpleHouse/result6.png\" width=\"1000\"/>
</p>
<p align=\"center\">
<img alt=\"Ventilation control signal as function of time.\"
src=\"modelica://AixLib/Resources/Images/Examples/Tutorial/SimpleHouse/result7.png\" width=\"1000\"/>
</p>
</html>"),
