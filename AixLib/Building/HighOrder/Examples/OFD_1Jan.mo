...
model OFD_1Jan "OFD with TMC, TIR and TRY"
  ...
  AixLib.Building.HighOrder.House.OFD_MiddleInnerLoadWall.BuildingAndEnergySystem.OFD_IdealHeaters OFD(TIR = 3) annotation(Placement(transformation(extent = {{94, -20}, {153, 19}})));
...
equation
  ...
  connect(NaturalVentilation.y[1], OFD.NaturalVentilation_UF[1]) annotation(Line(points = {{39, 35}, {59, 35}, {59, 8.47}, {93.6067, 8.47}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(NaturalVentilation.y[2], OFD.NaturalVentilation_UF[2]) annotation(Line(points = {{39, 35}, {59, 35}, {59, 10.03}, {93.6067, 10.03}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(TSet.y[1], OFD.TSet_UF[1]) annotation(Line(points = {{41, -13}, {59, -13}, {59, -9.81125}, {93.8033, -9.81125}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(TSet.y[1], OFD.TSet_GF[1]) annotation(Line(points = {{41, -13}, {59, -13}, {59, -19.298}, {94, -19.298}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(TSet.y[2], OFD.TSet_UF[2]) annotation(Line(points = {{41, -13}, {59, -13}, {59, -8.15375}, {93.8033, -8.15375}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(TSet.y[4], OFD.TSet_UF[3]) annotation(Line(points = {{41, -13}, {60, -13}, {60, -6.49625}, {93.8033, -6.49625}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(TSet.y[5], OFD.TSet_GF[4]) annotation(Line(points = {{41, -13}, {59, -13}, {59, -15.086}, {94, -15.086}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(TSet.y[3], OFD.TSet_UF[4]) annotation(Line(points = {{41, -13}, {60, -13}, {60, -4.83875}, {93.8033, -4.83875}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(TSet.y[3], OFD.TSet_GF[5]) annotation(Line(points = {{41, -13}, {60, -13}, {60, -27}, {94, -27}, {94, -13.682}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(NaturalVentilation.y[3], OFD.NaturalVentilation_UF[4]) annotation(Line(points = {{39, 35}, {60, 35}, {60, 13.15}, {93.6067, 13.15}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(NaturalVentilation.y[4], OFD.NaturalVentilation_UF[3]) annotation(Line(points = {{39, 35}, {60, 35}, {60, 11.59}, {93.6067, 11.59}}, color = {0, 0, 127}, smooth = Smooth.None));
