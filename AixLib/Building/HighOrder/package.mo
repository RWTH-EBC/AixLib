...
<ul>
  ...
  <li>build a model so that changing the parameters is easy, quick and will not lead to hidden mistakes
  </li>
  <li>have an easy to use graphical interface
  </li>
  <li>ensure a degree of flexibility for expanding or building new models
  </li>
</ul>
<p>
  <br/>
...
<ul>
  <li>the floor layouts were made based on existing buildings, by analyzing data provided by the German Federal Statistical Office and by consulting with experts
  </li>
  <li>for modeling realistical wall structures building catalogues as well as experts were consulted
  </li>
  <li>the physical properties of the materials for the wall layers were chosen to satisfy the insulation requirements of current and past German energy saving ordinances: WSchV 1984, WSchV1995, EnEV 2002 and EnEV 2009
  </li>
</ul>
<h4>
...
<p>
  Ana Constantin, Rita Streblow and Dirk Mueller The Modelica HouseModels Library: Presentation and Evaluation of a Room Model with the ASHRAE Standard 140 in Proceedings of Modelica Conference, Lund 2014, Pages 293-299. DOI: <a href=\"http://dx.doi.org/10.3384/ECP14096293\">10.3384/ECP14096293</a>
