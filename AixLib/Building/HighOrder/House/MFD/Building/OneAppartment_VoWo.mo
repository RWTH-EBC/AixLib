...
equation
  ...
  connect(Corridor.thermLivingroom, Livingroom.thermCorridor) annotation(Line(points = {{21.696, 13.84}, {18, 13.84}, {18, -20}, {36, -20}, {36, -80}, {-80, -80}, {-80, 43.3333}, {-64.9412, 43.3333}}, color = {191, 0, 0}));
  connect(Livingroom.thermChildren, Children.thermLivingroom) annotation(Line(points = {{-64.9412, 38.1333}, {-80, 38.1333}, {-80, 90}, {20, 90}, {20, 48.64}, {36, 48.64}}, color = {191, 0, 0}));
  ...
  connect(Children.ThermRoom, ThermChildren) annotation(Line(points = {{48.768, 61.712}, {46, 61.712}, {46, 32}, {48, 32}}, color = {191, 0, 0}));
