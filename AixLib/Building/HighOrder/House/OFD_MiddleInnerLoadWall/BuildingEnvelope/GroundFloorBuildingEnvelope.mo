...
equation
  ...
  connect(Hobby.starRoom, StarHobby) annotation(Line(points = {{61.2, 56.8}, {61.2, 44}, {36, 44}, {36, 40}, {20, 40}}, color = {95, 95, 95}, pattern = LinePattern.Solid, smooth = Smooth.None));
  connect(Corridor.starRoom, StarCorridor) annotation(Line(points = {{58, -5.2}, {58, -20}, {0, -20}}, color = {95, 95, 95}, pattern = LinePattern.Solid, smooth = Smooth.None));
  connect(StarWC_Storage, StarWC_Storage) annotation(Line(points = {{20, -60}, {20, -60}}, color = {95, 95, 95}, pattern = LinePattern.Solid, smooth = Smooth.None));
  ...
  connect(WC_Storage.starRoom, StarWC_Storage) annotation(Line(points = {{61.2, -64.8}, {61.2, -70}, {36, -70}, {36, -60}, {20, -60}}, color = {95, 95, 95}, pattern = LinePattern.Solid, smooth = Smooth.None));
  ...
  connect(Kitchen.starRoom, StarKitchen) annotation(Line(points = {{-60, -58.4}, {-60, -54}, {-34, -54}, {-34, -60}, {-20, -60}}, color = {95, 95, 95}, pattern = LinePattern.Solid, smooth = Smooth.None));
  ...
  connect(Livingroom.starRoom, StarLivingroom) annotation(Line(points = {{-59.6, 52.4}, {-59.6, 48}, {-32, 48}, {-32, 40}, {-20, 40}}, color = {95, 95, 95}, pattern = LinePattern.Solid, smooth = Smooth.None));
  connect(Livingroom.thermFloor, ThermFloor[1]) annotation(Line(points = {{-68.84, 38.32}, {-68.84, 6}, {-90, 6}, {-90, -92}, {2, -92}, {2, -98.8}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  connect(Hobby.thermFloor, ThermFloor[2]) annotation(Line(points = {{69.18, 46.24}, {69.18, 22}, {90, 22}, {90, -92}, {8, -92}, {2, -96.4}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  connect(Corridor.thermFloor, ThermFloor[3]) annotation(Line(points = {{66.4, -13.56}, {66.4, -32}, {90, -32}, {90, -92}, {4, -92}, {4, -94}, {2, -94}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  connect(WC_Storage.thermFloor, ThermFloor[4]) annotation(Line(points = {{69.18, -54.24}, {90, -54.24}, {90, -91.6}, {2, -91.6}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  connect(Kitchen.thermFloor, ThermFloor[5]) annotation(Line(points = {{-68.4, -44.32}, {-90, -44.32}, {-90, -92}, {-4, -92}, {2, -89.2}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  annotation(__Dymola_Images(Parameters(source = "AixLib/Images/House/Groundfloor_5Rooms.png")), Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
            -100},{100,100}}),                                                                                                    graphics), Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Bitmap(extent=  {{-96, 90}, {100, -106}}, fileName=  "modelica://AixLib/Images/House/Groundfloor_icon.png"), Text(extent=  {{-66, 66}, {10, 54}}, lineColor=  {0, 0, 0}, textString=  "Livingroom"), Text(extent=  {{14, 76}, {64, 62}}, lineColor=  {0, 0, 0}, textString=  "Hobby"), Text(extent=  {{22, 24}, {56, 14}}, lineColor=  {0, 0, 0}, textString=  "Corridor"), Text(extent=  {{-2, -42}, {74, -52}}, lineColor=  {0, 0, 0}, textString=  "WC_Storage"), Text(extent=  {{-50, -10}, {-6, -24}}, lineColor=  {0, 0, 0}, textString=  "Kitchen")}), Documentation(revisions = "<html>
 <ul>
