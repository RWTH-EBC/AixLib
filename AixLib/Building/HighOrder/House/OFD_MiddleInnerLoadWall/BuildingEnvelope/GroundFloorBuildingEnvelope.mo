...
model GroundFloorBuildingEnvelope
  ...
  Rooms.OFD.Ow2IwL2IwS1Gr1Uf1 Livingroom(TMC = TMC, TIR = TIR, room_lengthb = length2, room_width = room_width, room_height = room_height, room_length = length1 + length2 + thickness_IWsimple, solar_absorptance_OW = solar_absorptance_OW, T_Ground = T_Ground, windowarea_OW1 = windowarea_11, windowarea_OW2 = windowarea_12, withDoor1 = false, withDoor2 = false, withWindow1 = true, withWindow2 = true, withFloorHeating = withFloorHeating, withDynamicVentilation = withDynamicVentilation, HeatingLimit = HeatingLimit, Max_VR = Max_VR, Diff_toTempset = Diff_toTempset, Tset = Tset_Livingroom, T0_air = 295.15, T0_OW1 = 295.15, T0_OW2 = 295.15, T0_IW1a = 295.15, T0_IW1b = 295.15, T0_IW2 = 295.15, T0_CE = 295.13, T0_FL = 295.13) annotation(Placement(transformation(extent = {{-86, 14}, {-42, 78}})));
  Rooms.OFD.Ow2IwL1IwS1Gr1Uf1 Hobby(TMC = TMC, TIR = TIR, room_length = length1, room_width = room_width, room_height = room_height, solar_absorptance_OW = solar_absorptance_OW, T_Ground = T_Ground, windowarea_OW2 = windowarea_22, withDoor1 = false, withDoor2 = false, withWindow1 = false, withWindow2 = true, withFloorHeating = withFloorHeating, T0_air = 295.15, T0_OW1 = 295.15, T0_OW2 = 295.15, T0_IW1 = 295.15, T0_IW2 = 295.15, T0_CE = 295.13, T0_FL = 295.13, withDynamicVentilation = withDynamicVentilation, HeatingLimit = HeatingLimit, Max_VR = Max_VR, Diff_toTempset = Diff_toTempset, Tset = Tset_Hobby) annotation(Placement(transformation(extent = {{84, 28}, {46, 76}})));
  Rooms.OFD.Ow2IwL1IwS1Gr1Uf1 WC_Storage(TMC = TMC, TIR = TIR, room_length = length4, room_width = room_width, room_height = room_height, solar_absorptance_OW = solar_absorptance_OW, T_Ground = T_Ground, withWindow1 = true, windowarea_OW1 = windowarea_41, withDoor2 = true, door_width_OD2 = door_width_42, door_height_OD2 = door_height_42, withWindow2 = false, withDoor1 = false, withFloorHeating = withFloorHeating, T0_air = 291.15, T0_OW1 = 291.15, T0_OW2 = 291.15, T0_IW1 = 291.15, T0_IW2 = 291.15, T0_CE = 291.13, T0_FL = 291.13, withDynamicVentilation = withDynamicVentilation, HeatingLimit = HeatingLimit, Max_VR = Max_VR, Diff_toTempset = Diff_toTempset, Tset = Tset_WC) annotation(Placement(transformation(extent = {{84, -36}, {46, -84}})));
  Rooms.OFD.Ow2IwL2IwS1Gr1Uf1 Kitchen(TMC = TMC, TIR = TIR, room_length = length3 + length4 + thickness_IWsimple, room_width = room_width, room_height = room_height, solar_absorptance_OW = solar_absorptance_OW, T_Ground = T_Ground, withWindow1 = true, windowarea_OW1 = windowarea_51, withWindow2 = true, windowarea_OW2 = windowarea_52, room_lengthb = length3, withDoor1 = false, withDoor2 = false, withFloorHeating = withFloorHeating, T0_air = 295.15, T0_OW1 = 295.15, T0_OW2 = 295.15, T0_IW1a = 295.15, T0_IW1b = 295.15, T0_IW2 = 295.15, T0_CE = 295.13, T0_FL = 295.13, withDynamicVentilation = withDynamicVentilation, HeatingLimit = HeatingLimit, Max_VR = Max_VR, Diff_toTempset = Diff_toTempset, Tset = Tset_Kitchen) annotation(Placement(transformation(extent = {{-84, -20}, {-44, -84}})));
  Rooms.OFD.Ow1IwL2IwS1Gr1Uf1 Corridor(TMC = TMC, TIR = TIR, room_length = length2 + length3 + thickness_IWsimple, room_width = room_width, room_height = room_height, solar_absorptance_OW = solar_absorptance_OW, T_Ground = T_Ground, withDoor1 = true, door_width_OD1 = door_width_31, door_height_OD1 = door_height_31, room_lengthb = length3, withWindow1 = false, withFloorHeating = withFloorHeating, T0_air = 291.15, T0_OW1 = 291.15, T0_IW1 = 291.15, T0_IW2a = 291.15, T0_IW2b = 291.15, T0_IW3 = 291.15, T0_CE = 291.13, T0_FL = 291.13) annotation(Placement(transformation(extent = {{82, -28}, {42, 10}})));
...
equation
  if withFloorHeating then
    connect(Livingroom.thermFloor, ThermFloor[1]) annotation(Line(points = {{-68.84, 38.32}, {-68.84, 6}, {-90, 6}, {-90, -92}, {2, -92}, {2, -98.8}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
    connect(Hobby.thermFloor, ThermFloor[2]) annotation(Line(points = {{69.18, 46.24}, {69.18, 22}, {90, 22}, {90, -92}, {8, -92}, {2, -96.4}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  ...
  connect(Livingroom.SolarRadiationPort_OW2, West) annotation(Line(points = {{-52.89, 77.68}, {-52.89, 86}, {90, 86}, {90, -16}, {110, -16}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Hobby.SolarRadiationPort_OW2, West) annotation(Line(points = {{55.405, 75.76}, {55.405, 86}, {90, 86}, {90, -16}, {110, -16}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Hobby.SolarRadiationPort_OW1, North) annotation(Line(points = {{83.905, 59.2}, {90, 59.2}, {90, 88}, {110, 88}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Corridor.SolarRadiationPort_OW1, North) annotation(Line(points = {{81.9, 2.4}, {90, 2.4}, {90, 88}, {110, 88}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(WC_Storage.SolarRadiationPort_OW1, North) annotation(Line(points = {{83.905, -67.2}, {90, -67.2}, {90, 88}, {110, 88}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(WC_Storage.SolarRadiationPort_OW2, East) annotation(Line(points = {{55.405, -83.76}, {55.405, -92}, {-90, -92}, {-90, 86}, {90, 86}, {90, 60}, {110, 60}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Kitchen.SolarRadiationPort_OW2, East) annotation(Line(points = {{-53.9, -83.68}, {-53.9, -92}, {-90, -92}, {-90, 86}, {90, 86}, {90, 60}, {110, 60}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Livingroom.SolarRadiationPort_OW1, South) annotation(Line(points = {{-85.89, 55.6}, {-90, 55.6}, {-90, 86}, {90, 86}, {90, 26}, {110, 26}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Livingroom.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{-85.89, 33.2}, {-90, 33.2}, {-90, 27}, {-115, 27}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Kitchen.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{-83.9, -39.2}, {-90, -39.2}, {-90, 27}, {-115, 27}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(WC_Storage.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{83.905, -50.4}, {90, -50.4}, {90, -92}, {-90, -92}, {-90, 27}, {-115, 27}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Corridor.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{81.9, -20.4}, {90, -20.4}, {90, -92}, {-90, -92}, {-90, 27}, {-115, 27}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Hobby.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{83.905, 42.4}, {90, 42.4}, {90, -92}, {-90, -92}, {-90, 27}, {-115, 27}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Livingroom.thermOutside, thermOutside) annotation(Line(points = {{-83.8, 74.8}, {-90, 74.8}, {-90, 74}, {-108, 74}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Kitchen.thermOutside, thermOutside) annotation(Line(points = {{-82, -80.8}, {-90, -80.8}, {-90, 74}, {-108, 74}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(WC_Storage.thermOutside, thermOutside) annotation(Line(points = {{82.1, -81.6}, {82.1, -92}, {-90, -92}, {-90, 74}, {-108, 74}}, color = {191, 0, 0}, smooth = Smooth.None));
  ...
  connect(Hobby.thermOutside, thermOutside) annotation(Line(points = {{82.1, 73.6}, {90, 73.6}, {90, 86}, {-90, 86}, {-90, 74}, {-108, 74}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Livingroom.thermCeiling, thermCeiling_Livingroom) annotation(Line(points = {{-44.2, 68.4}, {-32, 68.4}, {-32, 86}, {-92, 86}, {-92, 109}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Livingroom.thermInsideWall1a, Hobby.thermInsideWall1) annotation(Line(points = {{-44.2, 55.6}, {-32, 55.6}, {-32, 86}, {36, 86}, {36, 54.4}, {47.9, 54.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Hobby.thermCeiling, thermCeiling_Hobby) annotation(Line(points = {{47.9, 68.8}, {36, 68.8}, {36, 86}, {-50, 86}, {-50, 109}, {-49, 109}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Corridor.thermCeiling, thermCeiling_Corridor) annotation(Line(points = {{44, 4.3}, {36, 4.3}, {36, 86}, {-10, 86}, {-10, 109}, {-11, 109}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(WC_Storage.thermCeiling, thermCeiling_WCStorage) annotation(Line(points = {{47.9, -76.8}, {36, -76.8}, {36, -92}, {90, -92}, {90, 86}, {29, 86}, {29, 109}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Kitchen.thermCeiling, thermCeiling_Kitchen) annotation(Line(points = {{-46, -74.4}, {-34, -74.4}, {-34, -92}, {90, -92}, {90, 86}, {71, 86}, {71, 109}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Kitchen.thermInsideWall1a, WC_Storage.thermInsideWall1) annotation(Line(points = {{-46, -61.6}, {-34, -61.6}, {-34, -92}, {36, -92}, {36, -62}, {47.9, -62}, {47.9, -62.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Livingroom.thermInsideWall1b, Corridor.thermInsideWall2a) annotation(Line(points = {{-44.2, 42.8}, {-32, 42.8}, {-32, 86}, {36, 86}, {36, -3.3}, {44, -3.3}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Kitchen.thermInsideWall2, Livingroom.thermInsideWall2) annotation(Line(points = {{-58, -23.2}, {-58, -14}, {-90, -14}, {-90, 6}, {-57.4, 6}, {-57.4, 17.2}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Corridor.thermInsideWall3, WC_Storage.thermInsideWall2) annotation(Line(points = {{56, -26.1}, {56, -32}, {59.3, -32}, {59.3, -38.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Hobby.thermInsideWall2, Corridor.thermInsideWall1) annotation(Line(points = {{59.3, 30.4}, {59.3, 22}, {90, 22}, {90, 14}, {56, 14}, {56, 8.1}}, color = {191, 0, 0}, smooth = Smooth.None));
  ...
  connect(Livingroom.AirExchangePort, AirExchangePort[1]) annotation(Line(points = {{-68.51, 77.52}, {-68.51, 86}, {-90, 86}, {-90, -14.25}, {-115, -14.25}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Hobby.AirExchangePort, AirExchangePort[2]) annotation(Line(points = {{68.895, 75.64}, {68.895, 86}, {-90, 86}, {-90, -6.75}, {-115, -6.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Kitchen.SolarRadiationPort_OW1, South) annotation(Line(points = {{-83.9, -61.6}, {-90, -61.6}, {-90, -92}, {90, -92}, {90, 26}, {110, 26}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(Corridor.thermInsideWall2b, Kitchen.thermInsideWall1b) annotation(Line(points = {{44, -10.9}, {36, -10.9}, {36, -92}, {-34, -92}, {-34, -48.8}, {-46, -48.8}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(WC_Storage.starRoom, StarWC_Storage) annotation(Line(points = {{61.2, -64.8}, {61.2, -70}, {36, -70}, {36, -60}, {20, -60}}, color = {95, 95, 95}, pattern = LinePattern.None, smooth = Smooth.None));
  connect(WC_Storage.thermRoom, ThermWC_Storage) annotation(Line(points = {{69.18, -64.8}, {69.18, -70}, {36, -70}, {36, -40}, {20, -40}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(WC_Storage.AirExchangePort, AirExchangePort[3]) annotation(Line(points = {{68.895, -83.64}, {68.895, -92}, {-90, -92}, {-90, 0.75}, {-115, 0.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Kitchen.AirExchangePort, AirExchangePort[4]) annotation(Line(points = {{-68.1, -83.52}, {-68.1, -92}, {-90, -92}, {-90, 8.25}, {-115, 8.25}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Kitchen.starRoom, StarKitchen) annotation(Line(points = {{-60, -58.4}, {-60, -54}, {-34, -54}, {-34, -60}, {-20, -60}}, color = {95, 95, 95}, pattern = LinePattern.None, smooth = Smooth.None));
  connect(Kitchen.thermRoom, ThermKitchen) annotation(Line(points = {{-68, -58.4}, {-68, -54}, {-34, -54}, {-34, -40}, {-20, -40}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Corridor.AirExchangePort, AirExchangePort_doorSt.y) annotation(Line(points = {{82, -12.8}, {90, -12.8}, {90, -92}, {-90, -92}, {-90, -60}, {-99.2, -60}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Livingroom.starRoom, StarLivingroom) annotation(Line(points = {{-59.6, 52.4}, {-59.6, 48}, {-32, 48}, {-32, 40}, {-20, 40}}, color = {95, 95, 95}, pattern = LinePattern.None, smooth = Smooth.None));
  connect(Livingroom.thermFloor, ThermFloor[1]) annotation(Line(points = {{-68.84, 38.32}, {-68.84, 6}, {-90, 6}, {-90, -92}, {2, -92}, {2, -98.8}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  connect(Hobby.thermFloor, ThermFloor[2]) annotation(Line(points = {{69.18, 46.24}, {69.18, 22}, {90, 22}, {90, -92}, {8, -92}, {2, -96.4}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  connect(Corridor.thermFloor, ThermFloor[3]) annotation(Line(points = {{66.4, -13.56}, {66.4, -32}, {90, -32}, {90, -92}, {4, -92}, {4, -94}, {2, -94}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
  connect(WC_Storage.thermFloor, ThermFloor[4]) annotation(Line(points = {{69.18, -54.24}, {90, -54.24}, {90, -91.6}, {2, -91.6}}, color = {191, 0, 0}, pattern = LinePattern.Dash, smooth = Smooth.None));
