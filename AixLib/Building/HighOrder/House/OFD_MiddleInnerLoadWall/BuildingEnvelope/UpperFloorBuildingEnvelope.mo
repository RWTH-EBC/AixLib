...
model UpperFloorBuildingEnvelope
  ...
  parameter Modelica.SIunits.Temperature Tset_Children1 = 295.15 "Tset_children1" annotation(Dialog(group = "Dynamic ventilation", descriptionLabel = true, enable = if withDynamicVentilation then true else false));
  ...
  parameter Modelica.SIunits.Temperature Tset_Children2 = 295.15 "Tset_children2" annotation(Dialog(group = "Dynamic ventilation", descriptionLabel = true, enable = if withDynamicVentilation then true else false));
...
equation
  ...
  connect(Children1.starRoom, StarChildren1) annotation(Line(points = {{59.2, 56.8}, {59.2, 46}, {36, 46}, {36, 40}, {20, 40}}, color = {95, 95, 95}, pattern = LinePattern.None, smooth = Smooth.None));
  ...
  connect(Bedroom.starRoom, StarBedroom) annotation(Line(points = {{-58, 52.4}, {-58, 28}, {-32, 28}, {-32, 40}, {-20, 40}}, color = {95, 95, 95}, pattern = LinePattern.None, smooth = Smooth.None));
  ...
  connect(Children2.starRoom, StarChildren2) annotation(Line(points = {{-60, -58.4}, {-60, -34}, {-34, -34}, {-34, -60}, {-20, -60}}, color = {95, 95, 95}, pattern = LinePattern.None, smooth = Smooth.None));
  ...
  connect(Bath.starRoom, StarBath) annotation(Line(points = {{61.2, -64.8}, {61.2, -52}, {36, -52}, {36, -60}, {20, -60}}, color = {95, 95, 95}, pattern = LinePattern.None, smooth = Smooth.None));
