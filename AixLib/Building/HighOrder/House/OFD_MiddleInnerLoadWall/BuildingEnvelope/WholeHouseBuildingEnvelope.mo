...
equation
  ...
  connect(attic_2Ro_5Rooms.SolarRadiationPort_OW1, East) annotation (Line(
      ...
      color={255,128,0}));
  annotation(__Dymola_Resources/Images(Parameters(source = "AixLib/Resources/Images/House/Grundriss.png")), Icon(graphics={  Bitmap(extent = {{-78, 74}, {72, -68}}, fileName = "modelica://AixLib/Resources/Images/House/Grundriss.PNG")}), Documentation(info = "<html>
