...
equation
  ...
  connect(PI_bedroom.y, gainConv_bedroom.u) annotation(Line(points = {{-78, 9}, {-73, 9}, {-73, 17.5}, {-68.9, 17.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(gainRad_bedroom.y, SourceRad_bedroom.Q_flow) annotation(Line(points = {{-57.55, 0.5}, {-54, 0.5}, {-54, 0}, {-52, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(SourceConv_bedroom.Q_flow, gainConv_bedroom.y) annotation(Line(points = {{-53, 18}, {-55, 18}, {-55, 17.5}, {-58.55, 17.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(tempSensor_children1.T, PI_children1.u_m) annotation(Line(points = {{16, 42}, {34, 42}, {34, 44}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_children1.y, gainRad_children1.u) annotation(Line(points = {{45, 56}, {50, 56}, {50, 47.5}, {55.1, 47.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_children1.y, gainConv_children1.u) annotation(Line(points = {{45, 56}, {50, 56}, {50, 64.5}, {54.1, 64.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(gainRad_children1.y, SourceRad_children1.Q_flow) annotation(Line(points = {{65.45, 47.5}, {69, 47.5}, {69, 47}, {71, 47}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(SourceConv_children1.Q_flow, gainConv_children1.y) annotation(Line(points = {{70, 65}, {68, 65}, {68, 64.5}, {64.45, 64.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(tempSensor_bath.T, PI_bath.u_m) annotation(Line(points = {{29, -58}, {47, -58}, {47, -56}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_bath.y, gainRad_bath.u) annotation(Line(points = {{58, -44}, {63, -44}, {63, -52.5}, {68.1, -52.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_bath.y, gainConv_bath.u) annotation(Line(points = {{58, -44}, {63, -44}, {63, -35.5}, {67.1, -35.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(gainRad_bath.y, SourceRad_bath.Q_flow) annotation(Line(points = {{78.45, -52.5}, {82, -52.5}, {82, -53}, {84, -53}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(SourceConv_bath.Q_flow, gainConv_bath.y) annotation(Line(points = {{83, -35}, {81, -35}, {81, -35.5}, {77.45, -35.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(tempSensor_children2.T, PI_children2.u_m) annotation(Line(points = {{-111, -63}, {-93, -63}, {-93, -61}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_children2.y, gainRad_children2.u) annotation(Line(points = {{-82, -49}, {-77, -49}, {-77, -57.5}, {-71.9, -57.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_children2.y, gainConv_children2.u) annotation(Line(points = {{-82, -49}, {-77, -49}, {-77, -40.5}, {-72.9, -40.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(gainRad_children2.y, SourceRad_children2.Q_flow) annotation(Line(points = {{-61.55, -57.5}, {-58, -57.5}, {-58, -58}, {-56, -58}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(SourceConv_children2.Q_flow, gainConv_children2.y) annotation(Line(points = {{-57, -40}, {-59, -40}, {-59, -40.5}, {-62.55, -40.5}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(Con_Bedroom, tempSensor_bedroom.port) annotation(Line(points = {{-140, 59}, {-129, 59}, {-129, -5}, {-119, -5}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(tempSensor_children1.port, Con_Chidlren1) annotation(Line(points = {{4, 42}, {0, 42}, {0, 30}, {139, 30}, {139, 50}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(tempSensor_bath.port, Con_Bath) annotation(Line(points = {{17, -58}, {1, -58}, {1, -68}, {139, -68}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(tempSensor_children2.port, Con_Children2) annotation(Line(points = {{-123, -63}, {-129, -63}, {-129, -51}, {-141, -51}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(SourceRad_children2.port, Rad_Children2) annotation(Line(points = {{-36, -58}, {-23, -58}, {-23, -15}, {-139, -15}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(SourceConv_children2.port, Con_Children2) annotation(Line(points = {{-37, -40}, {-23, -40}, {-23, -71}, {-129, -71}, {-129, -51}, {-141, -51}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(SourceConv_children1.port, Con_Chidlren1) annotation(Line(points = {{90, 65}, {139, 65}, {139, 50}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(SourceRad_children1.port, Rad_Children1) annotation(Line(points = {{91, 47}, {137, 47}, {137, 73}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(SourceConv_bath.port, Con_Bath) annotation(Line(points = {{103, -35}, {111, -35}, {111, -36}, {139, -36}, {139, -68}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(SourceRad_bath.port, Rad_Bath) annotation(Line(points = {{104, -53}, {118, -53}, {118, -55}, {140, -55}, {140, -40}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(PI_bedroom.u_s, TSet_UF[1]) annotation(Line(points = {{-101, 9}, {-129, 9}, {-129, 85.75}, {-71, 85.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_children1.u_s, TSet_UF[2]) annotation(Line(points = {{22, 56}, {0, 56}, {0, 93.25}, {-71, 93.25}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(PI_bath.u_s, TSet_UF[3]) annotation(Line(points = {{35, -44}, {0, -44}, {0, 100.75}, {-71, 100.75}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  annotation(Dialog(group = "Radiators", descriptionLabel = true), Dialog(group = "Valves", descriptionLabel = true), __Dymola_Images(Parameters(source = "AixLib/Images/House/UpperFloor_Hydraulics.png")), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-130, -100}, {130, 100}}, grid = {1, 1}), graphics = {Rectangle(extent=  {{0, 73}, {127, 30}}, pattern=  LinePattern.Solid, lineColor=  {0, 0, 0}, fillColor=  {215, 215, 215}, fillPattern=  FillPattern.Solid), Rectangle(extent=  {{0, -14}, {129, -71}}, pattern=  LinePattern.Solid, lineColor=  {0, 0, 0}, fillColor=  {215, 215, 215}, fillPattern=  FillPattern.Solid), Rectangle(extent=  {{-129, 43}, {-22, -11}}, pattern=  LinePattern.Solid, lineColor=  {0, 0, 0}, fillColor=  {215, 215, 215}, fillPattern=  FillPattern.Solid), Rectangle(extent=  {{-130, -16}, {-23, -70}}, pattern=  LinePattern.Solid, lineColor=  {0, 0, 0}, fillColor=  {215, 215, 215}, fillPattern=  FillPattern.Solid), Text(extent=  {{-129, -17}, {-78, -31}}, lineColor=  {0, 0, 0}, fillColor=  {0, 0, 0}, fillPattern=  FillPattern.Solid, textString=  "Children2"), Text(extent=  {{-155, 38}, {-48, 25}}, lineColor=  {0, 0, 0}, fillColor=  {0, 0, 0}, fillPattern=  FillPattern.Solid, textString=  "Bedroom"), Text(extent=  {{31, -15}, {138, -28}}, lineColor=  {0, 0, 0}, fillColor=  {0, 0, 0}, fillPattern=  FillPattern.Solid, textString=  "Bath"), Text(extent=  {{52, 41}, {159, 28}}, lineColor=  {0, 0, 0}, fillColor=  {0, 0, 0}, fillPattern=  FillPattern.Solid, textString=  "Children1"), Text(extent=  {{-53, 95}, {-11, 72}}, lineColor=  {0, 0, 0}, textString=  "1 - Bedroom
 2- Children1
 3 - Bath
 4 - Children2")}), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-130, -100}, {130, 100}}, grid = {1, 1}), graphics={  Rectangle(extent=  {{-122, 91}, {120, -80}}, lineColor=  {255, 0, 0}, fillColor=  {135, 135, 135},
            fillPattern=                                                                                                    FillPattern.Solid), Line(points=  {{-17, 22}, {-17, 44}}, color=  {255, 0, 0}, thickness=  1, smooth=  Smooth.None), Line(points=  {{-102, 21}, {101, 21}, {101, -7}}, color=  {255, 0, 0}, smooth=  Smooth.None, thickness=  1), Line(points=  {{-101, 12}, {92, 12}, {92, -7}}, color=  {0, 0, 255}, smooth=  Smooth.None, thickness=  1), Line(points=  {{-24, 12}, {-24, 34}}, color=  {0, 0, 255}, thickness=  1, smooth=  Smooth.None), Text(extent=  {{-79, 66}, {-37, 43}}, lineColor=  {0, 0, 0}, textString=  "1 - Bedroom
 2- Children1
 3 - Bath
