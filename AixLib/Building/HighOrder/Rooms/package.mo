...
<ul>
  <li>transient heat conduction through walls; each wall consists of several layers with different physical properties; further discretization of each layer is possible
  </li>
  <li>steady-state heat conduction through glazing systems; transmission of short wave radiation through the window depends on a constant coefficient; transmitted radiation is considered together with the radiation from room facing elements
  </li>
  <li>heat convection at outside facing surfaces either with a constant coefficient, depending on wind speed, or depending on wind speed and surface abrasiveness
  </li>
  <li>heat convection at inside facing surfaces either with a constant coefficient, depending on wind speed, or depending on wind speed and surface abrasiveness
  </li>
  <li>heat convection at inside facing surfaces depends on the wall orientation and the temperature difference between the room air and the wall surface
  </li>
  <li>radiation exchange between room facing elements
  </li>
  <li>temperature balance equations for the room airvolume; per room only one air node is considered; humidity is not considered in the air node
  </li>
</ul>
<p>
  <br/>
...
<ul>
  ...
  <li>energy saving ordinance: WSchV 1984, WSchV1995, EnEV 2002 and EnEV 2009
  </li>
</ul>
<p>
