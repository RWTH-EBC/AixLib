...
model Attic_Ro2Lf5
  ...
  Modelica.Blocks.Interfaces.RealInput AirExchangePort annotation(Placement(transformation(origin = {-100, 17}, extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{-110, 30}, {-90, 50}})));
  ...
  AixLib.Building.Components.Walls.Wall OW1(withDoor = false, door_height = 0, door_width = 0, windowarea = windowarea_RO1, WindowType = Type_Win, ISOrientation = 1, WallType = Type_OW, wall_length = sqrt(VerticalWall_Area), wall_height = sqrt(VerticalWall_Area), solar_absorptance = solar_absorptance_OW, withWindow = false, T0 = T0_OW1) annotation(Placement(transformation(extent = {{-4, -21}, {4, 21}}, origin = {-75, -22})));
...
protected
  ...
  parameter AixLib.DataBase.Walls.WallBaseDataDefinition Type_FL = if TIR == 1 then AixLib.DataBase.Walls.EnEV2009.Floor.FLattic_EnEV2009_SML_upHalf() else if TIR == 2 then AixLib.DataBase.Walls.EnEV2002.Floor.FLattic_EnEV2002_SML_upHalf() else if TIR == 3 then AixLib.DataBase.Walls.WSchV1995.Floor.FLattic_WSchV1995_SML_upHalf() else AixLib.DataBase.Walls.WSchV1984.Floor.FLattic_WSchV1984_SML_upHalf() annotation(Dialog(tab = "Types"));
...
equation
  ...
  connect(SolarRadiationPort_RO1, roof1.SolarRadiationPort) annotation(Line(points={{-45.5,

          100},{-45.5,80},{-14.4167,80},{-14.4167,65.5}},                                                                                           color = {255, 128, 0}));

  connect(SolarRadiationPort_RO2, roof2.SolarRadiationPort) annotation(Line(points = {{48, 100}, {48, 80}, {71.75, 80}, {71.75, 65.5}}, color = {255, 128, 0}));

  connect(thermOutside, thermOutside) annotation(Line(points = {{-90, 90}, {-90, 90}}, color = {191, 0, 0}));

  connect(roof1.WindSpeedPort, WindSpeedPort) annotation(Line(points={{-19.7333,

          64.25},{-19.7333,80},{-80,80},{-80,0},{-99.5,0}},                                                                                  color = {0, 0, 127}));

  connect(roof2.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{66.8, 64.25}, {66.8, 80}, {-80, 80}, {-80, 0}, {-99.5, 0}}, color = {0, 0, 127}));

  connect(floorRoom1.port_outside, thermRoom1) annotation(Line(points = {{-60, -42.1}, {-60, -90}, {-90, -90}}, color = {191, 0, 0}));

  connect(floorRoom2.port_outside, thermRoom2) annotation(Line(points={{-29,

          -42.1},{-29,-90},{-50,-90}},                                                                          color = {191, 0, 0}));

  connect(thermRoom3, floorRoom3.port_outside) annotation(Line(points={{-10,-90},

          {3,-90},{3,-42.1}},                                                                               color = {191, 0, 0}));
  ...
  connect(airload.port, Tair.port) annotation(Line(points = {{1, -12}, {-10, -12}, {-10, 8}, {24, 8}, {24, -13}}, color = {191, 0, 0}));

  connect(infiltrationRate.port_a, thermOutside) annotation(Line(points = {{-62, 8}, {-80, 8}, {-80, 90}, {-90, 90}}, color = {191, 0, 0}));

  connect(infiltrationRate.port_b, airload.port) annotation(Line(points = {{-46, 8}, {-10, 8}, {-10, -12}, {1, -12}}, color = {191, 0, 0}));

  connect(thermStar_Demux.therm, airload.port) annotation(Line(points = {{-24.9, 0.1}, {-24.9, 8}, {-10, 8}, {-10, -12}, {1, -12}}, color = {191, 0, 0}));

  connect(roof1.port_outside, thermOutside) annotation(Line(points={{-41,64.25},

          {-41,80},{-90,80},{-90,90}},                                                                                color = {191, 0, 0}));

  connect(roof2.port_outside, thermOutside) annotation(Line(points = {{47, 64.25}, {47, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}));

  connect(floorRoom3.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points={{3,-38},

          {3,-28},{-30,-28},{-30,-19.4},{-29.9,-19.4}},                                                                                                    color = {191, 0, 0}));

  connect(floorRoom1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-60, -38}, {-60, -28}, {-30, -28}, {-30, -19.4}, {-29.9, -19.4}}, color = {191, 0, 0}));

  connect(floorRoom2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points={{-29,-38},

          {-29,-28},{-29.9,-28},{-29.9,-19.4}},                                                                                                    color = {191, 0, 0}));

  connect(floorRoom4.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points={{35,-38},

          {35,-28},{-29.9,-28},{-29.9,-19.4}},                                                                                                    color = {191, 0, 0}));

  connect(floorRoom5.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points={{69,-38},

          {69,-28},{-29.9,-28},{-29.9,-19.4}},                                                                                                    color = {191, 0, 0}));

  connect(roof2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{47, 54}, {47, 40}, {60, 40}, {60, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}));

  connect(roof1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points={{-41,54},

          {-41,40},{60,40},{60,-28},{-29.9,-28},{-29.9,-19.4}},                                                                                                    color = {191, 0, 0}));

  connect(NaturalVentilation.InPort1, AirExchangePort) annotation(Line(points = {{-63, 19.6}, {-80, 19.6}, {-80, 17}, {-100, 17}}, color = {0, 0, 127}));

  connect(NaturalVentilation.port_a, thermOutside) annotation(Line(points = {{-64, 26}, {-80, 26}, {-80, 90}, {-90, 90}}, color = {191, 0, 0}));

  connect(NaturalVentilation.port_b, airload.port) annotation(Line(points = {{-44, 26}, {-40, 26}, {-40, 8}, {-10, 8}, {-10, -12}, {1, -12}}, color = {191, 0, 0}));

  connect(OW1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-71, -22}, {-64, -22}, {-64, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}));

  connect(OW1.port_outside, thermOutside) annotation(Line(points = {{-79.2, -22}, {-86, -22}, {-86, 0}, {-80, 0}, {-80, 90}, {-90, 90}}, color = {191, 0, 0}));

  connect(OW1.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{-79.2, -6.6}, {-86, -6.6}, {-86, 0}, {-99.5, 0}}, color = {0, 0, 127}));
  ...
  annotation(__Dymola_Images(Parameters(source = "AixLib/Resources/Images/Building/HighOrder/Attic_2Ro_5Rooms.png", Width = 5, Length = 5)), Icon(graphics={  Polygon(points = {{-58, -20}, {16, 54}, {90, -20}, {76, -20}, {16, 40}, {-44, -20}, {-58, -20}}, lineColor = {0, 0, 0},
            ...
            fillPattern =                                                                                                   FillPattern.Solid, textString = "width"), Line(points = {{48, -20}, {76, -20}}, color = {0, 0, 0}), Line(points = {{-44, -20}, {-20, -20}}, color = {0, 0, 0}), Line(points = {{-62, -16}, {12, 58}}, color = {0, 0, 0}), Line(points = {{16, 54}, {10, 60}}, color = {0, 0, 0}), Line(points = {{-58, -20}, {-64, -14}}, color = {0, 0, 0}), Text(extent = {{-40, 52}, {16, 42}}, lineColor = {0, 0, 0}, textString = "wRO1"), Line(points = {{3, -3}, {-3, 3}}, color = {0, 0, 0}, origin = {93, -17}, rotation = 90), Line(points = {{-37, -37}, {37, 37}}, color = {0, 0, 0}, origin = {57, 21}, rotation = 90), Line(points = {{3, -3}, {-3, 3}}, color = {0, 0, 0}, origin = {19, 57}, rotation = 90), Text(extent = {{-28, 5}, {28, -5}}, lineColor = {0, 0, 0}, origin = {44, 47}, textString = "wRO2"), Line(points = {{-44, -20}, {-44, -24}}, color = {0, 0, 0}), Line(points = {{76, -20}, {76, -24}}, color = {0, 0, 0})}), Documentation(revisions = "<html>
<ul>
  <li>
...
<p>
  <img src=\"modelica://AixLib/Resources/Images/Building/HighOrder/Attic_2Ro_5Rooms.png\" alt=\"Room">
</p>
<p>
