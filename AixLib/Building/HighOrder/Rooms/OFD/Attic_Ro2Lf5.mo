...
model Attic_Ro2Lf5 "Attic with 2 saddle roofs and a floor toward 5 rooms on the lower floor, with all other walls towards the outside"
  import AixLib;
  ...
  parameter Modelica.SIunits.Temperature T0_OW1 = 282.15 "OW1" annotation(Dialog(tab = "Initial temperatures", descriptionLabel = true));
  parameter Modelica.SIunits.Temperature T0_OW2 = 282.15 "OW2" annotation(Dialog(tab = "Initial temperatures", descriptionLabel = true));
  ...
  parameter Modelica.SIunits.Temperature T0_FL4 = 284.15 "FL4" annotation(Dialog(tab = "Initial temperatures", descriptionLabel = true));
  parameter Modelica.SIunits.Temperature T0_FL5 = 284.15 "FL5" annotation(Dialog(tab = "Initial temperatures", descriptionLabel = true));
  //////////room geometry
  ...
  // Infiltration rate
  AixLib.Building.Components.Walls.Wall roof1(withDoor = false, door_height = 0, door_width = 0, T0 = T0_RO1, solar_absorptance = solar_absorptance_RO, withWindow = withWindow1, windowarea = windowarea_RO1, wall_length = length, wall_height = roof_width1, WallType = Type_RO, WindowType = Type_Win, ISOrientation = 1) annotation(Placement(transformation(extent = {{-5.00001, -29}, {5.00001, 29}}, rotation = 270, origin = {-41, 59})));
  AixLib.Building.Components.Walls.Wall floorRoom2(T0 = T0_FL2, WallType = Type_FL, wall_length = room2_length, wall_height = room2_width, withWindow = false, ISOrientation = 2, outside = false, withDoor = false) annotation(Placement(transformation(origin = {-29, -40}, extent = {{-1.99999, -13}, {1.99999, 13}}, rotation = 90)));
  ...
  AixLib.Building.Components.Walls.Wall floorRoom1(T0 = T0_FL1, WallType = Type_FL, wall_length = room1_length, wall_height = room1_width, withWindow = false, ISOrientation = 2, outside = false, withDoor = false) annotation(Placement(transformation(origin = {-60, -40}, extent = {{-2, -12}, {2, 12}}, rotation = 90)));
  ...
  Utilities.Interfaces.SolarRad_in SolarRadiationPort_RO1 annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {-45.5, 100}), iconTransformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {-50, 90})));
  Modelica.Blocks.Interfaces.RealInput AirExchangePort annotation(Placement(transformation(origin = {-100, 17}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(extent = {{-110, 30}, {-90, 50}})));
  AixLib.Building.Components.Walls.Wall roof2(solar_absorptance = solar_absorptance_RO, withDoor = false, door_height = 0, door_width = 0, T0 = T0_RO2, wall_height = roof_width2, withWindow = withWindow2, windowarea = windowarea_RO2, wall_length = length, WallType = Type_RO, WindowType = Type_Win, ISOrientation = 1) annotation(Placement(transformation(origin = {47, 59}, extent = {{-5, -27}, {5, 27}}, rotation = 270)));
  Utilities.Interfaces.SolarRad_in SolarRadiationPort_RO2 annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {48, 100}), iconTransformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin = {50, 90})));
  AixLib.Building.Components.Walls.Wall floorRoom3(T0 = T0_FL3, WallType = Type_FL, wall_length = room3_length, wall_height = room3_width, withWindow = false, ISOrientation = 2, outside = false, withDoor = false) annotation(Placement(transformation(origin = {3, -40}, extent = {{-1.99999, -13}, {1.99999, 13}}, rotation = 90)));
  AixLib.Building.Components.Walls.Wall floorRoom4(T0 = T0_FL4, WallType = Type_FL, wall_length = room4_length, wall_height = room4_width, withWindow = false, ISOrientation = 2, outside = false, withDoor = false) annotation(Placement(transformation(origin = {35, -40}, extent = {{-1.99998, -13}, {1.99999, 13}}, rotation = 90)));
  AixLib.Building.Components.Walls.Wall floorRoom5(T0 = T0_FL5, WallType = Type_FL, wall_length = room5_length, wall_height = room5_width, withWindow = false, ISOrientation = 2, outside = false, withDoor = false) annotation(Placement(transformation(origin = {69, -40}, extent = {{-1.99998, -13}, {1.99998, 13}}, rotation = 90)));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a thermRoom1 annotation(Placement(transformation(extent = {{-100, -100}, {-80, -80}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a thermRoom2 annotation(Placement(transformation(extent = {{-60, -100}, {-40, -80}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a thermRoom3 annotation(Placement(transformation(extent = {{-20, -100}, {0, -80}})));
  ...
  Utilities.Interfaces.SolarRad_in SolarRadiationPort_OW1 annotation(Placement(transformation(extent = {{-116, -30}, {-96, -10}})));
  AixLib.Building.Components.Walls.Wall OW2(withDoor = false, door_height = 0, door_width = 0, windowarea = windowarea_RO1, WindowType = Type_Win, ISOrientation = 1, WallType = Type_OW, wall_length = sqrt(VerticalWall_Area), wall_height = sqrt(VerticalWall_Area), solar_absorptance = solar_absorptance_OW, withWindow = false, T0 = T0_OW2) annotation(Placement(transformation(extent = {{-4, 21}, {4, -21}}, rotation = 180, origin = {85, -16})));
  Utilities.Interfaces.SolarRad_in SolarRadiationPort_OW2 annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin = {110, -18})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a ThermAttic annotation(Placement(transformation(extent = {{8, 8}, {28, 28}}), iconTransformation(extent = {{8, 8}, {28, 28}})));
protected
  ...
  // semi perimeter
  parameter Modelica.SIunits.Area VerticalWall_Area = sqrt(p * (p - width) * (p - roof_width2) * (p - roof_width1));
  // Heron's formula
  // Outer wall type
...
equation
  ...
  connect(floorRoom2.port_outside, thermRoom2) annotation(Line(points = {{-29, -42.1}, {-29, -90}, {-50, -90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(thermRoom3, floorRoom3.port_outside) annotation(Line(points = {{-10, -90}, {3, -90}, {3, -42.1}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(thermRoom4, floorRoom4.port_outside) annotation(Line(points = {{30, -90}, {38, -90}, {38, -70}, {35, -70}, {35, -42.1}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(floorRoom5.port_outside, thermRoom5) annotation(Line(points = {{69, -42.1}, {69, -84}, {72, -84}, {72, -88}, {70, -88}, {70, -90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(airload.port, Tair.port) annotation(Line(points = {{1, -12}, {-10, -12}, {-10, 8}, {24, 8}, {24, -13}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(infiltrationRate.port_a, thermOutside) annotation(Line(points = {{-62, 8}, {-80, 8}, {-80, 90}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(infiltrationRate.port_b, airload.port) annotation(Line(points = {{-46, 8}, {-10, 8}, {-10, -12}, {1, -12}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(thermStar_Demux.therm, airload.port) annotation(Line(points = {{-24.9, 0.1}, {-24.9, 8}, {-10, 8}, {-10, -12}, {1, -12}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof1.port_outside, thermOutside) annotation(Line(points = {{-41, 64.25}, {-41, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof2.port_outside, thermOutside) annotation(Line(points = {{47, 64.25}, {47, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(floorRoom3.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{3, -38}, {3, -28}, {-30, -28}, {-30, -19.4}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(floorRoom1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-60, -38}, {-60, -28}, {-30, -28}, {-30, -19.4}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(floorRoom2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-29, -38}, {-29, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(floorRoom4.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{35, -38}, {35, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(floorRoom5.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{69, -38}, {69, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{47, 54}, {47, 40}, {60, 40}, {60, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-41, 54}, {-41, 40}, {60, 40}, {60, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(NaturalVentilation.InPort1, AirExchangePort) annotation(Line(points = {{-63, 19.6}, {-80, 19.6}, {-80, 17}, {-100, 17}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(NaturalVentilation.port_a, thermOutside) annotation(Line(points = {{-64, 26}, {-80, 26}, {-80, 90}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(NaturalVentilation.port_b, airload.port) annotation(Line(points = {{-44, 26}, {-40, 26}, {-40, 8}, {-10, 8}, {-10, -12}, {1, -12}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(OW1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-71, -22}, {-64, -22}, {-64, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(OW1.port_outside, thermOutside) annotation(Line(points = {{-79.2, -22}, {-86, -22}, {-86, 0}, {-80, 0}, {-80, 90}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(OW1.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{-79.2, -6.6}, {-86, -6.6}, {-86, 0}, {-99.5, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(OW1.SolarRadiationPort, SolarRadiationPort_OW1) annotation(Line(points = {{-80.2, -2.75}, {-86, -2.75}, {-86, -20}, {-106, -20}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(OW2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{81, -16}, {76, -16}, {76, -28}, {-29.9, -28}, {-29.9, -19.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(OW2.port_outside, thermOutside) annotation(Line(points = {{89.2, -16}, {100, -16}, {100, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(OW2.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{89.2, -0.6}, {100, -0.6}, {100, -28}, {-86, -28}, {-86, 0}, {-99.5, 0}}, color = {0, 0, 127}, smooth = Smooth.None));
  connect(OW2.SolarRadiationPort, SolarRadiationPort_OW2) annotation(Line(points = {{90.2, 3.25}, {100, 3.25}, {100, -18}, {110, -18}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(airload.port, ThermAttic) annotation(Line(points = {{1, -12}, {-4, -12}, {-4, -10}, {18, -10}, {18, 18}}, color = {191, 0, 0}, smooth = Smooth.None));
  annotation(__Dymola_Images(Parameters(source = "AixLib/Images/House/Attic_2Ro_5Rooms.png", Width = 5, Length = 5)), Icon(graphics = {Polygon(points = {{-58, -20}, {16, 54}, {90, -20}, {76, -20}, {16, 40}, {-44, -20}, {-58, -20}}, lineColor = {0, 0, 0}, smooth = Smooth.None, fillPattern = FillPattern.Solid, fillColor = {175, 175, 175}), Polygon(points = {{-24, 0}, {6, 30}, {-8, 30}, {-38, 0}, {-24, 0}}, lineColor = {0, 0, 0}, smooth = Smooth.None, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, visible = withWindow1), Text(extent = {{-36, 10}, {12, 22}}, lineColor = {0, 0, 0}, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, textString = "Win1", visible = withWindow1), Polygon(points = {{26, 30}, {56, 0}, {70, 0}, {40, 30}, {26, 30}}, lineColor = {0, 0, 0}, smooth = Smooth.None, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, visible = withWindow2), Text(extent = {{22, 10}, {70, 22}}, lineColor = {0, 0, 0}, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, textString = "Win2", visible = withWindow2), Text(extent = {{-44, -14}, {74, -26}}, lineColor = {0, 0, 0}, fillColor = {255, 170, 170}, fillPattern = FillPattern.Solid, textString = "width"), Line(points = {{48, -20}, {76, -20}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{-44, -20}, {-20, -20}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{-62, -16}, {12, 58}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{16, 54}, {10, 60}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{-58, -20}, {-64, -14}}, color = {0, 0, 0}, smooth = Smooth.None), Text(extent = {{-40, 52}, {16, 42}}, lineColor = {0, 0, 0}, textString = "wRO1"), Line(points = {{3, -3}, {-3, 3}}, color = {0, 0, 0}, smooth = Smooth.None, origin = {93, -17}, rotation = 90), Line(points = {{-37, -37}, {37, 37}}, color = {0, 0, 0}, smooth = Smooth.None, origin = {57, 21}, rotation = 90), Line(points = {{3, -3}, {-3, 3}}, color = {0, 0, 0}, smooth = Smooth.None, origin = {19, 57}, rotation = 90), Text(extent = {{-28, 5}, {28, -5}}, lineColor = {0, 0, 0}, origin = {44, 47}, rotation = 0, textString = "wRO2"), Line(points = {{-44, -20}, {-44, -24}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{76, -20}, {76, -24}}, color = {0, 0, 0}, smooth = Smooth.None)}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), Documentation(revisions = "<html>
 <p><ul>
