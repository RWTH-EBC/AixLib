...
model Ow2IwL2IwS1Gr1Uf1
  ...
  AixLib.Building.Components.DryAir.InfiltrationRate_DIN12831 infiltrationRate(room_V = room_V, n50 = n50, e = e, eps = eps) annotation(Placement(transformation(extent={{-68,52},
            {-50,60}})));
  AixLib.Building.Components.DryAir.DynamicVentilation dynamicVentilation(HeatingLimit = HeatingLimit, Max_VR = Max_VR, Diff_toTempset = Diff_toTempset, Tset = Tset) if withDynamicVentilation annotation(Placement(transformation(extent={{-70,-58},
            {-46,-46}})));
  ...
  AixLib.Building.Components.DryAir.VarAirExchange NaturalVentilation(V = room_V) annotation(Placement(transformation(extent={{-68,-42},
            {-48,-22}})));
  //Door properties
protected
...
equation
  ...
  connect(thermOutside, outside_wall1.port_outside) annotation(Line(points={{-90,90},
          {-90,82},{-80,82},{-80,6},{-68,6},{-68,15},{-64.25,15}},                                                                                         color = {191, 0, 0}));
  ...
  connect(outside_wall1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points={{-54,15},
          {-40,15},{-40,-40},{-20.1,-40},{-20.1,-35.4}},                                                                                                                        color = {191, 0, 0}));
  ...
  connect(SolarRadiationPort_OW1, outside_wall1.SolarRadiationPort) annotation(Line(points={{-99.5,
          30},{-80,30},{-80,41.5833},{-65.5,41.5833}},                                                                                                   color = {255, 128, 0}));
  ...
  connect(NaturalVentilation.port_a, thermOutside) annotation(Line(points={{-68,-32},
          {-80,-32},{-80,90},{-90,90}},                                                                                     color = {191, 0, 0}));
  connect(NaturalVentilation.InPort1, AirExchangePort) annotation(Line(points={{-67,
          -38.4},{-80,-38.4},{-80,74},{-20,74},{-20,100}},                                                                                      color = {0, 0, 127}));
  connect(NaturalVentilation.port_b, airload.port) annotation(Line(points={{-48,-32},
          {-40,-32},{-40,-40},{-6,-40},{-6,-12},{1,-12}},                                                                 color = {191, 0, 0}));
