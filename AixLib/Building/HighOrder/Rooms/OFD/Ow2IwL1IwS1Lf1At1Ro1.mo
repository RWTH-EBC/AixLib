...
model Ow2IwL1IwS1Lf1At1Ro1 "2 outer walls, 1 inner wall load, 1 inner wall simple, 1 floor towards lower floor, 1 ceiling towards attic, 1 roof towards outside"
  import AixLib;
  ...
  //Door properties
  AixLib.Building.Components.Walls.Wall outside_wall1(solar_absorptance = solar_absorptance_OW, T0 = T0_OW1, wall_length = room_length, wall_height = room_height_short, withWindow = false, windowarea = 0, withDoor = false, door_height = 0, door_width = 0, WallType = Type_OW) annotation(Placement(transformation(extent = {{-64, -26}, {-54, 32}}, rotation = 0)));
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a thermInsideWall1 annotation(Placement(transformation(extent = {{80, 0}, {100, 20}}, rotation = 0)));
...
equation
  ...
  if withFloorHeating then
    ...
    connect(floor.port_outside, thermFloor) annotation(Line(points = {{-27, -62.1}, {-27, -82}, {-30, -82}, {-30, -90}}, color = {191, 0, 0}, smooth = Smooth.None, pattern = LinePattern.Dash));
  ...
  connect(thermOutside, infiltrationRate.port_a) annotation(Line(points = {{-90, 90}, {-90, 80}, {-80, 80}, {-80, 40}, {-72, 40}, {-72, 40}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(SolarRadiationPort_OW1, outside_wall1.SolarRadiationPort) annotation(Line(points = {{-99.5, 30}, {-65.5, 30}, {-65.5, 29.5833}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(outside_wall2.SolarRadiationPort, SolarRadiationPort_OW2) annotation(Line(points = {{-2.41667, 65.5}, {-2.41667, 70}, {44.5, 70}, {44.5, 92}, {44.5, 101}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(roof.SolarRadiationPort, SolarRadiationPort_Roof) annotation(Line(points = {{70.5833, 62.8999}, {70.5833, 70}, {74, 70}, {74, 100}}, color = {255, 128, 0}, smooth = Smooth.None));
  connect(roof.port_outside, thermOutside) annotation(Line(points = {{55, 62.1499}, {55, 70}, {-80, 70}, {-80, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(outside_wall1.port_outside, thermOutside) annotation(Line(points = {{-64.25, 3}, {-70, 2}, {-80, 2}, {-80, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(outside_wall2.port_outside, thermOutside) annotation(Line(points = {{-29, 64.25}, {-29, 70}, {-80, 70}, {-80, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(outside_wall1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-54, 3}, {-40, 3}, {-40, -40}, {-20.1, -40}, {-20.1, -35.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(outside_wall2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-29, 54}, {-29, 40}, {-40, 40}, {-40, -40}, {-20.1, -40}, {-20.1, -35.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Ceiling.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{22, 58}, {22, 40}, {-40, 40}, {-40, -40}, {-20.1, -40}, {-20.1, -35.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{55, 56}, {55, 40}, {-40, 40}, {-40, -40}, {-20.1, -40}, {-20.1, -35.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  ...
  connect(thermStar_Demux.therm, thermRoom) annotation(Line(points = {{-25.1, -15.9}, {-25.1, 6}, {-20, 6}, {-20, 20}}, color = {191, 0, 0}, smooth = Smooth.None));
  ...
  connect(inside_wall1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{56, 4.00001}, {40, 4.00001}, {40, -40}, {-20.1, -40}, {-20.1, -35.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(inside_wall2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{32, -54}, {32, -40}, {-20.1, -40}, {-20.1, -35.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(infiltrationRate.port_b, airload.port) annotation(Line(points = {{-54, 40}, {-40, 40}, {-40, -40}, {-6, -40}, {-6, -12}, {1, -12}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(NaturalVentilation.InPort1, AirExchangePort) annotation(Line(points = {{-67, -46.4}, {-80, -46.4}, {-80, 70}, {-20, 70}, {-20, 100}}, color = {0, 0, 127}, smooth = Smooth.None));
  ...
  connect(roof.WindSpeedPort, WindSpeedPort) annotation(Line(points = {{67.4667, 62.1499}, {67.4667, 70}, {-80, 70}, {-80, -40}, {-99.5, -40}}, color = {0, 0, 127}, smooth = Smooth.None));
