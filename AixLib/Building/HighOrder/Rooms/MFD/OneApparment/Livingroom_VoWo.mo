...
model Livingroom_VoWo "Livingroom from the VoWo appartment"
  ...
  // Infiltration rate
  AixLib.Building.Components.Walls.Wall Wall_Neighbour(T0 = T0_IWNeighbour, outside = false, WallType = Type_IWNeigbour, wall_length = 4.2, wall_height = 2.46, withWindow = false, withDoor = false) annotation(Placement(transformation(extent = {{-80, -24}, {-68, 54}})));
  ...
  AixLib.Building.Components.DryAir.Airload airload(V = room_V, T(start = T0_air)) annotation(Placement(transformation(extent = {{-28, 0}, {-48, 20}})));
...
equation
  ...
  annotation(__Dymola_Resources/Images(Parameters(source = "AixLib/Resources/Images/House/VoWo_Livingroom.png")), Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-170, -150}, {170, 150}}), graphics), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-170, -150}, {170, 150}}), graphics={  Rectangle(extent=  {{-62, 60}, {112, -92}}, lineColor=  {0, 0, 0}, fillColor=  {255, 255, 255},
 ...
 <p><img src=\"modelica://AixLib/Resources/Images/House/VoWo_Livingroom.png\"
    alt=\"Room layout\"/></p>
 </html>"));
end Livingroom_VoWo;
