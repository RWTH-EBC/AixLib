...
model Bedroom_VoWo "Bedroom from the VoWo appartment"
  ...
  AixLib.Building.Components.Walls.Wall Wall_Neighbour(T0 = T0_IWNeighbour, outside = false, WallType = Type_IWNeigbour, wall_length = 5.3, wall_height = 2.46, withWindow = false, withDoor = false) annotation(Placement(transformation(extent = {{-74, -58}, {-60, 20}})));
  ...
  AixLib.Building.Components.DryAir.Airload airload(V = room_V, T(start = T0_air)) annotation(Placement(transformation(extent = {{30, -2}, {10, 18}})));
...
equation
  ...
  annotation(__Dymola_Resources/Images(Parameters(source = "AixLib/Resources/Images/House/VoWo_Bedroom.png")), Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -150}, {150, 100}}), graphics), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -150}, {150, 100}}), graphics={  Rectangle(extent=  {{-54, 68}, {98, -112}}, lineColor=  {0, 0, 0}, fillColor=  {255, 255, 255},
 ...
 <p><img src=\"modelica://AixLib/Resources/Images/House/VoWo_Bedroom.png\"
    alt=\"Room layout\"/></p>
 </html>"));
end Bedroom_VoWo;
