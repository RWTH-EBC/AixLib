...
model Children_VoWo "Children room from the VoWo appartment"
 ...
 parameter Real solar_absorptance_OW=0.7 "Solar absoptance outer walls "
 ...
 parameter Integer ModelConvOW =  1 "Heat Convection Model"
  ...
  parameter Modelica.SIunits.Temperature T0_IWLivingroom=294.15 "IWLivingroom"
                                                           annotation(Dialog(tab="Initial temperatures", descriptionLabel = true));
  parameter Modelica.SIunits.Temperature T0_IWNeighbour=294.15 "IWNeighbour"
                                                           annotation(Dialog(tab="Initial temperatures", descriptionLabel = true));
  parameter Modelica.SIunits.Temperature T0_IWCorridor=290.15 "IWCorridor"
                                                           annotation(Dialog(tab="Initial temperatures", descriptionLabel = true));
  parameter Modelica.SIunits.Temperature T0_IWStraicase=288.15 "IWStaircase"
                                                           annotation(Dialog(tab="Initial temperatures", descriptionLabel = true));
...
protected
  ...
  if TIR == 3 then 4 else 6 "Air exchange rate at 50 Pa pressure difference"
