...
model Attic_Ro2Lf1 "Attic with two saddle roofs and on floor towards the rooms on the lower floors"
  import AixLib;
...
equation
  ...
  connect(Floor.port_outside, thermFloor) annotation(Line(points = {{1, -48.1}, {1, -65.55}, {0, -65.55}, {0, -76}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Floor.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{1, -44}, {1, -28}, {-28.1, -28}, {-28.1, -3.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  ...
  connect(roof2.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{50, 58}, {50, 50}, {-42, 50}, {-42, -3.4}, {-28.1, -3.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof1.thermStarComb_inside, thermStar_Demux.thermStarComb) annotation(Line(points = {{-42, 58}, {-42, -3.4}, {-28.1, -3.4}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof1.port_outside, thermOutside) annotation(Line(points = {{-42, 68.25}, {-42, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(roof2.port_outside, thermOutside) annotation(Line(points = {{50, 68.25}, {50, 80}, {-90, 80}, {-90, 90}}, color = {191, 0, 0}, smooth = Smooth.None));
  ...
  annotation(__Dymola_Images(Parameters(source = "AixLib/Images/House/MFD_Attic.png", Width = 5, Length = 5)), Icon(graphics = {Polygon(points = {{-58, -20}, {16, 54}, {90, -20}, {76, -20}, {16, 40}, {-44, -20}, {-58, -20}}, lineColor = {0, 0, 0}, smooth = Smooth.None, fillPattern = FillPattern.Solid, fillColor = {175, 175, 175}), Polygon(points = {{-24, 0}, {6, 30}, {-8, 30}, {-38, 0}, {-24, 0}}, lineColor = {0, 0, 0}, smooth = Smooth.None, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, visible = withWindow1), Text(extent = {{-36, 10}, {12, 22}}, lineColor = {0, 0, 0}, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, textString = "Win1", visible = withWindow1), Polygon(points = {{26, 30}, {56, 0}, {70, 0}, {40, 30}, {26, 30}}, lineColor = {0, 0, 0}, smooth = Smooth.None, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, visible = withWindow2), Text(extent = {{22, 10}, {70, 22}}, lineColor = {0, 0, 0}, fillColor = {170, 213, 255}, fillPattern = FillPattern.Solid, textString = "Win2", visible = withWindow2), Text(extent = {{-44, -14}, {74, -26}}, lineColor = {0, 0, 0}, fillColor = {255, 170, 170}, fillPattern = FillPattern.Solid, textString = "width"), Line(points = {{-44, -20}, {-44, -24}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{-44, -20}, {-20, -20}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{48, -20}, {76, -20}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{76, -20}, {76, -24}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{-37, -37}, {37, 37}}, color = {0, 0, 0}, smooth = Smooth.None, origin = {57, 21}, rotation = 90), Line(points = {{3, -3}, {-3, 3}}, color = {0, 0, 0}, smooth = Smooth.None, origin = {93, -17}, rotation = 90), Text(extent = {{-28, 5}, {28, -5}}, lineColor = {0, 0, 0}, origin = {44, 47}, rotation = 0, textString = "wRO2"), Line(points = {{3, -3}, {-3, 3}}, color = {0, 0, 0}, smooth = Smooth.None, origin = {19, 57}, rotation = 90), Line(points = {{16, 54}, {10, 60}}, color = {0, 0, 0}, smooth = Smooth.None), Line(points = {{-62, -16}, {12, 58}}, color = {0, 0, 0}, smooth = Smooth.None), Text(extent = {{-40, 52}, {16, 42}}, lineColor = {0, 0, 0}, textString = "wRO1"), Line(points = {{-58, -20}, {-64, -14}}, color = {0, 0, 0}, smooth = Smooth.None)}), Diagram(graphics), Documentation(revisions = "<html>
 <p><ul>
