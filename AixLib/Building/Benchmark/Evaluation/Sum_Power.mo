...
equation
  ...
  connect(add3_1.u2, measureBus.Heatpump_small_power) annotation (Line(points={
          {-62,90},{-80,90},{-80,0},{-99.9,0},{-99.9,0.1}}, color={0,0,127}));
  connect(add3_1.u3, measureBus.Heatpump_big_power) annotation (Line(points={{
          -62,82},{-80,82},{-80,0.1},{-99.9,0.1}}, color={0,0,127}));
  ...
  connect(multiSum.u[1], add3_1.y) annotation (Line(points={{38,11.34},{18,
          11.34},{18,90},{-39,90}}, color={0,0,127}));
  connect(multiSum.u[2], add3_9.y) annotation (Line(points={{38,8.82},{18,8.82},
          {18,8},{18,8},{18,40},{3,40}}, color={0,0,127}));
  connect(multiSum.u[3], add3_2.y) annotation (Line(points={{38,6.3},{18,6.3},{
          18,6},{18,6},{18,64},{-39,64}}, color={0,0,127}));
  connect(multiSum.u[4], add3_3.y) annotation (Line(points={{38,3.78},{18,3.78},
          {18,2},{18,2},{18,38},{-39,38}}, color={0,0,127}));
  connect(multiSum.u[5], add3_5.y) annotation (Line(points={{38,1.26},{18,1.26},
          {18,0},{18,0},{18,12},{-39,12}}, color={0,0,127}));
  connect(multiSum.u[6], add3_6.y) annotation (Line(points={{38,-1.26},{18,
          -1.26},{18,-16},{-39,-16}}, color={0,0,127}));
  connect(multiSum.u[7], add3_7.y) annotation (Line(points={{38,-3.78},{18,
          -3.78},{18,-42},{-39,-42}}, color={0,0,127}));
  connect(multiSum.u[8], add3_8.y) annotation (Line(points={{38,-6.3},{18,-6.3},
          {18,-68},{-39,-68}}, color={0,0,127}));
  connect(multiSum.u[9], add3_10.y) annotation (Line(points={{38,-8.82},{18,
          -8.82},{18,-94},{-39,-94}}, color={0,0,127}));
  connect(add3_10.u3, measureBus.InternalLoad_Power) annotation (Line(points={{
          -62,-102},{-80,-102},{-80,0.1},{-99.9,0.1}}, color={0,0,127}));
  connect(add.u1, measureBus.PV_Power) annotation (Line(points={{-18,-24},{-30,
