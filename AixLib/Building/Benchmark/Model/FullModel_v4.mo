within AixLib.Building.Benchmark.Model;
model FullModel_v4
  replaceable package Medium_Air =
    AixLib.Media.Air "Medium in the component";
  AixLib.Building.Benchmark.Model.Weather weather
  ...
  AixLib.Building.Benchmark.Model.InternalLoad.InternalLoads internalLoads
    annotation (Placement(transformation(extent={{-48,50},{-8,10}})));
  inner Modelica.Fluid.System system
    annotation (Placement(transformation(extent={{-100,80},{-80,100}})));
  AixLib.Building.Benchmark.Model.Evaluation.Evaluation evaluation
  ...
  AixLib.Building.Benchmark.Model.BusSystems.LogModel logModel
    annotation (Placement(transformation(extent={{100,-26},{120,-46}})));
  AixLib.Building.Benchmark.Model.BusSystems.Bus_measure Measure
    annotation (Placement(transformation(extent={{-120,0},{-80,40}})));
  AixLib.Building.Benchmark.Model.BusSystems.Bus_Control Control
