...
model Controller_NoChpAndBoiler
  ...
  AixLib.Building.Benchmark.ControlStrategies.Controller_Temp.PI_Regler_RLT
    RLT_Temp annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-60,0})));
  AixLib.Building.Benchmark.ControlStrategies.Controller_PumpsAndFans.Pump_NoChpAndBoiler
    pump_NoChpAndBoiler
  ...
  AixLib.Building.Benchmark.ControlStrategies.Controller_Generation.Valve_NoChpAndBoiler
    valve_NoChpAndBoiler
    annotation (Placement(transformation(extent={{20,-10},{40,10}})));
  AixLib.Building.Benchmark.ControlStrategies.Controller_Generation.Generation_NoChpAndBoiler
