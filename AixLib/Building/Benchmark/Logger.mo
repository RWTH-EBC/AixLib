...
model Logger
  ...
  MatchVariable(className="AixLib.Building.Benchmark.BusSystem.Logger*", name="WallTemp_Openplanoffice"),
  MatchVariable(className="AixLib.Building.Benchmark.BusSystem.Logger*", name="WallTemp_Conferenceroom"),
  MatchVariable(className="AixLib.Building.Benchmark.BusSystem.Logger*", name="WallTemp_Multipersonoffice"),
  MatchVariable(className="AixLib.Building.Benchmark.BusSystem.Logger*", name="WallTemp_Canteen"),
  MatchVariable(className="AixLib.Building.Benchmark.BusSystem.Logger*", name="WallTemp_Workshop"),
