...
model TestSpeicher
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=6.601)
  ...
  Modelica.Blocks.Sources.RealExpression realExpression1(y=7.999)
    annotation (Placement(transformation(extent={{-84,-52},{-64,-32}})));
  Modelica.Blocks.Sources.RealExpression realExpression2(y=273.15 + 30)
    annotation (Placement(transformation(extent={{-88,-70},{-68,-50}})));
  Modelica.Blocks.Sources.RealExpression realExpression3(y=273.15 + 50)
...
equation
  ...
  connect(bou1.ports[1], vol.ports[1])
    annotation (Line(points={{-90,-12},{-76,-12}}, color={0,127,255}));
  ...
  connect(boundary.ports[1], bufferStorage.portHC2In) annotation (Line(points={
          {-66,18},{-42,18},{-42,-3.25},{-18.25,-3.25}}, color={0,127,255}));
  connect(vol.ports[2], bufferStorage.portHC2Out) annotation (Line(points={{-72,
          -12},{-46,-12},{-46,-11.25},{-18.25,-11.25}}, color={0,127,255}));
end TestSpeicher;
