...
equation
  ...
  connect(boundary.ports[1], hex.port_a2)
    annotation (Line(points={{-10,-40},{-10,-42},{-6,-42}},
                                                   color={0,127,255}));
  ...
  connect(fan4.port_b, hex.port_a1)
    annotation (Line(points={{18,2},{18,-30},{14,-30}},color={0,127,255}));
  connect(bou1.ports[1], hex.port_a1) annotation (Line(points={{36,-14},{18,-14},
          {18,-30},{14,-30}},color={0,127,255}));
  connect(fan4.y, controlBus.Pump_Aircooler_y) annotation (Line(points={{27.6,
          10},{38,10},{38,0.1},{-99.9,0.1}}, color={0,0,127}));
  connect(hex.port_a2, boundary.ports[2]) annotation (Line(points={{-6,-42},{
          -10,-42},{-10,-44}}, color={0,127,255}));
  connect(combiTable1D.u[1], controlBus.Fan_Aircooler) annotation (Line(points=
          {{-74,-24},{-99.9,-24},{-99.9,0.1}}, color={0,0,127}));
  connect(combiTable1D.y[1], boundary.m_flow_in) annotation (Line(points={{-51,
          -24},{-40,-24},{-40,-34},{-30,-34}}, color={0,0,127}));
  connect(hex.port_b2, bou.ports[1])
    annotation (Line(points={{14,-42},{30,-42}}, color={0,127,255}));
  connect(realExpression.y, feedback.u1)
    annotation (Line(points={{-81.4,-92},{-68,-92}}, color={0,0,127}));
  connect(boundary.X_in[1], measureBus.WaterInAir) annotation (Line(points={{-32,
          -46},{-60,-46},{-60,-69.9},{-109.9,-69.9}}, color={0,0,127}));
  ...
  connect(feedback.y, boundary.X_in[2]) annotation (Line(points={{-51,-92},{-46,
          -92},{-46,-46},{-32,-46}}, color={0,0,127}));
  connect(boundary.T_in, measureBus.AirTemp) annotation (Line(points={{-32,-38},
          {-60,-38},{-60,-69.9},{-109.9,-69.9}}, color={0,0,127}));
  connect(bou.T_in, measureBus.AirTemp) annotation (Line(points={{52,-38},{60,-38},
          {60,-69.9},{-109.9,-69.9}}, color={0,0,127}));
  ...
  connect(senMasFlo.port_a, hex.port_b1)
    annotation (Line(points={{-16,8},{-16,-30},{-6,-30}}, color={0,127,255}));
  ...
  connect(senTem1.port, hex.port_b1) annotation (Line(points={{-28,-18},{-16,-18},
          {-16,-30},{-6,-30}}, color={0,127,255}));
