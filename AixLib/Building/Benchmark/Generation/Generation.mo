...
model Generation
  ...
  Modelica.Fluid.Vessels.OpenTank tank1(
    ...
    T_start=293.15)
    annotation (Placement(transformation(extent={{52,-40},{66,-26}})));
  ...
  Fluid.Actuators.Valves.ThreeWayLinear val4(
    ...
    dpValve_nominal=10,
    y_start=0)
    annotation (Placement(transformation(extent={{-14,8},{-30,24}})));
...
equation
  ...
  connect(fan2.port_b, Fluid_out_cold)
    annotation (Line(points={{84,-46},{92,-46},{92,-40},{100,-40}},
                                                  color={0,127,255}));
  connect(tank1.ports[1], fan2.port_a)
    annotation (Line(points={{57.6,-40},{58,-40},{58,-46},{64,-46}},
                                                   color={0,127,255}));
  ...
  connect(val4.port_1, HotWater.portHC2In) annotation (Line(points={{-14,16},{0,
  ...
  connect(realExpression4.y, val4.y) annotation (Line(points={{-113,60},{-86,60},
          {-86,54},{-22,54},{-22,25.6}}, color={0,0,127}));
  ...
  connect(val4.port_3, generation_AirCooling.Fluid_in_warm_airCooler)
    annotation (Line(points={{-22,8},{-22,-24},{-40,-24}}, color={0,127,255}));
  ...
  connect(tank1.ports[2], ColdWater.fluidportBottom1) annotation (Line(points={
          {60.4,-40},{58,-40},{58,-94},{27.9375,-94},{27.9375,-88.38}}, color={
          0,127,255}));
