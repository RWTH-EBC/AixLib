...
model Generation
  ...
  Modelica.Blocks.Sources.RealExpression realExpression1(y=270)
...
equation
  ...
  connect(realExpression1.y, generation_Hot.TAmbient1)
  ...
  connect(booleanExpression1.y, generation_Hot.switchToNightMode1) annotation (
      Line(points={{-55,64},{-71.8,64},{-71.8,40}}, color={255,0,255}));
  ...
  connect(pump.IsNight, generation_Hot.switchToNightMode1) annotation (Line(
        points={{64,50.2},{64,88},{-66,88},{-66,64},{-71.8,64},{-71.8,40}},
        color={255,0,255}));
