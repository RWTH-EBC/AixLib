...
equation
  ...
  connect(cHP.port_b, bou3.ports[1])
    annotation (Line(points={{-66,16},{-55.2,16}}, color={0,127,255}));
  connect(bou3.ports[2], fan2.port_a)
    annotation (Line(points={{-56.8,16},{-46,16}}, color={0,127,255}));
