...
model Full_Transfer_TBA_Heatexchanger
  ...
  TBA_Pipe_Openplanoffice_v2 OpenPlanOffice(
    pipe_length=8,
    V_mixing=0.0001,
  ...
  TBA_Pipe_v2 Conferenceroom(m_flow_nominal=m_flow_nominal_conferenceroom,
  ...
  TBA_Pipe_v2 Multipersonoffice(dp_Valve_nominal=
  ...
  TBA_Pipe_v2 Canteen(dp_Valve_nominal=dp_Valve_nominal_canteen, m_flow_nominal=
  ...
  TBA_Pipe_v2 Workshop(dp_Valve_nominal=dp_Valve_nominal_workshop, m_flow_nominal=
...
end Full_Transfer_TBA_Heatexchanger;
