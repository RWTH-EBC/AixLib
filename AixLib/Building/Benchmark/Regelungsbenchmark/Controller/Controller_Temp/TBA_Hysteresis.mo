...
equation
  ...
  connect(greaterThreshold.u, y_pump) annotation (Line(points={{-52,50},{-70,50},
          {-70,-40},{-100,-40}}, color={0,0,127}));
  ...
  connect(greaterThreshold1.y, switch4.u2)
    annotation (Line(points={{-29,-64},{-2,-64}}, color={255,0,255}));
  connect(greaterThreshold1.u, y_pump) annotation (Line(points={{-52,-64},{-70,
          -64},{-70,-40},{-100,-40}}, color={0,0,127}));
