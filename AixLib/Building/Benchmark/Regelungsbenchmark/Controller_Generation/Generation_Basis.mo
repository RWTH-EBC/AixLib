...
equation
  ...
  connect(hysteresis6.u, measureBus.Aircooler_out) annotation (Line(points={{
          -77.2,6},{-100,6},{-100,86},{0.1,86},{0.1,100.1}}, color={0,0,127}));
  connect(or3.y, controlBus.OnOff_heatpump_small) annotation (Line(points={{
          -9.4,26},{0.1,26},{0.1,-99.9}}, color={255,0,255}));
