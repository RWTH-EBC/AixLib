...
model FullModel_v2
  ...
  BusSystem.Bus_measure Measure
    annotation (Placement(transformation(extent={{-120,0},{-80,40}})));
  BusSystem.Bus_Control Control
    annotation (Placement(transformation(extent={{-120,-40},{-80,0}})));
  Transfer.Transfer_TBA.Full_Transfer_TBA_Heatexchanger
...
equation
  ...
  connect(weather.measureBus, Measure) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(generation.measureBus, Measure) annotation (Line(
  ...
  connect(weather.internalBus,office. internalBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(generation.controlBus, Control) annotation (Line(
  ...
  connect(full_Transfer_TBA_Heatexchanger.HeatPort_TBA, office.Heatport_TBA)
    annotation (Line(points={{74,-40},{74,-20},{79.6,-20},{79.6,0}}, color={191,
          0,0}));
  connect(full_Transfer_TBA_Heatexchanger.Fluid_out_cold, generation.Fluid_in_cold)
    annotation (Line(points={{60,-58},{40,-58},{40,-80},{-20,-80},{-20,-54},{-60,
          -54}}, color={0,127,255}));
  connect(full_Transfer_TBA_Heatexchanger.Fluid_in_cold, generation.Fluid_out_cold)
    annotation (Line(points={{60,-54},{40,-54},{40,-80},{-20,-80},{-20,-58},{-60,
          -58}}, color={0,127,255}));
  ...
  connect(full_Transfer_TBA_Heatexchanger.measureBus, Measure) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(full_Transfer_TBA_Heatexchanger.Fluid_in_warm, generation.Fluid_out_warm)
    annotation (Line(points={{60,-47.4},{40,-47.4},{40,-48},{40,-48},{40,-80},{
          -20,-80},{-20,-48},{-60,-48}}, color={0,127,255}));
  connect(generation.Fluid_in_warm, full_Transfer_TBA_Heatexchanger.Fluid_out_warm)
    annotation (Line(points={{-60,-52},{-20,-52},{-20,-80},{40,-80},{40,-51.4},
          {60,-51.4}}, color={0,127,255}));
