...
model Case650
  ...
  Modelica.Blocks.Sources.CombiTimeTable Source_Weather(
    ...
    Utilities.Sources.HourOfDay hourOfDay
      ...
      annotation (Placement(transformation(extent={{82,64},{102,84}})));
    ...
    Modelica.Blocks.Interfaces.RealOutput PowerLoad "in MWh"
...
equation
  ...
  connect(idealHeaterCooler.heatCoolRoom, reducedOrderModel.internalGainsConv)
    ...
    annotation (Line(points={{25,-28},{31,-28},{31,-7},{32.2,-7},{32.2,12.3}},
...
<ul>
  ...
  <li>From 0700 hours to 1800 hours, cool = ON if temperature &gt; 27 degC; otherwise, cool = OFF
  </li>
