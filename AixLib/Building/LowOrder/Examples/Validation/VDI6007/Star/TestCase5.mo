...
model TestCase5
  ...
  Utilities.Sources.PrescribedSolarRad PrescribedSolarRad(n = 5) annotation(Placement(transformation(extent={{-50,78},
            {-30,98}})));
  Components.Weather.Sunblinds.Sunblind sunblind(n = 5, gsunblind = {0, 0, 0.15, 0, 0}) annotation(Placement(transformation(extent={{-24,77},
            {-4,97}})));
...
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,
             ...
             __Dymola_Commands(file=
                               "modelica://AixLib/Resources/Scripts/Dymola/Building/LowOrder/Examples/Validation/Star/TestCase5.mos"
        "Simulate and plot"),
