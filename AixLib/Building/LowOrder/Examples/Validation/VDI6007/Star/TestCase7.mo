...
model TestCase7
  ...
  HVAC.HeatGeneration.IdealHeaterCooler                idealHeaterCoolerVar1_1(                                    h_cooler = 0, TN_heater = 1, TN_cooler = 1, h_heater = 500, l_cooler = -500, KR_heater = 1000, KR_cooler = 1000) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = -90, origin = {-26, -20})));
