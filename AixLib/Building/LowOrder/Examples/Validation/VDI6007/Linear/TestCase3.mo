...
model TestCase3
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableMachines(extrapolation = Modelica.Blocks.Types.Extrapolation.Periodic, tableName = "NoName", fileName = "NoName", tableOnFile = false,                                                                                                    columns = {2},
