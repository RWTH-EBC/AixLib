...
<p>
  ReducedOrderModelEBCMod extends from partialReducedOrderModel.
</p>
<p>
  As windows have nearly no capacity an additional resistance for heat transfer calculation through the window is implemented.
</p>
<p>
  This class contains following additional components:
</p>
<ul>
  <li>additional Resistance for window, with additional equivalent air temperature for window
  </li>
  <li>distribution of radiative heat transfer
  </li>
  <li>longwave radiative heat transfer between inner and outer walls and windows
  </li>
  <li>convective heat transfer for windows
  </li>
</ul>
<h4>
  Main equations
...
<p>
  The concept is described in VDI 6007. All equations can be found in VDI 6007 and "Improving a Low Order Building Model for Urban Scale Applications"
</p>
<h4>
  Assumption and limitations
</h4>
<p>
  This model will only work with <a href=\"AixLib.Building.LowOrder.BaseClasses.EqAirTemp.EqAirTempEBCMod\">EqAirTempEBCMod</a>The longwave radiative heat transfer between the building components is modeled according to Stefan-Boltzmann Law.
</p>
<h4>
  Typical use and important parameters
</h4>
<p>
  Resistance and coefficient of heat transfer for windows
</p>
<h4>
  Options
</h4>
...
<ul>
  ...
  <li>Lauster, Moritz; Bruentjen, Mark-Alexander; Leppmann, Henning; Fuchs, Marcus; Teichmann, Jens; Streblow, Rita; Mueller, Dirk (2014): Improving a Low Order Building Model for Urban Scale Applications. In: Fifth German-Austrian IBPSA Conference, September 2014, Aachen, Germany, page 511-518
  </li>
</ul></html>",revisions="<html>
