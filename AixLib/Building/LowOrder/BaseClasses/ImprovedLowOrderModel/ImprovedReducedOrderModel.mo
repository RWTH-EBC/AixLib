...
public
  ...
  SplitterThermPercentAir splitterThermPercentAir(
      ZoneFactor=vector_help1, dimension=dimension_help)
    annotation (Placement(transformation(extent={{-14,80},{6,100}})));
  SplitterThermPercentAir splitterThermPercentAir1(dimension=dimension_help,
      ZoneFactor=vector_help2)                     annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={94,0})));
