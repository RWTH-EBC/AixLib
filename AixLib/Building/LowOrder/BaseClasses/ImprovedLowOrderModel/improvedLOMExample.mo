...
model improvedLOMExample
  ...
  replaceable
    AixLib.Building.LowOrder.BaseClasses.ImprovedLowOrderModel.ImprovedReducedOrderModel
                                reducedOrderModel(
    R1i=0.001236773,
    C1i=9.32664e+05,
    Ai=48.0,
    ...
    Ao=123.6,
    alphaiwi=3.16,
    epsi=0.9)                                     constrainedby partialLOM
    annotation (Placement(transformation(extent={{44,18},{78,52}})), choicesAllMatching=true);
  replaceable AixLib.Building.LowOrder.BaseClasses.EqualAirTemp.WindowEqAirTemp
    partialEqAirTemp(
    alphaowo=25,
    aowo=0.6,
    eowo=0.9,
    ...
    alphaconv_wall=24,
    alphaconv_win=16,
    awin=0) constrainedby EqualAirTemp.partialEqAirTemp
...
equation
  ...
  connect(const.y, gain.u) annotation (Line(
      points={{-43,-46},{-32,-46},{-32,-29},{-23,-29}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const.y, gain1.u) annotation (Line(
      points={{-43,-46},{-36,-46},{-36,-49},{-21,-49}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const.y, gain2.u) annotation (Line(
      points={{-43,-46},{-36,-46},{-36,-78},{-20.8,-78}},
      color={0,0,127},
      smooth=Smooth.None));
