...
<p>
  ThermSplitter is a simple model which weights a given set of therm inputs to calculate an average temperature or heat flow and the other way around
</p>
<h4>
  Main equations
</h4>
<p>
  <img src=\"modelica://AixLib/Resources/Images/Building/LowOrder/BaseClasses/ThermSplitter/equation-ShHZPTo9.png\" alt=\"signalOutput.Q_flow" splitfactor="">
</p>
<p>
  <img src=\"modelica://AixLib/Resources/Images/Building/LowOrder/BaseClasses/ThermSplitter/equation-BtreVeqi.png\" alt=\"signalInput.T">
</p>
<h4>
...
<p>
  This model is used to weight therm ports according to given split factors.
</p>
<p>
  The model needs the dimension of the splitted therm port and the split factors, which are between 0 and 1.
</p>
<h4>
  Options
</h4>
...
<p>
  In ReducedOrderModelVDI and ReducedOrderModelEBCMod
</p>
<h4>
  References
</h4></html>",revisions="<html>
<ul>
  <li>
  ...
  <li>
    <i>January 2015,&#160;</i> by Peter Remmen:<br/>
