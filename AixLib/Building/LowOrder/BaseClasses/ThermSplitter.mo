...
<p><img src=\"modelica://AixLib/Resources/Images/equations/equation-ShHZPTo9.png\" alt=\"signalOutput.Q_flow = splitFactor .* (signalInput.Q_flow * unitvec) \"/></p>
<p><img src=\"modelica://AixLib/Resources/Images/equations/equation-BtreVeqi.png\" alt=\"signalInput.T = sum(signalOutput.T * splitFactor) \"/></p>
