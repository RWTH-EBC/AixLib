...
<p>
  The model works like an electric circuit as the equations of heat transfer are similar to them.
</p>
<p>
  The class contains following components:
</p>
<ul>
  <li>connector for heat transfer
  </li>
  <li>heat storage as a thermal resistor
  </li>
  <li>heat load as a heat capacitor
  </li>
</ul>
<h4>
...
<p>
  The model underlies all assumptions which are made in VDI 6007, especially that all heat transfer parts are combined in one part. It can be used in combination with various other models. There are no known limitaions.
</p>
<h4>
...
<p>
  The wall model is tested and validated in the context of the <a href=\"AixLib.Building.LowOrder.BaseClasses.ReducedOrderModel\">ReducedOrderModel</a>. See <a href=\"AixLib.Building.LowOrder.Examples.Validation\">Validation</a> for some results.
...
<ul>
  <li>
    ...
    Implemented.
            ...
            fillPattern =                                                                                                   FillPattern.Solid, pattern=LinePattern.None), Line(points = {{-90, 0}, {-2, 0}}, color = {0, 0, 0}, thickness = 0.5), Rectangle(extent = {{-74, 12}, {-26, -10}}, lineColor = {0, 0, 0},
            ...
            fillPattern =                                                                                                   FillPattern.Solid, pattern=LinePattern.None), Line(points = {{-19, -32}, {15, -32}}, pattern=LinePattern.None, thickness = 0.5), Line(points = {{-19, -44}, {15, -44}}, pattern=LinePattern.None, thickness = 0.5), Text(extent = {{-90, 142}, {90, 104}}, lineColor = {0, 0, 255}, textString = "%name")}));
