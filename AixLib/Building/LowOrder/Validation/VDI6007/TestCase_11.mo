...
model TestCase_11
  ...
  VDIComponents.ReducedOrderModel_surfaceCooling reducedModel(C1i = 1.48216e+007, Aw = 7, g = 0.15, C1o = 1.60085e+006, epsi = 1, epso = 1, T0all(displayUnit = "K") = 295.15, rad_split_conv(x = 0.09), withWindows = false, R1i = 0.000595515, Ai = 75.5, RRest = 0.042748777, R1o = 0.004366222, Ao = 10.5, alphaiwi = 3) annotation(Placement(transformation(extent = {{64, 36}, {98, 76}})));
