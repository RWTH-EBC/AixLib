...
model TestCase_5
  ...
  Building.LowOrder.BaseClasses.ReducedOrderModel reducedModel(C1i = 1.48216e+007, C1o = 1.60085e+006, alphaiwi = 2.2, epsi = 1, epso = 1, T0all(displayUnit = "K") = 295.15, Aw = 7, splitfac = 0.09, R1i = 0.000595515, Ai = 75.5, epsw = 1, g = 1, RRest = 0.042748777, R1o = 0.004366222, Ao = 10.5) annotation(Placement(transformation(extent = {{48, 26}, {82, 66}})));
