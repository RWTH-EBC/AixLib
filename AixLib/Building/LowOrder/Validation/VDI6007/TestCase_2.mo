...
model TestCase_2
  ...
  Building.LowOrder.BaseClasses.ReducedOrderModel reducedModel(Aw = 0.000000001, Ai = 75.5, epsi = 1, epso = 1, epsw = 1, g = 1, alphaiwi = 2.2, alphaowi = 2.7, splitfac = 0.09, R1i = 0.000595515, C1i = 1.48216e+007, withWindows = false, RRest = 0.042748777, R1o = 0.004366222, C1o = 1.60085e+006, Ao = 10.5) annotation(Placement(transformation(extent = {{12, 10}, {46, 44}})));
