...
model TestCase6
  ...
  Modelica.Blocks.Sources.CombiTimeTable setTemp(extrapolation = Modelica.Blocks.Types.Extrapolation.Periodic,
    columns={2,3},
    table=[0,295.15,295.15; 3600,295.15,295.15; 7200,295.15,295.15; 10800,
        ...
        295.15,295.15; 86400,295.15,295.15])                                                                                    annotation(Placement(transformation(extent = {{-62, -38}, {-42, -18}})));
  ...
  Utilities.Sources.HeaterCooler.IdealHeaterCoolerVar1 idealHeaterCoolerVar1_1
    annotation (Placement(transformation(
        extent={{-10,-9},{10,9}},
        rotation=-90,
        origin={-18,-27})));
  Modelica.Blocks.Math.Add sumHeatLoad
    annotation (Placement(transformation(extent={{-90,78},{-78,90}})));
equation
  ...
  connect(setTemp.y[1], idealHeaterCoolerVar1_1.soll_cool) annotation (Line(
      points={{-41,-28},{-32,-28},{-32,-22.2},{-22.32,-22.2}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(setTemp.y[2], idealHeaterCoolerVar1_1.soll_heat) annotation (Line(
      points={{-41,-28},{-32,-28},{-32,-30},{-22.32,-30}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(idealHeaterCoolerVar1_1.heatCoolRoom, reducedModel.internalGainsConv)
    annotation (Line(
      points={{-18,-36},{74.4,-36},{74.4,30}},
      color={191,0,0},
      smooth=Smooth.None));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
            -100},{100,100}}),                                                                           graphics), experiment(StopTime = 5.184e+006, Interval = 3600, __Dymola_Algorithm = "Lsodar"), __Dymola_experimentSetupOutput(events = false), Documentation(revisions = "<html>
