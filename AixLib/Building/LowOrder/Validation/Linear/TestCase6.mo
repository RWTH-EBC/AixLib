...
model TestCase6
  ...
  Modelica.Blocks.Sources.CombiTimeTable setTemp(extrapolation = Modelica.Blocks.Types.Extrapolation.Periodic,
    ...
    table=[0,295.1; 3600,295.1; 7200,295.1; 10800,295.1; 14400,295.1; 18000,
        ...
        79200,295.1; 82800,295.1; 86400,295.1])                                                                                 annotation(Placement(transformation(extent = {{-62, -38}, {-42, -18}})));
...
equation
  ...
  connect(setTemp.y[1], varTemp.T) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(varTemp.port, heatFlowSensor.port_a) annotation (Line(
      points={{-4,-28},{12,-28}},
      color={191,0,0},
      smooth=Smooth.None));
  connect(heatFlowSensor.port_b, reducedModel.internalGainsConv) annotation (
      Line(
      points={{32,-28},{74.4,-28},{74.4,30}},
      color={191,0,0},
      smooth=Smooth.None));
