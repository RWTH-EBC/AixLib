...
model TestCase_7
  ...
  BaseClasses.ReducedOrderModelVDI                reducedModel(                    Aw = 7, g = 0.15,                     alphaiwi = 2.2, epsi = 1, epso = 1, T0all(displayUnit = "K") = 295.15, withWindows = false, R1i = 0.000595515, Ai = 75.5,                                         Ao = 10.5,
    C1i=1.48362e+007,
    RRest=0.042768721,
    R1o=0.004367913,
    C1o=1.6008e+006)                                                                                                     annotation(Placement(transformation(extent = {{44, 38}, {78, 78}})));
