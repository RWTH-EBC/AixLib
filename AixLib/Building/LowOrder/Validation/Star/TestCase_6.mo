...
model TestCase_6
  ...
  Building.LowOrder.BaseClasses.ReducedOrderModel reducedModel(C1i = 1.48216e+007, Aw = 7, g = 0.15, C1o = 1.60085e+006, alphaiwi = 2.2, epsi = 1, epso = 1, T0all(displayUnit = "K") = 295.15, R1i = 0.000595515, Ai = 75.5, RRest = 0.042748777, R1o = 0.004366222, Ao = 10.5, withWindows = false) annotation(Placement(transformation(extent = {{54, 26}, {88, 66}})));
