...
model TestCase7
  ...
  Modelica.Blocks.Sources.CombiTimeTable setTemp(
    ...
    table=[0,295.15,295.15; 3600,295.15,295.15; 7200,295.15,295.15; 10800,
        ...
        295.15,295.15; 86400,295.15,295.15])
...
equation
  ...
  connect(setTemp.y[1], idealHeaterCoolerVar1_1.soll_heat) annotation (Line(
      points={{-55,-20},{-42,-20},{-42,-23},{-30.8,-23}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(setTemp.y[2], idealHeaterCoolerVar1_1.soll_cool) annotation (Line(
      points={{-55,-20},{-42,-20},{-42,-15.2},{-30.8,-15.2}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
            -100},{100,100}}),                                                                           graphics), experiment(StopTime = 5.184e+006, Interval = 3600, Algorithm = "Lsodar"), __Dymola_experimentSetupOutput(events = false), Documentation(revisions = "<html>
