...
model TestCase_10
  ...
  Building.LowOrder.BaseClasses.ReducedOrderModel reducedModel(R1i = 0.000779672, C1i = 1.23140e+07, Ai = 58, splitfac = 0.09, Aw = 7, epsw = 1, RRest = 0.014406788, R1o = 0.001719315, C1o = 4.33875e+06, Ao = 28, alphaiwi = 2.4, alphaowi = 2.1, epsi = 1, epso = 1, g = 1, T0all = 290.75) annotation(Placement(transformation(extent = {{50, 42}, {98, 92}})));
...
equation
  ...
  connect(outdoorTemp.y, eqAirTemp_TestCase_8_1.WeatherDataVector)
    annotation (Line(
      points={{-79,22},{-56,22},{-56,40},{-34,40}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(reducedModel.equalAirTemp, eqAirTemp_TestCase_8_1.equalairtemp)
    annotation (Line(
      points={{54.8,68},{19.4,68},{19.4,40},{-18,40}},
      color={191,0,0},
      smooth=Smooth.None));
