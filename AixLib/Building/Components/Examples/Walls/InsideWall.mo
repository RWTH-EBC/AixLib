...
model InsideWall
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature Tinside2(T = 283.15) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {-84, 62})));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature Tinside3(T = 283.15) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {-84, 22})));
  Components.Walls.Wall wall_simple_new(outside = false, wall_length = 5, wall_height = 2, withDoor = true, WallType = DataBase.Walls.WSchV1984.IW.IWsimple_WSchV1984_L_half(), T0 = 289.15) annotation(Placement(transformation(extent = {{28, -4}, {40, 68}})));
  Components.Walls.Wall wall_simple1_new(outside = false, wall_length = 5, wall_height = 2, withDoor = true, WallType = DataBase.Walls.WSchV1984.IW.IWsimple_WSchV1984_L_half(), T0 = 287.15) annotation(Placement(transformation(extent = {{-6, 36}, {6, -36}}, rotation = 180, origin = {-30, 30})));
...
equation
  connect(wall_simple1_new.port_outside, wall_simple_new.port_outside) annotation(Line(points = {{-23.7, 30}, {-23.7, 32}, {27.7, 32}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(thermStar_Demux.thermStarComb, wall_simple1_new.thermStarComb_inside) annotation(Line(points = {{-56.48, -44.075}, {-39.24, -44.075}, {-39.24, 30}, {-36, 30}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(thermStar_Demux1.thermStarComb, wall_simple_new.thermStarComb_inside) annotation(Line(points = {{56.42, -46.075}, {49.21, -46.075}, {49.21, 32}, {40, 32}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Tinside2.port, thermStar_Demux.star) annotation(Line(points = {{-74, 62}, {-56, 62}, {-56, -22}, {-88, -22}, {-88, -39.65}, {-72.32, -39.65}}, color = {191, 0, 0}, smooth = Smooth.None));
  connect(Tinside3.port, thermStar_Demux.therm) annotation(Line(points = {{-74, 22}, {-60, 22}, {-60, -18}, {-92, -18}, {-92, -47.825}, {-72.08, -47.825}}, color = {191, 0, 0}, smooth = Smooth.None));
