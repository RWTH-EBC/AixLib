...
<p>
  Heat source with convective and radiative component. The load is determined by a schedule and the type of activity.
</p>
<p>
  <img src=\"modelica://AixLib/Resources/Images/Stars/stars2.png\" alt=\"stars:" out="" of="">
</p>
<h4>
  <span style=\"color:">Concept</span>
</h4>
<p>
  The schedule sets the times when the machines are used. They tend to be used more when people are present in the room, and go on stand-by when people are absent from the room.
</p>
<p>
  The schedule describes the machines corresponding to only one person, and can take values from 0 to 1. For more people, a factor, <b>NrPeople</b>, is provided as parameter.
</p>
<p>
  The type of activity determines the load for machines in the room for one person according to DIN 18599-10. The following values are used:
</p>
<table cellspacing=\"2\" cellpadding=\"0\" border=\"0\" summary=\"Load" according="" to="" type="" of="">
  <tr>
...
<p>
  ...
  <br/>
  <br/>
  <b><span style=\"color:">Assumptions</span></b>
</p>
<p>
  The surface for radiation exchange is constant throught the simulation, as the machines are always present in the room. For stability reasons a lower limitation of 1e-4 m2 has been introduced.
</p>
<h4>
  <span style=\"color:">References</span>
</h4>
<p>
  DIN 18599-10
</p>
...
<p>
  <a href=\"AixLib.Building.Examples.Sources.InternalGains.Machines\">AixLib.Building.Examples.Sources.InternalGains.Machines</a>
</p>
<p>
  <a href=\"AixLib.Building.Examples.Sources.InternalGains.OneOffice\">AixLib.Building.Examples.Sources.InternalGains.OneOffice</a>
