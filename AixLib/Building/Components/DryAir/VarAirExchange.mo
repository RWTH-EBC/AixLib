...
equation
 ...
 <p>The <b>VarAirExchange</b> model describes heat transfer by air exchange (e.g. due to opening a window). It needs the air exchange rate (in <img src=\"modelica://AixLib/Resources/Images/Equations/equation-fHlz87wz.png\" alt=\"h^(-1)\"/>) as input value. </p>
