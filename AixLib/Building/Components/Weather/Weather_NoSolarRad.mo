...
model Weather_NoSolarRad
  "weather model without calculation of solar radiation"
...
public
  SolarRadiationBus solarRadiationBus annotation (Placement(transformation(
          extent={{-4,70},{36,110}}), iconTransformation(extent={{14,84},{34,
            104}})));
initial equation
...
equation
  ...
  connect(Sun.OutDayAngleSun, solarRadiationBus.DayAngleSun) annotation (Line(
        points={{-39.2,30.72},{-39.2,30},{16.1,30},{16.1,90.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(Sun.OutDeclinationSun, solarRadiationBus.DeclinationSun) annotation (
      Line(points={{-39.2,23.28},{16.1,23.28},{16.1,90.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(Sun.OutHourAngleSun, solarRadiationBus.HourAngleSun) annotation (Line(
        points={{-39.2,26.88},{-39.2,26},{16.1,26},{16.1,90.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(deMultiplex.y1[1], solarRadiationBus.DiffRadHor) annotation (Line(
        points={{-5,-53},{16.1,-53},{16.1,90.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(deMultiplex.y2[1], solarRadiationBus.BeamRadHor) annotation (Line(
        points={{-5,-60},{16.1,-60},{16.1,90.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  annotation(Dialog(group = "Solar radiation on oriented surfaces"), Dialog(tab = "Optional output vector", descriptionLabel = true), Diagram(coordinateSystem(preserveAspectRatio=false,  extent={{-150,
            -100},{150,100}})),                                                                                                                                                                                                        Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-150, -100}, {150, 100}}), graphics={  Rectangle(extent = {{-150, 78}, {10, -82}}, lineColor = {0, 0, 0}, fillColor = {255, 255, 255},
