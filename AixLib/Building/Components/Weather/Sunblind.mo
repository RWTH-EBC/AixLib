...
equation
 ...
 <li>At which amount of radiance the sunblind will be closed is defined by Imax. Each directon is independent from all other directions and closes/opens separately due to the radiance hitting the direction.</li>
