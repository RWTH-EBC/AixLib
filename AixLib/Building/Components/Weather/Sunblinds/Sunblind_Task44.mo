...
<ul>
  ...
  <li>Normally used as replacable model in Walls.Wall of EBC Building Library
  </li>
</ul>
<p>
  Requires a variable Tamb to be able to calculate the running mean of ambient temperature. Should be supplied by inner Modelica.SIunits.Temperature Tamb, see Examples.Weather.sunblind_T44_test for an example how to implement inner data
</p>
<p>
...
<p>
  According to IEA Task 44 sunblindes are lowerd partially based on horizontal global radiation, thus there is no dependance on the buildings orientation, sunblinds are lowered the same for every side of the building
</p>
<h4>
...
<ul>
  ...
  <li>running average over last 24 hours of ambient temperature is &gt; 12 °C
  </li>
</ul>
<p>
  <br/>
