...
model Wall_withRadOnSurface
  "Simple wall model for outside and inside walls with windows and doors with internal radiation on tilted surface model"
 ...
 DataBase.Surfaces.RoughnessForHT.PolynomialCoefficients_ASHRAEHandbook         surfaceType = DataBase.Surfaces.RoughnessForHT.Brick_RoughPlaster()
  ...
  Weather.SolarRadiationBus solarRadiationBus annotation (Placement(
        transformation(
        extent={{-20,-20},{20,20}},
        rotation=270,
