...
<ul>
  <li>the conductive heat transfer through the door with a U-Value is set to 1.8 W/(m²K) (EnEV2009)
  </li>
...
<p>
  <a href=\"AixLib.Building.Components.Examples.WindowsDoors.DoorSimple\">AixLib.Building.Examples.WindowsDoors.DoorSimple</a>
...
<ul>
  ...
  <li>
    <i>March 30, 2012&#160;</i> by Corinna Leonhardt and Ana Constantin:<br/>
    Implemented.
  </li>
