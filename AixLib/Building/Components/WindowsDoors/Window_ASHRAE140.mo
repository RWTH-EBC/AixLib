...
<p>
  The <b>WindowSimple</b> model represents a window described by the thermal transmission coefficient and the coefficient of solar energy transmission( with correction factors).
</p>
<p>
...
<ul>
  <li>
    <i>March 30, 2015&#160;</i> by Ana Constantin:Improved implementation of transmitted solar radiation<br/>
  </li>
  <li>
