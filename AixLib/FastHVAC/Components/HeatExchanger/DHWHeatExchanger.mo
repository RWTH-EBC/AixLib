...
public
  ...
  Modelica.Blocks.Interfaces.RealOutput T_DHW( unit="degC")
    "output temperature of domestic hot water"                                           annotation (Placement(
        ...
        rotation=90,
        origin={30,90})));
  BaseClasses.WorkingFluid                                 layer_heater[n](
  each medium = medium,
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor heat_transfer[
    n](each G=k_HE*A_HE/n) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={0,0})));
  BaseClasses.WorkingFluid                                 layer_dHW[n](
  each medium = medium,
  each m_fluid=m_heater/n,
  each T0=T0)
    annotation (Placement(transformation(extent={{-20,-20},{20,20}},
...
<p>Model for a counterflow heat exchanger for two circuits. In the first instance this heat exchanger is used to warm domestic hot water. </p>

<h4><span style=\"color:#008000\">Level of Development</span></h4>
<p><img src=\"modelica://HVAC/Images/stars3.png\"/></p>

<h4><span style=\"color:#008000\">Concept</span></h4>
<p>The heat transfer between the two circuits is based on the model <a href=\"modelica:/Modelica.Thermal.HeatTransfer.Components.ThermalConductor\">ThermalConductor</a>.
The fluid inside the heat exchanger (each side separately) is represented by the model  <a href=\"modelica:/Modelica.Thermal.HeatTransfer.Components.HeatCapacitor\">HeatCapacitor</a>.</p>
...
<p>Examples can be found in <a href=\"modelica:/FastHVAC.Examples.HeatExchanger.DHWHeatExchanger.TestDHWHeatexchanger\">TestDHWHeatexchanger</a></p>
</html>",
    revisions="<html>
<ul>
<li><i>April 13, 2017&nbsp; </i> Tobias Blacha:<br/>Moved into AixLib</li>
<li><i>January 12, 2015&nbsp;</i> by Konstantin Finkbeiner:<br>Formatted documentation appropriately</li>
