...
<p>
  The heat transfer between the two circuits is based on the model <a href=\"modelica:/Modelica.Thermal.HeatTransfer.Components.ThermalConductor\">ThermalConductor</a>. The fluid inside the heat exchanger (each side separately) is represented by the model <a href=\"modelica:/Modelica.Thermal.HeatTransfer.Components.HeatCapacitor\">HeatCapacitor</a>.
</p>The heat exchanger is discretized in n single layers (min. 3 layers) towards the flow direction at the heater side.
<h4>
  <span style=\"color:#008000\">Example Results</span>
</h4>
<p>
  Examples can be found in <a href=\"modelica:/FastHVAC.Examples.HeatExchanger.DHWHeatExchanger.TestDHWHeatexchanger\">TestDHWHeatexchanger</a>
