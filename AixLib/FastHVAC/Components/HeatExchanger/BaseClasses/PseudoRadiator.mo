...
<ul>
  <li>It acts as a vessel for a part of the heat medium flow entering the MultiRadiator model;
  </li>
  <li>It prescribes a convective and radiative heat into the environment of the MultiRadiator;
  </li>
