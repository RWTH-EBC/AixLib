...
equation
  ...
  connect(radiator.enthalpyPort_b1, manifold.enthalpyPort_a[1]) annotation (
      Line(
      points={{8,-0.2},{8,0},{40,0}},
      color={176,0,0},
      smooth=Smooth.None));
  annotation (Documentation(info="<html>
<h4><span style=\"color:#008000\">Overview</span></h4>

<li>This model emulates the behavour of n identical radiators.</li>

<h4><span style=\"color:#008000\">Level of Development</span></h4>
<p><img src=\"modelica://HVAC/Images/stars3.png\"/></p>

<h4><span style=\"color:#008000\">Concept</span></h4>
<p>Instead of connecting n radiator models in parallel , the MultiRadiator model consists of one single radiator model and a pseudoradiator model.</p>
<p>The radiator model receives the n-th part of the total flow of heat medium, which interacts with its environment via the therm (ConvectiveHeat) and star (RadiativeHeat) connectors and flows out of the radiator at a different temperature and specific enthalpy. </p>
<p>The pseudoradiator emulates the behaivour of the reamaining (identical) n-1 radiators. It receives the remaining flow of heat medium, injects (or absorbs) (n-1)-times the heat flow of the radiator into the environment and injects back heat medium back into to the circuit with the same temperature and specific enthalpy than at the output of the actual radiator model.</p>
<p>This method reduces the number of state variables and therefore the simulation time. </p>


<h4><span style=\"color:#008000\">Example Results</span></h4>
<p>Examples can be found in <a href=\"modelica:/FastHVAC.Examples.HeatExchanger.MultiRadiator.ValidationMultiRadiator\">ValidationMultiRadiator.</a></p>
</html>",
revisions="<html>
<p><ul>
<li><i>April 13, 2017&nbsp; </i> Tobias Blacha:<br/>Moved into AixLib</li>
<li><i>February 22, 2014&nbsp;</i> by  Nicol&aacute;s Chang:<br/>Implemented.</li>
</ul></p>
</html>"),
