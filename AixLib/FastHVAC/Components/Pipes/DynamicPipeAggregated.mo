...
<p>
  Dynamic Pipe with pipe wall and insulation wall which allows discretisation of pipe wall and pipe insulation.
</p>
<h4>
  <span style=\"color:#008000\">Concept</span>
</h4>
<p>
  For each discretisation of the pipe, there is a connector to the corresponding element of the discretized pipe wall. Each element of the discretised pipe wall is connected to a corresponding element of the discretized insulation wall.
</p>
<p>
  The outside heat port is a multiple heat port.
</p>
<h4>
  <span style=\"color:#008000\">Example Results</span>
</h4>
<p>
  <a href=\"FastHVAC.Examples.Pipes.DynamicPipeAggregated\">DynamicPipeAggregated</a>
