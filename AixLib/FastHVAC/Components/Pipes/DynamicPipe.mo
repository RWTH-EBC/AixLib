...
<h4>
  DynamicPipe with heat transfer through pipe wall and insulation
</h4>
<h4>
  <span style=\"color:#008000\">Overview</span>
</h4>
<p>
  Dynamic Pipe is based on the model <a href=\"FastHVAC.Components.Pipes.BaseClasses.DynamicPipeBase\">DynamicPipeBase</a>. The pipes parameter can be chosen from <a href=\"DataBase\">DataBase</a> or entered manually .
</p>
<h4>
  <span style=\"color:#008000\">Concept</span>
</h4>
<p>
  The fluid inside the pipe is represented by the model <a href=\"modelica:/Modelica.Thermal.HeatTransfer.Components.HeatCapacitor\">HeatCapacitor</a>. Two cilindrical layers with <a href=\"HVAC.Components.Pipes.BaseClasses.Insulation.CylindricHeatConduction\">heat conduction</a> and <a href=\"HVAC.Components.Pipes.BaseClasses.Insulation.CylindricLoad\">heat storage</a> where added for the pipe wall and pipe insulation each.
</p>
<p>
  There is only one heat port connection for the pipe wall, and only one wall and insulation element each.
</p>
<p>
...
<p>
  <a href=\"FastHVAC.Examples.Pipes.DynamicPipe\">DynamicPipe</a>
...
<ul>
  ...
  <li>
    <i>June 21, 2014&#160;</i> by Ana Constantin:<br/>
    Removed nParallel parameter.
  </li>
  <li>
