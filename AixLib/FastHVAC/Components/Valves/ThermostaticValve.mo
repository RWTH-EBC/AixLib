...
<p>Thermostatic valve model.</p>
<h4><span style=\"color:#008000\">Level of Development</span></h4>
<p><img src=\"modelica://HVAC/Images/stars2.png\"/></p>
<h4><span style=\"color:#008000\">Concept</span></h4>
<p>The thermostatic valve model is designed as a pump controller. The mass flow set value is calculated based on nominal mass flow and the temperature difference between the setpoint and actual value.  </p>
<p>The valve opening characteristic is described by the function <code>valveCharacteristic</code>, linear characteristic by default, can be replaced by any user-defined function. Equal percentage with customizable rangeability and an optimal characteristic are already provided by the library.
</p>
<p>
...
a step input of opening. 
</p>

<h4><span style=\"color:#008000\">Example Results</span></h4>
<p><a href=\"FastHVAC.Examples.Valves.ThermostaticValveRadiator\">ThermostaticValve</a></p>
</html>",
        revisions="<html>
<p><ul>
<li><i>April 13, 2017&nbsp; </i> Tobias Blacha:<br/>Moved into AixLib</li>
<li><i>February 19, 2015&nbsp;</i> by Konstantin Finkbeiner:<br/>Implemented</li>
</ul></p>
</html>
"));
