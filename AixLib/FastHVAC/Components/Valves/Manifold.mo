...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
    ...
    <p> Model for a manifold  </p>
    <h4><span style=\"color:#008000\">Level of Development</span></h4>
    <p><img src=\"modelica://HVAC/Images/stars2.png\"/></p>
    <h4><span style=\"color:#008000\">Concept</span></h4>
    <p>  Collects the flow of the n input ports into one single output port. Input flows must be of the same medium (same density and specific heat capacity). The temperature and enthalpy of the output flow are obtained by balancing the mass and enthalpy flows. </p>
</html>",
revisions="<html>
<p><ul>
