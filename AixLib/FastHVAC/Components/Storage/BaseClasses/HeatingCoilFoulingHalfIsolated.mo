...
model HeatingCoilFoulingHalfIsolated
 ...
 parameter AixLib.DataBase.Pipes.PipeBaseDataDefinition pipe_HC=
  ...
  AixLib.Utilities.HeatTransfer.HeatConv conv_HC1_Outside[dis_HC](each alpha=
        alpha_HC, A=fill(pipe_HC.d_o*Modelica.Constants.pi*length_HC/(2*dis_HC),
  ...
  Utilities.HeatTransfer.HeatConvPipe_inside conv_HC1_Inside[dis_HC](
    ...
    length=fill(length_HC, dis_HC),
    A_sur=fill(pipe_HC.d_o*Modelica.Constants.pi*length_HC/(2*dis_HC), dis_HC))
                                       annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-4,20})));
  ...
  Utilities.HeatTransfer.CylindricHeatConduction_fouling
    ...
    length=fill(length_HC/(2*dis_HC), dis_HC))
    annotation (Placement(transformation(extent={{-14,58},{6,78}})));
  Utilities.HeatTransfer.CylindricHeatTransfer_halfpipeisolated
                                               cylindricHeatTransfer[dis_HC](
...
"));
end HeatingCoilFoulingHalfIsolated;
