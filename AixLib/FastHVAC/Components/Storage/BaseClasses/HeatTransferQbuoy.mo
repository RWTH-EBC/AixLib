...
<ul>
  <li>Freebuoy: Desribes the heatflow which is transfered directly by the upflowing mass to the overlying layers.
  </li>
  <li>Botmix and Topmix: Describes the heat that is transfered due to the mixing of the layers above and below the buoyancy layer that is induced by the upflowing mass
  </li>
</ul>
<p>
  Model was developed by Christian Grozescu in his master thesis <i>Extension of Thermal Storage Models for Energy System Simulations</i>, 2017
