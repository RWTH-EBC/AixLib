...
model WasteWaterStorage "Simple model of a wastewater storage"
  import AixLib;
...
public
  ...
  parameter Modelica.SIunits.Temperature T_start=323.15
    "Start temperature of medium" annotation(Dialog(tab="Initialisation"));
  parameter Modelica.SIunits.Temperature T_start_HC=323.15
    "Start temperature of medium" annotation(Dialog(tab="Initialisation"));
...
public
  ...
  FastHVAC.Interfaces.EnthalpyPort_a port_HC1_in
    "Fluid connector a (positive design flow direction is from port_a to port_b)"
    annotation (Placement(transformation(extent={{-110,70},{-90,90}}),
        iconTransformation(extent={{-88,52},{-72,68}})));
  FastHVAC.Interfaces.EnthalpyPort_b port_HC1_out
...
<p>Storage for wastewater to store heat for heatpump usage with one heatcoil. Model with variable connection pairs for loading and unlouding cycles which are defined by the associated <U>storage layer number </U> of the ports.  </p>
