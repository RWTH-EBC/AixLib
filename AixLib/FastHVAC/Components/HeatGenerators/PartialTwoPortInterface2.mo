...
partial model PartialTwoPortInterface2
  "Partial model transporting fluid between two ports without storing mass or energy"
  extends AixLib.FastHVAC.Components.HeatGenerators.PartialTwoPort2;
...
//     start=_dp_start,
//     displayUnit="Pa") = enthalpyPort_a.p - enthalpyPort_b.p
