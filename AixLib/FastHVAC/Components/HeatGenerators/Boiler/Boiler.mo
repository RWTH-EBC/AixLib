...
<p>
  The boilers parameterization is based on records from the <a href=\"DataBase.Boiler.General.BoilerTwoPointBaseDataDefinition\">DataBase</a> library. In the range of minimal and nominal heat power a modulating operation is possible.
</p>
<p>
...
<p>
  Both, actually and integrated gas consumption can be taken from boilers outputs.
</p>
<h4>
