within AixLib.FastHVAC.Components.HeatGenerators.CHP.BaseClasses;
...
equation
  connect(timer.y, lessThreshold.u) annotation (Line(points={{-15,32},{-12,32},{-12,42},{-4,42}}, color={0,0,127}));
  connect(lessThreshold.y, and1.u1) annotation (Line(points={{19,42},{28,42},{28,32},{38,32}}, color={255,0,255}));
  ...
  connect(Start, Start)
    annotation (Line(points={{112,48},{114,48},{114,64},{114,64},{114,48},{112,48}}, color={255,0,255}));
