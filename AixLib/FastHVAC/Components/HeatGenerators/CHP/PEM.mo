...
parameter AixLib.FastHVAC.Media.BaseClasses.MediumSimple medium=
  ...
  parameter AixLib.FastHVAC.Data.CHP.FuelcellPEM.BaseDataDefinition param=
...
Modelica.SIunits.Efficiency eta_el "electrical efficiency of the fuel cell itself";
Modelica.SIunits.Efficiency eta_PCU "electrical efficiency of the PCU, which converts the DC power from the PEM fuel cell to AC power";
