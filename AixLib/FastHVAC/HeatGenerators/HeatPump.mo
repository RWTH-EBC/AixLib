...
//Advanced
  ...
  AixLib.FastHVAC.Sensors.TemperatureSensor senT_a2 "Temperature at sink inlet"
    annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={40,-86})));
  AixLib.FastHVAC.Sensors.TemperatureSensor senT_b2
    "Temperature at sink outlet" annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={-52,-86})));
  AixLib.FastHVAC.Sensors.MassFlowSensor mFlow_eva
    "Mass flow sensor at the evaporator" annotation (Placement(transformation(
        origin={70,-60},
        extent={{10,-10},{-10,10}},
        rotation=0)));
  AixLib.FastHVAC.Sensors.TemperatureSensor senT_b1
    "Temperature at sink outlet" annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=0,
        origin={38,92})));
  AixLib.FastHVAC.Sensors.TemperatureSensor senT_a1 "Temperature at sink inlet"
    annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=0,
        origin={-34,92})));
  AixLib.FastHVAC.Sensors.MassFlowSensor mFlow_con
    "Mass flow sensor at the evaporator" annotation (Placement(transformation(
        origin={-80,60},
        extent={{-10,10},{10,-10}},
        rotation=0)));
equation
  ...
  connect(mFlow_con.m_flow, sigBusHP.m_flow_co) annotation (Line(points={{-80,51},
          {-80,-42.915},{-104.925,-42.915}},     color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,-6},{-3,-6}},
      horizontalAlignment=TextAlignment.Right));
  ...
  connect(innerCycle.sigBusHP, sigBusHP) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(mFlow_eva.m_flow, sigBusHP.m_flow_ev) annotation (Line(points={{70,-51},
          {70,-36},{-30,-36},{-30,-42.915},{-104.925,-42.915}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
