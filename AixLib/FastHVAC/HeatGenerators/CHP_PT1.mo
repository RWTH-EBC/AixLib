...
public
 ...
 /* *******************************************************************
  ...
  /* *******************************************************************
    ...
    AixLib.FastHVAC.BaseClasses.WorkingFluid fluidCHP(
    medium=medium,
    ...
    "1=P_el 2=dotQ_th 3=dotE_fuel" annotation (Placement(transformation(
        ...
        rotation=0,
        origin={102,56})));
  AixLib.FastHVAC.Controller.SwitchCounter switchCounter
    annotation (Placement(transformation(extent={{-50,58},{-30,78}})));
  Sensors.MassFlowSensor massFlowRate annotation (Placement(transformation(
        extent={{-11,-11},{11,11}},
        rotation=270,
        origin={-71,-11})));
  Sensors.TemperatureSensor T_flow annotation (Placement(transformation(
        extent={{-11,-13},{11,13}},
        rotation=0,
        origin={-61,-75})));
  Sensors.TemperatureSensor T_return annotation (Placement(transformation(
        extent={{-11,-13},{11,13}},
        rotation=0,
        origin={71,-75})));
  ...
  connect(massFlowRate.enthalpyPort_b, T_flow.enthalpyPort_a) annotation (Line(
    ...
    Rectangle(
        ...
        Bitmap(extent={{66,-16},{94,-100}}, fileName=
              "modelica://AixLib.FastHVAC/Images/Blitz-T-Shirts.jpg"),
        Bitmap(extent={{16,56},{74,-38}}, fileName=
              "modelica://AixLib.FastHVAC/Images/10_metaheiss.jpg"),
        Ellipse(
          extent={{-44,-52},{-36,-60}},
          lineColor={0,0,0},
...
<p>
  ...
  \"AixLib.FastHVAC.Data.CHP.BaseDataDefinition\">AixLib.FastHVAC.DataBase</a>. In this
...
<p>
  <a href=\"AixLib.FastHVAC.Examples.HeatGenerators.CHP.CHP\">CHP</a>
</p>
</html>",
  revisions="<html><ul>
  <li>
