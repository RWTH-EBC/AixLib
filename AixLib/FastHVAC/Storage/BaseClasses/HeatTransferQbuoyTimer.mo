within AixLib.FastHVAC.Storage.BaseClasses;
model HeatTransferQbuoyTimer

//  import BufferStorage = BufferStorage2;
   extends AixLib.FastHVAC.Storage.BaseClasses.PartialHeatTransferLayers;
  ...
  parameter Modelica.SIunits.ThermalConductivity lambda_water=0.64;
   parameter Modelica.SIunits.Density rho=1000
    ...
    parameter Modelica.SIunits.Time tau_refresh=900;
      ...
      function isBuoy =
      AixLib.FastHVAC.Storage.BaseClasses.QBuoyFunctions.isBuoy;

equation
  q_buoy = AixLib.FastHVAC.Storage.BaseClasses.QBuoyFunctions.qbuoyTotal(n,
    therm.T);
