within AixLib.FastHVAC.Storage;
...
public
  ...
  AixLib.FastHVAC.Storage.BaseClasses.HeatingCoil heatingCoil1(
    T_start=T_start,
    dis_HC=dis_HC1,
    hConHC=hConHC1,
    medium_HC=mediumHC1,
    ...
    pipeRecordHC=data.pipeHC1) if use_heatingCoil1 annotation (Placement(
        ...
        rotation=270,
        origin={-72,59})));
  AixLib.FastHVAC.Storage.BaseClasses.HeatingCoil heatingCoil2(
    T_start=T_start,
    dis_HC=dis_HC2,
    hConHC=hConHC2,
    medium_HC=mediumHC2,
