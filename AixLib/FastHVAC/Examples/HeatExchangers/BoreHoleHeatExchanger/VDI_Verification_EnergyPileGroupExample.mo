...
<p>
  ...
  forward and backward flow of the system. In addition, the following
  model parameters are taken from VDI 4640 for a comparison of the
  determined specific heat flow over the probe length:
</p>
<p>
  - 1 single double U-tube probe
</p>
<p>
  - Temperature over entire probe length: 11°C
</p>
<p>
  - Probe input temperature: 1°C (&gt; 0°C -&gt; VDI Appendix B4)
</p>
<p>
  - Plausible flow conditions (Re=2400)
</p>
<p>
  - Probe parameter (d_i=0.032m; d_a=0.035m, lambda=0.8W/(m.K))
</p>
<p>
  - 100m probe depth with drill hole diameter D=0,15m
</p>
<p>
  - Heat conduction of soil with lambda=2W/(m.K)
</p>
</html>"));
