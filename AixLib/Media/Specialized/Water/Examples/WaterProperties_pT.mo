...
<p>
  This example checks the thermophysical properties of the medium <a href=\"modelica://AixLib.Media.Specialized.Water.Examples.WaterProperties_pT\">AixLib.Media.Specialized.Water.Examples.WaterProperties_pT</a>.
</p></html>",revisions="<html>
<ul>
  <li>September 12, 2016, by Marcus Fuchs:<br/>
