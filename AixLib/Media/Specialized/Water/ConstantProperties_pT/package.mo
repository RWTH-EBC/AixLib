...
<p>
  This water model is similar to <a href=\"modelica://AixLib.Media.Water\">AixLib.Media.Water</a> with regard to its complexity. It also uses constant values for properties such as density and specific heat capacity. The main difference is that the constants <code>T_nominal</code> and <code>p_nominal</code> allow for user-provided nominal condition of the water model. The constant properties will be derived for this nominal condition. The maximum allowed temperature is set at the saturation temperature for the given nominal pressure <code>p_nominal</code>.
</p>
<h4>
  Assumptions and limitations
</h4>
<p>
  The nominal values for the constant medium properties are calculated using the <a href=\"modelica://Modelica.Media.Water.WaterIF97_base\">Modelica.Media.Water.WaterIF97_base</a> model.
</p>
<h4>
