...
model DetailedDerivativeCheck "Model that tests the derivative implementation"
  extends Modelica.Icons.Example;
   ...
   package Medium = AixLib.Media.Water.Detailed;
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Media/Water/Examples/DetailedDerivativeCheck.mos"
        "Simulate and plot"),
