...
model DetailedTemperatureEnthalpyInversion
  ...
  extends AixLib.Media.Examples.BaseClasses.TestTemperatureEnthalpyInversion(
    redeclare package Medium = AixLib.Media.Water.Detailed);
  annotation (
experiment(StopTime=1.0),
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Media/Water/Examples/DetailedTemperatureEnthalpyInversion.mos"
        "Simulate and plot"),
