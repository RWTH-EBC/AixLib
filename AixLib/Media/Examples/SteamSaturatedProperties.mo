...
model SteamSaturatedProperties
  ...
  package Medium = AixLib.Media.Steam  "Steam medium model";
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Media/Examples/SteamSaturatedProperties.mos"
        "Simulate and plot"),
...
the <a href=\"modelica://AixLib.Media.Steam\">
AixLib.Media.Steam</a> model (vapor phase) and the
<a href=\"modelica://AixLib.Media.Water\"> AixLib.Media.Water</a>
model (liquid phase). See <a href=\"modelica://AixLib.Media.Steam\">
AixLib.Media.Steam</a> for more information.
</p>
<p>
