...
algorithm
    ...
    x .^ (4/3) + (1438792.78172267) .* x .^ (5/3) + (-133857.617994352) .* x .^
    (6/3) + (-902180.017600717) .* x .^ (7/3) + (-812539.662160855) .* x .^ (8/3)
     + (685305.621672549) .* x .^ (9/3) + (689783.232726976) .* x .^ (10/3) + (1027396.02629172)
     .* x .^ (11/3) + (-527730.424281767) .* x .^ (12/3) + (-228779.518490116) .*
    x .^ (13/3) + (-842117.608572627) .* x .^ (14/3) + (-1110850.40019966) .* x .^
    (15/3) + (165936.295201719) .* x .^ (16/3) + (-381364.657497601) .* x .^ (17
    /3) + (1065824.60373945) .* x .^ (18/3) + (2128788.40782349) .* x .^ (19/3) +
    (577593.240467662) .* x .^ (20/3) + (1278047.43879684) .* x .^ (21/3) + (-1222329.61991827)
     .* x .^ (22/3) + (-3539546.26251493) .* x .^ (23/3) + (-3243680.19253677) .*
    x .^ (24/3) + (-168642.585698017) .* x .^ (25/3) + (4210620.55406797) .* x .^
    (26/3) + (6052566.3465585) .* x .^ (27/3) + (-5526855.61850467) .* x .^ (28/
    3));
...
algorithm
    ...
    elseif h_IIR>h_scr then //SCr
        ...
        T  :=  327.197781935892 + 20.1689191976422 *( y3*(y3*(y3*(y3*(y3*(y3*(y3*(y3*(y3*(y3*((-0.000939036255501953)*y3 + (-6.40449860099882e-06) + x3*(-0.00148696936311922))  +(0.00582909108085912) + x3*((3.08343385541494e-05)*x3 + (-0.00179434912959592)))  +(-0.00337608018566535) + x3*((-0.000857644807702166)*x3 + (0.00999079694572103)))  + (-0.0113436636739131) + x3*((-0.00118437955830187)*x3 + (0.00864417561353578)))  + (0.0240911243159528) + x3*((0.00474753441451223)*x3 + (-0.0281216242373478)))  +(0.00245224936877350) + x3*((0.00355971143102101)*x3 + (-0.0138264060178187)))  +(-0.121154138164734) + x3*((-0.00941298519624451)*x3 + (0.0472332916594976)))  + (0.104098429636939) + x3*((-0.00414526384253996)*x3 + (0.0133946337552411)))  +(0.699052912583400) + x3*((0.0106618719338033)*x3 + (-0.104950210334764)))  +(0.898533079116176) + x3*((0.00508047274963100)*x3 + (0.0233968615764063)))  +x3*((-0.0189052771014906)*x3 + (0.340880756284145)) +(-0.481681032173056));
    end if;
...
elseif s_IIR>s_scr then //SCr
    ...
    T := 327.841893249596 + 18.8072394686965 * ( y3*(y3*(y3*(y3*(y3*((0.00250865983045063)*y3 + (-0.00248824730779821) + (-8.33028706454965e-05)*x3)  +(-0.0324832922501074) + x3*((-0.000159447738460534)*x3 + (0.00222224815048957)))  +(0.0780692296275204) + x3*((0.000330749546139952)*x3 + (-0.000588009343781178)))  +(0.469370314543304) + x3*((-9.78038881600861e-05)*x3 + (-0.0223313821364520)))  +(0.796111390606469) + x3*((0.00113367299843682)*x3 + (0.0772413578677678)))  +x3*((0.00140489175581534)*x3 + (0.344735554261573)) +(-0.417723629037136));
