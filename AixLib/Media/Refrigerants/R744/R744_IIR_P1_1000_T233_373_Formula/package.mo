...
if p<7377300 then
  if s<s_bubble-ds then //SC
    ...
    y1 := (s-690.083971553611) / 257.741313505105;
  ...
  elseif s>s_dew+ds then //SH
    ...
    y2 := (s-2354.62309776343)/368.384949113833;
...
elseif s>s_scr then //SCr
    ...
    y3 := (s-2190.89392400879)/500.554575056586;
...
algorithm
 ...
 elseif T>335 then
  ...
  elseif p < fluidConstants[1].criticalPressure then
    if p > sat.psat then
