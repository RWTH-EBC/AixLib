  ...
  */
  ...
  algorithm
    ...
    if h < h_bubble - dh then
      ...
      T := (0) + (1)*(314.827695408612 + (0.0532548969281581)*x1^1 + (-0.0327402932674217)
        *x1^2 + (0.00529495748475652)*x1^3 + (-0.0147899438674052)*x1^4 + (59.7998195834653)
        *y1^1 + (-6.62177534265252)*y1^2 + (-2.9999979725331)*y1^3 + (1.18395227550521)
        *y1^4 + (2.80248047103141)*y1^5 + (-2.62761643515741)*y1^6 + (-3.56947078020548)
        *y1^7 + (0.491461507071165)*y1^8 + (0.927463043044066)*y1^9 + (-1.19878518364951)
        *y1^8*x1^1 + (-0.962577907835024)*y1^7*x1^1 + (0.878481585133851)*y1^7*
        x1^2 + (3.91182176711109)*y1^6*x1^1 + (1.04265487024909)*y1^6*x1^2 + (-0.48195831147019)
        *y1^6*x1^3 + (3.9963905002665)*y1^5*x1^1 + (-1.69733815644078)*y1^5*x1^2
         + (-0.731437549563384)*y1^5*x1^3 + (0.0770329850582095)*y1^5*x1^4 + (-1.83698529629045)
        *y1^4*x1^1 + (-2.43696481656084)*y1^4*x1^2 + (0.468070335493652)*y1^4*
        x1^3 + (0.181462921419216)*y1^4*x1^4 + (-1.82312663184436)*y1^3*x1^1 + (
        -0.0230311877679581)*y1^3*x1^2 + (0.982708752218969)*y1^3*x1^3 + (0.0536451024965748)
        *y1^3*x1^4 + (1.14817103067673)*y1^2*x1^1 + (0.640727250560578)*y1^2*x1^
        2 + (0.128969357549004)*y1^2*x1^3 + (-0.134539808379163)*y1^2*x1^4 + (1.23170727519629)
        *y1^1*x1^1 + (0.0597699698084911)*y1^1*x1^2 + (-0.129555670548255)*y1^1*
        x1^3 + (-0.0975402807270774)*y1^1*x1^4);
    elseif h > h_dew + dh then
      x2 := (p - (1719894.77673686))/(1540579.65824516);
      y2 := (h - (487589.599174287))/(53286.5415637663);
      T := (0) + (1)*(384.887228284855 + (16.0277892305806)*x2^1 + (-0.280054633259371)
        *x2^2 + (-0.0862386801135974)*x2^3 + (-0.0071872911519771)*x2^4 + (47.2999217262801)
        *y2^1 + (0.490805722850081)*y2^2 + (-0.713558854358399)*y2^3 + (0.566082948649152)
        *y2^4 + (-0.238622396379761)*y2^5 + (-0.0324190551456607)*y2^6 + (-0.0438944050163095)
        *y2^7 + (0.0198009907836571)*y2^8 + (0.00799803851910601)*y2^9 + (0.0134093429455308)
        *y2^8*x2^1 + (0.0577166163217205)*y2^7*x2^1 + (0.0250462869800139)*y2^7*
        x2^2 + (-0.112960440538396)*y2^6*x2^1 + (-0.0812221108454732)*y2^6*x2^2 +
        (0.0420737667377818)*y2^6*x2^3 + (-0.316712035692023)*y2^5*x2^1 + (0.178448516987831)
        *y2^5*x2^2 + (0.0271210785688044)*y2^5*x2^3 + (-0.0339943251927748)*y2^5
        *x2^4 + (0.731158374613456)*y2^4*x2^1 + (-0.0897688196381538)*y2^4*x2^2 +
        (-0.280726419955516)*y2^4*x2^3 + (0.0728759701359258)*y2^4*x2^4 + (-0.992211615465268)
        *y2^3*x2^1 + (-0.23122977047837)*y2^3*x2^2 + (0.108445737730122)*y2^3*
        x2^3 + (0.0618460783528747)*y2^3*x2^4 + (2.69702075193169)*y2^2*x2^1 + (
        0.0758598705853331)*y2^2*x2^2 + (0.156065701700265)*y2^2*x2^3 + (-0.14157815774677)
        *y2^2*x2^4 + (-7.61619054006736)*y2^1*x2^1 + (0.227014864995315)*y2^1*
        x2^2 + (0.0221858958030908)*y2^1*x2^3 + (0.0347674551168145)*y2^1*x2^4);
    else
      if h < h_bubble then
        x1 := (p-(3258359.21215142))/(1352817.03780238);
        y1 := (h-(258541.38494292))/(87545.3330013087);
      ...
      elseif h > h_dew then
        x2 := (p-(1719894.77673686))/(1540579.65824516);
        y2 := (h-(487589.599174287))/(53286.5415637663);
        T2 := (0) + (1) * (384.887228284855 + (16.0277892305806)*x2^1 + (-0.280054633259371)*x2^2 + (-0.0862386801135974)*x2^3 + (-0.0071872911519771)*x2^4 + (47.2999217262801)*y2^1 + (0.490805722850081)*y2^2 + (-0.713558854358399)*y2^3 + (0.566082948649152)*y2^4 + (-0.238622396379761)*y2^5 + (-0.0324190551456607)*y2^6 + (-0.0438944050163095)*y2^7 + (0.0198009907836571)*y2^8 + (0.00799803851910601)*y2^9 + (0.0134093429455308)*y2^8*x2^1 + (0.0577166163217205)*y2^7*x2^1 + (0.0250462869800139)*y2^7*x2^2 + (-0.112960440538396)*y2^6*x2^1 + (-0.0812221108454732)*y2^6*x2^2 + (0.0420737667377818)*y2^6*x2^3 + (-0.316712035692023)*y2^5*x2^1 + (0.178448516987831)*y2^5*x2^2 + (0.0271210785688044)*y2^5*x2^3 + (-0.0339943251927748)*y2^5*x2^4 + (0.731158374613456)*y2^4*x2^1 + (-0.0897688196381538)*y2^4*x2^2 + (-0.280726419955516)*y2^4*x2^3 + (0.0728759701359258)*y2^4*x2^4 + (-0.992211615465268)*y2^3*x2^1 + (-0.23122977047837)*y2^3*x2^2 + (0.108445737730122)*y2^3*x2^3 + (0.0618460783528747)*y2^3*x2^4 + (2.69702075193169)*y2^2*x2^1 + (0.0758598705853331)*y2^2*x2^2 + (0.156065701700265)*y2^2*x2^3 + (-0.14157815774677)*y2^2*x2^4 + (-7.61619054006736)*y2^1*x2^1 + (0.227014864995315)*y2^1*x2^2 + (0.0221858958030908)*y2^1*x2^3 + (0.0347674551168145)*y2^1*x2^4);
  ...
  algorithm
    ...
    if s < s_bubble - ds then
      ...
      T := (0) + (1)*(300.587264376628 + (0.94996237530845)*x1^1 + (0.303157516353388)
        *x1^2 + (0.0425905424516415)*x1^3 + (-0.00612110456282157)*x1^4 + (52.1272715438709)
        *y1^1 + (0.934991565642564)*y1^2 + (-1.66612434799561)*y1^3 + (-1.27792380300538)
        *y1^4 + (0.410987961018363)*y1^5 + (1.20370954075399)*y1^6 + (-0.533205810766702)
        *y1^7 + (-1.00320676865041)*y1^8 + (0.0173571141739969)*y1^9 + (0.180140992292161)
        *y1^10 + (-0.291069659186083)*y1^9*x1^1 + (-0.0872169090380506)*y1^8*x1^
        1 + (0.210931565927688)*y1^8*x1^2 + (1.54473840594432)*y1^7*x1^1 + (0.242658047959267)
        *y1^7*x1^2 + (-0.125471470126885)*y1^7*x1^3 + (1.27724167635143)*y1^6*
        x1^1 + (-0.749529598236941)*y1^6*x1^2 + (-0.260793835526211)*y1^6*x1^3 +
        (0.0285723567918958)*y1^6*x1^4 + (-1.20931903922332)*y1^5*x1^1 + (-1.20679390142769)
        *y1^5*x1^2 + (0.14579825633924)*y1^5*x1^3 + (0.0761667567718539)*y1^5*
        x1^4 + (-0.980601828987551)*y1^4*x1^1 + (-0.0414786123544972)*y1^4*x1^2 +
        (0.67239714034787)*y1^4*x1^3 + (0.0115047530756927)*y1^4*x1^4 + (0.633536586430794)
        *y1^3*x1^1 + (0.603963042415619)*y1^3*x1^2 + (0.449251036040618)*y1^3*
        x1^3 + (-0.143342451130932)*y1^3*x1^4 + (0.739997965709238)*y1^2*x1^1 +
        (0.284571979372862)*y1^2*x1^2 + (0.00615406154781733)*y1^2*x1^3 + (-0.170430522133426)
        *y1^2*x1^4 + (0.674829627189691)*y1^1*x1^1 + (0.191394330126145)*y1^1*
        x1^2 + (-0.041146019162364)*y1^1*x1^3 + (-0.0717852001683681)*y1^1*x1^4);
    elseif s > s_dew + ds then
      x2 := (log(p) - (13.8189946103085))/(1.11267159199945);
      y2 := (s - (1922.29441435659))/(150.020162361676);
      T := (0) + (1)*(381.756235490692 + (41.4905130939605)*x2^1 + (3.41590400716243)
        *x2^2 + (0.760857020511076)*x2^3 + (0.0927368036952897)*x2^4 + (54.6329364654732)
        *y2^1 + (3.07932837439632)*y2^2 + (-0.540549385737291)*y2^3 + (-0.185089008021239)
        *y2^4 + (0.0805350377484417)*y2^5 + (0.171967336761961)*y2^6 + (-0.108037463310497)
        *y2^7 + (-0.0760413932705522)*y2^8 + (0.0282575996944983)*y2^9 + (0.0160863341328156)
        *y2^10 + (0.0707699435032942)*y2^9*x2^1 + (0.087348047848133)*y2^8*x2^1 +
        (0.109300099544007)*y2^8*x2^2 + (-0.203423350021696)*y2^7*x2^1 + (0.114835359401901)
        *y2^7*x2^2 + (0.0563237562569882)*y2^7*x2^3 + (-0.209781147375106)*y2^6*
        x2^1 + (-0.147738404297775)*y2^6*x2^2 + (0.0818156706212271)*y2^6*x2^3 +
        (-0.0227654525969673)*y2^6*x2^4 + (0.189614068719873)*y2^5*x2^1 + (-0.285137989158683)
        *y2^5*x2^2 + (0.0693938477347246)*y2^5*x2^3 + (0.138511562432481)*y2^5*
        x2^4 + (0.221582811766985)*y2^4*x2^1 + (0.3964599089687)*y2^4*x2^2 + (0.0314109655481778)
        *y2^4*x2^3 + (0.0269980519937071)*y2^4*x2^4 + (-0.541168587069816)*y2^3*
        x2^1 + (0.106993860907924)*y2^3*x2^2 + (-0.0698110113090461)*y2^3*x2^3 +
        (-0.143359623566139)*y2^3*x2^4 + (0.588543861114898)*y2^2*x2^1 + (-0.143744012868645)
        *y2^2*x2^2 + (0.0457917549005302)*y2^2*x2^3 + (0.0609784328464427)*y2^2*
        x2^4 + (-0.815549708454031)*y2^1*x2^1 + (-1.45794185345551)*y2^1*x2^2 +
        (-0.446632414584788)*y2^1*x2^3 + (-0.0359193897064731)*y2^1*x2^4);
    else
      if s < s_bubble then
        x1 := (log(p)-(14.7875365886205))/(0.663511063673611);
        y1 := (s-(1126.31192475932))/(244.853512874793);
      ...
      elseif s > s_dew then
        x2 := (log(p)-(13.8189946103085))/(1.11267159199945);
        y2 := (s-(1922.29441435659))/(150.020162361676);
        T2 := (0) + (1) * (381.756235490692 + (41.4905130939605)*x2^1 + (3.41590400716243)*x2^2 + (0.760857020511076)*x2^3 + (0.0927368036952897)*x2^4 + (54.6329364654732)*y2^1 + (3.07932837439632)*y2^2 + (-0.540549385737291)*y2^3 + (-0.185089008021239)*y2^4 + (0.0805350377484417)*y2^5 + (0.171967336761961)*y2^6 + (-0.108037463310497)*y2^7 + (-0.0760413932705522)*y2^8 + (0.0282575996944983)*y2^9 + (0.0160863341328156)*y2^10 + (0.0707699435032942)*y2^9*x2^1 + (0.087348047848133)*y2^8*x2^1 + (0.109300099544007)*y2^8*x2^2 + (-0.203423350021696)*y2^7*x2^1 + (0.114835359401901)*y2^7*x2^2 + (0.0563237562569882)*y2^7*x2^3 + (-0.209781147375106)*y2^6*x2^1 + (-0.147738404297775)*y2^6*x2^2 + (0.0818156706212271)*y2^6*x2^3 + (-0.0227654525969673)*y2^6*x2^4 + (0.189614068719873)*y2^5*x2^1 + (-0.285137989158683)*y2^5*x2^2 + (0.0693938477347246)*y2^5*x2^3 + (0.138511562432481)*y2^5*x2^4 + (0.221582811766985)*y2^4*x2^1 + (0.3964599089687)*y2^4*x2^2 + (0.0314109655481778)*y2^4*x2^3 + (0.0269980519937071)*y2^4*x2^4 + (-0.541168587069816)*y2^3*x2^1 + (0.106993860907924)*y2^3*x2^2 + (-0.0698110113090461)*y2^3*x2^3 + (-0.143359623566139)*y2^3*x2^4 + (0.588543861114898)*y2^2*x2^1 + (-0.143744012868645)*y2^2*x2^2 + (0.0457917549005302)*y2^2*x2^3 + (0.0609784328464427)*y2^2*x2^4 + (-0.815549708454031)*y2^1*x2^1 + (-1.45794185345551)*y2^1*x2^2 + (-0.446632414584788)*y2^1*x2^3 + (-0.0359193897064731)*y2^1*x2^4);
  ...
  algorithm
    if p < sat.psat - dp then
      ...
      d := (0) + (0.999)*(76.9824520822144 + (53.5948897532093)*x1^1 + (7.59950591538574)
        *x1^2 + (3.51118774475011)*x1^3 + (3.8538650913542)*x1^4 + (-4.13860201411395)
        *x1^5 + (-7.31163962690073)*x1^6 + (5.10456118569183)*x1^7 + (7.57062104040729)
        *x1^8 + (-3.00786021671651)*x1^9 + (-3.95227298587599)*x1^10 + (0.884229177904279)
        *x1^11 + (1.00676471744864)*x1^12 + (-0.118477324245665)*x1^13 + (-0.0996336579192435)
        *x1^14 + (0.00496385659820933)*x1^15 + (-17.2338779008828)*y1^1 + (5.96838352276987)
        *y1^2 + (-1.96990781124985)*y1^3 + (0.860773677118076)*y1^4 + (-1.38129604768092)
        *y1^5 + (1.05303629161267)*y1^6 + (-0.250177147477056)*y1^7 + (0.0904149813293892)
        *x1^14*y1^1 + (0.378557137393641)*x1^13*y1^1 + (-0.232936293595214)*x1^13
        *y1^2 + (-0.54161289449382)*x1^12*y1^1 + (-0.777472588825111)*x1^12*y1^2
         + (0.337541058656876)*x1^12*y1^3 + (-3.42418016477856)*x1^11*y1^1 + (1.40711615984606)
        *x1^11*y1^2 + (0.901954879976998)*x1^11*y1^3 + (-0.295780158398361)*x1^11
        *y1^4 + (0.250932789822737)*x1^10*y1^1 + (6.71784911464534)*x1^10*y1^2 +
        (-2.58104210458268)*x1^10*y1^3 + (-0.353095371377448)*x1^10*y1^4 + (0.109258743833424)
        *x1^10*y1^5 + (11.3674854801103)*x1^9*y1^1 + (-0.24100586534812)*x1^9*
        y1^2 + (-9.43257389403552)*x1^9*y1^3 + (4.13198056708439)*x1^9*y1^4 + (-0.662773449733226)
        *x1^9*y1^5 + (0.0873657394323733)*x1^9*y1^6 + (3.72874057740284)*x1^8*
        y1^1 + (-18.0684968035889)*x1^8*y1^2 + (-1.02736427835427)*x1^8*y1^3 + (
        11.0859059271659)*x1^8*y1^4 + (-5.34005227957268)*x1^8*y1^5 + (1.1239073056808)
        *x1^8*y1^6 + (-0.0905194738550183)*x1^8*y1^7 + (-17.3498916410814)*x1^7*
        y1^1 + (-6.89936938532347)*x1^7*y1^2 + (17.2496031022842)*x1^7*y1^3 + (4.61220596628886)
        *x1^7*y1^4 + (-10.4831155876196)*x1^7*y1^5 + (4.10636344712901)*x1^7*y1^
        6 + (-0.574654786257368)*x1^7*y1^7 + (-8.19211033235535)*x1^6*y1^1 + (21.9623284600454)
        *x1^6*y1^2 + (4.60493299702452)*x1^6*y1^3 + (-7.28407246963353)*x1^6*y1^
        4 + (-6.88629775954955)*x1^6*y1^5 + (6.15298739803927)*x1^6*y1^6 + (-1.26699986159215)
        *x1^6*y1^7 + (12.2668340658702)*x1^5*y1^1 + (12.7020798185675)*x1^5*y1^2
         + (-21.6362920291809)*x1^5*y1^3 + (4.96646189941888)*x1^5*y1^4 + (-3.32186844859451)
        *x1^5*y1^5 + (4.09247094120152)*x1^5*y1^6 + (-1.08772960672421)*x1^5*y1^
        7 + (5.02733224655341)*x1^4*y1^1 + (-9.69224046961466)*x1^4*y1^2 + (-14.9010971810094)
        *x1^4*y1^3 + (23.7274145116731)*x1^4*y1^4 + (-12.0884385008997)*x1^4*y1^
        5 + (3.2724171777264)*x1^4*y1^6 + (-0.432684729684214)*x1^4*y1^7 + (-7.55320145162013)
        *x1^3*y1^1 + (-3.31426058299345)*x1^3*y1^2 + (0.246208285395598)*x1^3*
        y1^3 + (18.6394346305447)*x1^3*y1^4 + (-18.7150447960026)*x1^3*y1^5 + (6.96390379920541)
        *x1^3*y1^6 + (-0.943830197559171)*x1^3*y1^7 + (-11.617503923793)*x1^2*
        y1^1 + (9.23371478617744)*x1^2*y1^2 + (-1.4012143507501)*x1^2*y1^3 + (6.45196526586939)
        *x1^2*y1^4 + (-13.3549214683021)*x1^2*y1^5 + (8.13509500053135)*x1^2*y1^
        6 + (-1.61487572873515)*x1^2*y1^7 + (-19.6799555257834)*x1^1*y1^1 + (11.080291384742)
        *x1^1*y1^2 + (-4.07186139946364)*x1^1*y1^3 + (2.38623731064217)*x1^1*y1^
        4 + (-5.76455751192622)*x1^1*y1^5 + (4.47709584394524)*x1^1*y1^6 + (-1.04093863930973)
        *x1^1*y1^7);
    elseif p > sat.psat + dp then
      x2 := (p - (3067141.02087822))/(1250016.64160742);
      y2 := (T - (306.333739723678))/(39.7052211222868);
      d := (0) + (1.007596524)*(1189.94427795653 + (7.87433412548864)*x2^1 + (-0.393021216688428)
        *x2^2 + (-0.0297809665090564)*x2^3 + (-152.964391932951)*y2^1 + (-26.5844725397398)
        *y2^2 + (-13.2573880132147)*y2^3 + (8.42443025706179)*y2^4 + (14.2596863645139)
        *y2^5 + (-18.3785897660491)*y2^6 + (-24.8669510003648)*y2^7 + (7.78387180871463)
        *y2^8 + (15.7146697953855)*y2^9 + (0.681093877003925)*y2^10 + (-3.80893784483356)
        *y2^11 + (-1.02415118562434)*y2^12 + (2.06494548963484)*y2^11*x2^1 + (7.57753444222479)
        *y2^10*x2^1 + (-1.26044732839976)*y2^10*x2^2 + (0.305045780960498)*y2^9*
        x2^1 + (-5.16251152860913)*y2^9*x2^2 + (0.227139340077688)*y2^9*x2^3 + (
        -24.4943337560739)*y2^8*x2^1 + (-2.88562398358126)*y2^8*x2^2 + (1.13671327198115)
        *y2^8*x2^3 + (-14.5056545529004)*y2^7*x2^1 + (11.723519090061)*y2^7*x2^2
         + (1.48106761398927)*y2^7*x2^3 + (28.7134548150431)*y2^6*x2^1 + (12.5950803196686)
        *y2^6*x2^2 + (-1.02019713556307)*y2^6*x2^3 + (22.307603797593)*y2^5*x2^1
         + (-8.24807441103373)*y2^5*x2^2 + (-3.24960897757928)*y2^5*x2^3 + (-10.5027246393796)
        *y2^4*x2^1 + (-12.0818129588016)*y2^4*x2^2 + (-0.922165432363117)*y2^4*
        x2^3 + (-6.49123842323816)*y2^3*x2^1 + (0.746728622500784)*y2^3*x2^2 + (
        1.59789449316334)*y2^3*x2^3 + (5.70882420483716)*y2^2*x2^1 + (2.56319794925055)
        *y2^2*x2^2 + (0.824892590067656)*y2^2*x2^3 + (7.146645111271)*y2^1*x2^1 +
        (-0.411530121945932)*y2^1*x2^2 + (-0.0588201589015566)*y2^1*x2^3);
    else
      if p < sat.psat then
        x1 := (p-(2016798.31335388))/(1139245.87751285);
        y1 := (T-(388.187521019938))/(44.8108150330116);
        d1 := (0) + (0.999) * (76.9824520822144 + (53.5948897532093)*x1^1 + (7.59950591538574)*x1^2 + (3.51118774475011)*x1^3 + (3.8538650913542)*x1^4 + (-4.13860201411395)*x1^5 + (-7.31163962690073)*x1^6 + (5.10456118569183)*x1^7 + (7.57062104040729)*x1^8 + (-3.00786021671651)*x1^9 + (-3.95227298587599)*x1^10 + (0.884229177904279)*x1^11 + (1.00676471744864)*x1^12 + (-0.118477324245665)*x1^13 + (-0.0996336579192435)*x1^14 + (0.00496385659820933)*x1^15 + (-17.2338779008828)*y1^1 + (5.96838352276987)*y1^2 + (-1.96990781124985)*y1^3 + (0.860773677118076)*y1^4 + (-1.38129604768092)*y1^5 + (1.05303629161267)*y1^6 + (-0.250177147477056)*y1^7 + (0.0904149813293892)*x1^14*y1^1 + (0.378557137393641)*x1^13*y1^1 + (-0.232936293595214)*x1^13*y1^2 + (-0.54161289449382)*x1^12*y1^1 + (-0.777472588825111)*x1^12*y1^2 + (0.337541058656876)*x1^12*y1^3 + (-3.42418016477856)*x1^11*y1^1 + (1.40711615984606)*x1^11*y1^2 + (0.901954879976998)*x1^11*y1^3 + (-0.295780158398361)*x1^11*y1^4 + (0.250932789822737)*x1^10*y1^1 + (6.71784911464534)*x1^10*y1^2 + (-2.58104210458268)*x1^10*y1^3 + (-0.353095371377448)*x1^10*y1^4 + (0.109258743833424)*x1^10*y1^5 + (11.3674854801103)*x1^9*y1^1 + (-0.24100586534812)*x1^9*y1^2 + (-9.43257389403552)*x1^9*y1^3 + (4.13198056708439)*x1^9*y1^4 + (-0.662773449733226)*x1^9*y1^5 + (0.0873657394323733)*x1^9*y1^6 + (3.72874057740284)*x1^8*y1^1 + (-18.0684968035889)*x1^8*y1^2 + (-1.02736427835427)*x1^8*y1^3 + (11.0859059271659)*x1^8*y1^4 + (-5.34005227957268)*x1^8*y1^5 + (1.1239073056808)*x1^8*y1^6 + (-0.0905194738550183)*x1^8*y1^7 + (-17.3498916410814)*x1^7*y1^1 + (-6.89936938532347)*x1^7*y1^2 + (17.2496031022842)*x1^7*y1^3 + (4.61220596628886)*x1^7*y1^4 + (-10.4831155876196)*x1^7*y1^5 + (4.10636344712901)*x1^7*y1^6 + (-0.574654786257368)*x1^7*y1^7 + (-8.19211033235535)*x1^6*y1^1 + (21.9623284600454)*x1^6*y1^2 + (4.60493299702452)*x1^6*y1^3 + (-7.28407246963353)*x1^6*y1^4 + (-6.88629775954955)*x1^6*y1^5 + (6.15298739803927)*x1^6*y1^6 + (-1.26699986159215)*x1^6*y1^7 + (12.2668340658702)*x1^5*y1^1 + (12.7020798185675)*x1^5*y1^2 + (-21.6362920291809)*x1^5*y1^3 + (4.96646189941888)*x1^5*y1^4 + (-3.32186844859451)*x1^5*y1^5 + (4.09247094120152)*x1^5*y1^6 + (-1.08772960672421)*x1^5*y1^7 + (5.02733224655341)*x1^4*y1^1 + (-9.69224046961466)*x1^4*y1^2 + (-14.9010971810094)*x1^4*y1^3 + (23.7274145116731)*x1^4*y1^4 + (-12.0884385008997)*x1^4*y1^5 + (3.2724171777264)*x1^4*y1^6 + (-0.432684729684214)*x1^4*y1^7 + (-7.55320145162013)*x1^3*y1^1 + (-3.31426058299345)*x1^3*y1^2 + (0.246208285395598)*x1^3*y1^3 + (18.6394346305447)*x1^3*y1^4 + (-18.7150447960026)*x1^3*y1^5 + (6.96390379920541)*x1^3*y1^6 + (-0.943830197559171)*x1^3*y1^7 + (-11.617503923793)*x1^2*y1^1 + (9.23371478617744)*x1^2*y1^2 + (-1.4012143507501)*x1^2*y1^3 + (6.45196526586939)*x1^2*y1^4 + (-13.3549214683021)*x1^2*y1^5 + (8.13509500053135)*x1^2*y1^6 + (-1.61487572873515)*x1^2*y1^7 + (-19.6799555257834)*x1^1*y1^1 + (11.080291384742)*x1^1*y1^2 + (-4.07186139946364)*x1^1*y1^3 + (2.38623731064217)*x1^1*y1^4 + (-5.76455751192622)*x1^1*y1^5 + (4.47709584394524)*x1^1*y1^6 + (-1.04093863930973)*x1^1*y1^7);
