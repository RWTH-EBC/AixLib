...
model RefrigerantFittedFormulasR744
  "Model that checks the fitted formulas of R744"
  ...
  //
  parameter Modelica.SIunits.SpecificEnthalpy h_min = 180e3-505.8414680723884e+03
  ...
  parameter Modelica.SIunits.SpecificEnthalpy h_max = 550e3-505.8414680723884e+03
    ...
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.SpecificEntropy s_min = 0.50e3-2.736808957627727e3
    "Fluid limit: Minimum specific entropy"
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.SpecificEntropy s_max = 3e3-2.736808957627727e3
    "Fluid limit: Maximum specific entropy"
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.Density d_min = 20.0
    "Fluid limit: Minimum density"
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.Density d_max = 1125
    "Fluid limit: Maximum density"
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.AbsolutePressure p_min = 10e5
    "Fluid limit: Minimum absolute pressure"
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.AbsolutePressure p_max = 7377300
    "Fluid limit: Maximum absolute pressure"
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.Temperature T_min = 233.15
    "Fluid limit: Minimum temperature"
    annotation (Dialog(group="Fluid limits"));
  parameter Modelica.SIunits.Temperature T_max = 304.1282
  ...
  properties.T_psExt = extProp.y[25];
   ...
   annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)),
             experiment(StopTime=6400, Tolerance=1e-006),
...
end RefrigerantFittedFormulasR744;
