...
model RefrigerantsDerivativesR744
  "Model that checks the implementation of derivatives for R744"
  ...
  //
  parameter MediumInt.AbsolutePressure p0=7000000
    "Fixed pressure for calculations at initialization";
  parameter MediumInt.Density d0=1100
...
end RefrigerantsDerivativesR744;
