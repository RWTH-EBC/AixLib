within AixLib.Media.Refrigerants.R718;
package R718_FstImp "Refrigerant model developed by Engelpracht"
  ...
  */
  constant Modelica.Media.Interfaces.PartialTwoPhaseMedium.FluidConstants[1]
    refrigerantConstants(
     ...
     each hasCriticalData=true) "Thermodynamic constants for R718";
  ...
  */
  redeclare record EoS
    ...
    extends AixLib.DataBase.Media.Refrigerants.R718.EoS_Engelpracht;
  end EoS;

  redeclare record BDSP
    "Record that contains fitting coefficients of the state properties at bubble
    and dew lines"
    extends AixLib.DataBase.Media.Refrigerants.R718.BDSP_Engelpracht;
  end BDSP;
  ...
  redeclare record TSP
    ...
    extends AixLib.DataBase.Media.Refrigerants.R718.TSP_Engelpracht;
  end TSP;
