...
<table>
  <caption>
    ...
    <p>
      ...
      obtained from the Helmholtz equation of state. They found out
      that relative error of the refrigerant model compared to
      HelmholtzMedia (Thorade and Saadat, 2012) is close to zero.
    </p>
    <h4>
      References
    </h4>
    ...
    <p>
      ...
      Functional Form. In: <i>J. Phys. Chem. Ref. Data, Vol. 35, No.
      3</i>, S. 1415-1442
    </p>
  </caption>
</table>
