  ...
  */
  ...
  algorithm
    ...
    h_bubble := bubbleEnthalpy(sat=setSat_p(p=p));
     ...
     elseif h > h_dew + dh then
       ...
       T := (0) + (1) * (355.510911331556 + (18.9181570336269)*x2^1 + (-1.4460957111986)*x2^2 + (0.128879370267952)*x2^3 + (-0.0378180176318431)*x2^4 + (0.00571427728154803)*x2^5 + (48.7849078146379)*y2^1 + (1.59922925673916)*y2^2 + (-1.30007177175693)*y2^3 + (0.373024232467583)*y2^4 + (-0.0468655416614089)*y2^5 + (0.0305368941798241)*y2^6 + (-0.0318835866306795)*y2^7 + (0.0140533923437734)*y2^8 + (-0.0040237368844822)*y2^9 + (0.000664861068806102)*y2^10 + (0.000468436089337861)*y2^9*x2^1 + (-0.00398289557684647)*y2^8*x2^1 + (-0.00632335505692255)*y2^8*x2^2 + (0.0457897081241502)*y2^7*x2^1 + (0.0447110011535857)*y2^7*x2^2 + (-0.0272344003138221)*y2^7*x2^3 + (-0.133688844832315)*y2^6*x2^1 + (-0.0432943953851347)*y2^6*x2^2 + (0.114342018012712)*y2^6*x2^3 + (-0.0273374878631007)*y2^6*x2^4 + (0.055161676993571)*y2^5*x2^1 + (-0.121948064385487)*y2^5*x2^2 + (-0.0987734536871835)*y2^5*x2^3 + (0.0992382178078569)*y2^5*x2^4 + (-0.0111860675691328)*y2^5*x2^5 + (0.228460205670602)*y2^4*x2^1 + (0.0584811624438732)*y2^4*x2^2 + (-0.0574573938569313)*y2^4*x2^3 + (-0.091975243010589)*y2^4*x2^4 + (0.0295616887105625)*y2^4*x2^5 + (-0.680869863314376)*y2^3*x2^1 + (0.50926697462963)*y2^3*x2^2 + (-0.0638816419306195)*y2^3*x2^3 + (0.0306063416218453)*y2^3*x2^4 + (-0.0281126961811652)*y2^3*x2^5 + (2.70679496102607)*y2^2*x2^1 + (-1.04932002479848)*y2^2*x2^2 + (0.328793925176839)*y2^2*x2^3 + (-0.104611635551803)*y2^2*x2^4 + (0.0291925169706824)*y2^2*x2^5 + (-8.72511614453892)*y2^1*x2^1 + (1.4613603371237)*y2^1*x2^2 + (-0.303189728394237)*y2^1*x2^3 + (0.127239121598212)*y2^1*x2^4 + (-0.0253808809174481)*y2^1*x2^5);
     else
       if h < h_bubble then
         x1 := (p -3.386089757408981e+06)/1.327435555967400e+06;
       ...
       elseif h > h_dew then
         ...
         T2 := (0) + (1) * (355.510911331556 + (18.9181570336269)*x2^1 + (-1.4460957111986)*x2^2 + (0.128879370267952)*x2^3 + (-0.0378180176318431)*x2^4 + (0.00571427728154803)*x2^5 + (48.7849078146379)*y2^1 + (1.59922925673916)*y2^2 + (-1.30007177175693)*y2^3 + (0.373024232467583)*y2^4 + (-0.0468655416614089)*y2^5 + (0.0305368941798241)*y2^6 + (-0.0318835866306795)*y2^7 + (0.0140533923437734)*y2^8 + (-0.0040237368844822)*y2^9 + (0.000664861068806102)*y2^10 + (0.000468436089337861)*y2^9*x2^1 + (-0.00398289557684647)*y2^8*x2^1 + (-0.00632335505692255)*y2^8*x2^2 + (0.0457897081241502)*y2^7*x2^1 + (0.0447110011535857)*y2^7*x2^2 + (-0.0272344003138221)*y2^7*x2^3 + (-0.133688844832315)*y2^6*x2^1 + (-0.0432943953851347)*y2^6*x2^2 + (0.114342018012712)*y2^6*x2^3 + (-0.0273374878631007)*y2^6*x2^4 + (0.055161676993571)*y2^5*x2^1 + (-0.121948064385487)*y2^5*x2^2 + (-0.0987734536871835)*y2^5*x2^3 + (0.0992382178078569)*y2^5*x2^4 + (-0.0111860675691328)*y2^5*x2^5 + (0.228460205670602)*y2^4*x2^1 + (0.0584811624438732)*y2^4*x2^2 + (-0.0574573938569313)*y2^4*x2^3 + (-0.091975243010589)*y2^4*x2^4 + (0.0295616887105625)*y2^4*x2^5 + (-0.680869863314376)*y2^3*x2^1 + (0.50926697462963)*y2^3*x2^2 + (-0.0638816419306195)*y2^3*x2^3 + (0.0306063416218453)*y2^3*x2^4 + (-0.0281126961811652)*y2^3*x2^5 + (2.70679496102607)*y2^2*x2^1 + (-1.04932002479848)*y2^2*x2^2 + (0.328793925176839)*y2^2*x2^3 + (-0.104611635551803)*y2^2*x2^4 + (0.0291925169706824)*y2^2*x2^5 + (-8.72511614453892)*y2^1*x2^1 + (1.4613603371237)*y2^1*x2^2 + (-0.303189728394237)*y2^1*x2^3 + (0.127239121598212)*y2^1*x2^4 + (-0.0253808809174481)*y2^1*x2^5);
  ...
  algorithm
    ...
    s_bubble := bubbleEntropy(sat=setSat_p(p=p));
     ...
     if s < s_bubble - ds then
       ...
       T := (0) + (1) * (285.694699667815 + (1.02968381585158)*x1^1 + (0.275193128445195)*x1^2 + (0.043941556562575)*x1^3 + (0.00203028958902996)*x1^4 + (39.25784184622)*y1^1 + (-0.538203800364751)*y1^2 + (-1.35891209361109)*y1^3 + (-0.37547776638412)*y1^4 + (0.103684161622761)*y1^5 + (-0.0674005888547959)*y1^6 + (-0.287988292846959)*y1^7 + (-0.115330088394623)*y1^8 + (0.0316726651980843)*y1^9 + (0.0176359573966827)*y1^10 + (-0.0164121223780564)*y1^9*x1^1 + (-0.021049391159093)*y1^8*x1^1 + (0.00964207302480855)*y1^8*x1^2 + (0.160836146227042)*y1^7*x1^1 + (0.00446666151932734)*y1^7*x1^2 + (0.000448400580450467)*y1^7*x1^3 + (0.407078466782749)*y1^6*x1^1 + (-0.136779662319749)*y1^6*x1^2 + (0.0237831303795189)*y1^6*x1^3 + (-0.00184914832370402)*y1^6*x1^4 + (0.232664909912497)*y1^5*x1^1 + (-0.331019995172275)*y1^5*x1^2 + (0.113054265723455)*y1^5*x1^3 + (-0.0155224543284392)*y1^5*x1^4 + (-0.0570300608606503)*y1^4*x1^1 + (-0.226383454966623)*y1^4*x1^2 + (0.202926583202097)*y1^4*x1^3 + (-0.0489805912413537)*y1^4*x1^4 + (0.118289457566212)*y1^3*x1^1 + (0.0619867405719159)*y1^3*x1^2 + (0.156042986921594)*y1^3*x1^3 + (-0.0744032871840306)*y1^3*x1^4 + (0.444334054359482)*y1^2*x1^1 + (0.159824750585592)*y1^2*x1^2 + (0.0432588380531332)*y1^2*x1^3 + (-0.0560518828539283)*y1^2*x1^4 + (0.712211978720827)*y1^1*x1^1 + (0.181304075574015)*y1^1*x1^2 + (0.0174579733698449)*y1^1*x1^3 + (-0.0169796856907351)*y1^1*x1^4);
     elseif s > s_dew + ds then
       x2 := (log(p)-13.907966429457247)/1.059628190402793;
       y2 := (s-2.089844878394273e+03+70.6)/1.777751615173121e+02;
       T := (0) + (1) * (353.111903524476 + (53.4524886207332)*x2^1 + (3.46209163015464)*x2^2 + (0.444680383304694)*x2^3 + (0.0553158085523391)*x2^4 + (-0.0022349731521148)*x2^5 + (63.6083149561675)*y2^1 + (5.49531435397497)*y2^2 + (-1.01356267291782)*y2^3 + (0.222438139282022)*y2^4 + (-0.0146570062631716)*y2^5 + (0.0246783900765901)*y2^6 + (-0.0147428202029603)*y2^7 + (0.00448954787158712)*y2^8 + (-0.00741437901373733)*y2^9 + (0.00310380139642257)*y2^10 + (0.0194055969657806)*y2^9*x2^1 + (-0.0495407606347934)*y2^8*x2^1 + (0.0444292560081583)*y2^8*x2^2 + (0.0182958707394186)*y2^7*x2^1 + (-0.108929463221465)*y2^7*x2^2 + (0.0515888927719554)*y2^7*x2^3 + (0.00783052006384202)*y2^6*x2^1 + (0.026192048061914)*y2^6*x2^2 + (-0.124013449981662)*y2^6*x2^3 + (0.0317260816164067)*y2^6*x2^4 + (0.0244430826926872)*y2^5*x2^1 + (0.0578445265137205)*y2^5*x2^2 + (0.0286564869346609)*y2^5*x2^3 + (-0.0757790985121584)*y2^5*x2^4 + (0.0102448430800938)*y2^5*x2^5 + (-0.0135671197103399)*y2^4*x2^1 + (0.021117616150203)*y2^4*x2^2 + (0.0836942132317105)*y2^4*x2^3 + (0.0165057054764454)*y2^4*x2^4 + (-0.0321874526720959)*y2^4*x2^5 + (0.023140444373838)*y2^3*x2^1 + (-0.0746327014360172)*y2^3*x2^2 + (-0.0451392647684845)*y2^3*x2^3 + (0.0413756294930583)*y2^3*x2^4 + (0.0266983160352966)*y2^3*x2^5 + (0.377843086012363)*y2^2*x2^1 + (0.301141558843086)*y2^2*x2^2 + (0.0245140368245663)*y2^2*x2^3 + (-0.00918454208336028)*y2^2*x2^4 + (-0.00255059969916032)*y2^2*x2^5 + (1.34811712218406)*y2^1*x2^1 + (-0.992980687409664)*y2^1*x2^2 + (-0.0925350619257881)*y2^1*x2^3 + (0.00577747037367436)*y2^1*x2^4 + (0.00482444147971987)*y2^1*x2^5);
     else
       if s < s_bubble then
        x1 := (log(p)-14.868246454896550)/0.572967793317542;
        y1 := (s-1.133256902616489e+03+71)/2.147250379807040e+02;
       ...
       elseif s > s_dew then
         x2 := (log(p)-13.907966429457247)/1.059628190402793;
         y2 := (s-2.089844878394273e+03+70.6)/1.777751615173121e+02;
         T2 := (0) + (1) * (353.111903524476 + (53.4524886207332)*x2^1 + (3.46209163015464)*x2^2 + (0.444680383304694)*x2^3 + (0.0553158085523391)*x2^4 + (-0.0022349731521148)*x2^5 + (63.6083149561675)*y2^1 + (5.49531435397497)*y2^2 + (-1.01356267291782)*y2^3 + (0.222438139282022)*y2^4 + (-0.0146570062631716)*y2^5 + (0.0246783900765901)*y2^6 + (-0.0147428202029603)*y2^7 + (0.00448954787158712)*y2^8 + (-0.00741437901373733)*y2^9 + (0.00310380139642257)*y2^10 + (0.0194055969657806)*y2^9*x2^1 + (-0.0495407606347934)*y2^8*x2^1 + (0.0444292560081583)*y2^8*x2^2 + (0.0182958707394186)*y2^7*x2^1 + (-0.108929463221465)*y2^7*x2^2 + (0.0515888927719554)*y2^7*x2^3 + (0.00783052006384202)*y2^6*x2^1 + (0.026192048061914)*y2^6*x2^2 + (-0.124013449981662)*y2^6*x2^3 + (0.0317260816164067)*y2^6*x2^4 + (0.0244430826926872)*y2^5*x2^1 + (0.0578445265137205)*y2^5*x2^2 + (0.0286564869346609)*y2^5*x2^3 + (-0.0757790985121584)*y2^5*x2^4 + (0.0102448430800938)*y2^5*x2^5 + (-0.0135671197103399)*y2^4*x2^1 + (0.021117616150203)*y2^4*x2^2 + (0.0836942132317105)*y2^4*x2^3 + (0.0165057054764454)*y2^4*x2^4 + (-0.0321874526720959)*y2^4*x2^5 + (0.023140444373838)*y2^3*x2^1 + (-0.0746327014360172)*y2^3*x2^2 + (-0.0451392647684845)*y2^3*x2^3 + (0.0413756294930583)*y2^3*x2^4 + (0.0266983160352966)*y2^3*x2^5 + (0.377843086012363)*y2^2*x2^1 + (0.301141558843086)*y2^2*x2^2 + (0.0245140368245663)*y2^2*x2^3 + (-0.00918454208336028)*y2^2*x2^4 + (-0.00255059969916032)*y2^2*x2^5 + (1.34811712218406)*y2^1*x2^1 + (-0.992980687409664)*y2^1*x2^2 + (-0.0925350619257881)*y2^1*x2^3 + (0.00577747037367436)*y2^1*x2^4 + (0.00482444147971987)*y2^1*x2^5);
  ...
  algorithm
    if p < sat.psat - dp then
      ...
      d := (0) + (1)*(84.139999758958 + (67.6100707083323)*x1^1 + (18.8214831219552)
        *x1^2 + (7.88742448104687)*x1^3 + (4.84880513849624)*x1^4 + (5.26283636517838)
        *x1^5 + (3.02091398421476)*x1^6 + (-0.704366042615507)*x1^7 + (-0.760435798997538)
        *x1^8 + (0.914800113049461)*x1^9 + (0.963585468711737)*x1^10 + (0.274216301297376)
        *x1^11 + (0.017261709321129)*x1^12 + (-16.9606407389203)*y1^1 + (6.77158339360549)
        *y1^2 + (-4.11016853249533)*y1^3 + (1.38727891703213)*y1^4 + (-0.248878323514509)
        *x1^11*y1^1 + (-2.3845382310834)*x1^10*y1^1 + (1.21239256484831)*x1^10*
        y1^2 + (-6.84683212512403)*x1^9*y1^1 + (7.907146451594)*x1^9*y1^2 + (-2.26093972663603)
        *x1^9*y1^3 + (-6.02383816032881)*x1^8*y1^1 + (17.9959884739015)*x1^8*y1^
        2 + (-11.6557332748761)*x1^8*y1^3 + (1.34734913070178)*x1^8*y1^4 + (2.4805263727)
        *x1^7*y1^1 + (13.3565194267492)*x1^7*y1^2 + (-20.3703200914964)*x1^7*y1^
        3 + (6.43947650667893)*x1^7*y1^4 + (1.07942630583476)*x1^6*y1^1 + (-4.46379459562203)
        *x1^6*y1^2 + (-10.5583543972069)*x1^6*y1^3 + (9.30964627311458)*x1^6*y1^
        4 + (-14.4835385246543)*x1^5*y1^1 + (2.4057682137968)*x1^5*y1^2 + (3.91570074600322)
        *x1^5*y1^3 + (0.929959359240351)*x1^5*y1^4 + (-24.1103495016718)*x1^4*
        y1^1 + (31.8063400583554)*x1^4*y1^2 + (-5.10339352652816)*x1^4*y1^3 + (-5.7446593077267)
        *x1^4*y1^4 + (-23.8187899707303)*x1^3*y1^1 + (40.208541359721)*x1^3*y1^2
         + (-23.4724075893299)*x1^3*y1^3 + (2.33153900957907)*x1^3*y1^4 + (-24.2592217972724)
        *x1^2*y1^1 + (28.8800649919003)*x1^2*y1^2 + (-25.5769665769935)*x1^2*y1^
        3 + (9.19536897161365)*x1^2*y1^4 + (-26.4413770963882)*x1^1*y1^1 + (17.8897180948262)
        *x1^1*y1^2 + (-14.6913315929263)*x1^1*y1^3 + (5.73661907561273)*x1^1*y1^
        4);
    elseif p > sat.psat + dp then
      ...
      d := (0) + (1)*(1128.29342170365 + (7.87960605987028)*x2^1 + (-0.257941704085539)
        ...
        *y2^4 + (-18.6737509725287)*y2^5 + (-13.42480950003)*y2^6 + (11.9194637097639)
        *y2^7 + (7.18763169338531)*y2^8 + (-3.14754559007914)*y2^9 + (-1.72623019772007)
        *y2^10 + (1.34539694151813)*y2^9*x2^1 + (3.89985990853728)*y2^8*x2^1 + (
        -0.477663643528785)*y2^8*x2^2 + (-1.01963032819307)*y2^7*x2^1 + (-1.58757914444201)
        *y2^7*x2^2 + (0.0535260150930145)*y2^7*x2^3 + (-9.82580093531666)*y2^6*
        x2^1 + (-0.688688832277525)*y2^6*x2^2 + (0.238676850832625)*y2^6*x2^3 +
        (-0.0128186939933804)*y2^6*x2^4 + (-1.63106702729664)*y2^5*x2^1 + (1.9888439943296)
        *y2^5*x2^2 + (0.340643562102322)*y2^5*x2^3 + (-0.00246289257004601)*y2^5
        *x2^4 + (10.360113896152)*y2^4*x2^1 + (1.02660482095755)*y2^4*x2^2 + (0.0543199338072468)
        *y2^4*x2^3 + (0.0558666269760638)*y2^4*x2^4 + (5.26843887978288)*y2^3*
        x2^1 + (-1.40297227072936)*y2^3*x2^2 + (-0.221168110890005)*y2^3*x2^3 +
        (0.00360942200618328)*y2^3*x2^4 + (0.881530520864514)*y2^2*x2^1 + (-0.930022610155721)
        *y2^2*x2^2 + (-0.0481483280978479)*y2^2*x2^3 + (-0.0835073418715788)*y2^
        2*x2^4 + (4.79216519948661)*y2^1*x2^1 + (-0.284394146008372)*y2^1*x2^2 +
        (0.10599088619427)*y2^1*x2^3 + (-0.0311912243742686)*y2^1*x2^4);
    else
      if p < sat.psat then
        x1 := (p-(2450527.84438656))/(1412272.92887283);
        y1 := (T-(335.125102884223))/(26.6939958044661);
        d1 := (0) + (1) * (84.139999758958 + (67.6100707083323)*x1^1 + (18.8214831219552)*x1^2 + (7.88742448104687)*x1^3 + (4.84880513849624)*x1^4 + (5.26283636517838)*x1^5 + (3.02091398421476)*x1^6 + (-0.704366042615507)*x1^7 + (-0.760435798997538)*x1^8 + (0.914800113049461)*x1^9 + (0.963585468711737)*x1^10 + (0.274216301297376)*x1^11 + (0.017261709321129)*x1^12 + (-16.9606407389203)*y1^1 + (6.77158339360549)*y1^2 + (-4.11016853249533)*y1^3 + (1.38727891703213)*y1^4 + (-0.248878323514509)*x1^11*y1^1 + (-2.3845382310834)*x1^10*y1^1 + (1.21239256484831)*x1^10*y1^2 + (-6.84683212512403)*x1^9*y1^1 + (7.907146451594)*x1^9*y1^2 + (-2.26093972663603)*x1^9*y1^3 + (-6.02383816032881)*x1^8*y1^1 + (17.9959884739015)*x1^8*y1^2 + (-11.6557332748761)*x1^8*y1^3 + (1.34734913070178)*x1^8*y1^4 + (2.4805263727)*x1^7*y1^1 + (13.3565194267492)*x1^7*y1^2 + (-20.3703200914964)*x1^7*y1^3 + (6.43947650667893)*x1^7*y1^4 + (1.07942630583476)*x1^6*y1^1 + (-4.46379459562203)*x1^6*y1^2 + (-10.5583543972069)*x1^6*y1^3 + (9.30964627311458)*x1^6*y1^4 + (-14.4835385246543)*x1^5*y1^1 + (2.4057682137968)*x1^5*y1^2 + (3.91570074600322)*x1^5*y1^3 + (0.929959359240351)*x1^5*y1^4 + (-24.1103495016718)*x1^4*y1^1 + (31.8063400583554)*x1^4*y1^2 + (-5.10339352652816)*x1^4*y1^3 + (-5.7446593077267)*x1^4*y1^4 + (-23.8187899707303)*x1^3*y1^1 + (40.208541359721)*x1^3*y1^2 + (-23.4724075893299)*x1^3*y1^3 + (2.33153900957907)*x1^3*y1^4 + (-24.2592217972724)*x1^2*y1^1 + (28.8800649919003)*x1^2*y1^2 + (-25.5769665769935)*x1^2*y1^3 + (9.19536897161365)*x1^2*y1^4 + (-26.4413770963882)*x1^1*y1^1 + (17.8897180948262)*x1^1*y1^2 + (-14.6913315929263)*x1^1*y1^3 + (5.73661907561273)*x1^1*y1^4);
