...
package R410a_IIR_P1_48_T233_473_Horner
  "Refrigerant model for R410a using a hybrid approach with explicit Horner formulas"
  ...
  */
  ...
  algorithm
    ...
    if s<s_bubble-ds then
     ...
     T := (0) + (1) * ((285.694699667815) + y1*(y1*(y1*(y1*(y1*(y1*(y1*(y1*(y1*((0.0176359573966827)*y1 + (0.0316726651980843) + (-0.0164121223780564)*x1) + (-0.115330088394623) + x1*((0.00964207302480855)*x1 + (-0.021049391159093))) + (-0.287988292846959) + x1*(x1*((0.000448400580450467)*x1 + (0.00446666151932734)) + (0.160836146227042))) + (-0.0674005888547959) + x1*(x1*(x1*((-0.00184914832370402)*x1 + (0.0237831303795189)) + (-0.136779662319749)) + (0.407078466782749))) + (0.103684161622761) + x1*(x1*(x1*((-0.0155224543284392)*x1 + (0.113054265723455)) + (-0.331019995172275)) + (0.232664909912497))) + (-0.37547776638412) + x1*(x1*(x1*((-0.0489805912413537)*x1 + (0.202926583202097)) + (-0.226383454966623)) + (-0.0570300608606503))) + (-1.35891209361109) + x1*(x1*(x1*((-0.0744032871840306)*x1 + (0.156042986921594)) + (0.0619867405719159)) + (0.118289457566212))) + (-0.538203800364751) + x1*(x1*(x1*((-0.0560518828539283)*x1 + (0.0432588380531332)) + (0.159824750585592)) + (0.444334054359482))) + (39.25784184622) + x1*(x1*(x1*((-0.0169796856907351)*x1 + (0.0174579733698449)) + (0.181304075574015)) + (0.712211978720827))) + x1*(x1*(x1*((0.00203028958902996)*x1 + (0.043941556562575)) + (0.275193128445195)) + (1.02968381585158)));
    elseif s>s_dew+ds then
     x2 := (log(p)-(13.9633083007351))/(1.0544928909531);
     y2 := (s-(2038.24821446123))/(182.368581972174);
     T := (0) + (1) * ((362.780429406726) + y2*(y2*(y2*(y2*(y2*(y2*(y2*(y2*(y2*((0.00143691811058645)*y2 + (-0.0067888044083486) + (0.00913195481359379)*x2) + (0.00966378023797837) + x2*((0.0171350539134858)*x2 + (-0.0430345823130263))) + (-0.0027549017535748) + x2*(x2*((0.013260520352129)*x2 + (-0.0860624242518243)) + (0.0412715307520025))) + (-0.0126978939045207) + x2*(x2*(x2*((0.00263775754316385)*x2 + (-0.0833330343192107)) + (0.0829846036839661)) + (0.050353274463767))) + (-0.0369077715111301) + x2*(x2*(x2*(x2*((0.000580068228029518)*x2 + (-0.0339664301243253)) + (0.0999632250360851)) + (0.0967647474299231)) + (-0.0960583200277675))) + (0.261713154987473) + x2*(x2*(x2*(x2*((-0.0126569601251682)*x2 + (0.0556366141911953)) + (0.08683709431814)) + (-0.159492293757689)) + (-0.112248284624909))) + (-0.959764190149959) + x2*(x2*(x2*(x2*((0.0311254594242568)*x2 + (0.0249648964493416)) + (-0.19857043646911)) + (-0.214744852220885)) + (0.0830757358076766))) + (5.48129300138706) + x2*(x2*(x2*(x2*((-0.0160699196008859)*x2 + (-0.0905900761832388)) + (-0.0794219527244774)) + (0.355311305918674)) + (0.507873375509499))) + (66.4905228835631) + x2*(x2*(x2*(x2*((-0.0109582919094829)*x2 + (-0.0347404280037205)) + (-0.0804760434416528)) + (-0.905686167783714)) + (1.3654391575539))) + x2*(x2*(x2*(x2*((-0.00286577362938595)*x2 + (0.0522653189730272)) + (0.443209929215919)) + (3.39955470785848)) + (53.6928909515271)));
    else
     if s<s_bubble then
      x1 := (log(p)-(14.8682464548966))/(0.572967793317542);
      y1 := (s-(1062.25690261649))/(214.725037980704);
      T1 := (0) + (1) * ((285.694699667815) + y1*(y1*(y1*(y1*(y1*(y1*(y1*(y1*(y1*((0.0176359573966827)*y1 + (0.0316726651980843) + (-0.0164121223780564)*x1) + (-0.115330088394623) + x1*((0.00964207302480855)*x1 + (-0.021049391159093))) + (-0.287988292846959) + x1*(x1*((0.000448400580450467)*x1 + (0.00446666151932734)) + (0.160836146227042))) + (-0.0674005888547959) + x1*(x1*(x1*((-0.00184914832370402)*x1 + (0.0237831303795189)) + (-0.136779662319749)) + (0.407078466782749))) + (0.103684161622761) + x1*(x1*(x1*((-0.0155224543284392)*x1 + (0.113054265723455)) + (-0.331019995172275)) + (0.232664909912497))) + (-0.37547776638412) + x1*(x1*(x1*((-0.0489805912413537)*x1 + (0.202926583202097)) + (-0.226383454966623)) + (-0.0570300608606503))) + (-1.35891209361109) + x1*(x1*(x1*((-0.0744032871840306)*x1 + (0.156042986921594)) + (0.0619867405719159)) + (0.118289457566212))) + (-0.538203800364751) + x1*(x1*(x1*((-0.0560518828539283)*x1 + (0.0432588380531332)) + (0.159824750585592)) + (0.444334054359482))) + (39.25784184622) + x1*(x1*(x1*((-0.0169796856907351)*x1 + (0.0174579733698449)) + (0.181304075574015)) + (0.712211978720827))) + x1*(x1*(x1*((0.00203028958902996)*x1 + (0.043941556562575)) + (0.275193128445195)) + (1.02968381585158)));
      T := saturationTemperature(p)*(1 - (s_bubble - s)/ds) + T1*(s_bubble - s)/ds;
     elseif s>s_dew then
      x2 := (log(p)-(13.9633083007351))/(1.0544928909531);
      y2 := (s-(2038.24821446123))/(182.368581972174);
      T2 := (0) + (1) * ((362.780429406726) + y2*(y2*(y2*(y2*(y2*(y2*(y2*(y2*(y2*((0.00143691811058645)*y2 + (-0.0067888044083486) + (0.00913195481359379)*x2) + (0.00966378023797837) + x2*((0.0171350539134858)*x2 + (-0.0430345823130263))) + (-0.0027549017535748) + x2*(x2*((0.013260520352129)*x2 + (-0.0860624242518243)) + (0.0412715307520025))) + (-0.0126978939045207) + x2*(x2*(x2*((0.00263775754316385)*x2 + (-0.0833330343192107)) + (0.0829846036839661)) + (0.050353274463767))) + (-0.0369077715111301) + x2*(x2*(x2*(x2*((0.000580068228029518)*x2 + (-0.0339664301243253)) + (0.0999632250360851)) + (0.0967647474299231)) + (-0.0960583200277675))) + (0.261713154987473) + x2*(x2*(x2*(x2*((-0.0126569601251682)*x2 + (0.0556366141911953)) + (0.08683709431814)) + (-0.159492293757689)) + (-0.112248284624909))) + (-0.959764190149959) + x2*(x2*(x2*(x2*((0.0311254594242568)*x2 + (0.0249648964493416)) + (-0.19857043646911)) + (-0.214744852220885)) + (0.0830757358076766))) + (5.48129300138706) + x2*(x2*(x2*(x2*((-0.0160699196008859)*x2 + (-0.0905900761832388)) + (-0.0794219527244774)) + (0.355311305918674)) + (0.507873375509499))) + (66.4905228835631) + x2*(x2*(x2*(x2*((-0.0109582919094829)*x2 + (-0.0347404280037205)) + (-0.0804760434416528)) + (-0.905686167783714)) + (1.3654391575539))) + x2*(x2*(x2*(x2*((-0.00286577362938595)*x2 + (0.0522653189730272)) + (0.443209929215919)) + (3.39955470785848)) + (53.6928909515271)));
