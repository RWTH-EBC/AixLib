...
package R410a_IIR_P1_48_T233_473_Horner
  "Refrigerant model for R410a using a hybrid approach with explicit
  Horner formulas"
  ...
  */
  ...
  algorithm
    alpha_0 := log(delta) + (-1) * log(tau^(1)) + (36.8871) * tau^(0) +
  ...
  algorithm
    alpha_r := (0.987252) * delta^(1) * tau^(0.44) + (-1.03017) * delta^(1)
  ...
  algorithm
    tau_d_alpha_0_d_tau := (-1)*(1) + (36.8871)*(0)*tau^(0) + (7.15807)*(1)*
  ...
  algorithm
    tau2_d2_alpha_0_d_tau2 := -(-1)*(1) + (36.8871)*(0)*((0)-1)*tau^(0) +
  ...
  algorithm
    tau_d_alpha_r_d_tau := (0.987252)*(0.44)*delta^(1)*tau^(0.44) +
  ...
  algorithm
    tau2_d2_alpha_r_d_tau2 := (0.987252)*(0.44)*((0.44)-1)*delta^(1)*
  ...
  algorithm
    delta_d_alpha_r_d_delta := (0.987252)*(1)*delta^(1)*tau^(0.44)
  ...
  algorithm
    delta2_d2_alpha_r_d_delta2 := (0.987252)*(1)*((1)-1)*delta^(1)*tau^(0.44)
  ...
  algorithm
    tau_delta_d2_alpha_r_d_tau_d_delta := (0.987252)*(1)*(0.44)*delta^(1)
  ...
  algorithm
    tau3_d3_alpha_0_d_tau3 := 2*(-1)*(1) + (36.8871)*(0)*((0)-1)*((0)-2) *
  ...
  algorithm
    tau3_d3_alpha_r_d_tau3 := (0.987252)*(0.44)*((0.44)-1)*((0.44)-2)*
  ...
  algorithm
    delta3_d3_alpha_r_d_delta3 := (0.987252)*(1)*((1)-1)*((1)-2)*delta^(1)*
  ...
  algorithm
    tau_delta2_d3_alpha_r_d_tau_d_delta2 := (0.987252)*(1)*(0.44)*(1-1)*
  ...
  algorithm
    tau2_delta_d3_alpha_r_d_tau2_d_delta := (0.987252)*(1)*(0.44)*(0.44-1)*
