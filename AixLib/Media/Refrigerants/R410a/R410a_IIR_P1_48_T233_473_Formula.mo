...
package R410a_IIR_P1_48_T233_473_Formula
  ...
  */
  ...
  algorithm
    ...
    if h < h_bubble - dh then
      ...
      T := (0) + (1)*(287.021664392518 + (0.0784539758046494)*x1^1 + (-0.0139499454480583)
        *x1^2 + (0.0014409474800833)*x1^3 + (-0.00847904392329953)*x1^4 + (
        53.34763090261)*y1^1 + (-5.88862734169674)*y1^2 + (-2.04065167066883)*
        y1^3 + (-0.431165279279122)*y1^4 + (0.176294552751571)*y1^5 + (-0.370648789311289)
        *y1^6 + (-0.872911774900146)*y1^7 + (-0.297748052935782)*y1^8 + (
        0.171784244137346)*y1^9 + (0.0864117831531705)*y1^10 + (-0.0754087777872457)
        *y1^9*x1^1 + (-0.113732590174603)*y1^8*x1^1 + (0.0174851132885221)*y1^8
        *x1^2 + (0.348152824991852)*y1^7*x1^1 + (-0.0060899049206074)*y1^7*x1^2
         + (0.0279225582194194)*y1^7*x1^3 + (0.793238216844397)*y1^6*x1^1 + (-0.180427599342632)
        *y1^6*x1^2 + (0.0913740201046021)*y1^6*x1^3 + (-0.0201076646974901)*y1^
        6*x1^4 + (0.328350703575568)*y1^5*x1^1 + (-0.269409245572516)*y1^5*x1^2
         + (0.0811142564076022)*y1^5*x1^3 + (-0.0586819391563395)*y1^5*x1^4 + (
        -0.070776597639706)*y1^4*x1^1 + (-0.0997281511935187)*y1^4*x1^2 + (-0.00805504114050181)
        *y1^4*x1^3 + (-0.0302212183613812)*y1^4*x1^4 + (0.304572997097524)*y1^3
        *x1^1 + (-0.015533863828046)*y1^3*x1^2 + (-0.0236752632712486)*y1^3*x1^
        3 + (0.0433631502561081)*y1^3*x1^4 + (0.669171917292208)*y1^2*x1^1 + (-0.0638071155038644)
        *y1^2*x1^2 + (0.0123678914525845)*y1^2*x1^3 + (0.0337585408958696)*y1^2
        *x1^4 + (0.786295970183816)*y1^1*x1^1 + (-0.0457611197544299)*y1^1*x1^2
         + (0.011937105968086)*y1^1*x1^3 + (-0.00956248998345363)*y1^1*x1^4);
    elseif h > h_dew + dh then
      x2 := (p - (1892065.91097279))/(1644413.85209216);
      y2 := (h - (499554.093389481))/(58727.7569010133);
      T := (0) + (1)*(365.146842872405 + (17.2483894918718)*x2^1 + (-1.18709182937648)
        *x2^2 + (0.0770766169578993)*x2^3 + (-0.0207390776905432)*x2^4 + (
        0.00395092103052318)*x2^5 + (54.9826366363199)*y2^1 + (1.32987408992145)
        *y2^2 + (-1.49238889408244)*y2^3 + (0.537922635233623)*y2^4 + (-0.0549304792713878)
        *y2^5 + (0.0187475886663365)*y2^6 + (-0.0471817882838252)*y2^7 + (
        0.00984123984001866)*y2^8 + (-0.00242661170883643)*y2^9 + (
        0.00237194280566996)*y2^10 + (0.000840569788988142)*y2^9*x2^1 + (-0.00432837936077168)
        *y2^8*x2^1 + (-0.0116499567302523)*y2^8*x2^2 + (0.085377268026775)*y2^7
        *x2^1 + (0.0531393188529756)*y2^7*x2^2 + (-0.0463425507102811)*y2^7*x2^
        3 + (-0.171330421821666)*y2^6*x2^1 + (0.0230222331968282)*y2^6*x2^2 + (
        0.13780304779475)*y2^6*x2^3 + (-0.0489685316884883)*y2^6*x2^4 + (-0.0929200275911617)
        *y2^5*x2^1 + (-0.191987470592909)*y2^5*x2^2 + (-0.0171832389900513)*y2^
        5*x2^3 + (0.121635292261662)*y2^5*x2^4 + (-0.0189371252586533)*y2^5*x2^
        5 + (0.351109821077926)*y2^4*x2^1 + (-0.0996812537150541)*y2^4*x2^2 + (
        -0.13859503421283)*y2^4*x2^3 + (-0.0405204964449092)*y2^4*x2^4 + (
        0.0383733903927351)*y2^4*x2^5 + (-0.703423308021757)*y2^3*x2^1 + (
        0.634484271554577)*y2^3*x2^2 + (-0.122945011915202)*y2^3*x2^3 + (-0.00902698301946151)
        *y2^3*x2^4 + (-0.0194802531401436)*y2^3*x2^5 + (2.911142242608)*y2^2*x2
        ^1 + (-0.94530847153653)*y2^2*x2^2 + (0.337776046181807)*y2^2*x2^3 + (-0.0967477066845138)
        *y2^2*x2^4 + (0.0101680900894223)*y2^2*x2^5 + (-8.61552286082537)*y2^1*
        x2^1 + (1.25182009270752)*y2^1*x2^2 + (-0.214366060484023)*y2^1*x2^3 +
        (0.0923297717937169)*y2^1*x2^4 + (-0.0150312740494949)*y2^1*x2^5);
    else
      if h < h_bubble then
  x1 := (p-(3386089.75740898))/(1327435.5559674);
  y1 := (h-(221403.010195671))/(83334.0890066773);
  T1 := (0) + (1) * (287.021664392518 + (0.0784539758046494)*x1^1 + (-0.0139499454480583)*x1^2 + (0.0014409474800833)*x1^3 + (-0.00847904392329953)*x1^4 + (53.34763090261)*y1^1 + (-5.88862734169674)*y1^2 + (-2.04065167066883)*y1^3 + (-0.431165279279122)*y1^4 + (0.176294552751571)*y1^5 + (-0.370648789311289)*y1^6 + (-0.872911774900146)*y1^7 + (-0.297748052935782)*y1^8 + (0.171784244137346)*y1^9 + (0.0864117831531705)*y1^10 + (-0.0754087777872457)*y1^9*x1^1 + (-0.113732590174603)*y1^8*x1^1 + (0.0174851132885221)*y1^8*x1^2 + (0.348152824991852)*y1^7*x1^1 + (-0.0060899049206074)*y1^7*x1^2 + (0.0279225582194194)*y1^7*x1^3 + (0.793238216844397)*y1^6*x1^1 + (-0.180427599342632)*y1^6*x1^2 + (0.0913740201046021)*y1^6*x1^3 + (-0.0201076646974901)*y1^6*x1^4 + (0.328350703575568)*y1^5*x1^1 + (-0.269409245572516)*y1^5*x1^2 + (0.0811142564076022)*y1^5*x1^3 + (-0.0586819391563395)*y1^5*x1^4 + (-0.070776597639706)*y1^4*x1^1 + (-0.0997281511935187)*y1^4*x1^2 + (-0.00805504114050181)*y1^4*x1^3 + (-0.0302212183613812)*y1^4*x1^4 + (0.304572997097524)*y1^3*x1^1 + (-0.015533863828046)*y1^3*x1^2 + (-0.0236752632712486)*y1^3*x1^3 + (0.0433631502561081)*y1^3*x1^4 + (0.669171917292208)*y1^2*x1^1 + (-0.0638071155038644)*y1^2*x1^2 + (0.0123678914525845)*y1^2*x1^3 + (0.0337585408958696)*y1^2*x1^4 + (0.786295970183816)*y1^1*x1^1 + (-0.0457611197544299)*y1^1*x1^2 + (0.011937105968086)*y1^1*x1^3 + (-0.00956248998345363)*y1^1*x1^4);
  T := saturationTemperature(p)*(1 - (h_bubble - h)/dh) + T1*(h_bubble - h)/dh;
      elseif h > h_dew then
  x2 := (p-(1892065.91097279))/(1644413.85209216);
  y2 := (h-(499554.093389481))/(58727.7569010133);
  T2 := (0) + (1) * (365.146842872405 + (17.2483894918718)*x2^1 + (-1.18709182937648)*x2^2 + (0.0770766169578993)*x2^3 + (-0.0207390776905432)*x2^4 + (0.00395092103052318)*x2^5 + (54.9826366363199)*y2^1 + (1.32987408992145)*y2^2 + (-1.49238889408244)*y2^3 + (0.537922635233623)*y2^4 + (-0.0549304792713878)*y2^5 + (0.0187475886663365)*y2^6 + (-0.0471817882838252)*y2^7 + (0.00984123984001866)*y2^8 + (-0.00242661170883643)*y2^9 + (0.00237194280566996)*y2^10 + (0.000840569788988142)*y2^9*x2^1 + (-0.00432837936077168)*y2^8*x2^1 + (-0.0116499567302523)*y2^8*x2^2 + (0.085377268026775)*y2^7*x2^1 + (0.0531393188529756)*y2^7*x2^2 + (-0.0463425507102811)*y2^7*x2^3 + (-0.171330421821666)*y2^6*x2^1 + (0.0230222331968282)*y2^6*x2^2 + (0.13780304779475)*y2^6*x2^3 + (-0.0489685316884883)*y2^6*x2^4 + (-0.0929200275911617)*y2^5*x2^1 + (-0.191987470592909)*y2^5*x2^2 + (-0.0171832389900513)*y2^5*x2^3 + (0.121635292261662)*y2^5*x2^4 + (-0.0189371252586533)*y2^5*x2^5 + (0.351109821077926)*y2^4*x2^1 + (-0.0996812537150541)*y2^4*x2^2 + (-0.13859503421283)*y2^4*x2^3 + (-0.0405204964449092)*y2^4*x2^4 + (0.0383733903927351)*y2^4*x2^5 + (-0.703423308021757)*y2^3*x2^1 + (0.634484271554577)*y2^3*x2^2 + (-0.122945011915202)*y2^3*x2^3 + (-0.00902698301946151)*y2^3*x2^4 + (-0.0194802531401436)*y2^3*x2^5 + (2.911142242608)*y2^2*x2^1 + (-0.94530847153653)*y2^2*x2^2 + (0.337776046181807)*y2^2*x2^3 + (-0.0967477066845138)*y2^2*x2^4 + (0.0101680900894223)*y2^2*x2^5 + (-8.61552286082537)*y2^1*x2^1 + (1.25182009270752)*y2^1*x2^2 + (-0.214366060484023)*y2^1*x2^3 + (0.0923297717937169)*y2^1*x2^4 + (-0.0150312740494949)*y2^1*x2^5);
  ...
  algorithm
    ...
    if s < s_bubble - ds then
      ...
      T := (0) + (1)*(285.694699667815 + (1.02968381585158)*x1^1 + (
        ...
        0.00203028958902996)*x1^4 + (39.25784184622)*y1^1 + (-0.538203800364751)
        *y1^2 + (-1.35891209361109)*y1^3 + (-0.37547776638412)*y1^4 + (
        0.103684161622761)*y1^5 + (-0.0674005888547959)*y1^6 + (-0.287988292846959)
        *y1^7 + (-0.115330088394623)*y1^8 + (0.0316726651980843)*y1^9 + (
        0.0176359573966827)*y1^10 + (-0.0164121223780564)*y1^9*x1^1 + (-0.021049391159093)
        *y1^8*x1^1 + (0.00964207302480855)*y1^8*x1^2 + (0.160836146227042)*y1^7
        *x1^1 + (0.00446666151932734)*y1^7*x1^2 + (0.000448400580450467)*y1^7*
        x1^3 + (0.407078466782749)*y1^6*x1^1 + (-0.136779662319749)*y1^6*x1^2
         + (0.0237831303795189)*y1^6*x1^3 + (-0.00184914832370402)*y1^6*x1^4 +
        (0.232664909912497)*y1^5*x1^1 + (-0.331019995172275)*y1^5*x1^2 + (
        0.113054265723455)*y1^5*x1^3 + (-0.0155224543284392)*y1^5*x1^4 + (-0.0570300608606503)
        *y1^4*x1^1 + (-0.226383454966623)*y1^4*x1^2 + (0.202926583202097)*y1^4*
        x1^3 + (-0.0489805912413537)*y1^4*x1^4 + (0.118289457566212)*y1^3*x1^1
         + (0.0619867405719159)*y1^3*x1^2 + (0.156042986921594)*y1^3*x1^3 + (-0.0744032871840306)
        *y1^3*x1^4 + (0.444334054359482)*y1^2*x1^1 + (0.159824750585592)*y1^2*
        x1^2 + (0.0432588380531332)*y1^2*x1^3 + (-0.0560518828539283)*y1^2*x1^4
         + (0.712211978720827)*y1^1*x1^1 + (0.181304075574015)*y1^1*x1^2 + (
        0.0174579733698449)*y1^1*x1^3 + (-0.0169796856907351)*y1^1*x1^4);
    elseif s > s_dew + ds then
      ...
      T := (0) + (1)*(362.780429406726 + (53.6928909515271)*x2^1 + (
        3.39955470785848)*x2^2 + (0.443209929215919)*x2^3 + (0.0522653189730272)
        *x2^4 + (-0.00286577362938595)*x2^5 + (66.4905228835631)*y2^1 + (
        5.48129300138706)*y2^2 + (-0.959764190149959)*y2^3 + (0.261713154987473)
        *y2^4 + (-0.0369077715111301)*y2^5 + (-0.0126978939045207)*y2^6 + (-0.0027549017535748)
        *y2^7 + (0.00966378023797837)*y2^8 + (-0.0067888044083486)*y2^9 + (
        0.00143691811058645)*y2^10 + (0.00913195481359379)*y2^9*x2^1 + (-0.0430345823130263)
        *y2^8*x2^1 + (0.0171350539134858)*y2^8*x2^2 + (0.0412715307520025)*y2^7
        *x2^1 + (-0.0860624242518243)*y2^7*x2^2 + (0.013260520352129)*y2^7*x2^3
         + (0.050353274463767)*y2^6*x2^1 + (0.0829846036839661)*y2^6*x2^2 + (-0.0833330343192107)
        *y2^6*x2^3 + (0.00263775754316385)*y2^6*x2^4 + (-0.0960583200277675)*y2
        ^5*x2^1 + (0.0967647474299231)*y2^5*x2^2 + (0.0999632250360851)*y2^5*x2
        ^3 + (-0.0339664301243253)*y2^5*x2^4 + (0.000580068228029518)*y2^5*x2^5
         + (-0.112248284624909)*y2^4*x2^1 + (-0.159492293757689)*y2^4*x2^2 + (
        0.08683709431814)*y2^4*x2^3 + (0.0556366141911953)*y2^4*x2^4 + (-0.0126569601251682)
        *y2^4*x2^5 + (0.0830757358076766)*y2^3*x2^1 + (-0.214744852220885)*y2^3
        *x2^2 + (-0.19857043646911)*y2^3*x2^3 + (0.0249648964493416)*y2^3*x2^4
         + (0.0311254594242568)*y2^3*x2^5 + (0.507873375509499)*y2^2*x2^1 + (
        0.355311305918674)*y2^2*x2^2 + (-0.0794219527244774)*y2^2*x2^3 + (-0.0905900761832388)
        *y2^2*x2^4 + (-0.0160699196008859)*y2^2*x2^5 + (1.3654391575539)*y2^1*
        x2^1 + (-0.905686167783714)*y2^1*x2^2 + (-0.0804760434416528)*y2^1*x2^3
         + (-0.0347404280037205)*y2^1*x2^4 + (-0.0109582919094829)*y2^1*x2^5);
    else
      if s < s_bubble then
  x1 := (log(p)-(14.8682464548966))/(0.572967793317542);
  y1 := (s-(1062.25690261649))/(214.725037980704);
  T1 := (0) + (1) * (285.694699667815 + (1.02968381585158)*x1^1 + (0.275193128445195)*x1^2 + (0.043941556562575)*x1^3 + (0.00203028958902996)*x1^4 + (39.25784184622)*y1^1 + (-0.538203800364751)*y1^2 + (-1.35891209361109)*y1^3 + (-0.37547776638412)*y1^4 + (0.103684161622761)*y1^5 + (-0.0674005888547959)*y1^6 + (-0.287988292846959)*y1^7 + (-0.115330088394623)*y1^8 + (0.0316726651980843)*y1^9 + (0.0176359573966827)*y1^10 + (-0.0164121223780564)*y1^9*x1^1 + (-0.021049391159093)*y1^8*x1^1 + (0.00964207302480855)*y1^8*x1^2 + (0.160836146227042)*y1^7*x1^1 + (0.00446666151932734)*y1^7*x1^2 + (0.000448400580450467)*y1^7*x1^3 + (0.407078466782749)*y1^6*x1^1 + (-0.136779662319749)*y1^6*x1^2 + (0.0237831303795189)*y1^6*x1^3 + (-0.00184914832370402)*y1^6*x1^4 + (0.232664909912497)*y1^5*x1^1 + (-0.331019995172275)*y1^5*x1^2 + (0.113054265723455)*y1^5*x1^3 + (-0.0155224543284392)*y1^5*x1^4 + (-0.0570300608606503)*y1^4*x1^1 + (-0.226383454966623)*y1^4*x1^2 + (0.202926583202097)*y1^4*x1^3 + (-0.0489805912413537)*y1^4*x1^4 + (0.118289457566212)*y1^3*x1^1 + (0.0619867405719159)*y1^3*x1^2 + (0.156042986921594)*y1^3*x1^3 + (-0.0744032871840306)*y1^3*x1^4 + (0.444334054359482)*y1^2*x1^1 + (0.159824750585592)*y1^2*x1^2 + (0.0432588380531332)*y1^2*x1^3 + (-0.0560518828539283)*y1^2*x1^4 + (0.712211978720827)*y1^1*x1^1 + (0.181304075574015)*y1^1*x1^2 + (0.0174579733698449)*y1^1*x1^3 + (-0.0169796856907351)*y1^1*x1^4);
  T := saturationTemperature(p)*(1 - (s_bubble - s)/ds) + T1*(s_bubble - s)/ds;
      elseif s > s_dew then
  x2 := (log(p)-(13.9633083007351))/(1.0544928909531);
  y2 := (s-(2038.24821446123))/(182.368581972174);
  T2 := (0) + (1) * (362.780429406726 + (53.6928909515271)*x2^1 + (3.39955470785848)*x2^2 + (0.443209929215919)*x2^3 + (0.0522653189730272)*x2^4 + (-0.00286577362938595)*x2^5 + (66.4905228835631)*y2^1 + (5.48129300138706)*y2^2 + (-0.959764190149959)*y2^3 + (0.261713154987473)*y2^4 + (-0.0369077715111301)*y2^5 + (-0.0126978939045207)*y2^6 + (-0.0027549017535748)*y2^7 + (0.00966378023797837)*y2^8 + (-0.0067888044083486)*y2^9 + (0.00143691811058645)*y2^10 + (0.00913195481359379)*y2^9*x2^1 + (-0.0430345823130263)*y2^8*x2^1 + (0.0171350539134858)*y2^8*x2^2 + (0.0412715307520025)*y2^7*x2^1 + (-0.0860624242518243)*y2^7*x2^2 + (0.013260520352129)*y2^7*x2^3 + (0.050353274463767)*y2^6*x2^1 + (0.0829846036839661)*y2^6*x2^2 + (-0.0833330343192107)*y2^6*x2^3 + (0.00263775754316385)*y2^6*x2^4 + (-0.0960583200277675)*y2^5*x2^1 + (0.0967647474299231)*y2^5*x2^2 + (0.0999632250360851)*y2^5*x2^3 + (-0.0339664301243253)*y2^5*x2^4 + (0.000580068228029518)*y2^5*x2^5 + (-0.112248284624909)*y2^4*x2^1 + (-0.159492293757689)*y2^4*x2^2 + (0.08683709431814)*y2^4*x2^3 + (0.0556366141911953)*y2^4*x2^4 + (-0.0126569601251682)*y2^4*x2^5 + (0.0830757358076766)*y2^3*x2^1 + (-0.214744852220885)*y2^3*x2^2 + (-0.19857043646911)*y2^3*x2^3 + (0.0249648964493416)*y2^3*x2^4 + (0.0311254594242568)*y2^3*x2^5 + (0.507873375509499)*y2^2*x2^1 + (0.355311305918674)*y2^2*x2^2 + (-0.0794219527244774)*y2^2*x2^3 + (-0.0905900761832388)*y2^2*x2^4 + (-0.0160699196008859)*y2^2*x2^5 + (1.3654391575539)*y2^1*x2^1 + (-0.905686167783714)*y2^1*x2^2 + (-0.0804760434416528)*y2^1*x2^3 + (-0.0347404280037205)*y2^1*x2^4 + (-0.0109582919094829)*y2^1*x2^5);
  ...
  algorithm
    if p < sat.psat - dp then
      ...
      d := (0) + (1)*(72.4673451196848 + (48.747095068058)*x1^1 + (
        6.23191503754805)*x1^2 + (1.04050224938105)*x1^3 + (0.567726549561638)*
        x1^4 + (0.0932321559076097)*x1^5 + (-0.360885881436796)*x1^6 + (
        1.28068452524156)*x1^7 + (1.06577883644539)*x1^8 + (-1.99711947941136)*
        x1^9 + (-1.44678640775593)*x1^10 + (1.20018741172135)*x1^11 + (
        0.853546056385162)*x1^12 + (-0.329764047290808)*x1^13 + (-0.23272984842566)
        *x1^14 + (0.0344891241850553)*x1^15 + (0.0241532472331232)*x1^16 + (-17.9789227494755)
        *y1^1 + (5.82503909222006)*y1^2 + (-2.78595570494937)*y1^3 + (
        3.19530678611049)*y1^4 + (-2.13520897173966)*y1^5 + (0.476112131319811)
        *y1^6 + (0.0180148100259595)*x1^15*y1^1 + (0.0671983465772878)*x1^14*y1
        ^1 + (-0.0231125330926145)*x1^14*y1^2 + (-0.0894987039385263)*x1^13*y1^
        1 + (0.0313955248670506)*x1^13*y1^2 + (-0.040051833346326)*x1^13*y1^3
         + (-0.532041879544919)*x1^12*y1^1 + (0.481814040999413)*x1^12*y1^2 + (
        -0.275970127268419)*x1^12*y1^3 + (0.0595656346612924)*x1^12*y1^4 + (
        0.0982162914145338)*x1^11*y1^1 + (0.15313898975363)*x1^11*y1^2 + (-0.417480184022921)
        *x1^11*y1^3 + (0.398690880981839)*x1^11*y1^4 + (-0.0701269844815475)*x1
        ^11*y1^5 + (1.80583502511502)*x1^10*y1^1 + (-2.61992220201529)*x1^10*y1
        ^2 + (0.927414069768541)*x1^10*y1^3 + (0.646867664174733)*x1^10*y1^4 +
        (-0.358268894813906)*x1^10*y1^5 + (0.0317598014122311)*x1^10*y1^6 + (
        0.255369672573349)*x1^9*y1^1 + (-2.10284280349872)*x1^9*y1^2 + (
        2.70476046968443)*x1^9*y1^3 + (-0.831729960654545)*x1^9*y1^4 + (-0.367575376717921)
        *x1^9*y1^5 + (0.118852155856873)*x1^9*y1^6 + (-3.42174233434026)*x1^8*
        y1^1 + (6.17083877403159)*x1^8*y1^2 + (-0.830116315750902)*x1^8*y1^3 +
        ...
        1.0530366207728)*x1^7*y1^4 + (1.37039039275325)*x1^7*y1^5 + (-0.324542370497003)
        *x1^7*y1^6 + (3.87963397609216)*x1^6*y1^1 + (-4.18020614281834)*x1^6*y1
        ^2 + (-6.62046825385111)*x1^6*y1^3 + (8.75770767644535)*x1^6*y1^4 + (-2.55855423377597)
        *x1^6*y1^5 + (0.117380045025554)*x1^6*y1^6 + (1.78744711380603)*x1^5*y1
        ^1 + (-8.5130194254542)*x1^5*y1^2 + (0.432267641929898)*x1^5*y1^3 + (
        11.3113517826107)*x1^5*y1^4 + (-7.85980012364802)*x1^5*y1^5 + (
        1.47071603482735)*x1^5*y1^6 + (-1.91705372885997)*x1^4*y1^1 + (-0.0949843941880612)
        *x1^4*y1^2 + (-1.997473493718)*x1^4*y1^3 + (10.2988208629762)*x1^4*y1^4
         + (-8.49155787450058)*x1^4*y1^5 + (1.93615111192894)*x1^4*y1^6 + (-2.50033746594717)
        *x1^3*y1^1 + (5.70360979762331)*x1^3*y1^2 + (-10.5322720390077)*x1^3*y1
        ^3 + (12.2400759177558)*x1^3*y1^4 + (-6.89614017369394)*x1^3*y1^5 + (
    ...
    elseif p > sat.psat + dp then
      ...
      d := (0) + (1)*(1128.29342170365 + (7.87960605987028)*x2^1 + (-0.257941704085539)
        *x2^2 + (0.0359536256629997)*x2^3 + (0.00468405676173685)*x2^4 + (-133.244855967764)
        *y2^1 + (-23.0011865132665)*y2^2 + (2.65009519098121)*y2^3 + (
        7.41012261893865)*y2^4 + (-18.6737509725287)*y2^5 + (-13.42480950003)*
        y2^6 + (11.9194637097639)*y2^7 + (7.18763169338531)*y2^8 + (-3.14754559007914)
        *y2^9 + (-1.72623019772007)*y2^10 + (1.34539694151813)*y2^9*x2^1 + (
        3.89985990853728)*y2^8*x2^1 + (-0.477663643528785)*y2^8*x2^2 + (-1.01963032819307)
        *y2^7*x2^1 + (-1.58757914444201)*y2^7*x2^2 + (0.0535260150930145)*y2^7*
        x2^3 + (-9.82580093531666)*y2^6*x2^1 + (-0.688688832277525)*y2^6*x2^2
         + (0.238676850832625)*y2^6*x2^3 + (-0.0128186939933804)*y2^6*x2^4 + (-1.63106702729664)
        *y2^5*x2^1 + (1.9888439943296)*y2^5*x2^2 + (0.340643562102322)*y2^5*x2^
        3 + (-0.00246289257004601)*y2^5*x2^4 + (10.360113896152)*y2^4*x2^1 + (
        1.02660482095755)*y2^4*x2^2 + (0.0543199338072468)*y2^4*x2^3 + (
        0.0558666269760638)*y2^4*x2^4 + (5.26843887978288)*y2^3*x2^1 + (-1.40297227072936)
        *y2^3*x2^2 + (-0.221168110890005)*y2^3*x2^3 + (0.00360942200618328)*y2^
        3*x2^4 + (0.881530520864514)*y2^2*x2^1 + (-0.930022610155721)*y2^2*x2^2
         + (-0.0481483280978479)*y2^2*x2^3 + (-0.0835073418715788)*y2^2*x2^4 +
        (4.79216519948661)*y2^1*x2^1 + (-0.284394146008372)*y2^1*x2^2 + (
        0.10599088619427)*y2^1*x2^3 + (-0.0311912243742686)*y2^1*x2^4);
    else
      if p < sat.psat then
  x1 := (p-(2557114.88519498))/(1413182.14146982);
  y1 := (T-(368.962789646881))/(49.6511585937515);
  d1 := (0) + (1) * (72.4673451196848 + (48.747095068058)*x1^1 + (6.23191503754805)*x1^2 + (1.04050224938105)*x1^3 + (0.567726549561638)*x1^4 + (0.0932321559076097)*x1^5 + (-0.360885881436796)*x1^6 + (1.28068452524156)*x1^7 + (1.06577883644539)*x1^8 + (-1.99711947941136)*x1^9 + (-1.44678640775593)*x1^10 + (1.20018741172135)*x1^11 + (0.853546056385162)*x1^12 + (-0.329764047290808)*x1^13 + (-0.23272984842566)*x1^14 + (0.0344891241850553)*x1^15 + (0.0241532472331232)*x1^16 + (-17.9789227494755)*y1^1 + (5.82503909222006)*y1^2 + (-2.78595570494937)*y1^3 + (3.19530678611049)*y1^4 + (-2.13520897173966)*y1^5 + (0.476112131319811)*y1^6 + (0.0180148100259595)*x1^15*y1^1 + (0.0671983465772878)*x1^14*y1^1 + (-0.0231125330926145)*x1^14*y1^2 + (-0.0894987039385263)*x1^13*y1^1 + (0.0313955248670506)*x1^13*y1^2 + (-0.040051833346326)*x1^13*y1^3 + (-0.532041879544919)*x1^12*y1^1 + (0.481814040999413)*x1^12*y1^2 + (-0.275970127268419)*x1^12*y1^3 + (0.0595656346612924)*x1^12*y1^4 + (0.0982162914145338)*x1^11*y1^1 + (0.15313898975363)*x1^11*y1^2 + (-0.417480184022921)*x1^11*y1^3 + (0.398690880981839)*x1^11*y1^4 + (-0.0701269844815475)*x1^11*y1^5 + (1.80583502511502)*x1^10*y1^1 + (-2.61992220201529)*x1^10*y1^2 + (0.927414069768541)*x1^10*y1^3 + (0.646867664174733)*x1^10*y1^4 + (-0.358268894813906)*x1^10*y1^5 + (0.0317598014122311)*x1^10*y1^6 + (0.255369672573349)*x1^9*y1^1 + (-2.10284280349872)*x1^9*y1^2 + (2.70476046968443)*x1^9*y1^3 + (-0.831729960654545)*x1^9*y1^4 + (-0.367575376717921)*x1^9*y1^5 + (0.118852155856873)*x1^9*y1^6 + (-3.42174233434026)*x1^8*y1^1 + (6.17083877403159)*x1^8*y1^2 + (-0.830116315750902)*x1^8*y1^3 + (-2.67778456580955)*x1^8*y1^4 + (0.867895545592989)*x1^8*y1^5 + (0.0136992544264435)*x1^8*y1^6 + (-0.96520996414829)*x1^7*y1^1 + (7.6160126741786)*x1^7*y1^2 + (-7.93528126528024)*x1^7*y1^3 + (1.0530366207728)*x1^7*y1^4 + (1.37039039275325)*x1^7*y1^5 + (-0.324542370497003)*x1^7*y1^6 + (3.87963397609216)*x1^6*y1^1 + (-4.18020614281834)*x1^6*y1^2 + (-6.62046825385111)*x1^6*y1^3 + (8.75770767644535)*x1^6*y1^4 + (-2.55855423377597)*x1^6*y1^5 + (0.117380045025554)*x1^6*y1^6 + (1.78744711380603)*x1^5*y1^1 + (-8.5130194254542)*x1^5*y1^2 + (0.432267641929898)*x1^5*y1^3 + (11.3113517826107)*x1^5*y1^4 + (-7.85980012364802)*x1^5*y1^5 + (1.47071603482735)*x1^5*y1^6 + (-1.91705372885997)*x1^4*y1^1 + (-0.0949843941880612)*x1^4*y1^2 + (-1.997473493718)*x1^4*y1^3 + (10.2988208629762)*x1^4*y1^4 + (-8.49155787450058)*x1^4*y1^5 + (1.93615111192894)*x1^4*y1^6 + (-2.50033746594717)*x1^3*y1^1 + (5.70360979762331)*x1^3*y1^2 + (-10.5322720390077)*x1^3*y1^3 + (12.2400759177558)*x1^3*y1^4 + (-6.89614017369394)*x1^3*y1^5 + (1.41546506608579)*x1^3*y1^6 + (-6.78589792338576)*x1^2*y1^1 + (7.03151752112028)*x1^2*y1^2 + (-12.3736046239659)*x1^2*y1^3 + (13.6930855976963)*x1^2*y1^4 + (-6.96053351490482)*x1^2*y1^5 + (1.30538371420034)*x1^2*y1^6 + (-18.3917285008394)*x1^1*y1^1 + (8.58256357158168)*x1^1*y1^2 + (-7.9576902925063)*x1^1*y1^3 + (9.72582231178454)*x1^1*y1^4 + (-5.73211692947672)*x1^1*y1^5 + (1.17509668533631)*x1^1*y1^6);
  d := bubbleDensity(sat)*(1 -(sat.psat - p)/dp) + d1*(sat.psat - p)/dp;
      elseif p >= sat.psat then
  x2 := (p-(3230978.96987517))/(1215430.51013093);
  y2 := (T-(286.37703960126))/(30.2813023973015);
  d2 := (0) + (1) * (1128.29342170365 + (7.87960605987028)*x2^1 + (-0.257941704085539)*x2^2 + (0.0359536256629997)*x2^3 + (0.00468405676173685)*x2^4 + (-133.244855967764)*y2^1 + (-23.0011865132665)*y2^2 + (2.65009519098121)*y2^3 + (7.41012261893865)*y2^4 + (-18.6737509725287)*y2^5 + (-13.42480950003)*y2^6 + (11.9194637097639)*y2^7 + (7.18763169338531)*y2^8 + (-3.14754559007914)*y2^9 + (-1.72623019772007)*y2^10 + (1.34539694151813)*y2^9*x2^1 + (3.89985990853728)*y2^8*x2^1 + (-0.477663643528785)*y2^8*x2^2 + (-1.01963032819307)*y2^7*x2^1 + (-1.58757914444201)*y2^7*x2^2 + (0.0535260150930145)*y2^7*x2^3 + (-9.82580093531666)*y2^6*x2^1 + (-0.688688832277525)*y2^6*x2^2 + (0.238676850832625)*y2^6*x2^3 + (-0.0128186939933804)*y2^6*x2^4 + (-1.63106702729664)*y2^5*x2^1 + (1.9888439943296)*y2^5*x2^2 + (0.340643562102322)*y2^5*x2^3 + (-0.00246289257004601)*y2^5*x2^4 + (10.360113896152)*y2^4*x2^1 + (1.02660482095755)*y2^4*x2^2 + (0.0543199338072468)*y2^4*x2^3 + (0.0558666269760638)*y2^4*x2^4 + (5.26843887978288)*y2^3*x2^1 + (-1.40297227072936)*y2^3*x2^2 + (-0.221168110890005)*y2^3*x2^3 + (0.00360942200618328)*y2^3*x2^4 + (0.881530520864514)*y2^2*x2^1 + (-0.930022610155721)*y2^2*x2^2 + (-0.0481483280978479)*y2^2*x2^3 + (-0.0835073418715788)*y2^2*x2^4 + (4.79216519948661)*y2^1*x2^1 + (-0.284394146008372)*y2^1*x2^2 + (0.10599088619427)*y2^1*x2^3 + (-0.0311912243742686)*y2^1*x2^4);
