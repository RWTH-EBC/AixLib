...
package R410a_FstImp "Refrigerant model developed by Engelpracht"
  ...
  */
  redeclare record EoS
    ...
    extends AixLib.DataBase.Media.Refrigerants.R410a.EoS_Engelpracht;
  end EoS;

  redeclare record BDSP
    "Record that contains fitting coefficients of the state properties at bubble
    and dew lines"
    extends AixLib.DataBase.Media.Refrigerants.R410a.BDSP_Engelpracht;
  end BDSP;
  ...
  redeclare record TSP
    ...
    extends AixLib.DataBase.Media.Refrigerants.R410a.TSP_Engelpracht;
  end TSP;
