...
<ul>
  ...
  <li>August 02, 2016, by Philipp Mehrfeld:<br/>
    First implementation.
  </li>
</ul></html>",revisions="<html>
<p>
  This model tests the implementation the <a href=\"Modelica://AixLib.Controls.Continuous.LimPID\">AixLib.Controls.Continuous.LimPID</a> with integrator reset.
</p>
<p>
  The instance <code>limPIOri</code> is the original implementation of the controller from the Modelica Standard Library. The instance <code>limPIWithReset</code> is the implementation from this library with integrator reset enabled. Whenever the boolean pulse input becomes true, the integrator is reset to <code>y_reset</code>.
