...
<p>
  Example that demonstrates the use of the signal ranker model. The figure below shows the input and output signals of the block. Note that <code>sigRan.y[1] ≥ sigRan.y[2] ≥ sigRan.y[3]</code>.
</p>
<p align=\"center\">
  <img src=\"modelica://AixLib/Resources/Images/Controls/Continuous/Examples/SignalRankerU.png\" border=\"1\" alt=\"Input" to="" signal=""><br/>
  <img src=\"modelica://AixLib/Resources/Images/Controls/Continuous/Examples/SignalRankerY.png\" border=\"1\" alt=\"Output" of="" signal="">
