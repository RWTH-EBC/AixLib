...
<p>
  Example that demonstrates the use of the PID controller with hysteresis and off timer. The example is identical to <a href=\"modelica://AixLib.Controls.Continuous.Examples.PIDHysteresis\">AixLib.Controls.Continuous.Examples.PIDHysteresis</a>, except that the controller also has an off timer. This timer keeps the control signal at <i>y=0</i> for a period of <code>minOffTime=1000</code> seconds. This may be used to avoid short-cycling if the load is small and the system has little heat capacity.
</p>
<p>
  The figure below shows the control error <code>con.feeBac.y</code> and the control signal <code>con.y</code>.
</p>
<p align=\"center\">
  <img src=\"modelica://AixLib/Resources/Images/Controls/Continuous/Examples/PIDHysteresisTimerError.png\" border=\"1\" alt=\"Control"><br/>
  <img src=\"modelica://AixLib/Resources/Images/Controls/Continuous/Examples/PIDHysteresisTimerOutput.png\" border=\"1\" alt=\"Control">
