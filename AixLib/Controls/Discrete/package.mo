...
This package contains components models for discrete time controls. For additional models, see also <a href=\"modelica://Modelica.Blocks.Discrete\">Modelica.Blocks.Discrete</a>. </html>",revisions="<html>
