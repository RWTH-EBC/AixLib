...
info="<html>
<p>
  Block that delays the boolean input signal by one sampling interval. For example, if <i>u</i> denotes the input, <i>y</i> denotes the output, and <i>t<sub>i</sub></i> and <i>t<sub>i+1</sub></i> denote subsequent sampling instants, then the model outputs
</p>
...
<ul>
  <li>June 6, 2015, by Michael Wetter:<br/>
    Set start value and <code>fixed</code> attribute for <code>firstTrigger</code> to avoid a translation warning in pedantic mode in Dymola 2016. This is for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/266\">#266</a>.
  </li>
