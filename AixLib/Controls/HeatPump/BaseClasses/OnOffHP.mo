...
model OnOffHP "Converts a desired temperature to a certain compressor speed"
  ...
  Modelica.Blocks.Sources.BooleanConstant booleanConstant annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={0,38})));
equation
  ...
  connect(swiNullsecHeaGen.u2, booleanConstant.y) annotation (Line(points={{
          -5.55112e-16,78.4},{0,78.4},{0,49}}, color={255,0,255}));
