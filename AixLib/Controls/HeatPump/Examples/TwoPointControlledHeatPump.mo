...
<p>Example for an two-point hysteresis controlled heat pump. Play around with the bandwith settings to see how it influence nSet depending on TSet and TMea.</p>
