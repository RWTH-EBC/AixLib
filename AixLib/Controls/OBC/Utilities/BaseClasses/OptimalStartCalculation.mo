within AixLib.Controls.OBC.Utilities.BaseClasses;
block OptimalStartCalculation
  ...
  AixLib.Controls.OBC.CDL.Interfaces.RealInput TDif(
    final quantity="TemperatureDifference",
    final unit="K")
  ...
  AixLib.Controls.OBC.CDL.Interfaces.BooleanInput staCal
    "Start calculation"
    annotation (Placement(transformation(extent={{-320,20},{-280,60}}),
      iconTransformation(extent={{-140,-20},{-100,20}})));
  AixLib.Controls.OBC.CDL.Interfaces.RealInput tNexOcc(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  AixLib.Controls.OBC.CDL.Interfaces.RealOutput tOpt(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  AixLib.Controls.OBC.CDL.Interfaces.BooleanOutput optOn
...
protected
  ...
  AixLib.Controls.OBC.CDL.Reals.Min min
    "Get the final optimal start time"
    annotation (Placement(transformation(extent={{240,-16},{260,4}})));
  AixLib.Controls.OBC.CDL.Discrete.TriggeredSampler triSam
  ...
  AixLib.Controls.OBC.CDL.Reals.Switch dTUse
    "dT used in the calculations (to avoid negative dT)"
    annotation (Placement(transformation(extent={{80,70},{100,90}})));
  AixLib.Controls.OBC.CDL.Reals.GreaterThreshold reqStaUp(
    final t=0,
    final h=0)
    "Output true if optimal startup is needed"
    annotation (Placement(transformation(extent={{10,70},{30,90}})));
  AixLib.Controls.OBC.CDL.Logical.And triAve
...
<a href=\"modelica://AixLib.Controls.OBC.Utilities.OptimalStart\">
AixLib.Controls.OBC.Utilities.OptimalStart</a>.
</p>
</html>",
      revisions="<html>
<ul>
