...
block OptimalStart
  ...
  AixLib.Controls.OBC.CDL.Interfaces.RealInput TSetZonHea(
  ...
  AixLib.Controls.OBC.CDL.Interfaces.RealInput TZon(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
    min=200)
  ...
  AixLib.Controls.OBC.CDL.Interfaces.RealInput TSetZonCoo(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
  ...
  AixLib.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optHea(
  ...
  AixLib.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optCoo(
    final tOptMax=tOptMax,
    final thrOptOn=thrOptOn,
    final nDay=nDay,
    final uLow=uLow,
  ...
  AixLib.Controls.OBC.CDL.Reals.GreaterThreshold hysSta(
    t=60,
    h=60)
...
protected
  AixLib.Controls.OBC.CDL.Reals.Max max
    "Get the maximum optimal start time "
    annotation (Placement(transformation(extent={{100,30},{120,50}})));
  AixLib.Controls.OBC.CDL.Reals.AddParameter addPar(
    p=-tOptMax)
    "Maximum optimal start time"
    annotation (Placement(transformation(extent={{-100,-10},{-80,10}})));
  AixLib.Controls.OBC.CDL.Logical.Or or2
    "Get the optimal start boolean output"
    annotation (Placement(transformation(extent={{100,-50},{120,-30}})));
  AixLib.Controls.OBC.CDL.Reals.Subtract dTHea if computeHeating
    "Temperature difference between heating setpoint and zone temperature"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  AixLib.Controls.OBC.CDL.Reals.Subtract dTCoo if computeCooling
...
The base class
<a href=\"modelica://AixLib.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation\">
AixLib.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation</a> is used
for the calculation.
</p>
<h4>Algorithm</h4>
<p>
...
<a href=\"modelica://AixLib.Controls.OBC.CDL.Discrete.TriggeredMovingMean\">
AixLib.Controls.OBC.CDL.Discrete.TriggeredMovingMean</a> for details about
...
<a href=\"modelica://AixLib.Controls.OBC.Utilities.Validation\">
AixLib.Controls.OBC.Utilities.Validation</a>.
</p>
</html>",
      revisions="<html>
<ul>
