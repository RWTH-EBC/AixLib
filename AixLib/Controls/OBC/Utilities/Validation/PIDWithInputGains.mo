...
model PIDWithInputGains
  ...
  AixLib.Controls.OBC.CDL.Logical.Sources.Pulse resSig(period=1)
    "Reset signal"
    annotation (Placement(transformation(extent={{-80,40},{-60,60}})));
  AixLib.Controls.OBC.CDL.Reals.Sources.Pulse k(
    amplitude=0.2,
    width=0.4,
    period=1,
    shift=0.6,
  ...
  AixLib.Controls.OBC.CDL.Reals.Sources.Pulse Ti(
    amplitude=0.2,
    width=0.4,
    period=1,
    shift=0.6,
  ...
  AixLib.Controls.OBC.CDL.Reals.Sources.Pulse Td(
    amplitude=0.1,
    width=0.4,
    period=1,
    shift=0.6,
  ...
  AixLib.Controls.OBC.CDL.Reals.Abs abs1
    "Absolute value of controller output"
    annotation (Placement(transformation(extent={{110,-10},{130,10}})));
  AixLib.Controls.OBC.CDL.Reals.Subtract sub
    "Difference in controller output"
    annotation (Placement(transformation(extent={{80,-10},{100,10}})));
  AixLib.Controls.OBC.CDL.Reals.LessThreshold lesThr(t=1E-5, h=1E-4)
    "Output true if outputs are bigger than threshold"
    annotation (Placement(transformation(extent={{140,-10},{160,10}})));
  AixLib.Controls.OBC.CDL.Utilities.Assert assMes(
  ...
  AixLib.Controls.OBC.CDL.Reals.Sources.CivilTime modTim
    "Civil time"
    annotation (Placement(transformation(extent={{80,40},{100,60}})));
  AixLib.Controls.OBC.CDL.Reals.GreaterThreshold greThr(t=0.59)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/PIDWithInputGains.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.Utilities.PIDWithInputGains\">
AixLib.Controls.OBC.Utilities.PIDWithInputGains</a>.
</p>
<p>
