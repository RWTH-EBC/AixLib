...
block MultiSum
  ...
  parameter Integer k[nin]=fill(1, nin)
    "Input gains";
  AixLib.Controls.OBC.CDL.Interfaces.IntegerInput u[nin]
...
<p>
See
<a href=\"modelica://AixLib.Controls.OBC.CDL.Integers.Validation.MultiSum\">
AixLib.Controls.OBC.CDL.Integers.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
