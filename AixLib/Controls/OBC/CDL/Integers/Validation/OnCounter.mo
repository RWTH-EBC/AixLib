...
model OnCounter
  ...
  AixLib.Controls.OBC.CDL.Integers.OnCounter onCounter
  ...
  AixLib.Controls.OBC.CDL.Logical.Sources.Pulse reset(
    width=0.5,
    period=1.0)
    "Block that outputs cyclic on and off"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/OnCounter.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Integers.OnCounter\">
AixLib.Controls.OBC.CDL.Integers.OnCounter</a>.
</p>
</html>",
      revisions="<html>
<ul>
