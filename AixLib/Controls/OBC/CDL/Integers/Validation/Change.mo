...
model Change
  ...
  AixLib.Controls.OBC.CDL.Integers.Change cha
  ...
  AixLib.Controls.OBC.CDL.Discrete.TriggeredSampler changeSampler
    "Triggered sampler"
  ...
  AixLib.Controls.OBC.CDL.Discrete.TriggeredSampler increaseSampler
    "Increase sampler"
    annotation (Placement(transformation(extent={{60,60},{80,80}})));
  AixLib.Controls.OBC.CDL.Discrete.TriggeredSampler decreaseSampler
    "Decrease sampler"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Change.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Integers.Change\">
AixLib.Controls.OBC.CDL.Integers.Change</a>.
</p>
</html>",
      revisions="<html>
<ul>
