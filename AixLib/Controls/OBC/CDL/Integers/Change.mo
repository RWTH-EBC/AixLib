...
block Change
  ...
  AixLib.Controls.OBC.CDL.Interfaces.IntegerInput u
  ...
  AixLib.Controls.OBC.CDL.Interfaces.BooleanOutput up
    "Output that is true when the input increased its value"
    annotation (Placement(transformation(extent={{100,40},{140,80}})));
  AixLib.Controls.OBC.CDL.Interfaces.BooleanOutput down
