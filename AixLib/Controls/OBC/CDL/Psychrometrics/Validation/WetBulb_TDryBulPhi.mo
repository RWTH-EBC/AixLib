...
model WetBulb_TDryBulPhi
  ...
  AixLib.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi wetBulPhi
    "Model for wet bulb temperature"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  AixLib.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi wetBulPhi1
    "Model for wet bulb temperature"
  ...
  AixLib.Controls.OBC.CDL.Reals.Sources.Ramp TDryBul1(
    duration=1,
    height=40,
    offset=273.15) "Dry bulb temperature"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  AixLib.Controls.OBC.CDL.Reals.Sources.Constant phi2(k=0.6)
    "Relative humidity"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Psychrometrics/Validation/WetBulb_TDryBulPhi.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This examples is a unit test for the dew point temperature computation
<a href=\"modelica://AixLib.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi\">
AixLib.Controls.OBC.CDL.Psychrometrics.WetBulb_TDryBulPhi</a>.
</p>
</html>",
      revisions="<html>
<ul>
