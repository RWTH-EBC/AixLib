...
block MultiSum
  ...
  parameter Real k[nin]=fill(1, nin)
    "Input gains";
  AixLib.Controls.OBC.CDL.Interfaces.RealInput u[nin]
...
<p>
See
<a href=\"modelica://AixLib.Controls.OBC.CDL.Reals.Validation.MultiSum\">
AixLib.Controls.OBC.CDL.Reals.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
