...
model CivilTime "Test model for the CivilTime block"
  AixLib.Controls.OBC.CDL.Reals.Sources.CivilTime civTim
    "Civil time"
  ...
  annotation (
    experiment(
      ...
      StopTime=1),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Sources/Validation/CivilTime.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
