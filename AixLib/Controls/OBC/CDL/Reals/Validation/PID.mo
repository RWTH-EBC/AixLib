...
model PID
  ...
  AixLib.Controls.OBC.CDL.Reals.PID limPID(
  ...
  AixLib.Controls.OBC.CDL.Reals.PID limPI(
    Ti=1,
    Td=1,
    yMin=-1,
  ...
  AixLib.Controls.OBC.CDL.Reals.PID limPD(
    Ti=1,
    Td=1,
    yMin=-1,
    controllerType=AixLib.Controls.OBC.CDL.Types.SimpleController.PD)
    "PD controller"
    annotation (Placement(transformation(extent={{-30,-30},{-10,-10}})));
  AixLib.Controls.OBC.CDL.Reals.PID limP(
    Ti=1,
    Td=1,
    yMin=-1,
    controllerType=AixLib.Controls.OBC.CDL.Types.SimpleController.P)
    "P controller"
    annotation (Placement(transformation(extent={{-30,-60},{-10,-40}})));
  AixLib.Controls.OBC.CDL.Reals.PID noLimPID(
    Ti=1,
    Td=1,
    yMax=1e15,
    yMin=-1e15,
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PID.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Reals.PID\">
AixLib.Controls.OBC.CDL.Reals.PID</a>.
