...
model PIDInitialDerivativeOutput
  ...
  AixLib.Controls.OBC.CDL.Reals.Sources.Constant ySet(
    k=0.75)
    "Set point"
    annotation (Placement(transformation(extent={{-40,30},{-20,50}})));
  AixLib.Controls.OBC.CDL.Reals.Sources.Constant yMea(
    k=0.75)
    "Measured value"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PIDInitialDerivativeOutput.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
