...
model Derivative
  ...
  AixLib.Controls.OBC.CDL.Reals.Derivative der1(y_start=1)
  ...
  AixLib.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes(y_start=1)
    "Integration of input"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  Logical.Sources.Constant booSig(k=false) "Contant boolean signal"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));
  AixLib.Controls.OBC.CDL.Reals.Cos cos "Cosine of model time"
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  AixLib.Controls.OBC.CDL.Reals.Derivative der2(y_start=0)
    "Derivative block with input gains"
  ...
  AixLib.Controls.OBC.CDL.Reals.Abs abs "Absolute difference"
    annotation (Placement(transformation(extent={{110,26},{130,46}})));
  AixLib.Controls.OBC.CDL.Reals.LessThreshold lesThr(t=0.1, h=0.01)
    "Output true if difference is within expected accuracy"
    annotation (Placement(transformation(extent={{140,26},{160,46}})));
  AixLib.Controls.OBC.CDL.Reals.MultiplyByParameter gai(final k=1)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-07),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/Derivative.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Reals.Derivative\">
AixLib.Controls.OBC.CDL.Reals.Derivative</a>.
