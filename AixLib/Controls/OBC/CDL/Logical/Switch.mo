...
block Switch
  ...
  AixLib.Controls.OBC.CDL.Interfaces.BooleanInput u1
    "Input u1"
    annotation (Placement(transformation(extent={{-140,60},{-100,100}})));
  AixLib.Controls.OBC.CDL.Interfaces.BooleanInput u2
    "Boolean switch input signal, if true, y=u1, else y=u3"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));
  AixLib.Controls.OBC.CDL.Interfaces.BooleanInput u3
    "Input u3"
