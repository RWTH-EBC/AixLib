...
model MultiAnd
  ...
  AixLib.Controls.OBC.CDL.Logical.MultiAnd mulAnd0
    "Logical and with multiple inputs: 0 input"
    annotation (Placement(transformation(extent={{40,60},{60,80}})));
  AixLib.Controls.OBC.CDL.Logical.MultiAnd mulAnd1(
    nin=1)
    "Logical 'MultiAnd': 1 input connection y=u"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  AixLib.Controls.OBC.CDL.Logical.MultiAnd mulAnd2(
    nin=2)
    "Logical 'MultiAnd': 2 input connections y=and(u1, u2)"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  AixLib.Controls.OBC.CDL.Logical.MultiAnd mulAnd5(
    nin=5)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/MultiAnd.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Logical.MultiAnd\">
AixLib.Controls.OBC.CDL.Logical.MultiAnd</a>.
</p>
<p>
