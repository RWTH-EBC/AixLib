...
model VariablePulse
  ...
  AixLib.Controls.OBC.CDL.Reals.Sources.Pulse conPul1(
    amplitude=0.65,
    width=0.85,
    period=3600,
    shift=360)
  ...
  AixLib.Controls.OBC.CDL.Reals.Sources.Pulse conPul2(
    amplitude=0.5,
    width=0.5,
    period=3600,
    shift=360,
  ...
  AixLib.Controls.OBC.CDL.Logical.VariablePulse conChaWid(
    period=900)
...
annotation (experiment(
      ...
      Tolerance=1e-06),
  __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/VariablePulse.mos" "Simulate and plot"),
  Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Logical.VariablePulse\">
AixLib.Controls.OBC.CDL.Logical.VariablePulse</a>.
</p>
<ul>
<li>
