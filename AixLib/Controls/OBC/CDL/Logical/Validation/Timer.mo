...
model Timer
  ...
  AixLib.Controls.OBC.CDL.Logical.Timer noThr
    "Timer that do not compare threshold"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  AixLib.Controls.OBC.CDL.Logical.Timer thrTim(
    final t=0.3)
    "Timer that compares threshold"
    annotation (Placement(transformation(extent={{20,-30},{40,-10}})));
  AixLib.Controls.OBC.CDL.Logical.Timer thrTim1(
    final t=0.3)
    "Timer that compares threshold"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Timer.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Logical.Timer\">
AixLib.Controls.OBC.CDL.Logical.Timer</a>.
</p>
</html>",
      revisions="<html>
<ul>
