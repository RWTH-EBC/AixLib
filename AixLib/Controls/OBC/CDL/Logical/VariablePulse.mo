within AixLib.Controls.OBC.CDL.Logical;
block VariablePulse "Generate boolean pulse with the width specified by input"
  ...
  AixLib.Controls.OBC.CDL.Interfaces.RealInput u(
    final min=0,
    final max=1,
    final unit="1")
  ...
  AixLib.Controls.OBC.CDL.Interfaces.BooleanOutput y
...
protected
  ...
  AixLib.Controls.OBC.CDL.Logical.Edge edg2
    "Rising edge when there is a width change"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  AixLib.Controls.OBC.CDL.Logical.Pre preBre
    "Break loop"
  ...
  block Cycle
    ...
    AixLib.Controls.OBC.CDL.Interfaces.BooleanInput go
  ...
  equation
    ...
    t_sta = t0 + AixLib.Utilities.Math.Functions.round(
...
<p align=\"center\">
<img src=\"modelica://AixLib/Resources/Images/Controls/OBC/CDL/Logical/VariablePulse.png\"
