...
model BooleanVectorFilter
  ...
  AixLib.Controls.OBC.CDL.Routing.BooleanVectorFilter
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/BooleanVectorFilter.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Routing.BooleanVectorFilter\">
AixLib.Controls.OBC.CDL.Routing.BooleanVectorFilter</a>.
</p>
</html>",
      revisions="<html>
<ul>
