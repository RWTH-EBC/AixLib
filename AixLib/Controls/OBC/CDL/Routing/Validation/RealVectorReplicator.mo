...
model RealVectorReplicator
  ...
  AixLib.Controls.OBC.CDL.Routing.RealVectorReplicator
    reaRep(nin=2, nout=3)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/RealVectorReplicator.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Routing.RealVectorReplicator\">
AixLib.Controls.OBC.CDL.Routing.RealVectorReplicator</a>.
</p>
</html>",
      revisions="<html>
<ul>
