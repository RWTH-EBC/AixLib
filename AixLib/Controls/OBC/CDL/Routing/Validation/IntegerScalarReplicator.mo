...
model IntegerScalarReplicator
  ...
  AixLib.Controls.OBC.CDL.Routing.IntegerScalarReplicator intRep(
    nout=3)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/IntegerScalarReplicator.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Routing.IntegerScalarReplicator\">
AixLib.Controls.OBC.CDL.Routing.IntegerScalarReplicator</a>.
</p>
</html>",
      revisions="<html>
<ul>
