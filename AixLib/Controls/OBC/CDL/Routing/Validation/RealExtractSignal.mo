...
model RealExtractSignal
  ...
  AixLib.Controls.OBC.CDL.Routing.RealExtractSignal extSig(
    final nin=5,
    final nout=3,
    final extract={1,2,5})
    "Block that extracts signals from an input signal vector"
    annotation (Placement(transformation(extent={{20,30},{40,50}})));
  AixLib.Controls.OBC.CDL.Routing.RealExtractSignal extSig1(
    final nin=5,
    final nout=6,
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/RealExtractSignal.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Routing.RealExtractSignal\">
AixLib.Controls.OBC.CDL.Routing.RealExtractSignal</a>.
</p>
<p>
