...
model BooleanExtractor
  ...
  AixLib.Controls.OBC.CDL.Integers.Sources.Constant conInt1(
    k=6)
    "Index to extract input signal"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/BooleanExtractor.mos" "Simulate and plot"),
  Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Routing.BooleanExtractor\">
AixLib.Controls.OBC.CDL.Routing.BooleanExtractor</a>.
</p>
<p>
