...
model IntegerExtractor
  ...
  AixLib.Controls.OBC.CDL.Routing.IntegerExtractor extIndInt(
    final nin=4) "Extracts signal from an input signal vector"
    annotation (Placement(transformation(extent={{40,80},{60,100}})));
  AixLib.Controls.OBC.CDL.Routing.IntegerExtractor extIndInt1(
    final nin=4)
    "Extracts signal from an input signal vector when the extract index is out of the upper range"
    annotation (Placement(transformation(extent={{40,40},{60,60}})));
  AixLib.Controls.OBC.CDL.Routing.IntegerExtractor extIndInt2(
    final nin=4)
    "Extracts signal from an input signal vector when the extract index is out of the lower range"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));
  AixLib.Controls.OBC.CDL.Routing.IntegerExtractor extIndInt3(
    final nin=4)
    "Extracts signal from an input signal vector when the extract index changes from within range to out of range"
    annotation (Placement(transformation(extent={{40,-40},{60,-20}})));
  AixLib.Controls.OBC.CDL.Routing.IntegerExtractor extIndInt4(
    final nin=4)
    "Extracts signal from an input signal vector when the extract index changes from out of range to within range"
    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));

  AixLib.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    final k=0)
    "Block that outputs integer constant"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Constant conInt3(
    final k=4)
    "Block that outputs integer constant"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Pulse intPul(
    final amplitude=1,
    final period=0.2) "Generate pulse signal of type Integer"
    annotation (Placement(transformation(extent={{-80,20},{-60,40}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Pulse intPul1(
    final period=0.3,
    final amplitude=2,
    final offset=-1)   "Generate pulse signal of type Integer"
    annotation (Placement(transformation(extent={{-80,-40},{-60,-20}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Constant conInt(
    final k=2)
    "Index to extract input signal"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Constant conInt1(k=6)
    "Index to extract input signal"
    annotation (Placement(transformation(extent={{0,20},{20,40}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Constant conInt4(k=0)
    "Index to extract input signal"
    annotation (Placement(transformation(extent={{0,-20},{20,0}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Pulse intPul2(
    final period=1,
    final amplitude=3,
    final offset=-1)
    "Generate pulse signal of type Integer"
    annotation (Placement(transformation(extent={{0,-60},{20,-40}})));
  AixLib.Controls.OBC.CDL.Integers.Sources.Pulse intPul3(
    final period=1,
    final amplitude=-3,
    final offset=3)
    "Generate pulse signal of type Integer"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/IntegerExtractor.mos" "Simulate and plot"),
  Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Routing.IntegerExtractor\">
AixLib.Controls.OBC.CDL.Routing.IntegerExtractor</a>.
</p>
<p>
