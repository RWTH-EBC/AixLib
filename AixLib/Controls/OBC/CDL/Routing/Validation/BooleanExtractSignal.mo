...
model BooleanExtractSignal
  ...
  AixLib.Controls.OBC.CDL.Routing.BooleanExtractSignal extBooSig(
    final nin=4,
    final nout=3,
    final extract={3,2,4})
    "Block that extracts signal from a boolean input signal vector"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  AixLib.Controls.OBC.CDL.Routing.BooleanExtractSignal extBooSig1(
    final nin=4,
    final nout=5,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/BooleanExtractSignal.mos" "Simulate and plot"),
  Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://AixLib.Controls.OBC.CDL.Routing.BooleanExtractSignal\">
AixLib.Controls.OBC.CDL.Routing.BooleanExtractSignal</a>.
</p>
<p>
