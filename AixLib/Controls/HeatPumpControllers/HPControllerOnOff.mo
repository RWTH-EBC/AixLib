...
equation
  ...
  connect(mode.y, heatPumpControlBus.input_mode) annotation (Line(points={{9,-40},
          {40,-40},{40,0},{99.6475,0},{99.6475,0.3525}},
                                                     color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(onOffController.y, heatPumpControlBus.input_on) annotation (Line(
        points={{11,0},{99.6475,0},{99.6475,0.3525}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
