...
<p>The results generated by this model differ from the results presented in [Roozbeh Sangi, Felix B&uuml;nning, Marc Baranski, Johannes F&uuml;tterer, Dirk M&uuml;ller. A Platform for the Agent-based Control of HVAC Systems. Modelica Conference, 2017, Prague, Czech Republic] because an older version of the AixLib library was used. The model presented here was adapted to the use of AixLib v0.4.0, which has a different physical model for the thermal zones than the version used originally. The result image below (generated with this model) however gives an impression on how the system behaves depneding on the price of electricity.</p>
