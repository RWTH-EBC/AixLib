...
equation
  ...
  connect(add4.y, product.u2) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(add1.u1, division.y) annotation (Line(
      points={{58,44},{44,44},{44,72},{-11,72}},
      color={0,0,127},
      smooth=Smooth.None));
...
<ul>
<li><span style=\"font-family: MS Shell Dlg 2;\">This model determines the exergy destruction of a heat pump in heating mode based on the inputs of the component.</span></li>
...
<p><span style=\"font-family: MS Shell Dlg 2;\"><img src=\"modelica://HVACAgentBasedControl/Resources/Images/HeatPump.png\"/></span></p>
...
<p><span style=\"font-family: MS Shell Dlg 2;\"><img src=\"modelica://HVACAgentBasedControl/Resources/Images/HPheatingCostfkt.PNG\"/></span></p>
