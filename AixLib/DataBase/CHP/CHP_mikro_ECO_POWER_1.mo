...
<p>Electrical output is taken from the manufacturer&apos;s website. The values for heat output, fuel input and fuel consumption are calculated with the provided efficiency. They are not given by the manufacturer.</p>
