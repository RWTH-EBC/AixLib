...
record CHPEngDataBaseRecord "Base record for CHP engine data"
  ...
  constant Modelica.SIunits.MassFlowRate m_floCooNominal=0.5556 "Nominal mass flow rate of coolant inside the engine cooling circle (default value is 0,5556kg/s)";
  ...
  constant Modelica.SIunits.Power P_mecNominal "Mechanical power output at nominal operating point";
