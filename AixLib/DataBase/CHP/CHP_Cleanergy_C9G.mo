...
<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\">
  ...
  <tr>
    <td valign=\"top\">
      <p>
        Fuels: natural gas (all qualities), mainly designed for low caloric gas (bio gas)
      </p>
    </td>
    <td valign=\"top\">
      <p>
...
<p>
  <br/>
  <br/>
  <b>The CHP engine is not designed for continuous operation at more than 80% load (7.2 kW).</b> Continuous use at higher load than 80% decreases the time between services.
</p>
<p>
  For low methane applications, the C9G LowCal is capped to 120 bar engine pressure being equivalent to 7.2 kW.
</p>
<p>
  Source:
</p>
<ul>
  <li>URL: <a href=\"http://www.ecpower.eu/deutsch/xrgi/technische-daten/xrgir-9.html\">www.ecpower.eu/xrgir-9.html</a>
  </li>
