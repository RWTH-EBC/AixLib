...
<p>Parameter <code>g</code> might be irrelevant, depening on calculation model used from <a href=\"AixLib.ThermalZones.HighOrder.Components.WindowsDoors.BaseClasses.CorrectionSolarGain\">AixLib.ThermalZones.HighOrder.Components.WindowsDoors.BaseClasses.CorrectionSolarGain</a>.</p>
...
<p>Base data definition for record to be used in model <a href=\"Building.Components.WindowsDoors.WindowSimple\">Building.Components.WindowsDoors.WindowSimple</a> </p>
 ...
 <ul>
  <li>July 22, 2020, by Philipp Mehrfeld:<br/>Deleted Emissivity, which is part of panes record.</li>
