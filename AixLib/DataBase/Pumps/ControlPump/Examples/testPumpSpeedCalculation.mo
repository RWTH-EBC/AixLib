within AixLib.DataBase.Pumps.ControlPump.Examples;
model testPumpSpeedCalculation
  ...
  //
  parameter AixLib.DataBase.Pumps.ControlPump.PumpBaseRecord param=
      AixLib.DataBase.Pumps.ControlPump.Pump_DN25_1_6_4()
