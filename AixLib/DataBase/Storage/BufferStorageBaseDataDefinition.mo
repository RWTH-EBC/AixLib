...
///////////input parameters////////////
  ...
  parameter SI.Height hLowerPort_Demand "Height of lower demand port";
  parameter SI.Height hUpperPort_Demand "Height of upper demand port";
  parameter SI.Height hLowerPort_Supply "Height of lower supply port";
  parameter SI.Height hUpperPort_Supply "Height of upper supply port";
