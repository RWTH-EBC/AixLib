...
record TSP_IIR_P1_395_T233_370
  ...
  extends
    ...
    temperature_ph_nT={4, 9, 40, 4, 9, 40},
    temperature_ph_sc_a={0.0532548969281581, -0.0327402932674217,
                         0.00529495748475652, -0.0147899438674052},
    temperature_ph_sc_b={59.7998195834653, -6.62177534265252,
                         -2.9999979725331, 1.18395227550521,
                         2.80248047103141, -2.62761643515741,
                         -3.56947078020548, 0.491461507071165,
                         0.927463043044066},
    temperature_ph_sc_c={-1.19878518364951, -0.962577907835024,
    ...
    temperature_ph_sc_d={314.827695408612},
    temperature_ph_sh_a={19.7159455145757, -0.349661716358068,
                         -0.0779836049824056, -0.0404894448559818},
    temperature_ph_sh_b={44.9076643959871, 1.61226716995587,
                         -1.69537088625365, 1.26072555204728,
                         -0.567008612580563, 0.0701057832233571,
                         0.0254180887275049, -0.0124041988508943,
                         0.0028610409309618},
    temperature_ph_sh_c={-0.00106840793875426, 0.0416365945399298,
    ...
    temperature_ph_sh_d={363.221803450648},
    temperature_ph_iO={3258359.21215142,1352817.03780238,
                       258541.38494292, 87545.3330013087, 0, 1,
                       1623982.43177388, 1517145.25710131,
                       464371.882231745, 51004.186742787, 0, 1},
    temperature_ps_nT={4, 10, 45, 4, 10, 45},
    temperature_ps_sc_a={0.94996237530845, 0.303157516353388,
                         0.0425905424516415, -0.00612110456282157},
    temperature_ps_sc_b={52.1272715438709, 0.934991565642564,
    ...
    temperature_ps_sc_c={-0.291069659186083, -0.0872169090380506,
    ...
    temperature_ps_sc_d={300.587264376628},
    temperature_ps_sh_a={40.390945841519, 3.15200862940067,
                         0.84009020654906, 0.177443077694145},
    temperature_ps_sh_b={39.8941858976051, 2.0764693478832,
    ...
    temperature_ps_sh_c={-0.00140522490504156, 0.00329122730110688,
    ...
    temperature_ps_sh_d={327.5152079225},
    temperature_ps_iO={14.7875365886205,0.663511063673611,
                       1126.31192475932, 244.853512874793, 0, 1,
                       13.204266881401, 1.16895892611495,
                       1831.0596916082, 116.879525072462, 0, 1},
    density_pT_nT={3, 12, 46, 18, 4, 85},
    density_pT_sc_a={7.87433412548864, -0.393021216688428,
                     -0.0297809665090564},
    density_pT_sc_b={-152.964391932951, -26.5844725397398,
    ...
    density_pT_sc_c={2.06494548963484, 7.57753444222479,
    ...
    density_pT_sc_d={1189.94427795653},
    density_pT_sh_a={63.4239308958369, 18.3003263667046,
    ...
    density_pT_sh_b={-12.4136441424452, 3.88226290732021,
                     -1.70439246480624, 0.562626262975482},
    density_pT_sh_c={-1.17017884482496, -2.3852489066477,
    ...
    density_pT_sh_d={73.118571695972},
    density_pT_iO={3067141.02087822,1250016.64160742,
