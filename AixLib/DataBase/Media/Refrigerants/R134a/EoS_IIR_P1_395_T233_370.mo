...
record EoS_IIR_P1_395_T233_370
  ...
  extends
    ...
    alpha_0_e2={0},
    alpha_r_nP=8,
    alpha_r_p1={0.05586817,0.498223,0.02458698,0.0008570145,0.0004788584,
                -1.800808,0.2671641,-0.04781652},
    alpha_r_p2={2,1,3,6,6,1,1,2},
    alpha_r_p3={-0.5,0,0,0,1.5,1.5,2,2},
    alpha_r_nB=13,
    alpha_r_b1={0.01423987,0.3324062,-0.007485907,0.0001017263,-0.5184567,
...
<p>
In this record, fitting coefficients are provided for the Helmholtz equation of
state (EoS). For detailed information of the EoS as well as the fitting
