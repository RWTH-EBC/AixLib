...
record TSP_IIR_P1_48_T233_340
  ...
  extends
    ...
    temperature_ph_nT={4, 10,
                       45, 5,
                       10, 51},
    temperature_ph_sc_a={0.0784539758046494, -0.0139499454480583,
                         0.0014409474800833, -0.00847904392329953},
    temperature_ph_sc_b={53.34763090261, -5.88862734169674,
    ...
    temperature_ph_sc_c={-0.0754087777872457, -0.113732590174603,
    ...
    temperature_ph_sc_d={287.021664392518},
    temperature_ph_sh_a={18.9181570336269, -1.4460957111986,
                         0.128879370267952, -0.0378180176318431,
                         0.00571427728154803},
    temperature_ph_sh_b={48.7849078146379, 1.59922925673916,
    ...
    temperature_ph_sh_c={0.000468436089337861, -0.00398289557684647,
                         ...
                         -0.0253808809174481},
    temperature_ph_sh_d={355.510911331556},
    temperature_ph_iO={3386089.75740898,1327435.5559674,
                       ...
                       0, 1},
    temperature_ps_nT={4, 10,
                       45, 5,
                       10, 51},
    temperature_ps_sc_a={1.02968381585158, 0.275193128445195,
                         0.043941556562575, 0.00203028958902996},
    temperature_ps_sc_b={39.25784184622, -0.538203800364751,
    ...
    temperature_ps_sc_c={-0.0164121223780564, -0.021049391159093,
    ...
    temperature_ps_sc_d={285.694699667815},
    temperature_ps_sh_a={53.4524886207332, 3.46209163015464,
                         0.444680383304694, 0.0553158085523391,
                         -0.0022349731521148},
    temperature_ps_sh_b={63.6083149561675, 5.49531435397497,
    ...
    temperature_ps_sh_c={0.0194055969657806, -0.0495407606347934,
                         ...
                         0.00482444147971987},
    temperature_ps_sh_d={353.111903524476},
    temperature_ps_iO={14.8682464548966,0.572967793317542,
    ...
    density_pT_nT={4, 10,
                   45, 12,
                   4, 55},
    density_pT_sc_a={7.87960605987028, -0.257941704085539,
                     0.0359536256629997, 0.00468405676173685},
    density_pT_sc_b={-133.244855967764, -23.0011865132665,
    ...
    density_pT_sc_c={1.34539694151813, 3.89985990853728,
    ...
    density_pT_sc_d={1128.29342170365},
    density_pT_sh_a={67.6100707083323, 18.8214831219552,
    ...
    density_pT_sh_b={-16.9606407389203, 6.77158339360549,
                     -4.11016853249533, 1.38727891703213},
    density_pT_sh_c={-0.248878323514509, -2.3845382310834,
    ...
    density_pT_sh_d={84.139999758958},
    density_pT_iO={3230978.96987517,1215430.51013093,
