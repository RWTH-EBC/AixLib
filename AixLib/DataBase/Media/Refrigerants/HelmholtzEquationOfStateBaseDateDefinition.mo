...
record HelmholtzEquationOfStateBaseDateDefinition
  ...
  parameter String name "Short description of the record"
  ...
  parameter Real f_ResG7[:]
    ...
    annotation (Dialog(group="Residual part"));
  parameter Integer f_ResNNa
    "Number of terms of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa1[:]
    "First coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa2[:]
    "Second coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa3[:]
    "Third coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa4[:]
    "Fourth coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa5[:]
    "Fifth coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa6[:]
    "Sixth coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa7[:]
    "Seventh coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
  parameter Real f_ResNa8[:]
    "Eigth coefficient of the equation's (alpha_r) fourth part (Non-Analytic)"
    annotation (Dialog(group="Residual part"));
...
energy as fundamental thermodynamic relation with temperature and density as
independent variables. The<b> general formula</b> of the EoS as it is
implemented within
...
<p align=\"center\">
  <img src=\"modelica://AixLib/Resources/Images/DataBase/Media/Refrigerants/Helmholtz_EoS.png\"
...
The <b>ideal gas part</b> and the <b>residual part</b>. Both parts&apos;
formulas are given below:
</p>
<p align=\"center\">
  <img src=\"modelica://AixLib/Resources/Images/DataBase/Media/Refrigerants/Helmholtz_IdealGasPart.png\"
  alt=\"Calculation procedure of dimensionless ideal gas Helmholtz energy\"/>
</p>
<p align=\"center\">
  <img src=\"modelica://AixLib/Resources/Images/DataBase/Media/Refrigerants/Helmholtz_ResidualPart.png\"
  alt=\"Calculation procedure of dimensionless residual Helmholtz energy\"/>
</p>
<p>
Both, the ideal gas part and the residual part can be divided in three subparts
(i.e. the summations) that contain different coefficients (e.g. nL,
l<sub>i</sub>, p<sub>i</sub> or e<sub>i</sub>). These coefficients are the
fitting coefficients and must be obtained during a fitting procedure. While the
...
data</b> that is given in terms of, for example, temperature and pressure.
Therefore, all other thermodynamic state properties are also just defined
within a certain predefined range and, as a consequence, the fitting
coefficients are also just valid within the predefined range of Helmholtz
energy.
</p>
<h4>References</h4>
<p>
...
Modelica Conference</i>; September 3-5; 2012; Munich; Germany. Link&ouml;ping
University Electronic Press, S. 63&ndash;70.
</p>
<p>
