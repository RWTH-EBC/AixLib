...
record TSP_IIR_P05_30_T263_343
  ...
  extends
    ...
    temperature_ph_nT={5, 5,
                       21, 5,
                       5, 21},
    temperature_ph_sc_a={-0.0704729863184529, -0.00678884566695906,
                         0.000202836611783306, -9.71248676197528e-06,
                         7.98267274869292e-07},
    temperature_ph_sc_b={20.5578417380748, -0.770247506716285,
                         -0.038647246926071, -0.00751600683912493,
                         -0.0016300055996751},
    temperature_ph_sc_c={-1.12691051342428e-05, 0.000273729410002939,
    ...
    temperature_ph_sh_a={6.59039876392094, 0.0453108439023189,
                         0.00540769150996739, -0.000196566506959251,
                         -4.64422678045603e-05},
    temperature_ph_sh_b={20.795024314138, -0.411365889418558,
                         -0.00497446957449581, 0.0046513295424428,
                         -0.000577281104194347},
    temperature_ph_sh_c={0.000787074643540945, -0.00847992074678385,
    ...
    temperature_ph_iO={1682457.5126701, 720642.233056887,
    ...
    temperature_ps_sc_a={0.490828546245446, 0.117871744016533,
                         0.0181671755438826, 0.00191602988674819,
                         0.00011497599662102},
    temperature_ps_sc_b={19.8608752914032, -0.040817223566116,
                         -0.0857625427384498, -0.0124017661200968,
                         -0.00192723964571896},
    temperature_ps_sc_c={0.000243666235393007, 0.0037715016370504,
    ...
    temperature_ps_sh_a={34.3546579581206, 0.95682930429454,
                         0.129780738468536, 0.0577060502424694,
                         0.0132124973316544},
    temperature_ps_sh_b={36.3220486736092, 0.702977715170277,
                         -0.100508863694088, 0.0160903628800248,
                         -0.00049456983306658},
    temperature_ps_sh_c={-0.00720862103838031, -0.0264862744961215,
    ...
    temperature_ps_iO={14.2251890031606,0.499169296800688,
    ...
    density_pT_nT={5, 5,
                   21, 5,
                   5, 21},
    density_pT_sc_a={1.8705425621798, -0.0351624357762205,
                     0.00126962771607607, 7.69903677841526e-06,
                     1.34663813731525e-05},
    density_pT_sc_b={-29.9062841232497, -2.21393734916457,
                     -0.419234944193293, -0.104815271970145,
                     -0.0227711391125435},
    density_pT_sc_c={1.90380071619604e-06, 0.00219916470789359,
    ...
    density_pT_sh_a={7.85762798977443, 0.561456406237816,
                     0.0745135118619033, 0.0141066470211284,
                     0.00292620516208197},
    density_pT_sh_b={-0.618509525341628, 0.0644646531072409,
                     -0.00894774750115025, 0.00116677386847406,
                     -2.13433530006928e-05},
    density_pT_sh_c={-0.01655069884562, -0.0614336770277778,
    ...
    density_pT_iO={1682457.5126701, 720642.233056887,
...
AixLib.DataBase.Media.Refrigerants.ThermodynamicStatePropertiesBaseDataDefinition
</a>. The fitting coefficients are used in a hybrid refrigerant model
provided in
...
<p>
The provided coefficients are fitted to external data by Sangi et al. and are
