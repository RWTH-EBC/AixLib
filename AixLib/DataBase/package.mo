...
package DataBase "Package contains records for the models in the library."
  ...
  annotation(Icon(graphics={
      ...
      Rectangle(extent={{-6,-20},{52,-62}}, lineColor={0,0,0})}),
                   Diagram, conversion(noneFromVersion = "0.1", noneFromVersion = "1.1", from(version = "2.0", script = "modelica://DataBase/Conversions/ConvertFromDataBase_2.0_To_2.1.mos"), from(version = "2.1", script = "Conversions/ConvertFromDataBase_2.1_To_2.2.mos")), Documentation(info = "<html><h4>
