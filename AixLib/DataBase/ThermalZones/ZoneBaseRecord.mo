...
record ZoneBaseRecord "Base record definition for zone records"
  ...
  parameter Modelica.SIUnits.ThermalConductance heaLoadFacOut "Factor for heat load calculation (part 1) , needs to be multiplied with (indoor set temperature - nominal outside temperature)";
  parameter Modelica.SIUnits.ThermalConductance heaLoadFacGrd "Factor for heat load calculation, (part 2), needs to be multiplied with (indoor set temperature - nominal ground temperature)";
