...
record ZoneRecordDummy "This is a dummy record with non-physical parameter values."
  extends AixLib.DataBase.ThermalZones.ZoneBaseRecord(
    ...
    hConExtHeat=Modelica.Constants.eps,
    hConExtCool=Modelica.Constants.eps,
    nExt=1,
    ...
    hConIntHeat=Modelica.Constants.eps,
    hConIntCool=Modelica.Constants.eps,
    nInt=1,
    ...
    hHeatTABS = Modelica.Constants.eps,
    lHeatTABS = Modelica.Constants.eps,
    KRHeatTABS = Modelica.Constants.eps,
    TNHeatTABS = Modelica.Constants.eps,
    hCoolTABS = Modelica.Constants.eps,
    lCoolTABS = Modelica.Constants.eps,
