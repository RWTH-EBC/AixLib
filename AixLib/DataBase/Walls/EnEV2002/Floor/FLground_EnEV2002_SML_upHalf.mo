...
record FLground_EnEV2002_SML_upHalf "Floor towards ground (upper part) after EnEV 2002, for building of type S (schwer), M (mittel) and L (leicht)"
  extends WallBaseDataDefinition(
    ...
    lambda={2.3,0.055} "Thermal conductivity of wall layers",
...
end FLground_EnEV2002_SML_upHalf;
