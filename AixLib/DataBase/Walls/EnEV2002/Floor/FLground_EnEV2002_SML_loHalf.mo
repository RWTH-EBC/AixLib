...
record FLground_EnEV2002_SML_loHalf "Floor towards ground (lower part) after EnEV 2002, for building of type S (schwer), M (mittel) and L (leicht)"
  extends WallBaseDataDefinition(
    ...
    lambda={2.3,0.04,1.4} "Thermal conductivity of wall layers",
...
end FLground_EnEV2002_SML_loHalf;
