...
record OW_EnEV2002_S_MFD

  "outer wall after EnEV 2002, for building of type S (schwer), for MFD"
  ...
  extends WallBaseDataDefinition(n(min=1) = 4 "Number of wall layers",
    ...
    lambda={1,0.04,0.56,0.51} "Thermal conductivity of wall layers",
