...
record OW_EnEV2002_M "outer wall after EnEV 2002, for building of type M (mittel)"
  extends WallBaseDataDefinition(n(min = 1) = 4 "Number of wall layers", d = {0.05, 0.04, 0.175, 0.015} "Thickness of wall layers", rho = {1800, 120, 500, 1200} "Density of wall layers", lambda = {1, 0.04, 0.16, 0.51} "Thermal conductivity of wall layers", c = {1000, 1030, 1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
