...
<p>The figure below depicts the basic structure of a single or multi-family house. </p>
<p>Additional walls can be added if further differentiation is necessary.</p>
<h4>Assumptions</h4>
<p>The vertical walls are assumed to be the same in the whole building. </p><p><img src=\"modelica://AixLib/Resources/Images/DataBase/Walls/Collections/Records_Floor_Ceiling.svg\" alt=\"Overview of wall types\"/></p>
<p>Source: Schulte, Lukas. April 2019. &bdquo;Model implementation and simulation of a multi-family house of different levels of detail for evaluation in hardware-in-the-loop experiments&ldquo;. RWTH Aachen University, E.ON Energy Research Center, Institute for Energy Efficient Buildings and Indoor Climate.</p>
</html>", revisions="<html>
<ul>
<li>January 9, 2020
