...
record IWneighbour_EnEV2009_S_half "Inner wall towards neighbour after EnEV 2009, for building of type S (schwer), only half"
  extends WallBaseDataDefinition(n(min = 1) = 3 "Number of wall layers", d = {0.02, 0.175, 0.015} "Thickness of wall layers", rho = {120, 1000, 1200} "Density of wall layers", lambda = {0.035, 0.5, 0.51} "Thermal conductivity of wall layers", c = {1030, 1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
