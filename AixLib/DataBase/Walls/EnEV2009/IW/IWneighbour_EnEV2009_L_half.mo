...
record IWneighbour_EnEV2009_L_half "Inner wall towards neighbour after EnEV 2009, for building of type L (leicht), only half"
  // New Walls for Dymola 2012, the same number of layers as other mass clases
  extends WallBaseDataDefinition(n(min = 1) = 3 "Number of wall layers", d = {0.0325, 0.18, 0.0275} "Thickness of wall layers", rho = {382, 93, 1018.2} "Density of wall layers", lambda = {0.052, 0.78, 0.346} "Thermal conductivity of wall layers", c = {1006, 1593, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
