...
record CE_RO_EnEV2009_SM_loHalf_TBA
  "Ceiling and Roof for a TBA after EnEV 2009, for building of type S (schwer) and M (mittel), lower half"
...
end CE_RO_EnEV2009_SM_loHalf_TBA;
