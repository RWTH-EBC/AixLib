...
record ROsaddleRoom_WSchV1984_SML "Saddle roof in room after WSchV1984, for building of type S (schwer), M (mittel) and L (leicht)"
  extends WallBaseDataDefinition(n(min = 1) = 3 "Number of wall layers", d = {0.18, 0.0125, 0.015} "Thickness of wall layers", rho = {160, 800, 1200} "Density of wall layers", lambda = {0.084, 0.25, 0.51} "Thermal conductivity of wall layers", c = {1358, 1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
