...
record CEattic_WSchV1984_SML_loHalf "Ceiling towards attic after WSchV1984, for building of type S (schwer), M (mittel) and L (leicht), lower half"
  extends WallBaseDataDefinition(n(min = 1) = 3 "Number of wall layers", d = {0.08, 0.0125, 0.015} "Thickness of wall layers", rho = {155, 800, 1200} "Density of wall layers", lambda = {0.09, 0.25, 0.51} "Thermal conductivity of wall layers", c = {1367, 1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
