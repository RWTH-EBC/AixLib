...
record CEpartition_WSchV1984_L_loHalf "Ceiling partition after WSchV1984, for building of type L (leicht), lower half"
  // New Walls for Dymola 2012, the same number of layers as other mass clases
  extends WallBaseDataDefinition(n(min = 1) = 3 "Number of wall layers", d = {0.04, 0.16, 0.0275} "Thickness of wall layers", rho = {510, 93, 1018.2} "Density of wall layers", lambda = {0.084, 0.73, 0.346} "Thermal conductivity of wall layers", c = {1621, 1593, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
