...
record IWneighbour_WSchV1984_M_half "Inner wall towards neighbour after WSchV1984, for building of type S (mitel), only half"
  extends WallBaseDataDefinition(n(min = 1) = 3 "Number of wall layers", d = {0.02, 0.175, 0.015} "Thickness of wall layers", rho = {1.23, 1000, 1200} "Density of wall layers", lambda = {0.22, 0.315, 0.51} "Thermal conductivity of wall layers", c = {1008, 1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
