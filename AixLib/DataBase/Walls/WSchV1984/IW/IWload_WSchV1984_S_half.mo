...
record IWload_WSchV1984_S_half "Inner wall load-bearing after WSchV1984, for building of type S (schwer), only half"
  extends WallBaseDataDefinition(n(min = 1) = 2 "Number of wall layers", d = {0.0875, 0.015} "Thickness of wall layers", rho = {1600, 1200} "Density of wall layers", lambda = {0.79, 0.51} "Thermal conductivity of wall layers", c = {1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
