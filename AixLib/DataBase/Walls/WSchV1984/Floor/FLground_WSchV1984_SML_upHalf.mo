...
record FLground_WSchV1984_SML_upHalf "Floor towards ground (upper part) after WSchV1984, for building of type S (schwer), M (mittel) and L (leicht)"
  extends WallBaseDataDefinition(
    n(min=1) = 2 "Number of wall layers",
    d={0.1,0.02} "Thickness of wall layers",
    rho={2300,100} "Density of wall layers",
    lambda={2.3,0.05} "Thermal conductivity of wall layers",
...
end FLground_WSchV1984_SML_upHalf;
