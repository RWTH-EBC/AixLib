...
record FLcellar_WSchV1984_SML_upHalf "Floor towards cellar after WSchV1984, for building of type S (schwer), M (mittel) and L (leicht), upper half."
  extends WallBaseDataDefinition(n(min = 1) = 2 "Number of wall layers", d = {0.02, 0.06} "Thickness of wall layers", rho = {120, 2000} "Density of wall layers", lambda = {0.055, 1.4} "Thermal conductivity of wall layers", c = {1030, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
