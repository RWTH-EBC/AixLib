...
record IWload_WSchV1995_L_half "Inner wall load-bearing after WSchV1995, for building of type L (leicht), only half"
  // New Walls for Dymola 2012, the same number of layers as other mass clases
  extends WallBaseDataDefinition(n(min = 1) = 2 "Number of wall layers", d = {0.09, 0.0275} "Thickness of wall layers", rho = {93, 1018.2} "Density of wall layers", lambda = {0.78, 0.346} "Thermal conductivity of wall layers", c = {1593, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
