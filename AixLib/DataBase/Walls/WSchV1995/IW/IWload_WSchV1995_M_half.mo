...
record IWload_WSchV1995_M_half "Inner wall load-bearing after WSchV1995, for building of type M (schwer), only half"
  extends WallBaseDataDefinition(n(min = 1) = 2 "Number of wall layers", d = {0.0875, 0.015} "Thickness of wall layers", rho = {1000, 1200} "Density of wall layers", lambda = {0.31, 0.51} "Thermal conductivity of wall layers", c = {1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
