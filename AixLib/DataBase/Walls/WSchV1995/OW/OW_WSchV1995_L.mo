...
record OW_WSchV1995_L "outer wall after WSchV1995, for building of type L (leicht)"
  // New Walls for Dymola 2012, the same number of layers as other mass clases
  extends WallBaseDataDefinition(n(min = 1) = 4 "Number of wall layers", d = {0.03, 0.02, 0.18, 0.0275} "Thickness of wall layers", rho = {1800, 600, 138, 1018.2} "Density of wall layers", lambda = {1, 0.14, 0.105, 0.346} "Thermal conductivity of wall layers", c = {1000, 1700, 1411, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
