...
record OW_WSchV1995_S "outer wall after WSchV1995, for building of type S (schwer)"
  extends WallBaseDataDefinition(n(min = 1) = 4 "Number of wall layers", d = {0.05, 0.06, 0.175, 0.015} "Thickness of wall layers", rho = {1800, 120, 1400, 1200} "Density of wall layers", lambda = {1, 0.04, 0.7, 0.51} "Thermal conductivity of wall layers", c = {1000, 1030, 1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
