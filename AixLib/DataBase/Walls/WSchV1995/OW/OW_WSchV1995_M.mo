...
record OW_WSchV1995_M "outer wall after WSchV1995, for building of type M (mittel)"
  extends WallBaseDataDefinition(n(min = 1) = 4 "Number of wall layers", d = {0.05, 0.04, 0.18, 0.015} "Thickness of wall layers", rho = {1800, 120, 700, 1200} "Density of wall layers", lambda = {1, 0.04, 0.21, 0.51} "Thermal conductivity of wall layers", c = {1000, 1030, 1000, 1000} "Specific heat capacity of wall layers", eps = 0.95 "Emissivity of inner wall surface");
