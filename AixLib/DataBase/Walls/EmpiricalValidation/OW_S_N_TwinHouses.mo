...
record OW_S_N_TwinHouses "Outside Wall South/North for Empirical Validation TwinHouses Holzkirchen"
  extends AixLib.DataBase.Walls.WallBaseDataDefinition(
     n(min=1) = 5 "Number of wall layers",
    d={0.01,0.12,0.03,0.3,0.01} "Thickness of wall layers, first=outside; last=inside",
    rho={1200,80,1200,800,1200} "Density of wall layers",
    lambda={0.8,0.035,1,0.22,1} "Thermal conductivity of wall layers",
