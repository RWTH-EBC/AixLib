...
<h4><span style=\"color: #008000\">Calculation of nominal mass flow rates</span></h4> 
<ul>
<li>General calculation m&#775; = Q&#775;<sub>nominal</sub> / c<sub>p</sub> / &Delta;T</li>
</ul>
<b>Condenser</b> <span style=\"font-family: Courier New;\">mFlow_conNom </span>
<ul>
...
<b>Evaporator</b> <span style=\"font-family: Courier New;\"> mFlow_evaNom:</span>
<ul>
...
<li>Possible calculation for <b>air</b> bound evaporator side <span>m&#775;<sub>eva,nominal</sub>  = (Q&#775;<sub>con,nominal</sub> - P&#775;<sub>el,nominal</sub>) / c<sub>p</sub> / &Delta;T</span> under the assumption (no literature source so far) of <span>&Delta;T = 5 K</span></li>
        ...
        revisions="<html>
<ul>
<li><i>MAy 7, 2020</i>  by Philipp Mehrfeld:<br/>Add description of how to calculate m_flows</li>
