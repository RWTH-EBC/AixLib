 ...
 //   annotation (Dialog(tab="NotManufacturer",tab="Advanced",group="General machine information"));
  ...
  BaseClasses.DesignGenericHP design(
    ...
    filename=ModelicaServices.ExternalReferences.loadResource(
        "modelica://AixLib/DataBase/HeatPump/PerformanceData/TEMP_COMP_MEAN_Scroll_R290_Luft.sdf"),
    filename_T_Design=ModelicaServices.ExternalReferences.loadResource(
        "modelica://AixLib/DataBase/HeatPump/PerformanceData/TEMP_COMP_MEAN_Scroll_R290_Luft.sdf"),
    filename_COP=ModelicaServices.ExternalReferences.loadResource(
        "modelica://AixLib/DataBase/HeatPump/PerformanceData/COP_Scroll_R290_Luft.sdf"),
    filename_PI=ModelicaServices.ExternalReferences.loadResource(
        "modelica://AixLib/DataBase/HeatPump/PerformanceData/PI_Scroll_R290_Luft.sdf"))
                           "design operation"
