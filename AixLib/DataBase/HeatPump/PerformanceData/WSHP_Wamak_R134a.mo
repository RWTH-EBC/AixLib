...
model WSHP_Wamak_R134a "WSHP_Wamak_R134a"
 extends
  ...
  LookUpTable2D lookUpTable2D(smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
      dataTable=AixLib.DataBase.HeatPump.EN14511.Wamak_WW100SHR_HD_Modul())
  ...
  Modelica.Blocks.Sources.RealExpression one(y=1)
    annotation (Placement(transformation(extent={{20,64},{-4,84}})));
equation
  ...
  connect(one.y, productQCon3.u1) annotation (Line(points={{-5.2,74},{-26,74},{
          -26,40},{-18,40}}, color={0,0,127}));
