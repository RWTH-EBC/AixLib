...
equation
  ...
  annotation (Icon(graphics={Text(
          ...
          textString="VapourCompression")}), Documentation(info="<html>
<p>This model uses tables generated by the Vapour Compression Library to calculate the relevant outputs of the inner refrigeration cycle.</p><p>If of interest, contact Fabian W&uuml;llhorst or Christian Vering for more information on how the maps are generated.</p><p>The publications regarding this model are currenlty in review.</p>
