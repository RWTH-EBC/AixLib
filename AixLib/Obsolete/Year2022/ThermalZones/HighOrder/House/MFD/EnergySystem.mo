  ...
  package OneAppartment
    ...
    equation
      ...
      connect(valveBe.T_setRoom, TSet[2]) annotation (Line(
          points={{57.58,86.87},{57.58,90},{-109,90}},
          color={0,0,127}));
      ...
      connect(valveBa.T_setRoom, TSet[4]) annotation (Line(
          points={{47.36,-31.16},{47.36,-7},{18,-7},{18,29},{-76,29},{-76,96},{
              -109,96}},
          color={0,0,127}));
      connect(valveKi.T_setRoom, TSet[5]) annotation (Line(
          points={{-78.7,-66.66},{-78.7,-62},{-76,-62},{-76,99},{-109,99}},
          color={0,0,127}));
      ...
      connect(tempSensorLi.T, valveLi.T_room) annotation (Line(
          points={{-95.4,36},{-69.16,36},{-69.16,11.84}},
          color={0,0,127}));
      connect(valveBe.T_room, tempSensorBe.T) annotation (Line(
          points={{50.98,86.87},{50.98,98},{62.4,98}},
          color={0,0,127}));
      ...
      connect(valveCh.T_room, tempSensorCh.T) annotation (Line(
          points={{66.16,47.84},{66.16,55},{75.4,55}},
          color={0,0,127}));
      ...
      connect(valveBa.T_room, tempSensorBa.T) annotation (Line(
          points={{40.16,-31.16},{40.16,-15},{53.4,-15}},
          color={0,0,127}));
      ...
      connect(tempSensorKi.T, valveKi.T_room) annotation (Line(
          points={{-78.4,-51},{-69.7,-51},{-69.7,-66.66}},
          color={0,0,127}));
...
<p>
  Package with two hydraulic systems based on radiators for the one
  appartment, considered as a single unit.
</p>
</html>"));
  end OneAppartment;
  annotation(Documentation(info = "<html><h4>
...
<p>
  The package contains a model for an energy system based on radiators,
  for just one appartment.
</p>
</html>"));
end EnergySystem;
