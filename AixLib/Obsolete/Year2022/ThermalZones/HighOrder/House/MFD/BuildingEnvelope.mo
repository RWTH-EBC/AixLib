within AixLib.Obsolete.Year2022.ThermalZones.HighOrder.House.MFD;
package BuildingEnvelope
  ...
  model OneAppartment_VoWo
    ...
    AixLib.Obsolete.Year2022.ThermalZones.HighOrder.Rooms.MFD.OneAppartment.Children_VoWo
      Children(
      TMC=TMC,
      TIR=TIR,
      Floor=Floor,
    ...
    AixLib.Obsolete.Year2022.ThermalZones.HighOrder.Rooms.MFD.OneAppartment.Corridor_VoWo
      Corridor(
      TMC=TMC,
      TIR=TIR,
      Floor=Floor,
    ...
    AixLib.Obsolete.Year2022.ThermalZones.HighOrder.Rooms.MFD.OneAppartment.Bedroom_VoWo
      Bedroom(
      TMC=TMC,
      TIR=TIR,
      Floor=Floor,
    ...
    AixLib.Obsolete.Year2022.ThermalZones.HighOrder.Rooms.MFD.OneAppartment.Bathroom_VoWo
      Bathroom(
      TMC=TMC,
      TIR=TIR,
      Floor=Floor,
    ...
    AixLib.Obsolete.Year2022.ThermalZones.HighOrder.Rooms.MFD.OneAppartment.Kitchen_VoWo
      Kitchen(
      TMC=TMC,
      TIR=TIR,
      Floor=Floor,
    ...
    Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a ThermChildren annotation(Placement(transformation(extent={{34,28},
              ...
              {50,44}})));
    AixLib.Utilities.Interfaces.RadPort StarChildren annotation (Placement(
          transformation(extent={{60,24},{76,40}}), iconTransformation(extent={
              {56,22},{76,42}})));
    ...
    AixLib.Utilities.Interfaces.RadPort StarBedroom annotation (Placement(
    ...
    AixLib.Utilities.Interfaces.RadPort StarBath annotation (Placement(
          transformation(extent={{0,-28},{16,-12}}), iconTransformation(extent=
              {{-2,-28},{16,-12}})));
    ...
    AixLib.Utilities.Interfaces.RadPort StarKitchen annotation (Placement(
          transformation(extent={{62,-22},{78,-6}}), iconTransformation(extent=
              {{34,-44},{52,-26}})));
  equation
    ...
    connect(Livingroom.AirExchangePort, AirExchangePort[1]) annotation(Line(points={{
            -64.9412,65.8667},{-80,65.8667},{-80,90},{-9,90},{-9,109}},                                                                                     color = {0, 0, 127}));
    connect(Children.AirExchangePort, AirExchangePort[2]) annotation(Line(points={{36,
            71.44},{20,71.44},{20,90},{-9,90},{-9,112}},                                                                                      color = {0, 0, 127}));
    ...
    connect(Bathroom.AirExchangePort, AirExchangePort[4]) annotation(Line(points={{-6.304,
            -40.08},{-18,-40.08},{-18,-80},{80,-80},{80,90},{-9,90},{-9,118}},                                                                                              color = {0, 0, 127}));
    connect(Bedroom.AirExchangePort, AirExchangePort[5]) annotation(Line(points={{-64,
            -37.04},{-80,-37.04},{-80,90},{-9,90},{-9,121}},                                                                                      color = {0, 0, 127}));
