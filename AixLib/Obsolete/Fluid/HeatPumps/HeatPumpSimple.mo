...
equation
  ...
  connect(volumeEvaporator.ports[2], port_b_source) annotation (Line(
      ...
      color={0,127,255}));
  annotation (obsolete = "This model is obsolete and will be removed in later versions", Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent = {{-80, 80}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = {249, 249, 249},
