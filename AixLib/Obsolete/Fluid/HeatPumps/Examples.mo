...
package Examples "Collection of models that illustrate model use and test models"
  ...
  model HeatPumpDetailed
   ...
   extends Modelica.Icons.Example;
    ...
    AixLib.Fluid.Sources.Boundary_pT sourceSideFixedBoundary(redeclare package
...
"));
  ...
  model HeatPumpSimple
   ...
   extends Modelica.Icons.Example;
    ...
    AixLib.Fluid.Sensors.TemperatureTwoPort temperature(redeclare package
...
<a href=\"modelica://AixLib.Fluid.HeatPumps\">
AixLib.Fluid.HeatPumps</a>.
</p>
</html>"));
end Examples;
