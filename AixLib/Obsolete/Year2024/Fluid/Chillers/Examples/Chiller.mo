within AixLib.Obsolete.Year2024.Fluid.Chillers.Examples;
model Chiller "Example for the reversible chiller model."
 extends Modelica.Icons.Example;
  ...
  Modelica.Blocks.Math.Gain gain(k=1)  annotation (Placement(transformation(
        ...
        rotation=270,
        origin={96,52})));
  AixLib.Fluid.Sources.Boundary_pT                sourceSideFixedBoundary(nPorts=1,
...
<p>
  ...
  \"modelica://AixLib.Obsolete.Year2024.DataBase.HeatPump\">AixLib.Obsolete.Year2024.DataBase.Chiller</a> or
  ...
  <li>
    ...
    __Dymola_Commands(file="Modelica://AixLib/Resources/Scripts/Dymola/Obsolete/Year2024/Fluid/HeatPumps/Examples/HeatPump.mos" "Simulate and plot"),
