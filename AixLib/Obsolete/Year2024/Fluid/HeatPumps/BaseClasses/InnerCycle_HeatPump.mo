...
model InnerCycle_HeatPump
  ...
  replaceable model PerDataMainHP =
    ...
    constrainedby AixLib.Obsolete.Year2024.DataBase.HeatPump.PerformanceData.BaseClasses.PartialPerformanceData(
  ...
  replaceable model PerDataRevHP =
    ...
    constrainedby AixLib.Obsolete.Year2024.DataBase.Chiller.PerformanceData.BaseClasses.PartialPerformanceData(
     final scalingFactor = scalingFactor)
...
<p>
  ...
  Used in AixLib.Obsolete.Year2024.Fluid.HeatPumps.HeatPump, this model serves the
