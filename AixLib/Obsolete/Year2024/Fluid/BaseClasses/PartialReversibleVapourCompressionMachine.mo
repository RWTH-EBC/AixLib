...
//Advanced
  ...
  AixLib.Obsolete.Year2024.Fluid.HeatExchangers.EvaporatorCondenserWithCapacity con(
  ...
  AixLib.Obsolete.Year2024.Fluid.HeatExchangers.EvaporatorCondenserWithCapacity eva(
...
equation
  ...
  connect(temperatureSensor1.T, sigBus.TEvaOutMea) annotation (Line(points={{
          -54.9,-61},{-104.925,-61},{-104.925,-42.915}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
...
<ol>
  <li>
    <a href=
    \"AixLib.Obsolete.Year2024.Fluid.HeatPumps.BaseClasses.InnerCycle_HeatPump\">InnerCycle</a>
