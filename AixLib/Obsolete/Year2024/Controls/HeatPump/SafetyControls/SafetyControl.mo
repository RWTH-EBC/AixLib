...
block SafetyControl "Block including all safety levels"
  ...
  Obsolete.Year2024.Controls.HeatPump.SafetyControls.OperationalEnvelope operationalEnvelope(
  ...
  Obsolete.Year2024.Controls.HeatPump.SafetyControls.OnOffControl onOffController(
  ...
  Obsolete.Year2024.Controls.HeatPump.SafetyControls.DefrostControl defrostControl(
  ...
  Modelica.Blocks.Interfaces.RealOutput Pel_deFro if not use_chiller and
    ...
    "Relative speed of compressor. From 0 to 1" annotation (Placement(
        ...
        rotation=180,
        origin={130,80})));
  Obsolete.Year2024.Controls.HeatPump.SafetyControls.AntiFreeze antiFreeze(final TAntFre=TantFre, final use_antFre=use_antFre)
...
<ul>
  <li>
    <a href=
    \"modelica://AixLib.Obsolete.Year2024.Controls.HeatPump.SafetyControls.DefrostControl\">
    DefrostControl</a>
  </li>
  <li>
    <a href=
    \"modelica://AixLib.Obsolete.Year2024.Controls.HeatPump.SafetyControls.OnOffControl+\">OnOffControl</a>
  </li>
  <li>
    <a href=
    \"modelica://AixLib.Obsolete.Year2024.Controls.HeatPump.SafetyControls.OperationalEnvelope\">
    OperationalEnvelope</a>
  </li>
  <li>
    <a href=
    \"modelica://AixLib.Obsolete.Year2024.Controls.HeatPump.SafetyControls.AntiFreeze\">AntiFreeze</a>
  </li>
</ul>
<p>
