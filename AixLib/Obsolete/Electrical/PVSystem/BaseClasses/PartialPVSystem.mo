within AixLib.Obsolete.Electrical.PVSystem.BaseClasses;
partial model PartialPVSystem "Partial model for PV System"
  ...
  AixLib.Obsolete.Electrical.PVSystem.BaseClasses.PVModuleDC
                                                    PVModuleDC(
  ...
  AixLib.Obsolete.Electrical.PVSystem.BaseClasses.PVInverterRMS
                                                       PVInverterRMS(final
