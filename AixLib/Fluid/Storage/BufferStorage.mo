...
////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 constant Integer[n] inpActLay = cat(1,{if (nLowerPorts==k) then (if (nUpperPorts==k) then 2 else 1) else (if (nUpperPorts==k) then 1 else 0) for k in 1:n});

 constant Integer[n] portsLayer=cat(1,{if inpActLay[1]==1 then 3 else 1},{inpActLay[k]*2+2 for k in 2:n-1},{if inpActLay[n]==1 then 3 else 1});
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  Modelica.Fluid.Interfaces.FluidPort_a portHC1In(redeclare package Medium =
  ...
  Modelica.Fluid.Interfaces.FluidPort_b portHC1Out(redeclare package Medium =
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  Modelica.Fluid.Interfaces.FluidPort_a portHC2In(redeclare package Medium =
  ...
  Modelica.Fluid.Interfaces.FluidPort_b portHC2Out(redeclare package Medium =
...
<ul>
  ...
  <li>
    ...
    mistake in losses calculation corrected (thickness of "wall" and "insulation" was only considered once but has to be considered twice, additionally the components "wall" and "insulation" were exchanged )<br/>
...
<p>
  <b>HeatTransferOnlyConduction</b>: Model for heat transfer between buffer storage layers. Models conductance of water. An effective heat conductivity is therefore calculated. Used in BufferStorage model.
</p>
<p>
  <b>HeatTransferLambdaSimple:</b> Model for heat transfer between buffer storage layers. Models conductance of water and additional effective conductivity (in case the above layer is colder than the lower layer). Used in BufferStorage model.
</p>
<p>
  <b>HeatTransferLambdaEff:</b> Model for heat transfer between buffer storage layers. Models conductance of water and buoyancy according to Viskanta et al., 1997. An effective heat conductivity is therefore calculated. Used in BufferStorage model.
</p>
<p>
  <b>HeatTransferLambdaEffSmooth:</b> Same as HeatTransfer_lambda_eff. In addition, the <i>smooth()</i> expression is used for the transition of the buoyancy model.
</p>
<p>
  <b>HeatTransferLambdaEffTanh:</b> Same as HeatTransfer_lambda_eff. In addition, a tanh function is used for the transition of the buoyancy model (VariableTransition model). Attention: the initial value of the FullTransition model is 0.5. This may lead to a mixture of the storage at the beginning of the simulation.
</p>
<p>
  <b>HeatTransferBuoyancyWetter:</b> Model for heat transfer between buffer storage layers. Models buoyancy according to Buildings.Fluid.Storage.BaseClasses.Buoyancy model of Buildings library, cf. https://simulationresearch.lbl.gov/modelica. No conduction is implemented apart from when buoyancy occurs.
</p>
<p>
...
<h4>
  <span style=\"color:">Sources</span>
</h4>
<ul>
  <li>R. Viskanta, A. KaraIds: Interferometric observations of the temperature structure in water cooled or heated from above. <i>Advances in Water Resources,</i> volume 1, 1977, pages 57-69. Bibtex-Key [R.VISKANTA1977]
  </li>
</ul>
<h4>
...
<p>
  <a href=\"AixLib.Fluid.Storage.Examples.BufferStorageCharging\">AixLib.Fluid.Storage.Examples.BufferStorageCharging</a>
</p>
