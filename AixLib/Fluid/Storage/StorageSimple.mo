...
<p>Simple multi-layer thermal energy storage model with volumes as heat exchangers (no pressure losses). </p>
<p><b><span style=\"color: #008000;\">Concept</span> </b></p>
<p>The water volume of the thermal energy storage can be discretised in several layers. </p>
...
<p><br>In contrast to the StorageDetailed model, the following simplifications are taken as a basis:</p>
<ul>
<li>Only indirect charging and discharging using a heat exchanger is possible. Thus, there are two separated hydraulic circuits.</li>
<li>The heat exchanger is an array of volumes without any pressure losses</li>
<li>There is no optional heating coil and no second heating coil. Hence, the StorageSimple model is limited to a two-circuit application.</li>
</ul>
<p><br><b><span style=\"color: #008000;\">Example Results</span></b> </p>
...
<ul>
<li>November 2022 by Laura Maier:</li>
<p>Rename model and specify difference compared to detailed thermal energy storage model</p>
<li><i>November 2014&nbsp;</i> by Marcus Fuchs:<br>Changed model to use Annex 60 base class </li>
<li><i>13.12.2013</i> by Sebastian Stinner:<br>implemented </li>
</ul>
</html>"));
end StorageSimple;
