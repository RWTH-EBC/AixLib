...
model IndoorSwimmingPool
  ...
  Modelica.Blocks.Sources.Pulse Opening(
    ...
    offset=0,
    startTime=3600*7)
    annotation (Placement(transformation(extent={{-94,-46},{-80,-32}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput QPool
    "Heat flow rate to maintain the pool at the set temperature" annotation (
      Placement(transformation(extent={{98,-20},{122,4}}), iconTransformation(
          extent={{98,-20},{122,4}})));
equation
  connect(TSoil.y, indoorSwimming.TSoil) annotation (Line(points={{79.2,52},{40,
          52},{40,18.39},{31.02,18.39}}, color={0,0,127}));
  ...
  connect(Opening.y, indoorSwimming.openingHours) annotation (Line(points={{-79.3,
          -39},{-50,-39},{-50,-20.46},{-40.04,-20.46}}, color={0,0,127}));
  connect(Person.y, indoorSwimming.persons) annotation (Line(points={{-79.3,-1},
          {-48,-1},{-48,-8.25},{-39.7,-8.25}}, color={0,0,127}));
  ...
  connect(indoorSwimming.TPool, TPool) annotation (Line(points={{32.72,6.92},{
  ...
  connect(indoorSwimming.QPool, QPool) annotation (Line(points={{32.72,-1.22},{32.72,
          0},{92,0},{92,-8},{110,-8}}, color={0,0,127}));
