within AixLib.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors;
   ...
   if t > 0 and (includeRealSource or includeMirrorSource) then
     ...
     if t >= timTre then
       ...
       h_21 :=Modelica.Math.Nonlinear.quadratureLobatto(
         function
           AixLib.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_Integrand_Equivalent(
           dis=dis,
           wDis=wDis,
           len1=len1,
           burDep1=burDep1,
 ...
 <p align=\"center\">
 <img alt=\"image\" src=\"modelica://AixLib/Resources/Images/Fluid/Geothermal/Borefields/FiniteLineSource_EquivalentBoreholes_01.png\" />
 </p>
 <p>
 ...
 <p align=\"center\">
 <img alt=\"image\" src=\"modelica://AixLib/Resources/Images/Fluid/Geothermal/Borefields/FiniteLineSource_EquivalentBoreholes_02.png\" />
 </p>
 <p>
 ...
 <a href=\"modelica://AixLib.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_Integrand_Equivalent\">AixLib.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.ThermalResponseFactors.finiteLineSource_Integrand_Equivalent</a>.
 </p>
 </html>", revisions="<html>
 <ul>
 <li>
