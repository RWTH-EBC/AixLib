within AixLib.Fluid.Geothermal.Aquifer;
  ...
  replaceable package Medium = Modelica.Media.Interfaces.PartialMedium "Medium in the component" annotation (choices(
   ...
   parameter Modelica.Units.SI.Temperature TGroHot=TGroCol
      "Undisturbed ground temperature (warm well)" annotation (
       Dialog(group="Properties of ground"));
   parameter AixLib.Fluid.Geothermal.Aquifer.Data.Template aquDat
 ...
 protected
   ...
   AixLib.Fluid.MixingVolumes.MixingVolume volCol[nVol](
     redeclare final package Medium = Medium,
 ...
 the model <a href=\"modelica://AixLib.Fluid.MixingVolumes.MixingVolume\">AixLib.Fluid.MixingVolumes.MixingVolume</a>.
 The geometric representation of the model is illustrated in the figure below.
 </p>
 <p align=\"center\">
 <img  alt=\"image\" src=\"modelica://AixLib/Resources/Images/Fluid/Geothermal/Aquifer/Geometry.png\">
 </p>
