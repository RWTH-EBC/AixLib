...
<p>
  where <code>epsS</code> and <code>epsL</code> are constant effectiveness for the sensible and latent heat transfer, <code>Q_max</code> is the maximum heat that can be transferred and <code>mWat_max</code> is the maximum moisture that can be transferred.
</p>
<p>
  For a sensible heat exchanger, use <a href=\"modelica://AixLib.Fluid.HeatExchangers.ConstantEffectiveness\">AixLib.Fluid.HeatExchangers.ConstantEffectiveness</a> instead of this model.
</p>
<p>
...
<ul>
  <li>October 14, 2013 by Michael Wetter:<br/>
    Replaced access to constant <code>Medium1.Water</code> by introducing the parameter <code>i1_w</code>, and used a similar construct for <code>Medium2</code>. This avoids an error during model check as these constants are not known in the partial medium model.
  </li>
  ...
  <li>October 21, 2008, by Michael Wetter:<br/>
    First implementation, based on <a href=\"modelica://AixLib.Fluid.HeatExchangers.ConstantEffectiveness\">AixLib.Fluid.HeatExchangers.ConstantEffectiveness</a>.
  </li>
</ul>
