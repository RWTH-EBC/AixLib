...
<ul>
<li>April 23, 2019, by Martin Kremer:<br>Changes extends due to changes on calculation of mass transfer coefficient.</li>
<li>August 21, 2018, by Martin Kremer:<br>First implementation.</li>
</ul>
</html>", info="<html>
<p>This mass transfer model calculates the convective mass flow using the function convectiveMassTransferCoefficient. The mass flow is calculated as follows.</p>
<p align=\"center\"><i>m&#775; = 2 &beta; C<sub>cross</sub> A<sub>surface</sub> ( flowPort.Xi - Xi<sub>s</sub> ) n<sub>parallel</sub> </i></p>
</html>"));
