...
<ul>
<li>April 23, 2019, by Martin Kremer:<br>Changes extends due to changes in calculation of heat transfer coefficient.</li>
...
<p align=\"center\"><i>Q̇ = 2 &alpha; C<sub>cross</sub> A<sub>surface</sub> ( heatPorts.T - T<sub>s</sub> ) n<sub>parallel</sub> </i></p>
</html>"));
