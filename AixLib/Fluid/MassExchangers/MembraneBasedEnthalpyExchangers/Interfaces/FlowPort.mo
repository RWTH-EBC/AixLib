...
<p>Basic definition of the connector.</p><p><b>Variables:</b> </p>
<ul>
<li>Pressure p</li>
<li>flow MassFlowRate m_flow</li>
<li>MassFraction Xi</li>
</ul>
<p>If ports with different media are connected, the simulation is asserted due to the check of parameter. </p>
</html>", revisions="<html>
<ul>
<li>
