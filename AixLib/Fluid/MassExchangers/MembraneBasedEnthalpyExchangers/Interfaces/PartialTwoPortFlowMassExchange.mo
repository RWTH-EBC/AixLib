...
partial model PartialTwoPortFlowMassExchange
  ...
  final parameter Integer nFMDistributed=if modelStructure==ModelStructure.a_v_b       then n+1 else if (modelStructure==
      ModelStructure.a_vb                                                                                                                          or modelStructure==
      ModelStructure.av_b)                                                                                                                                                                       then n else n-1;
