...
model Carnot_TEva
 ...
 package Medium2 = AixLib.Media.Water "Medium model";
  ...
  AixLib.Fluid.Sources.FixedBoundary sin2(nPorts=1,
...
info="<html>
<p>
  Example that simulates a chiller whose efficiency is scaled based on the Carnot cycle. The chiller takes as an input the evaporator leaving water temperature. The condenser mass flow rate is computed in such a way that it has a temperature difference equal to <code>dTEva_nominal</code>.
