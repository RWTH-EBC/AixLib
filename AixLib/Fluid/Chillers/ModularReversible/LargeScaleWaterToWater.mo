within AixLib.Fluid.Chillers.ModularReversible;
...
<p>
  ...
  AixLib.Fluid.Chillers.ModularReversible.Modular</a> approach.
</p>
<p>
  Contrary to the standard sizing approach for the <a href=\"modelica://AixLib.Fluid.Chillers.ModularReversible.Modular\">
  AixLib.Fluid.Chillers.ModularReversible.Modular</a> models,
  the parameters are based on an automatic estimation as described in
  <a href=\"modelica://AixLib.Fluid.HeatPumps.ModularReversible.BaseClasses.LargeScaleWaterToWaterDeclarations\">
  AixLib.Fluid.HeatPumps.ModularReversible.BaseClasses.LargeScaleWaterToWaterDeclarations</a>.
</p>
<p>
