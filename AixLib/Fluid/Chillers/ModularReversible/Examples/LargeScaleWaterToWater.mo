within AixLib.Fluid.Chillers.ModularReversible.Examples;
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Examples/LargeScaleWaterToWater.mos"
        "Simulate and plot"),
