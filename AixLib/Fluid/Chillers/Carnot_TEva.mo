...
<p>
  On the <code>Advanced</code> tab, a user can specify the temperatures that will be used as the evaporator and condenser temperature.
</p>
<p>
...
<p>
  For a similar model that can be used as a heat pump, see <a href=\"modelica://AixLib.Fluid.HeatPumps.Examples.Carnot_TCon\">AixLib.Fluid.HeatPumps.Examples.Carnot_TCon</a>.
