...
<p>
  This example extends from <a href=\"modelica://AixLib.Fluid.Chillers.Examples.Carnot_TEva\">AixLib.Fluid.Chillers.Examples.Carnot_TEva</a> but has a part load efficiency that varies with the load.
