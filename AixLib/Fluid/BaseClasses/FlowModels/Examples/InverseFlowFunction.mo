within AixLib.Fluid.BaseClasses.FlowModels.Examples;
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/BaseClasses/FlowModels/Examples/InverseFlowFunction.mos"
        "Simulate and plot"),
