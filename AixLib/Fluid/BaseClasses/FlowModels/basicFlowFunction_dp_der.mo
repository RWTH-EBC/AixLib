...
<p>
  Function that implements the first order derivative of <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp</a> with respect to the mass flow rate.
