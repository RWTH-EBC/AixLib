...
<p>
  Function that implements the first order derivative of <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow</a> with respect to the mass flow rate.
