...
<p>
  This model validates the implementation of <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow</a> and its first order derivative <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow_der</a>. If the derivative implementation is wrong, the simulation will stop with an error.
