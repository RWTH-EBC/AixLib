...
<p>
  This model validates the implementation of <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp</a> and its second order derivative <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2</a>. If the derivative implementation is wrong, the simulation will stop with an error.
</p>
<h4>
  Implementation
</h4>
<p>
  The pressure drop <code>dp</code> is increased non-linearly in order for the first and second derivatives in <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der2</a> to be non-zero during part of the simulation. This will ensure full code coverage of this function.
...
<ul>
  ...
  <li>July 29, 2015, by Michael Wetter:<br/>
