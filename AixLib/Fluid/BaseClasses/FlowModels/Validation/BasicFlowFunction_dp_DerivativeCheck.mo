...
<p>
  This model validates the implementation of <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp</a> and its first order derivative <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp_der</a>. If the derivative implementation is wrong, the simulation will stop with an error.
