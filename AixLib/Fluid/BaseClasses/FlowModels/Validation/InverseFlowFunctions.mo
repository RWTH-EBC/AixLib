...
<p>
  This model tests the inverse formulation of the flow functions. The pressure difference <code>dp</code> and <code>dpCalc</code> need to be equal up to the solver tolerance, except for a small neighborhood around the origin. In this neighborhood around the origin, the functions <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp</a> and <a href=\"modelica://AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow\">AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow</a> are not invertible.
...
<ul>
  ...
  <li>August 8, 2012, by Michael Wetter:<br/>
    Updated documentation.
  </li>
  <li>July 12, 2012, by Michael Wetter:<br/>
