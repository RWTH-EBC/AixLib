...
package ReversibleThermalMachine_PerformanceData
  "Different models used for a black box heat pump or chiller model"
...
end ReversibleThermalMachine_PerformanceData;
