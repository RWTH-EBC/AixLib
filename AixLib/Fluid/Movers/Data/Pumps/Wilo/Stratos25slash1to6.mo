...
<p>
  Data from <a href=\"http://productfinder.wilo.com/en/COM/product/00000018000028040002003a/fc_product_datasheet\">http://productfinder.wilo.com/en/COM/product/00000018000028040002003a/fc_product_datasheet</a>
</p>
<p>
  The nominal rpm is arbitrarily chosen as the rpm of the pump curve in the data sheet that has the highest rpm, without being limited by the maximum power limitation (see dotted curve on figure below). Pump curves (H(m_flow) and P(m_flow)) from the data sheets are digitized using <a href=\"http://arohatgi.info/WebPlotDigitizer/app/\">web plot digitizer</a>.
</p>
<h4>
  Limitations:
</h4>
<ul>
  <li>The pump curve cap at high rpm that can be seen is not enforced by the model.
  </li>
  <li>The pump curve may be altered slightly to guarantee that <i>dp/dm&lt;0</i>
  </li>
</ul>
<p>
...
<p align=\"center\">
  <img alt=\"Pump" src=\"modelica://AixLib/Resources/Images/Fluid/Movers/Data/stratoscurve.png/\">
...
<ul>
  ...
  <li>December 12, 2014, by Michael Wetter:<br/>
    Added <code>defaultComponentPrefixes</code> and <code>defaultComponentName</code> annotations.
  </li>
