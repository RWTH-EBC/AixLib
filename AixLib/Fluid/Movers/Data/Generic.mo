...
record Generic "Generic data record for movers"
  ...
  parameter AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod etaHydMet=
    if havePressureCurve
    then AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.EulerNumber
    else AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided
    "Efficiency computation method for the hydraulic efficiency etaHyd"
    annotation (Dialog(group="Power computation"));
  parameter AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod etaMotMet=
    if powerOrEfficiencyIsHydraulic and havePressureCurve
    then AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.GenericCurve
    else AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.NotProvided
  ...
  parameter
    ...
    annotation (Dialog(group="Power computation",
                       enable=etaHydMet == AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Efficiency_VolumeFlowRate));
  parameter
    AixLib.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters
    motorEfficiency(
      V_flow={0},
    ...
    annotation (Dialog(group="Power computation",
                       enable=etaMotMet == AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.Efficiency_VolumeFlowRate));
  parameter
    AixLib.Fluid.Movers.BaseClasses.Characteristics.efficiencyParameters_yMot
  ...
  parameter AixLib.Fluid.Movers.BaseClasses.Characteristics.powerParameters power(
    V_flow={0},
    P={0})
    "Power (either consumed or hydraulic) vs. volumetric flow rate"
   annotation (Dialog(group="Power computation",
                      enable =   etaHydMet==
      AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Power_VolumeFlowRate));

  // Peak condition
  parameter AixLib.Fluid.Movers.BaseClasses.Euler.peak peak(
  ...
  final parameter AixLib.Fluid.Movers.BaseClasses.Euler.peak peak_internal=
    if etaHydMet == AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.EulerNumber
    then AixLib.Fluid.Movers.BaseClasses.Euler.getPeak(pressure=pressure,power=power)
    else AixLib.Fluid.Movers.BaseClasses.Euler.peak(V_flow=V_flow_max/2,
                                                   dp=dpMax/2,
...
<a href=\"modelica://AixLib.Fluid.Movers.Validation.Pump_y_stratos\">
AixLib.Fluid.Movers.Validation.Pump_y_stratos</a>.
</p>
