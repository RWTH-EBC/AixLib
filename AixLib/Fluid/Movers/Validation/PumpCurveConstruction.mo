...
model PumpCurveConstruction
  ...
  AixLib.Fluid.Movers.SpeedControlled_y pum_dp(
    ...
    AixLib.Fluid.Movers.SpeedControlled_y pum_m_flow(
  ...
  AixLib.Fluid.Movers.SpeedControlled_y pum_no(
...
<p>
  The pump curves are such that the protected parameter <code>curve</code> of the pumps have different values. This then tests the correct extrapolation.
</p></html>",revisions="<html>
<ul>
  <li>December 6, 2016, by Michael Wetter:<br/>
  ...
  <li>January 7, 2015, by Michael Wetter:<br/>
