...
model ComparePowerTotal
  ...
  extends AixLib.Fluid.Movers.Validation.ComparePowerHydraulic(
    redeclare AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos40slash1to12 per);
annotation(experiment(Tolerance=1e-6, StopTime=200),
    __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/Validation/ComparePowerTotal.mos"
        "Simulate and plot"),
