...
model ControlledFlowMachine
  ...
  AixLib.Fluid.Movers.SpeedControlled_y fan1(
    ...
    constrainedby AixLib.Fluid.Movers.SpeedControlled_y
  ...
  AixLib.Fluid.Movers.FlowControlled_dp fan3(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
    constrainedby AixLib.Fluid.Movers.FlowControlled_dp
  ...
  AixLib.Fluid.Movers.FlowControlled_m_flow fan2(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    redeclare AixLib.Fluid.Movers.Data.Pumps.Wilo.Stratos32slash1to12 per)
    constrainedby AixLib.Fluid.Movers.FlowControlled_m_flow
    "Fan with mass flow rate as input"
    annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));
  AixLib.Fluid.FixedResistances.PressureDrop dp5(
    m_flow_nominal=6000/3600*1.2,
    redeclare package Medium = Medium,
    dp_nominal=300,
    from_dp=true) "Pressure drop"
    annotation (Placement(transformation(extent={{-52,50},{-32,70}})));
  AixLib.Fluid.FixedResistances.PressureDrop dp6(
    m_flow_nominal=6000/3600*1.2,
    redeclare package Medium = Medium,
    dp_nominal=300,
    from_dp=true) "Pressure drop"
    annotation (Placement(transformation(extent={{-52,-30},{-32,-10}})));
  AixLib.Fluid.FixedResistances.PressureDrop dp7(
    m_flow_nominal=6000/3600*1.2,
    redeclare package Medium = Medium,
    dp_nominal=300,
    from_dp=true) "Pressure drop"
