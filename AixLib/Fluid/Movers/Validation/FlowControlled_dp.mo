...
<ul>
  <li>November 5, 2015, by Michael Wetter:<br/>
    Changed parameters of fan since the power is no longer a parameter. This is for <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/457\">issue 457</a>.
  </li>
  <li>September 2, 2015, by Michael Wetter:<br/>
    Changed example so that the fans use different powers, one being computed based on efficiency, the other based on the specified power. This is for <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/457\">issue 457</a>.
  </li>
