...
model PumpCurveDerivatives
  ...
  AixLib.Utilities.Diagnostics.AssertInequality assIne(threShold=1e-8)

    "Assertion check for positive derivatives"

    annotation (Placement(transformation(extent={{40,-20},{60,0}})));

  AixLib.Fluid.Sensors.RelativePressure relPre1(
  ...
  AixLib.Utilities.Diagnostics.AssertInequality assIne1(threShold=1e-8)

    "Assertion check for positive derivatives"

    annotation (Placement(transformation(extent={{40,-80},{60,-60}})));

  AixLib.Utilities.Diagnostics.AssertInequality assIne2(threShold=1e-8)
...
<p>
  This example checks if the pump similarity law implementation results in monotoneously increasing or decreasing relations between <code>dp</code>, <code>m_flow</code> and <code>Nrpm</code>.
