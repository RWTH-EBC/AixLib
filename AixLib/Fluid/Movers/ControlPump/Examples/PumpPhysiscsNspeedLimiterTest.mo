...
model PumpPhysiscsNspeedLimiterTest
  ...
  AixLib.Fluid.Movers.ControlPump.BaseClasses.PumpBus pumpBus
...
<p>Tests the pump model with single parameter record that also uses the limitiation of the pump speed (<i>pumpParam.maxMinSpeedCurves</i>) instead of the pump head limitation (<i>maxMinHead</i>).</p>
    ...
    __Dymola_Commands(file(ensureSimulated=true)=
        "Resources/Scripts/Dymola/Fluid/Movers/ControlPump/Examples/PumpPhysiscsNspeedLimiterTest.mos"),
...
end PumpPhysiscsNspeedLimiterTest;
