...
model PumpPhysiscsNsimpleSpeedTest
...
<li>2017-11-21 by Peter Matthes<br>Implemented</li>
    ...
    __Dymola_Commands(file(ensureSimulated=true)=
        "Resources/Scripts/Dymola/Fluid/Movers/ControlPump/Examples/PumpPhysiscsNsimpleSpeedTest.mos"),
...
end PumpPhysiscsNsimpleSpeedTest;
