within AixLib.Fluid.Movers.ControlPump.Controls.BaseClasses;
partial model PumpStateController
  "pump controller with simple state machine"

  parameter AixLib.DataBase.Pumps.ControlPump.PumpBaseRecord pumpParam "pump parameter record"
    annotation (choicesAllMatching=true);
  AixLib.Fluid.Movers.ControlPump.BaseClasses.PumpControllerBus
    pumpControllerBus
    annotation (Placement(transformation(extent={{-20,80},{20,120}})));
  AixLib.Fluid.Movers.ControlPump.BaseClasses.PumpBus pumpBus annotation (
