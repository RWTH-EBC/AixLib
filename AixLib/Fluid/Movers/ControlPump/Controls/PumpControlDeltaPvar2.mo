...
model PumpControlDeltaPvar2
  "'dp variable' for PumpN"
...
equation
  ...
  connect(pumpOn.condition, pumpControllerBus.onOff_Input) annotation (Line(
        points={{-20,46},{-98,46},{-98,100},{0,100}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  ...
  connect(pumpBus.rpm_Act, nActPassThrough.u) annotation (Line(
      ...
      index=-1,
      extent={{-3,3},{-3,3}}));
  connect(nActPassThrough.y, pumpControllerBus.rpm_Act) annotation (Line(points=
         {{-88.7,-35},{-98,-35},{-98,100},{0,100}}, color={0,0,127}));
