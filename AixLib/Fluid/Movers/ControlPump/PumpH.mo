...
model PumpH
  "pump with physics model and replaceable controller that uses pressure head as input"
  ...
  replaceable AixLib.Fluid.Movers.ControlPump.Controls.PumpControlDeltaPvar pumpStateController(pumpParam=
...
equation
  ...
  connect(physics.port_b, port_b) annotation (Line(points={{30,-42},{66,-42},{66,
