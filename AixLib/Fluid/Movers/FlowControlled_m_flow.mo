...
model FlowControlled_m_flow
  ...
  extends AixLib.Fluid.Movers.BaseClasses.PartialFlowMachine(
    ...
    eff(per(
        ...
        final etaHydMet=if (per.etaHydMet == AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Power_VolumeFlowRate
            or per.etaHydMet == AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.EulerNumber)
            and not per.havePressureCurve then
              AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided
            else
              per.etaHydMet,
        final etaMotMet=if (per.etaMotMet == AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.Efficiency_MotorPartLoadRatio
            or per.etaMotMet == AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.GenericCurve)
...
AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod</a>.<br/>
This is for
