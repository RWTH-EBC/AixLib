...
model FlowMachine_y_linear
  ...
  AixLib.Fluid.Movers.FlowMachine_y pumFixDp(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Sources.Boundary_pT sou1(
    ...
    nPorts=1) annotation (Placement(transformation(extent={{-10,-10},{10,10}},
          rotation=180,
        origin={128,90})));
  AixLib.Fluid.FixedResistances.FixedResistanceDpM dp1(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Movers.FlowMachine_y pumFixM_flow(
    redeclare package Medium = Medium,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    dynamicBalance=false,
    pressure(V_flow=2/1000*{0, m_flow_nominal}, dp={2*dp_nominal, 0}),
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/Examples/FlowMachine_y_linear.mos"
        "Simulate and plot"),
