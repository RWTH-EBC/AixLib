...
model FlowMachineFeedbackControl "Flow machine with feedback control"
  ...
  AixLib.Fluid.Movers.FlowMachine_y fan(
      redeclare package Medium = Medium,
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/Examples/FlowMachineFeedbackControl.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
