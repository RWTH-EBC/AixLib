within AixLib.Fluid.Movers.Examples.BaseClasses;
model ControlledFlowMachine
  ...
  AixLib.Fluid.Sensors.RelativePressure relPre(redeclare package Medium =
        ...
        extent={{10,-10},{-10,10}},
        origin={-10,32})));
  AixLib.Fluid.Movers.FlowMachine_y fan1(
    redeclare package Medium = Medium,
  ...
  AixLib.Fluid.Sensors.MassFlowRate masFloRat2(redeclare package Medium =
        Medium)
  ...
  AixLib.Fluid.Sensors.MassFlowRate masFloRat3(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{60,-70},{80,-50}})));
  AixLib.Fluid.Movers.FlowMachine_dp fan3(
    redeclare package Medium = Medium,
    m_flow_nominal=6000/3600*1.2,
    dynamicBalance=false)
    annotation (Placement(transformation(extent={{-20,-70},{0,-50}})));
  AixLib.Fluid.Movers.FlowMachine_m_flow fan2(
    redeclare package Medium = Medium,
    m_flow_nominal=6000/3600*1.2,
    dynamicBalance=false)
  ...
  AixLib.Fluid.Sensors.MassFlowRate masFloRat4(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{60,100},{80,120}})));
  AixLib.Fluid.Movers.FlowMachine_Nrpm fan4(
    redeclare package Medium = Medium,
    pressure(final V_flow={0,1.8,3}, dp={1000,600,0}),
    dynamicBalance=false)
