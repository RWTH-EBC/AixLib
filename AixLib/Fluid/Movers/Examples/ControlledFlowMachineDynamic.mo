...
model ControlledFlowMachineDynamic
  ...
  extends AixLib.Fluid.Movers.Examples.BaseClasses.ControlledFlowMachine(
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/Examples/ControlledFlowMachineDynamic.mos"
        "Simulate and plot"),
