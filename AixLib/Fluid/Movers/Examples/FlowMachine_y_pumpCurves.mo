...
model FlowMachine_y_pumpCurves
  ...
  parameter Modelica.SIunits.Pressure dp_nominal = 10000 "Nominal pressure";
   ...
   model pumpModel = AixLib.Fluid.Movers.FlowMachine_y (
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/Examples/FlowMachine_y_pumpCurves.mos"
        "Simulate and plot"),
