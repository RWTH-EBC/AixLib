...
volumetric efficiencies that are based on a literature review. However, 
in this library the volumetric efficiency is implemented in such a way 
that it fulfills<br /><br />
<code>&eta;<sub>vol</sub> = V&#775;<sub>ide</sub> / 
V&#775;<sub>rea</sub></code>.<br /><br />
