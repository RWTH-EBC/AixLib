...
<table>
  <caption>
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          ...
          a6*(n/n<sub>ref</sub>)^2*π + a7*π^2 +
          a8*(n/n<sub>ref</sub>)*π^2 + a9*(n/n<sub>ref</sub>)^2*π^2 +
          a10*p<sub>out</sub> + a11*(n/n<sub>ref</sub>)*p<sub>out</sub>
          + a12*(n/n<sub>ref</sub>)^2*p<sub>out</sub> -
          a13*p<sub>inl</sub> - a14*(n/n<sub>ref</sub>)*p<sub>inl</sub>
    ...
    <p>
      ...
      Capacity Control of Residential Heat Pump Heating Systems</a>.
      In: <i>PhD thesis</i>
    </p>
    <p>
      R. Zhou, T. Zhang, J. Catano, J.T. Wen, G.J. Michna, Y. Peles,
      and M.K. Jensen, M. K. (2010): <a href=
      \"http://www.sciencedirect.com/science/article/pii/S135943111000219X\">
      The steady-state modeling and optimization of a refrigeration
      system for high heat flux removal</a>. In: <i>Applied Thermal
      Engineering 30(16)</i>, S. 2347–2356
    </p>
    <p>
      E. Kinab, D. Marchio, P. Rivière and A. Zoughaib (2010): <a href=
      \"http://www.sciencedirect.com/science/article/pii/S0378778810002239\">
      Reversible heat pump model for seasonal performance
      optimization</a>. In: <i>Energy and Buildings 42(12)</i>, S.
      2269–2280
    </p>
    <p>
      W. Li (2013): <a href=
    ...
    <p>
      ...
      Characteristics of an R-410A Multi-split Variable Refrigerant
      Flow Air-conditioning System</a>. In: <i>IEA Heat Pump Conference
      2017</i>
    </p>
    <p>
    ...
    <p>
      M. Engelpracht (2017): Development of modular and scalable
