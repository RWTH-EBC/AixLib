...
package StaticBoundaries "Package that contains validation models of different static boundaries"
...
protected
    ...
    annotation (experiment(StopTime=46.9999));
  end RefrigerantR134aScrollCompressor;
end StaticBoundaries;
