      ...
      <caption>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <code>η<sub>eng</sub> = a1 +
              a2*exp(p<sub>Inl</sub>)^b2</code>
            </td>
            <td>
              Generic model
            </td>
          ...
          <tr>
            ...
            <td>
              <code>η<sub>eng</sub> = a1 + a2*π + a3*π^2 + a4*π^3 +
              a5*π^4 + a6*π^5 + a7*π^6</code>
            </td>
            <td>
              Generic model
            </td>
          ...
          <tr>
            ...
            <td>
              <code>η<sub>eng</sub> = a1 + a2*π + a3*π^2 + a4*n*π +
              a5*n^2 + a6*π^2*n + a7*π*n^2 + a8*n^3 + a9*π^2n^2 +
              a10*π*π^3 + a11*n^4</code>
            </td>
            <td>
              Generic model
            </td>
        ...
        <table>
          <caption>
            \"Power approaches\" border=\"1\" cellspacing=\"0\"
            cellpadding=\"2\" style=\"border-collapse:collapse;\"&gt;
            <table>
              <tr>
                <th>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              ...
              a3*(n/n<sub>ref</sub>)^2 + a4*π +
              a5*(n/n<sub>ref</sub>)*π + a6*(n/n<sub>ref</sub>)^2*π +
              a7*π^2 + a8*(n/n<sub>ref</sub>)*π^2 +
      ...
      <caption>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <code>η<sub>ise</sub> = a1 + a2*π + a3*π^2 + a4*n +
              a5*n^2</code>
            </td>
            <td>
              R407c
          ...
          <tr>
            ...
            <td>
              <code>η<sub>ise</sub> = a1 + a2*n + a3*n^3 +
              a5*π^2</code>
            </td>
            <td>
              Generic model
...
<table>
  <caption>
    ...
    <p style=\"margin-left: 30px;\">
      <i>Approach of calculating efficiency</i> _ <i>Valid
      refrigerants</i> _ <i>Displacement volume</i> _ <i>Type of
      compressor</i>
    </p>
    <ol>
      <li>
      ...
      <li>
        <u>Refrigerant:</u> Refrigerants the efficiency model is valid
