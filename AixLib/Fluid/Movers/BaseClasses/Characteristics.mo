...
<a href=\"modelica://AixLib.Fluid.Movers.BaseClasses.Characteristic.flowParameters\">
AixLib.Fluid.Movers.BaseClasses.Characteristic.flowParameters</a>,
...
<a href=\"modelica://AixLib.Fluid.Movers\">
AixLib.Fluid.Movers</a> modify the user-supplied performance data to add the term
...
First implementation.
  ...
  function power "Flow vs. electrical power characteristics for fan or pump"
    extends Modelica.Icons.Function;
    input AixLib.Fluid.Movers.BaseClasses.Characteristics.powerParameters data
      "Pressure performance data";
    input Modelica.SIunits.VolumeFlowRate V_flow "Volumetric flow rate";
    input Real r_N(unit="1") "Relative revolution, r_N=N/N_nominal";
    input Real d[:] "Derivatives at support points for spline interpolation";
