...
model NegativePressureOrFlow
  ...
  AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface eff(
    ...
    preVar=AixLib.Fluid.Movers.BaseClasses.Types.PrescribedVariable.PressureDifference,
...
annotation(__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/NegativePressureOrFlow.mos"
        "Simulate and plot"),
   experiment(
      StopTime=3600,
      Tolerance=1e-06),
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://AixLib/Resources/Images/Fluid/Movers/BaseClasses/Validation/NegativePressureOrFlow.png\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
