...
model HydraulicEfficiencyMethods
  ...
  AixLib.Fluid.Movers.Data.Generic per(
    ...
    final etaMotMet=AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.NotProvided)
    "Performance record";
  ...
  AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface eff1(
    per(
      ...
      etaHydMet=AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided),
    rho_default=rhoFlu,
    nOri=2,
...
<a href=\"Modelica://AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod\">
AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/HydraulicEfficiencyMethods.mos"
        "Simulate and plot"));
