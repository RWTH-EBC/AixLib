...
model MotorEfficiencyMethods
  ...
  AixLib.Fluid.Movers.Data.Generic per(
    final pressure(V_flow={0,1}, dp={1000,0}),
    final etaHydMet=AixLib.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided)
    "Performance record";
  parameter Modelica.Units.SI.Density rhoFlu=1.2 "Fluid density";

  AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface eff1(
    per(
  ...
  AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface eff2(
    per(
      pressure=per.pressure,
      etaHydMet=per.etaHydMet,
  ...
  AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface eff3(
    per(
      pressure=per.pressure,
      etaHydMet=per.etaHydMet,
      etaMotMet=AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.Efficiency_MotorPartLoadRatio,
  ...
  AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface eff4(
    per(
      pressure=per.pressure,
      etaHydMet=per.etaHydMet,
...
<a href=\"Modelica://AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod\">
AixLib.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod</a>.
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/MotorEfficiencyMethods.mos"
        "Simulate and plot"));
