  ...
  parameter Real powDer[size(_per_y.power.V_flow,1)]=
   if _per_y.use_powerCharacteristic then
     AixLib.Utilities.Math.Functions.splineDerivatives(
                   ...
                   y=_per_y.power.P,
                   ensureMonotonicity=AixLib.Utilities.Math.Functions.isMonotonic(x=_per_y.power.P,
                                                                                     strict=false))
   else
...
initial algorithm
  ...
  assert(AixLib.Utilities.Math.Functions.isMonotonic(x=_per_y.pressure.V_flow, strict=true) and
...
<a href=\"modelica://AixLib.Fluids.Movers.BaseClasses.FlowControlledMachine\">FlowControlledMachine</a>.
</p>
<p>
