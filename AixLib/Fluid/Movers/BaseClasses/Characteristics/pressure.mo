...
<p>
  where <i>Δp</i> is the pressure rise, <i>r<sub>N</sub></i> is the normalized fan speed, <i>V̇</i> is the volume flow rate and <i>d</i> are performance data for fan or pump power consumption at <i>r<sub>N</sub>=1</i>.
</p>
<h4>
  Implementation
</h4>
...
<ul>
  <li>September 8, 2016, by Michael Wetter and Filip Jorissen:<br/>
    ...
    This is for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/458\">#458</a>.
  </li>
  <li>September 7, 2016, by Michael Wetter:<br/>
    Moved function which was a protected function to make it public, as it is now called by <a href=\"modelica://AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface\">AixLib.Fluid.Movers.BaseClasses.FlowMachineInterface</a>.
  </li>
</ul>
