...
<p>
  Model that is used to connect a fluid port with an output signal. The model needs to be used in conjunction with an instance of <a href=\"modelica://AixLib.Fluid.FMI.InletAdaptor\">AixLib.Fluid.FMI.InletAdaptor</a> in order for fluid mass flow rate and pressure to be properly assigned to the acausal fluid models.
</p>
<p>
