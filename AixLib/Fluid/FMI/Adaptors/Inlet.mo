...
<p>
  Model that is used to connect an input signal to a fluid port. The model needs to be used in conjunction with an instance of <a href=\"modelica://AixLib.Fluid.FMI.OutletAdaptor\">AixLib.Fluid.FMI.OutletAdaptor</a> in order for fluid mass flow rate and pressure to be properly assigned to the acausal fluid models.
</p>
<p>
  See <a href=\"modelica://AixLib.Fluid.FMI.ExportContainers.PartialTwoPortComponent\">AixLib.Fluid.FMI.ExportContainers.PartialTwoPortComponent</a> or <a href=\"modelica://AixLib.Fluid.FMI.ExportContainers.Examples.FMUs.ResistanceVolume\">AixLib.Fluid.FMI.ExportContainers.Examples.FMUs.ResistanceVolume</a> for how to use this model.
</p></html>",revisions="<html>
<ul>
  <li>November 8, 2016, by Michael Wetter:<br/>
    Corrected wrong argument type in function call of <code>Medium.temperature_phX</code> and <code>Medium.specificEnthalpy_pTX</code>.
  </li>
  <li>October 23, 2016, by Michael Wetter:<br/>
  ...
  <li>January 21, 2014 by Michael Wetter:<br/>
