...
<p>
  This example demonstrates how to use the adaptors <a href=\"modelica://AixLib.Fluid.FMI.Adaptors.HVAC\">AixLib.Fluid.FMI.Adaptors.HVAC</a> and <a href=\"modelica://AixLib.Fluid.FMI.Adaptors.ThermalZone\">AixLib.Fluid.FMI.Adaptors.ThermalZone</a>
</p>
<p>
...
<p>
  Note that the there is zero net air flow into and out of the volume <code>vol</code> because the adaptor <code>hvacAda</code> conserves mass. Hence, any infiltration or exfiltration needs to be connected to the adaptor <code>hvacAda</code>, rather than the volume <code>vol</code>.
</p></html>",revisions="<html>
<ul>
  <li>November 29, 2016, by Michael Wetter:<br/>
    Added separate signal for outdoor temperature used by HVAC system. This is to improve clarity regarding what signals are exchanged, see also <a href=\"https://github.com/iea-annex60/modelica-annex60/pull/598\">#598</a>.
  </li>
