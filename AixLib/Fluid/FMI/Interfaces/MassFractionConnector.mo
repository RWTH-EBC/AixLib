...
<p>
  Connector with variable of type <code>Modelica.SIunits.MassFraction</code>. Note that the mass fraction is in kg water vapor per total mass of air, rathern than per kg of dry air.
</p>
<p>
