...
block HeaterCooler_T
  ...
  "Declaration of an FMU that exports an ideal heater or cooler with prescribed outlet temperature"
   ...
   extends AixLib.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final AixLib.Fluid.HeatExchangers.HeaterCooler_T com(
...
<p>
  This example demonstrates how to export an FMU with a heater that takes as an input signal the leaving fluid temperature. The FMU has an instance of <a href=\"modelica://AixLib.Fluid.HeatExchangers.HeaterCooler_T\">AixLib.Fluid.HeatExchangers.HeaterCooler_T</a>.
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/HeaterCooler_T.mos"
