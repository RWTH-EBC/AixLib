...
<ul>
  <li>September 24, 2015 by Michael Wetter:<br/>
    Changed assignment of pressure to a <code>connect</code> statement because the pressure can be conditionally removed.
  </li>
