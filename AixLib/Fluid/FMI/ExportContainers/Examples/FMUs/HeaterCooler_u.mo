...
<p>
  This example demonstrates how to export an FMU with a heater that takes as an input signal the normalized heat flow rate. The FMU has an instance of <a href=\"modelica://AixLib.Fluid.HeatExchangers.HeaterCooler_u\">AixLib.Fluid.HeatExchangers.HeaterCooler_u</a>.
</p>
<p>
...
<ul>
  ...
  <li>November 3, 2014 by Michael Wetter:<br/>
