...
block Humidifier_u
  ...
  "Declaration of an FMU that exports an ideal humidifier"
   ...
   extends AixLib.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
     ...
     redeclare final AixLib.Fluid.MassExchangers.Humidifier_u com(
...
<p>
  This example demonstrates how to export an FMU with a humidifier that takes as an input signal the normalized mass flow rate of water that will be added to the medium. The FMU has an instance of <a href=\"modelica://AixLib.Fluid.MassExchangers.Humidifier_u\">AixLib.Fluid.MassExchangers.Humidifier_u</a>.
</p>
<p>
  The mass dynamics has been set to <code>massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState</code>. See the <a href=\"modelica://AixLib.Fluid.FMI.UsersGuide\">user's guide</a> for the rationale.
