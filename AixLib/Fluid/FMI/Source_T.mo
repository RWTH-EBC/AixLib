...
<p>
  Model of a source that takes as an input the mass flow rate, pressure and the medium properties temperature, mass fractions (if <code>Medium.nXi &gt; 0</code>) and trace substances (if <code>Medium.nC &gt; 0</code>).
</p>
<p>
  For a system of components with the connectors of the <a href=\"modelica://AixLib.Fluid.FMI\">AixLib.Fluid.FMI</a> package, this component is required to set the pressure and the mass flow rate of the system.
</p></html>",revisions="<html>
<ul>
  <li>October 15, 2016, by Michael Wetter:<br/>
