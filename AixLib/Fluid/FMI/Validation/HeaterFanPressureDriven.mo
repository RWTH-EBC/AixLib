...
<p>
  The component <code>invBloCon</code> at the bottom of the model sets up an equality constraint on the pressure between the sink and the source. It also outputs a signal for the mass flow rate. Hence, this component is used to declare how to break the algebraic loop in this signal flow diagram. For a model with prescribed mass flow rate, see <a href=\"modelica://AixLib.Fluid.FMI.Validation.HeaterFan\">AixLib.Fluid.FMI.Validation.HeaterFan</a>.
</p>
<p>
