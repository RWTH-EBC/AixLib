...
package Conversion "Package with blocks that convert between different connectors"
  ...
  annotation (Icon(graphics={
        ...
        Line(points={{-90,0},{30,0}}, color={191,0,0})}), Documentation(info="<html><p>
  This package contains blocks to convert between scalar input-output
  signals and the composite input-output connectors <a href=
