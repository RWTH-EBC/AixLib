...
<p>
  This example validates the conversion model <a href=\"modelica://AixLib.Fluid.FMI.Conversion.InletToAir\">AixLib.Fluid.FMI.Conversion.InletToAir</a> . The medium used is <a href=\"modelica://AixLib.Media.Air\">AixLib.Media.Air</a> without trace substances. The top model has no reverse flow, whereas the bottom model has reverse flow.
