...
<p>
  This example is identical to <a href=\"modelica://AixLib.Fluid.FMI.Conversion.Validation.AirToOutlet\">AixLib.Fluid.FMI.Conversion.Validation.AirToOutlet</a>, except that it has reverse flow. This tests whether the fluid properties from the upstream media are correctly converted to the output signals of <a href=\"modelica://AixLib.Fluid.FMI.Conversion.AirToOutlet\">AixLib.Fluid.FMI.Conversion.AirToOutlet</a>.
