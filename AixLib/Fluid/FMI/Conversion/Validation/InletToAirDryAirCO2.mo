...
<p>
  This validation test is identical to <a href=\"modelica://AixLib.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2\">AixLib.Fluid.FMI.Conversion.Validation.InletToAirMoistAirCO2</a> except that it uses a medium model without moisture. Hence, it tests whether the water vapor connectors are correctly removed.
