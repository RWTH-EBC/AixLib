...
model AirToOutlet "Validation model for air to outlet conversion"
  ...
  AixLib.Fluid.FMI.Conversion.AirToOutlet conAirNoC(
  ...
  AixLib.Fluid.FMI.Conversion.AirToOutlet conAirWithC(
  ...
  AixLib.Fluid.FMI.Conversion.AirToOutlet conDryAirNoC(
  ...
  AixLib.Fluid.FMI.Conversion.AirToOutlet conDryAirWithC(
...
<p>
  This example validates the conversion model <a href=\"modelica://AixLib.Fluid.FMI.Conversion.AirToOutlet\">AixLib.Fluid.FMI.Conversion.AirToOutlet</a> for the situation without reverse flow.
</p>
<p>
...
<ul>
  <li>April 20, 2016 by Michael Wetter:<br/>
