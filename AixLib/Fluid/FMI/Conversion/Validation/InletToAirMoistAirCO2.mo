...
<p>
  This example validates the conversion model <a href=\"modelica://AixLib.Fluid.FMI.Conversion.InletToAir\">AixLib.Fluid.FMI.Conversion.InletToAir</a> . It is identical to <a href=\"modelica://AixLib.Fluid.FMI.Conversion.Validation.InletToAirMoistAir\">AixLib.Fluid.FMI.Conversion.Validation.InletToAirMoistAir</a> except that the medium has <code>C02</code> trace substances.
