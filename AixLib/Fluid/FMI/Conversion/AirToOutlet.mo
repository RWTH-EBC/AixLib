...
<p>
  Block that takes real inputs for properties of an air-based HVAC system and converts them to an outlet connector of type <a href=\"modelica://AixLib.Fluid.FMI.Interfaces.Outlet\">AixLib.Fluid.FMI.Interfaces.Outlet</a>.
</p>
<p>
  See <a href=\"modelica://AixLib.Fluid.FMI.Adaptors.HVAC\">AixLib.Fluid.FMI.Adaptors.HVAC</a> for its usage.
