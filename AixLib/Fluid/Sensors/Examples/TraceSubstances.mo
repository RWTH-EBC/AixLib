...
<p>
  This example tests the sensors that measure trace substances. A CO<sub>2</sub> mass flow rate of <i>8.18E-8</i> kg/kg is added to the volume. The volume also has a fresh air mass flow rate and an exhaust air mass flow rate. The initial CO<sub>2</sub> concentration of the volume is <i>0</i> kg/kg. Note that the fresh air supply has zero carbon dioxide concentration. Therefore, if it were outside air, then all concentrations are relative to the outside air concentration.
</p></html>",revisions="<html>
<ul>
  <li>May 22, 2015, by Michael Wetter:<br/>
    Updated example to test the correction for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/249\">issue 249</a>.
  </li>
  <li>May 8, 2014, by Michael Wetter:<br/>
  ...
  <li>August 30, 2013 by Michael Wetter:<br/>
    Renamed example and added an instance of <a href=\"modelica://AixLib.Fluid.Sensors.TraceSubstancesTwoPort\">AixLib.Fluid.Sensors.TraceSubstancesTwoPort</a>.
  </li>
