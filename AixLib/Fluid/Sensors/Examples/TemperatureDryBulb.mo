...
model TemperatureDryBulb "Test model for the dry bulb temperature sensor"
 ...
 package Medium = AixLib.Media.Air "Medium model";
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort temSteSta(
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort temDyn(
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort temDynLoss(
...
<ul>
  <li>June 19, 2015 by Filip Jorissen:<br/>
