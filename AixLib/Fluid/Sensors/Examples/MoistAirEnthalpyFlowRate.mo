...
<ul>
  <li>November 2, 2016, by Michael Wetter:<br/>
    Removed assertion and added the enthalpy flow rates instead to the plot window so that they become part of the regression tests.<br/>
  ...
  <li>January 23 2013, by Michael Wetter:<br/>
    Changed time constant of <code>senH</code> so that it has the same transient response model as <code>senH_flow</code>.
  </li>
</ul>
