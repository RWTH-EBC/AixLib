...
<ul>
  ...
  <li>June 10, 2015, by Michael Wetter:<br/>
    Reformulated assignment of <code>s</code> and <code>assert</code> statement. The reformulation of the assignment of <code>s</code> was done to allow a model check in non-pedantic mode. This is for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/268\">issue 268</a>.
  </li>
  <li>May 22, 2015, by Michael Wetter:<br/>
    Corrected wrong sensor signal if <code>allowFlowReversal=false</code>. For this setting, the sensor output was for the wrong flow direction. This is for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/249\">issue 249</a>.
  </li>
  ...
  <li>August 30, 2013, by Michael Wetter:<br/>
    Added default value <code>C_start=0</code>.
  </li>
  <li>November 3, 2011, by Michael Wetter:<br/>
    Moved <code>der(C) := 0;</code> from the initial algorithm section to the initial equation section as this assignment does not conform to the Modelica specification.
  </li>
