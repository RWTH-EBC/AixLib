...
<p>
  The parameter <code>MM</code> is the molar mass of the trace substance. For a list of molar masses, see <a href=\"modelica://Modelica.Media.IdealGases.Common.SingleGasesData\">Modelica.Media.IdealGases.Common.SingleGasesData</a> and <a href=\"modelica://Modelica.Media.IdealGases.Common.FluidData\">Modelica.Media.IdealGases.Common.FluidData</a>.
</p>
<p>
...
<p>
  This sensor assumes that the concentration <i>C</i> of the medium is in mass fraction. Otherwise, the conversion to <i>ppm</i> will be wrong.
</p></html>",revisions="<html>
<ul>
  <li>December 16, 2015, by Michael Wetter:<br/>
