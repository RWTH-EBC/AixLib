...
<ul>
  <li>July 28, 2015, by Michael Wetter:<br/>
    Moved assignment of <code>m_condens</code> from equation section to declaration to avoid graphical and textual equations.
  </li>
...
<p>
  This example generates a non-linear algebraic loop that consists of <i>12</i> equations before manipulation. This loop can be decoupled and removed by changing the equation
</p>
<pre>
...
<p>
  in <a href=\"modelica://AixLib.Fluid.Interfaces.StaticTwoPortConservationEquation\">AixLib.Fluid.Interfaces.StaticTwoPortConservationEquation</a> to
</p>
<pre>
