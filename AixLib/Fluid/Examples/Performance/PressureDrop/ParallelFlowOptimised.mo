within AixLib.Fluid.Examples.Performance.PressureDrop;
 ...
 </html>"), experiment(Tolerance=1e-6, StopTime=1), __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Examples/Performance/PressureDrop/ParallelFlowOptimised.mos"
         "Simulate and plot"), 
