...
<p>
  Compare the C-code in dsmodel.c when setting the parameter <code>efficient</code> to <code>true</code> or <code>false</code> and when adding <code>annotation(Evaluate=true)</code> to the parameter <code>efficient</code>.
</p>
<p>
  This produces:
</p>
