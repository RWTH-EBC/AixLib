...
<p>
  This example demonstrates that the use of the parameter <code>from_dp</code> can be important for reducing the size of algebraic loops in hydraulic circuits with many pressure drop components connected in series and a pump setting the pressure head.
</p>
<p>
...
<ul>
  ...
  <li>May 20, 2015, by Filip Jorissen:<br/>
