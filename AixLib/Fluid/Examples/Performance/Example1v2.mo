...
<p>
  This example is an extension of <a href=\"modelica://AixLib.Fluid.Examples.Performance.Example1v1\">AixLib.Fluid.Examples.Performance.Example1v1</a> and demonstrates the use of mixing volumes for decoupling the algebraic loop that solves for the enthalpy of the system.
</p>
<h4>
  Example1v1:
</h4>
...
<ul>
  <li>August 31, 2015, by Michael Wetter:<br/>
    Added missing <code>each</code> in declaration of the energy balance for the volume.
  </li>
