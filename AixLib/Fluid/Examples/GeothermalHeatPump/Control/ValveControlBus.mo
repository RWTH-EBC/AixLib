...
expandable connector ValveControlBus
  ...
  Real opening_valveHeatSource "Rated value of the valve connecting the geothermal field to evaporator (0: closed, 1: open)";
...
<p>
Definition of a standard control bus that includes all the pressure set points required for <a href=\"modelica://AixLib.Fluid.Examples.GeothermalHeatPump.Components.GeothermalHeatPump\">
