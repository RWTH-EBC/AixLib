...
equation
  ...
  connect(pressureDifference.y, pumpEvaporator.dp_in) annotation (Line(points={{99,10},
          {82,10},{64,10},{64,54},{7.14,54},{7.14,44.4}},         color={0,0,
          127}));
  ...
  connect(pumpGeothermalSource.dp_in, pressureDifference.y) annotation (Line(
        points={{-89.14,-45.6},{-89.14,-36},{56,-36},{56,10},{99,10}}, color={0,
          0,127}));
