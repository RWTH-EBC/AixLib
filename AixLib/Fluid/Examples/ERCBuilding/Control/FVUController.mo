...
model FVUController
  ...
  parameter Real minimumSupTemp = 273.15+17
    "Minimum supply air temperature";

  parameter Real co2SetConcentration = 600
    "Set point for CO2 concentration";
  ...
  Modelica.Blocks.Sources.Constant hundred(k=100) annotation (Placement(
        transformation(
        extent={{-6,-6},{6,6}},
        rotation=0,
        origin={6,70})));
  ...
  Modelica.Blocks.Interfaces.RealOutput exhaustFanPower
  ...
  Modelica.Blocks.Interfaces.RealOutput supplyFanPower
  ...
  Modelica.Blocks.Sources.BooleanExpression booleanExpression(y=if
        exhaustFanPower > supplyFanPower + 0.1 or exhaustFanPower <
        supplyFanPower - 0.1 then false else true)
    annotation (Placement(transformation(extent={{120,-70},{140,-50}})));
  Modelica.Blocks.Logical.Switch switch6
    annotation (Placement(transformation(extent={{160,-66},{172,-54}})));
  Modelica.Blocks.Interfaces.RealOutput circulationFlapOpening
  ...
  Modelica.Blocks.Interfaces.RealOutput HRCFlapOpening
  ...
  Modelica.Blocks.Interfaces.RealOutput freshAirFlapOpening
    annotation (Placement(transformation(extent={{210,-100},{230,-80}})));
  Modelica.Blocks.Math.Add add2
    annotation (Placement(transformation(extent={{-94,58},{-82,70}})));
  Modelica.Blocks.Sources.Constant setDeviationFreeCooling1(k=0.5)
    annotation (Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=0,
        origin={-94,6})));
...
equation
  ...
  connect(hundred.y, useHeatingValve.u1) annotation (Line(points={{12.6,70},{30,
          70},{30,58.8},{60.8,58.8}}, color={0,0,127}));
  ...
  connect(switch4.y, exhaustFanPower)
    annotation (Line(points={{126.6,0},{192,0},{192,30},{220,30}},
                                                 color={0,0,127}));
  ...
  connect(hundred.y, switch5.u3) annotation (Line(points={{12.6,70},{30,70},{30,
          -12},{20,-12},{20,-30.8},{26.8,-30.8}}, color={0,0,127}));
  ...
  connect(switch1.y, supplyFanPower) annotation (Line(points={{172.6,-27},{
  ...
  connect(switch6.y, circulationFlapOpening)
    annotation (Line(points={{172.6,-60},{196,-60},{196,-30},{220,-30}},
                                                     color={0,0,127}));
  ...
  connect(hundred.y, useHRC.u1) annotation (Line(points={{12.6,70},{12.6,70},{
          30,70},{30,-12},{50,-12},{50,-38.2},{60.8,-38.2}}, color={0,0,127}));
  connect(zero.y, useHRC.u3) annotation (Line(points={{12.6,34},{34,34},{34,
          -6},{54,-6},{54,-47.8},{60.8,-47.8}}, color={0,0,127}));
  connect(useHRC.y, HRCFlapOpening) annotation (Line(points={{74.6,-43},{74,
          -43},{74,-44},{186,-44},{186,-60},{220,-60}},
                                    color={0,0,127}));
  ...
  connect(switch7.y, freshAirFlapOpening) annotation (Line(points={{76.6,
          -80},{180,-80},{180,-90},{220,-90}}, color={0,0,127}));
  ...
  connect(hundred.y, switch6.u3) annotation (Line(points={{12.6,70},{12.6,70},{
          30,70},{30,-12},{50,-12},{50,-56},{50,-58},{80,-58},{80,-64.8},{158.8,
          -64.8}}, color={0,0,127}));
  connect(zero.y, switch6.u1) annotation (Line(points={{12.6,34},{34,34},{
          34,-6},{80,-6},{80,-48},{146,-48},{146,-55.2},{158.8,-55.2}},
        color={0,0,127}));
  connect(roomSetTemperature, add2.u2) annotation (Line(points={{-100,-30},{-70,
          -30},{-70,50},{-100,50},{-100,60.4},{-95.2,60.4}}, color={0,0,127}));
  connect(add2.y, roomToBeCooled.u) annotation (Line(points={{-81.4,64},{-72,64},
          {-72,84},{-62,84}}, color={0,0,127}));
  connect(setDeviationFreeCooling1.y, add2.u1) annotation (Line(points={{-87.4,
          6},{-68,6},{-68,76},{-100,76},{-100,67.6},{-95.2,67.6}}, color={0,0,
          127}));
  connect(one1.y, switch7.u1) annotation (Line(points={{20.6,-68},{40,-68},{58,
          -68},{58,-75.2},{62.8,-75.2}}, color={0,0,127}));
  connect(zero1.y, switch7.u3) annotation (Line(points={{20.6,-90},{58,-90},{58,
          -84.8},{62.8,-84.8}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{
            -100,-100},{220,100}}), graphics={
          Rectangle(
