...
model GlycolCoolerController
  ...
  Modelica.Blocks.Tables.CombiTable1D Number_Fans_Table_Real(smoothness=
        Modelica.Blocks.Types.Smoothness.ConstantSegments, table=[29,0; 30,0;
        30.01,1; 31,1; 31.01,2; 32,2; 32.01,3; 33,3; 33.01,4; 34,4])
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=180,
        origin={-26,-36})));
  Modelica.Blocks.Tables.CombiTable1D Number_Fans_Table(table=[29,0; 30,0;
        30.01,1; 31,1; 31.01,2; 32,2; 32.01,3; 33,3; 33.01,4; 34,4],
  ...
  Modelica.Blocks.Logical.GreaterThreshold greaterThreshold(threshold=273.15 + 33)
    annotation (Placement(transformation(extent={{-62,24},{-50,36}})));
  Modelica.Blocks.Interfaces.RealInput HeatStorageTemperatures[n]
    "Connector of Boolean input signal"
    annotation (Placement(transformation(extent={{-120,62},{-80,102}})));
  Utilities.CalculateAverageTemperature calculateAverageTemperature(nin=n)
...
equation
  ...
  connect(greaterThreshold.y, switch3.u2) annotation (Line(points={{-49.4,30},{-21.2,
          30},{-21.2,30}}, color={255,0,255}));
  connect(greaterThreshold.y, switch1.u2) annotation (Line(points={{-49.4,30},{-44,
          30},{-44,-10},{46.8,-10}}, color={255,0,255}));
  connect(HeatStorageTemperatures, calculateAverageTemperature.u)
    annotation (Line(points={{-100,82},{-66,82}}, color={0,0,127}));
  connect(calculateAverageTemperature.y[1], greaterThreshold.u) annotation (
      Line(points={{-43,82},{-36,82},{-36,58},{-78,58},{-78,30},{-63.2,30}},
        color={0,0,127}));
