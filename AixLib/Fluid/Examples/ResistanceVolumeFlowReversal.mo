...
model ResistanceVolumeFlowReversal
  ...
  AixLib.Fluid.FixedResistances.FixedResistanceDpM[nRes.k] res(
    redeclare package Medium = Medium,
...
<a href=\"modelica://AixLib.Fluid.Interfaces.ConservationEquationcode\">
AixLib.Fluid.Interfaces.ConservationEquationcode</a>.
