...
<p>
  This model demonstrates the impact of the <code>allowFlowReversal</code> parameter on the size of nonlinear systems of equations. The user can change the parameter value in the <code>allowFlowReversal</code> block and rerun the simulation. The results are also demonstrated below for <code>nRes.k = 10</code>, which is the number of parallel branches containing one pressure drop element and one mixing volume each.
</p>
<p>
  This model was created to demonstrate the influence of a new implementation of <a href=\"modelica://AixLib.Fluid.Interfaces.ConservationEquation\">AixLib.Fluid.Interfaces.ConservationEquation</a>. The old implementation used the <code>actualStream()</code> function whereas the new implementation uses the <code>semiLinear()</code> function. This change allows Dymola to exploit knowledge about the <code>min</code> and <code>max</code> attributes of <code>m_flow</code>. When Dymola knows in which way the medium will flow, nonlinear systems can be simplified or completely removed. This is illustrated by the results below. See <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/216\">issue 216</a> for a discussion.
</p>
<p>
...
<p>
  These results were generated using Dymola 2015FD01 64 bit on Ubuntu 14.04 and with <code>Evaluate=false</code>.
</p>
<h4>
...
<ul>
  ...
  <li>February 22, 2016, by Michael Wetter:<br/>
    Removed parameter <code>dynamicBalance</code> for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/411\">issue 411</a>.
  </li>
  <li>April 17, 2015, by Filip Jorissen:<br/>
