...
<p>
  This model contains a simple model of a heating system, with a pump, ideal heat source, pipes, thermostatic valve and radiator. It serves as a demonstration case of how components of the <code>AixLib</code> library can be used.
</p></html>",revisions="<html>
<ul>
  <li>
    <i>April 25, 2017</i> by Peter Remmen:<br/>
    Move Example from <code>Fluid.HeatExchangers.Examples</code> to <code>Fluid.Examples</code>
  </li>
</ul>
<ul>
  <li>
