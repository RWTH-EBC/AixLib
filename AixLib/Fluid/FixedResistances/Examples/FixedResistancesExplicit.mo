...
model FixedResistancesExplicit "Test of multiple resistances in series"
 ...
 package Medium = AixLib.Media.Air;
  ...
  AixLib.Fluid.Sources.Boundary_ph sin(
    ...
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res11(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
    ...
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res12(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
             annotation (Placement(transformation(extent={{20,90},{40,110}})));
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res22(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
             annotation (Placement(transformation(extent={{20,50},{40,70}})));
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res21(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
             annotation (Placement(transformation(extent={{-20,50},{0,70}})));
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res31(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
             annotation (Placement(transformation(extent={{-20,-20},{0,0}})));
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res32(
    redeclare package Medium = Medium,
    from_dp=false,
    m_flow_nominal=2,
    dp_nominal=5)
             annotation (Placement(transformation(extent={{20,-20},{40,0}})));
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res42(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
             annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
    AixLib.Fluid.FixedResistances.FixedResistanceDpM res41(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5,
    from_dp=true)
  ...
  AixLib.Fluid.Sources.Boundary_ph sin2(            redeclare package Medium
      =        Medium,
    nPorts=1,
    use_p_in=false,
    p=101325)                         annotation (Placement(transformation(
          extent={{120,50},{100,70}})));
  AixLib.Fluid.Sources.Boundary_ph sou1(            redeclare package Medium
      =        Medium,
    nPorts=1,
    p(displayUnit="Pa") = 101335,
    use_p_in=true)                    annotation (Placement(transformation(
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/FixedResistances/Examples/FixedResistancesExplicit.mos"
        "Simulate and plot"),
