...
partial model PartialThreeWayValve "Partial three way valve"
  extends AixLib.Fluid.BaseClasses.PartialThreeWayResistance(
    ...
    redeclare replaceable AixLib.Fluid.Actuators.BaseClasses.PartialTwoWayValve res1
    ...
    redeclare replaceable AixLib.Fluid.Actuators.BaseClasses.PartialTwoWayValve res3
      constrainedby AixLib.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
        deltaM=deltaM,
        from_dp=from_dp,
