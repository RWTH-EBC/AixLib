...
equation
  ...
  kDam=sqrt(2*rho)*area/AixLib.Fluid.Actuators.BaseClasses.exponentialDamper(
...
<p>
  For a description of the opening characteristics and typical parameter values, see the damper model <a href=\"modelica://AixLib.Fluid.Actuators.Dampers.Exponential\">AixLib.Fluid.Actuators.Dampers.Exponential</a>.
</p></html>",revisions="<html>
<ul>
  <li>January 27, 2015 by Michael Wetter:<br/>
    Set <code>Evaluate=true</code> for <code>use_constant_density</code>. This is a structural parameter. Adding this annotation leads to fewer numerical Jacobians for <code>Buildings.Examples.VAVReheat.ClosedLoop</code> with <code>Buildings.Media.PerfectGases.MoistAirUnsaturated</code>.
  </li>
  ...
  <li>June 22, 2008 by Michael Wetter:<br/>
    Extended range of control signal from 0 to 1 by implementing the function <a href=\"modelica://AixLib.Fluid.Actuators.BaseClasses.exponentialDamper\">exponentialDamper</a>.
  </li>
