...
equation
 ...
 if (dpFixed_nominal > Modelica.Constants.eps) then
   ...
   if homotopyInitialization then
     if from_dp then
         m_flow=homotopy(actual=AixLib.Utilities.Math.Functions.spliceFunction(
                            x=dp-dp_min,
                            pos= m_flow_set + l2*(dp-dp_min)/dp_nominal*m_flow_nominal,
                            neg= AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
                                  dp=dp,
                                  k=k,
                                  m_flow_turbulent=m_flow_turbulent),
         ...
         dp=homotopy(actual=AixLib.Utilities.Math.Functions.spliceFunction(
                            x=m_flow-m_flow_set,
                            pos= dp_min + (m_flow-m_flow_set)/m_flow_nominal*dp_nominal/l2,
                            neg= AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
                                  m_flow=m_flow,
                                  k=k,
                                  m_flow_turbulent=m_flow_turbulent),
     ...
     if from_dp then
       m_flow=AixLib.Utilities.Math.Functions.spliceFunction(
                            x=dp-dp_min,
                            pos= m_flow_set + l2*(dp-dp_min)/dp_nominal*m_flow_nominal,
                            neg= AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_dp(
                                  dp=dp,
        ...
        dp=AixLib.Utilities.Math.Functions.spliceFunction(
                            x=m_flow-m_flow_set,
                            pos= dp_min + (m_flow-m_flow_set)/m_flow_nominal*dp_nominal/l2,
                            neg= AixLib.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(
                                  m_flow=m_flow,
