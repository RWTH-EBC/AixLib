...
partial model PartialMetaExpansionValve
   "Base model for all expansion valve models with metastability"
  ...
  replaceable model FlowCoefficient =
    Utilities.FlowCoefficient.SpecifiedFlowCoefficients.ConstantFlowCoefficient
                                                      constrainedby
    Coefficient.PartialFlowCoefficient
...
replaceable model MetastabilityCoefficient =
   Utilities.MetastabilityCoefficient.SpecifiedMetastabilityCoefficient.ConstantMetastabilityCoefficient
     ...
     "Model that describes the calculation of the metastability coefficient"
      annotation (choicesAllMatching=true, Dialog(enable=if (Utilities.Types.Choice.Bernoullip_th)
