...
<table>
  <caption>
    ...
    <table>
      <caption>
        \"Polynomial approaches\" border=\"1\" cellspacing=\"0\"
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <code>C = a1*A + a2*ρ<sub>inlet</sub> +
              a3*ρ<sub>outlet</sub> + a4*T<sub>subcooling</sub> +
              a5*d<sub>clearance</sub> + a6*(p<sub>inlet</sub>-
              p<sub>outlet</sub>)</code>
            </td>
            <td>
...
<table>
  <caption>
    ...
    <p>
      In the following, a guideline of naming flow coefficient models
      is summarised:
    </p>
    <p style=\"margin-left: 30px;\">
      <i>Approach of calculating flow coefficient</i> _ <i>Valid
      refrigerants</i> _ <i>Type of expansion valve</i> _ <i>Diameter
      of cross-sectional area of expansion valve</i>
    </p>
    <ol>
      <li>
      ...
      <li>
        <u>Refrigerant:</u> Refrigerants the flow coefficent model is
        valid for, e.g. R134a or R410a.
      </li>
      <li>
        <u>Type:</u> Type of expansion valve, e.g. electric expansion
        valve (EEV).
      </li>
      <li>
        <u>Diameter:</u> Diameter of the cross-sectional area of
        expansion valves if it is fully opened, e.g. 1.6 mm.
      </li>
    </ol>
    <h4>
      Transient behaviour
