...
class References "References"
  ...
  In the following, the literature used for the expansion valve library
  is summarised.
</p>
<h4>
  References regarding expansion valves in general
</h4>
<p>
...
<h4>
  References regarding polynomial approaches
</h4>
<p>
  M. Shanwei, Z. Chuan, C. Jiangping and C. Zhiujiu. (2005): <a href=
  \"http://dx.doi.org/10.1016/j.applthermaleng.2004.12.005\">Experimental
...
<h4>
  References regarding power approaches
</h4>
<p>
  Li, W. (2013): <a href=
  \"http://dx.doi.org/10.1016/j.applthermaleng.2012.12.035\">Simplified
