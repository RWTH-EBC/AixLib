...
Documentation(info="<html><p>
  This is a generic record for three way valve that includes two
  records for the gate A-AB and B-AB. The records define the normalized
  volume flow rates for different valve opening positions. See the
  documentation of <a href=
  \"modelica://AixLib.Fluid.Actuators.Valves.Data\">AixLib.Fluid.Actuators.Valves.Data</a>
  for how to use this record.
</p>
</html>",
revisions="<html><ul>
  <li>June 09, 2020, by Alexander Kümpel:<br/>
