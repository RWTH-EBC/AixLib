...
model ValveParameterization
 ...
 package Medium = AixLib.Media.Water;
  ...
  AixLib.Utilities.Diagnostics.AssertEquality equ1(threShold=0.01)

    annotation (Placement(transformation(extent={{80,60},{100,80}})));

  AixLib.Utilities.Diagnostics.AssertEquality equ2(threShold=0.01)
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/ValveParameterization.mos"
...
<ul>
  <li>April 1, 2013, by Michael Wetter:<br/>
    Removed the valve from <code>Modelica.Fluid</code> to allow a successful check of the model in the pedantic mode in Dymola 2014.
  </li>
  <li>March 1, 2013, by Michael Wetter:<br/>
    Removed assignment of <code>dpValve_nominal</code> if <code>CvData &lt;&gt; AixLib.Fluid.Types.CvTypes.OpPoint</code>, as in this case, it is computed by the model.
  </li>
