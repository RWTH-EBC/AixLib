...
model WetFluid
  ...
  extends
    AixLib.Fluid.CHPs.OrganicRankine.BaseClasses.Validation.DryFluid(
      TEva = 350,
      redeclare parameter
        AixLib.Fluid.CHPs.OrganicRankine.Data.WorkingFluids.R134a pro);
annotation (experiment(StopTime=1, Tolerance=1e-6),
  __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/CHPs/OrganicRankine/BaseClasses/Validation/WetFluid.mos"
  "Simulate and plot"),
  Documentation(info="<html>
<p>
This model is largely the same as
<a href=\"Modelica://AixLib.Fluid.CHPs.OrganicRankine.BaseClasses.Validation.DryFluid\">
AixLib.Fluid.CHPs.OrganicRankine.BaseClasses.Validation.DryFluid</a>,
