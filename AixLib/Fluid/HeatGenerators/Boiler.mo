...
model Boiler
  extends AixLib.Fluid.HeatGenerators.BaseClasses.PartialHeatGenerator(
      pressureDrop(a=paramBoiler.PressureDrop),                        vol(V=
          paramBoiler.volume));

  replaceable model ExtControl =
   AixLib.Fluid.HeatGenerators.BaseClasses.Controllers.ExternalControl_nightDayHC
  constrainedby
    AixLib.Fluid.HeatGenerators.BaseClasses.Controllers.PartialExternalControl
    "ExternalControl"
