...
package Medium = AixLib.Media.Air;
  AixLib.Utilities.Diagnostics.AssertEquality assTem(threShold=1E-8,
      startTime=0)
    "Assert to test if the outputs of the forward flow and reverse flow model are identical"
    annotation (Placement(transformation(extent={{160,0},{180,20}})));
  AixLib.Utilities.Diagnostics.AssertEquality assEnt(threShold=1E-8,
      startTime=0)
    "Assert to test if the outputs of the forward flow and reverse flow model are identical"
    annotation (Placement(transformation(extent={{160,-30},{180,-10}})));
  AixLib.Utilities.Diagnostics.AssertEquality assMas(threShold=1E-8,
      startTime=0)
    "Assert to test if the outputs of the forward flow and reverse flow model are identical"
  ...
  AixLib.Utilities.Diagnostics.AssertEquality assTem1(threShold=1E-8,
      startTime=0)
    "Assert to test if the outputs of the forward flow and reverse flow model are identical"
    annotation (Placement(transformation(extent={{-200,-20},{-180,0}})));
  AixLib.Utilities.Diagnostics.AssertEquality assEnt1(threShold=1E-8,
      startTime=0)
    "Assert to test if the outputs of the forward flow and reverse flow model are identical"
    annotation (Placement(transformation(extent={{-200,-50},{-180,-30}})));
  AixLib.Utilities.Diagnostics.AssertEquality assMas1(threShold=1E-8,
      startTime=0)
    "Assert to test if the outputs of the forward flow and reverse flow model are identical"
