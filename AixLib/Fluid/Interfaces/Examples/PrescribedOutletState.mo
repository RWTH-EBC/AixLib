...
model PrescribedOutletState "Test model for prescribed outlet state"
  ...
  AixLib.Fluid.Interfaces.PrescribedOutletState heaHigPow(
  ...
  AixLib.Fluid.Interfaces.PrescribedOutletState cooLimPow(
  ...
  AixLib.Fluid.Interfaces.PrescribedOutletState heaCooUnl(
...
__Dymola_Commands(file= "modelica://AixLib/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/PrescribedOutletState.mos"
...
<p>
  The heater model has an almost unlimited positive capacity (<code>Q_flow_nominal = 1.0e10</code> Watts), and hence its outlet temperature always reaches the set point temperatures.
</p>
<p>
  The cooler model has a limited negative capacitiy (<code>Q_flow_nominal = 1000</code> Watts), and hence its outlet temperature reaches only a limited value corresponding to its maximum negative capacity.
</p>
<p>
...
<p>
  The heater and cooler models have the parameter <code>show_T</code> set to <code>true</code> to allow inspecting the temperatures at their ports.
