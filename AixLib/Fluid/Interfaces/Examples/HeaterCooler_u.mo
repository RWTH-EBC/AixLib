...
model HeaterCooler_u
 ...
 package Medium = AixLib.Media.Water;
  ...
  AixLib.Utilities.Diagnostics.AssertEquality ass1(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,160},{180,180}})));
  AixLib.Utilities.Diagnostics.AssertEquality ass2(               threShold=
        0.05, startTime=600)
  ...
  AixLib.Utilities.Diagnostics.AssertEquality ass3(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,0},{180,20}})));
  AixLib.Utilities.Diagnostics.AssertEquality ass4(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,60},{180,80}})));
  AixLib.Utilities.Diagnostics.AssertEquality ass5(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,-164},{180,-144}})));
  AixLib.Utilities.Diagnostics.AssertEquality ass6(               threShold=
        0.05, startTime=600)
  ...
  AixLib.Utilities.Diagnostics.AssertEquality ass7(               threShold=
        0.05, startTime=600)
    annotation (Placement(transformation(extent={{160,-284},{180,-264}})));
  AixLib.Utilities.Diagnostics.AssertEquality ass8(               threShold=
        0.05, startTime=600)
