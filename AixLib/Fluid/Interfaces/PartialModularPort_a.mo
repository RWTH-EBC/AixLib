...
<p>
This component transports fluid between its multiple inlet ports and signle 
outlet port, without storing mass or energy. Energy may be exchanged with the 
...
modular evaporators that are used, for example, in modular heat pumps.
</p>
<p>
