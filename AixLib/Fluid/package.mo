...
<p>
The package <code>AixLib.Fluid</code> consists of models
...
<tr>
  ...
  <td>Specific enthalpy <i>h</i> of the outflowing fluid, i.e.,
      ...
      AixLib.Fluid.Sensors.SpecificEnthalpyTwoPort</a>.</td>
</tr>
<tr>
...
<tr>
  ...
  <td>Trace substances <i>c<sub>i</sub>/m</i> close to the connection point, i.e.,
      ...
      AixLib.Fluid.Sensors.Examples.TraceSubstances</a>.</td>
</tr>
</table>
...
<tr>
  ...
  <td>These parameter may be used
      ...
      AixLib.Fluid.FixedResistances.FixedResistanceDpM</a>.
  </td>
</tr>
<tr>
  <td>m_flow_nominal<br/>
