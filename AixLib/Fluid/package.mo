...
style=\"border-collapse:collapse;\">
  ...
  <tr>
    ...
    <td>
      ...
      the
      sensor
      <a href=\"modelica://AixLib.Fluid.Sensors.SpecificEnthalpyTwoPort\">
      AixLib.Fluid.Sensors.SpecificEnthalpyTwoPort</a>.
    </td>
  </tr>
  <tr>
    <td>
      <code>
      Xi_outflow[Medium.nXi]</code>
    </td>
    <td>
      Independent
      mixture
      ...
      the
      sensor
      <a href=\"modelica://AixLib.Fluid.Sensors.MassFractionTwoPort\">
      AixLib.Fluid.Sensors.MassFractionTwoPort</a>.
      Note
      that
      this
      variable
  ...
  <tr>
    ...
    <td>
      ...
      for
      example
      <a href=\"modelica://AixLib.Fluid.Sensors.Examples.TraceSubstances\">
      AixLib.Fluid.Sensors.Examples.TraceSubstances</a>.
    </td>
  </tr>
</table>
<h4>
...
style=\"font-style:italic;\">
  ...
  ṁ
  ⁄
  √<span style=\"text-decoration:overline;\">&#160;Δp
  &#160;</span>
</p>
<p>
  where
...
style=\"border-collapse:collapse;\">
  ...
  <tr>
    ...
    <td>
      ...
      set
      <code>
      m_flow_small=1E-4*abs(m_flow_nominal)</code>
      as
      the
      default
      value.
...
<p>
  ...
  classes
  from
  <a href=\"modelica://AixLib.Fluid.Interfaces\">
  AixLib.Fluid.Interfaces</a>
  and
  from
