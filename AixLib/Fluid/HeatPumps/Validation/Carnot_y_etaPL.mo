...
<p>
  This example extends from <a href=\"modelica://AixLib.Fluid.HeatPumps.Examples.Carnot_y\">AixLib.Fluid.HeatPumps.Examples.Carnot_y</a> but uses a part load efficiency curve that is different from <i>1</i>.
