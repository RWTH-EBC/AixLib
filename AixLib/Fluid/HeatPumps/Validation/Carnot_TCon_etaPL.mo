...
<p>
  This example extends from <a href=\"modelica://AixLib.Fluid.HeatPumps.Examples.Carnot_TCon\">AixLib.Fluid.HeatPumps.Examples.Carnot_TCon</a> but has a part load efficiency that varies with the load.
