...
package PerformanceDataNEW
  "Different moodels used for a black box heat pump model"
  model IcingBlock "Block which decreases evaporator power by an icing factor"
...
<p>Model for calculation of the icing factor. The replaceable function uses the inputs to calculate the resulting icing factor.</p>
  ...
  model LookUpTable2DNEW "Performance data coming from manufacturer"
    extends BaseClasses.PartialPerformanceDataNEW;
...
<p>The model <a href=\"modelica://AixLib.Utilities.Tables.CombiTable2DExtra\">CombiTable2DExtra</a> is able to disallow extrapolation by holding the last value. If one extrapolates the given perfomance data, warnings about occuring extrapolations are emitted. <b>CAUTION: Checking for possible extrapolations will trigger state events which results in higher computing time.</b></p>
  ...
  end LookUpTable2DNEW;

  model LookUpTableNDNEW "N-dimensional table with data for heat pump"
    extends BaseClasses.PartialPerformanceDataNEW;
...
First implementation (see issue <a href=\"https://github.com/RWTH-EBC/AixLib/issues/577\">#577</a>)
  ...
  end LookUpTableNDNEW;

  model PolynomalApproachNEW
...
<p>This model is used to calculate the COP or the EER of a device. As the electrical power could get negative, a lower boundary is used to avoid division by zero. A moving average ensure a stable calculation of the COP or EER.</p>
  ...
  package BaseClasses "Package with partial classes of Performance Data"
    partial model PartialPerformanceDataNEW
      ...
      Modelica.Blocks.Interfaces.RealOutput QCon(final unit="W", final displayUnit="kW")
        "Heat flow rate through Condenser" annotation (Placement(transformation(
            ...
            rotation=270,
            origin={-80,-110})));
      Controls.Interfaces.HeatPumpControlBusNEW
                                             sigBusHP "Bus-connector used in a heat pump" annotation (Placement(
            transformation(
            extent={{-15,-14},{15,14}},
            rotation=0,
            origin={1,104})));
