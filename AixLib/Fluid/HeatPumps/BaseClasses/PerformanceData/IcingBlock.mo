...
model IcingBlock
  ...
  replaceable function iceFunc =
      DataBase.HeatPump.Functions.IcingFactor.BasicIcingApproach       constrainedby AixLib.DataBase.HeatPump.Functions.IcingFactor.PartialBaseFct    "Replaceable function to calculate current icing factor" annotation(choicesAllMatching=true);
