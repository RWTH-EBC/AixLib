within AixLib.Fluid.HeatPumps.BaseClasses.HeatPumpControl.BaseClasses;
partial model partialTSetToNSet "Partial model to convert set temperature to compressor speed of heat pump"
  ...
  Modelica.Blocks.Interfaces.RealInput TAct "Actual temperature, control variable"
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-116,-80})));
  CalcQdot calcQdot if use_secHeaGen
