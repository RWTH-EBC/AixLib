within AixLib.Fluid.HeatPumps.ModularReversible.Validation;
model TableData2D
  extends Modelica.Icons.Example;
  extends
    AixLib.Fluid.HeatPumps.ModularReversible.Validation.BaseClasses.PartialValidation(
      heaPum(
      ...
      redeclare model RefrigerantCycleHeatPumpHeating =
          AixLib.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.TableData2D (
            datTab=
              AixLib.Fluid.HeatPumps.ModularReversible.Data.TableData2D.GenericHeatPump(
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=14365),
    __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Validation/TableData2D.mos"
            "Simulate and plot"),
