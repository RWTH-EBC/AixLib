within AixLib.Fluid.HeatPumps.ModularReversible.Validation.BaseClasses;
 partial model PartialValidation
   "Validation base case for the reversible heat pump model."
 
   replaceable package MediumSin = AixLib.Media.Water
     constrainedby Modelica.Media.Interfaces.PartialMedium
       "Medium of sink side"
       annotation (choicesAllMatching=true);
   replaceable package MediumSou = AixLib.Media.Water
     constrainedby Modelica.Media.Interfaces.PartialMedium
       "Medium of source side"
       annotation (choicesAllMatching=true);
   AixLib.Fluid.Sources.MassFlowSource_T souSidMasFlowSou(
     use_m_flow_in=true,
     use_T_in=true,
     m_flow=1,
     nPorts=1,
   ...
   AixLib.Fluid.Sources.Boundary_pT souSidFixBou(
     nPorts=1,
   ...
   AixLib.Fluid.Sources.Boundary_pT sinSidFixBou(redeclare final package Medium =
         MediumSin, nPorts=1) "Fixed boundary at the outlet of the sink side"
     annotation (Placement(transformation(
         extent={{10,10},{-10,-10}},
         rotation=0,
         origin={50,-24})));
   AixLib.Fluid.Sources.MassFlowSource_T sinSidMasFlowSou(
     use_m_flow_in=true,
     use_T_in=true,
     m_flow=1,
     nPorts=1,
   ...
   Modelica.Blocks.Sources.CombiTimeTable tabMea(
     ...
     fileName=Modelica.Utilities.Files.loadResource("modelica://AixLib/Resources/Data/Fluid/HeatPumps/Validation/MeasuredHeatPumpData.txt"),
     columns=2:10,
