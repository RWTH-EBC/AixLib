  ...
  AixLib.Fluid.HeatPumps.ModularReversible.Modular heaPum(
    ...
    redeclare model RefrigerantCycleHeatPumpCooling =
      AixLib.Fluid.Chillers.ModularReversible.RefrigerantCycle.TableData2D(
        ...
        mEva_flow_nominal=heaPum.mEva_flow_nominal,
        datTab=AixLib.Fluid.Chillers.ModularReversible.Data.TableData2D.EN14511.Vitocal251A08()),
...
<li>
  ...
  \"https://github.com/ibpsa/modelica-ibpsa/issues/1576\">#1576</a>)
   ...
   __Dymola_Commands(file=
     "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Examples/Modular_OneRoomRadiator.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=86400,
