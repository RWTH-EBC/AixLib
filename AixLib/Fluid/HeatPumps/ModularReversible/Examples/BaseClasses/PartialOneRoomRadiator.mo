...
//----------------------------------------------------------------------------//
  ...
  replaceable AixLib.Fluid.Movers.Preconfigured.FlowControlled_m_flow pumHeaPum(
    redeclare package Medium = MediumWat,
    m_flow_nominal=mCon_flow_nominal,
...
//--------------------------------------------------------------------------------------//
  ...
  AixLib.Fluid.Movers.Preconfigured.FlowControlled_m_flow pumHeaPumSou(
    redeclare package Medium = MediumWat,
  ...
  Modelica.Blocks.Sources.Pulse cooLoa(
    ...
    startTime=86400/2) if witCoo "Cooling load with step" annotation (Placement(
        ...
        rotation=0,
        origin={-130,70})));
  AixLib.Fluid.HeatPumps.ModularReversible.Examples.BaseClasses.OneRoomRadiatorHeatPumpControl oneRooRadHeaPumCtr(
    final witCoo=witCoo)
...
<p>
  ...
  <a href=\"modelica://AixLib.Fluid.HeatPumps.Examples.ScrollWaterToWater_OneRoomRadiator\">
