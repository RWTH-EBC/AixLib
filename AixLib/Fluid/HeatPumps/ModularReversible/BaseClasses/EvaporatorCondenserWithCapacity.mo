...
model EvaporatorCondenserWithCapacity
  ...
  extends AixLib.Fluid.Interfaces.TwoPortHeatMassExchanger(
    redeclare final AixLib.Fluid.MixingVolumes.MixingVolume vol(final V=
...
<p>
  Used in <a href=
  \"modelica://AixLib.Fluid.HeatPumps.ModularReversible.Modular\">
  AixLib.Fluid.HeatPumps.ModularReversible.Modular</a> and <a href=
  \"modelica://AixLib.Fluid.Chillers.ModularReversible.Modular\">
