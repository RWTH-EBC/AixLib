within AixLib.Fluid.HeatPumps.ModularReversible.BaseClasses;
 ...
 //Advanced
   ...
   AixLib.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity con(
   ...
   AixLib.Fluid.HeatPumps.ModularReversible.BaseClasses.EvaporatorCondenserWithCapacity eva(
   ...
   Modelica.Thermal.HeatTransfer.Sources.PrescribedTemperature varTOutCon
     ...
     annotation (Placement(transformation(
         ...
         rotation=0,
         origin={-50,130})));
   AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.Safety safCtr(
   ...
   AixLib.Fluid.Sensors.MassFlowRate mEva_flow(redeclare final package Medium =
     ...
     "Mass flow sensor at the evaporator" annotation (Placement(transformation(
         ...
         extent={{10,-10},{-10,10}},
         rotation=0)));
   AixLib.Fluid.Sensors.MassFlowRate mCon_flow(final allowFlowReversal=
   ...
   AixLib.Fluid.HeatPumps.ModularReversible.BaseClasses.CalculateEfficiency
