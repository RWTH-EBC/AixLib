...
model CarnotWithLosses
  ...
  extends AixLib.Fluid.HeatPumps.ModularReversible.Modular(
...
<p>
  ...
  AixLib.Fluid.HeatPumps.ModularReversible.Modular</a> and selects the
  constant Carnot effectiveness module for heat pumps
  (<a href=\"modelica://AixLib.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness\">
  AixLib.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness</a>)
  and chillers
  (<a href=\"modelica://AixLib.Fluid.Chillers.ModularReversible.RefrigerantCycle.ConstantCarnotEffectiveness\">
