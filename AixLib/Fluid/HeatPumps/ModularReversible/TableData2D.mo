...
model TableData2D
  ...
  replaceable parameter
    AixLib.Fluid.HeatPumps.ModularReversible.Data.TableData2D.GenericHeatPump datTabHea
    constrainedby
  ...
  replaceable parameter AixLib.Fluid.Chillers.ModularReversible.Data.TableData2D.Generic datTabCoo(
