...
record VCLibVaporInjectionPhaseSeparatorR152a
  ...
  extends AixLib.Fluid.HeatPumps.ModularReversible.Data.TableDataSDF.TableData3D.VCLibPy.Generic(
    ...
    filename="modelica://AixLib/Resources/Data/Fluid/HeatPumps/ModularReversible/Data/VCLibMap/VaporInjectionPhaseSeparator_R152a.sdf");
end VCLibVaporInjectionPhaseSeparatorR152a;
