within AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.Examples;
model OperationalEnvelope "Example for usage of operational envelope model"
  extends BaseClasses.PartialSafety;
  extends Modelica.Icons.Example;
  AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope opeEnv(tabUppHea
...
<p>
  ...
  <a href=\"modelica://AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope\">
  AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
  ...
  \"https://github.com/ibpsa/modelica-ibpsa/issues/1576\">#1576</a>)
   ...
   __Dymola_Commands(file=
     "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Controls/Safety/Examples/OperationalEnvelope.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=100,
