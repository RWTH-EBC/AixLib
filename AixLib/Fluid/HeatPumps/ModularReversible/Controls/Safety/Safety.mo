...
model Safety "Model including all safety levels"
  ...
  replaceable
    AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.OperationalEnvelope
  ...
  AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.AntiFreeze antFre(final TAntFre=
  ...
  AixLib.Fluid.HeatPumps.ModularReversible.Controls.Safety.MinimalFlowRate
