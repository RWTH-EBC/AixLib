...
</html>", info="<html>This model can be used to estimate the heat pumps behavior during
defrost. It assumes a constant COP and a constant compressor speed
(usually low to have efficient defrost). The default values were
calibrated for the custom build heat pump at the Institute EBC. Still,
note that the model heavily simplifies the real dynamics during
defrost. The model was used for studies in the PhD of Fabian Römer,
e.g. the publication Römer et al.
<h4>
  References
</h4>
<p>
