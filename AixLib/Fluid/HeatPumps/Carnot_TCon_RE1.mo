...
model Carnot_TCon_RE1
 ...
 extends AixLib.Fluid.HeatPumps.BaseClasses.Carnot1(
    ...
    QCon_flow= if COP_is_for_cooling then Q_flow_internal.y else max(0,con.Q_flow),
    QEva_flow= if COP_is_for_cooling then min(0,con.Q_flow) else Q_flow_internal.y,
