...
parameter  Modelica.SIunits.MassFlowRate m_flow_nominal=QNom/MediumCon.cp_const/DeltaTCon;
  ...
  Controls.Interfaces.ThermalMachineControlBus        sigBus annotation (
      Placement(transformation(extent={{-20,82},{10,116}}),
  ...
  Sources.Boundary_pT bouEvap_b(redeclare package Medium = MediumEvap, nPorts=1)
    annotation (Placement(transformation(extent={{-68,-50},{-48,-30}})));
  Sources.MassFlowSource_T bouEvap_a(
