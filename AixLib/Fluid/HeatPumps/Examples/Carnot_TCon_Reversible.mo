...
model Carnot_TCon_Reversible
  "Test model for reservible  heat pump based on Carnot efficiency and condenser outlet temperature control signal"
  ...
  AixLib.Fluid.HeatPumps.Carnot_TCon_Reversible
                                     heaPum(
