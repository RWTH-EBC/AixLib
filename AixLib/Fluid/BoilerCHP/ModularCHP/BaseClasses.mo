...
<p>The pressure level within the cooling circuit is assumed to be constant at about 3 bar.</p>
  ...
  equation
    ...
    connect(sigBus_coo.isOnPump, switch1.u2) annotation (Line(
        points={{0.14,53.135},{-74,53.135},{-74,34},{-37.2,34}},
        color={255,204,51},
        thickness=0.5));
    connect(massFlowPump.y, switch1.u1) annotation (Line(points={{-49,42},{-46,
            42},{-46,38.8},{-37.2,38.8}}, color={0,0,127}));
    connect(minMassFlowPump.y, switch1.u3) annotation (Line(points={{-49,24},{
            -46,24},{-46,29.2},{-37.2,29.2}}, color={0,0,127}));
    annotation (Icon(graphics={    Text(
            extent={{-151,113},{149,73}},
            lineColor={0,0,255},
            fillPattern=FillPattern.HorizontalCylinder,
...
<p>Simplifying it is assumed that the latent heat flux in addition to the convective heat flux is transferred to the capacity of the exhaust gas heat exchanger.</p>
  ...
  model ExhaustHeatExchangerBACKUP
    "Exhaust gas heat exchanger for engine combustion and its heat transfer to a cooling circle"
    import AixLib;
...
<p>Simplifying it is assumed that the latent heat flux in addition to the convective heat flux is transferred to the capacity of the exhaust gas heat exchanger.</p>
  ...
  end ExhaustHeatExchangerBACKUP;
