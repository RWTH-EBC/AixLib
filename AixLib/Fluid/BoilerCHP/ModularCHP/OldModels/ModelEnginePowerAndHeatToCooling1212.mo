...
model ModelEnginePowerAndHeatToCooling1212
...
/*                       constrainedby OldModels.CHPCombustionHeatToCooling(
  ...
  AixLib.Fluid.BoilerCHP.ModularCHP.OldModels.CHPGasolineEngineDynamic1212
    cHPGasolineEngine(
  ...
  Modelica.Fluid.Sources.MassFlowSource_T
    ...
    nPorts=1,
    T=T_ambient)
    annotation (Placement(transformation(extent={{-76,50},{-60,66}})));
  Modelica.Fluid.Sources.MassFlowSource_T
                                        inletAir(
    ...
    use_T_in=false,
    T=T_ambient)
    annotation (Placement(transformation(extent={{-76,22},{-60,38}})));
...
equation
  ...
  connect(cHPGasolineEngine.flange_a, aSM_CHPGenerator.flange) annotation (Line(
        points={{-25,50},{-26,50},{-26,92},{-38,92}}, color={0,0,0}));
...
end ModelEnginePowerAndHeatToCooling1212;
