...
model CHP_PowerUnitModulateWECHSEL2702
 ...
 /* parameter Modelica.SIunits.Temperature T_HeaRet=303.15
  ...
  AixLib.Fluid.BoilerCHP.ModularCHP.OldModels.CHPControlBus2702 sigBusCHP(
    ...
    calEtaElChp=eta_El,
    calFueUtiChp=FueUtiRate) annotation (Placement(transformation(extent={{-28,
            68},{26,118}}), iconTransformation(extent={{-28,68},{26,118}})));
...
end CHP_PowerUnitModulateWECHSEL2702;
