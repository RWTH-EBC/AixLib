...
model ExhaustHeatExchanger0612
  ...
  parameter Modelica.SIunits.Volume VExhHex=0.002
  ...
  AixLib.Fluid.BoilerCHP.ModularCHP.OldModels.heatFromExhaustGas0512
    heatFromExhaustGas(
    T1_start=T1_start,
    p1_start=p1_start,
    A_surExhHea=A_surExhHea,
    d_iExh=d_iExh,
    volExhaust(V=VExhHex),
    TAmb=TAmb,
    pAmb=pAmb,
    ...
    m_flow=senMasFloExh.m_flow) annotation (Placement(transformation(rotation=0,
          extent={{-42,32},{-8,66}})));
equation
