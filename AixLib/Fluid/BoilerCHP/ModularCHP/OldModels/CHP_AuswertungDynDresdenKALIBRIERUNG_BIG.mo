...
model CHP_AuswertungDynDresdenKALIBRIERUNG_BIG
 ...
 // Modelica.SIunits.Power Q_ExhUnused=exhaustHeatExchanger.volExhaust.ports_H_flow[1]+exhaustHeatExchanger.volExhaust.ports_H_flow[2]+exhaustHeatExchanger.volExhaust.heatPort.Q_flow "Total exhaust heat error";
  ...
  parameter Modelica.SIunits.Mass Cal_mEng=1350
  ...
  parameter Modelica.SIunits.MassFlowRate m_flowCoo=0.375
  ...
  parameter Modelica.SIunits.ThermalConductance GEngToAmb=20
    "Thermal conductance from engine housing to the surrounding air"
    annotation (Dialog(tab="Engine Cooling Circle", group="Calibration Parameters"));
  parameter Modelica.SIunits.ThermalConductance G_Amb=4
  ...
  AixLib.Fluid.BoilerCHP.ModularCHP.OldModels.OnOff_ControllerCHPTests2702
    ...
    CHPEngineModel=CHPEngineModel,
    startTimeChp=3600,
    modulationFactorControl(table=[0.0,0.82; 7200,0.82; 7200,0.93; 10800,0.93;
          10800,0.64; 14400,0.64; 14400,0.82; 18000,0.82; 18000,0.0]))
...
end CHP_AuswertungDynDresdenKALIBRIERUNG_BIG;
