...
model DynamicHX_Performance "Simple dynamic heat exchanger model"
  extends
    AixLib.Fluid.BoilerCHP.ModularCHP.OldModels.FourPortHeatExchanger_Performance(
                                                                              nNodes=1,
      redeclare MixingVolumes.MixingVolume vol1);
