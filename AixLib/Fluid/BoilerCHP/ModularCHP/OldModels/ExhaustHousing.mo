...
class ExhaustHousing
  ...
  Modelica.Blocks.Sources.RealExpression realExpr2(y=T_LogMeanExh) annotation (
      Placement(transformation(
        ...
        rotation=0,
        origin={-146,18})));
  Modelica.Blocks.Interfaces.RealOutput exhHeatToCoolant annotation (Placement(
        transformation(extent={{96,6},{124,34}}),  iconTransformation(extent={{-14,-14},
            {14,14}},
        rotation=-90,
        origin={0,-86})));
  ...
  Modelica.Blocks.Interfaces.RealOutput exhHeatToAmbient annotation (Placement(
        transformation(extent={{96,-82},{124,-54}}), iconTransformation(
        extent={{-12,-12},{12,12}},
        rotation=180,
        origin={-88,0})));
...
equation
  ...
  connect(exhHeatToCoolant,exhHeatToCoolant)
  ...
  connect(heatLimit2.y,exhHeatToCoolant)  annotation (Line(points={{8.8,-54},{26,
          -54},{26,20},{110,20}}, color={0,0,127}));
  ...
  connect(realExpr3.y,exhHeatToAmbient)
    annotation (Line(points={{73,-68},{110,-68}}, color={0,0,127}));
