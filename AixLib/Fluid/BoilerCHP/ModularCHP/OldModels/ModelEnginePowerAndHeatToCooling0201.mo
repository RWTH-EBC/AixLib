...
model ModelEnginePowerAndHeatToCooling0201
...
/*                       constrainedby OldModels.CHPCombustionHeatToCooling(
  ...
  AixLib.Fluid.BoilerCHP.ModularCHP.OldModels.ExhaustHeatExchanger0201
...
equation
  ...
  connect(cHPCombustionEngine.port_Exhaust, engineToCoolant.port_EngineIn)
...
end ModelEnginePowerAndHeatToCooling0201;
