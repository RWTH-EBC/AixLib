...
model EASY_ExhaustHeatExchangerTest
  ...
  parameter Modelica.SIunits.MassFlowRate m_Exh(min=0)=0.023
  "Mass flow rate of exhaust gas" annotation (Dialog(group = "Thermal"));
  parameter Modelica.SIunits.SpecificHeatCapacity meanCpExh=1227.23
 ...
 /* Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a port_referenceExhaust(T=
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature fixedTemperature(T=
        TAmb) annotation (Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=90,
        origin={-82,-12})));
...
equation
 ...
 // end if;
  ...
  connect(port_b1, outletExhaust.ports[1])
  ...
  connect(fixedTemperature.port,ambientLoss. port_b)
    annotation (Line(points={{-82,-6},{-82,0},{-66,0}}, color={191,0,0}));
  ...
  connect(ambientLoss.port_a, heatCapacitor.port)
    annotation (Line(points={{-46,0},{-28,0}}, color={191,0,0}));
  ...
  annotation (Icon(graphics={
        ...
        Rectangle(
          ...
          fillColor={0,0,0},
          fillPattern=FillPattern.Solid)}));
end EASY_ExhaustHeatExchangerTest;
