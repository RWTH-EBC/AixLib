...
<p>
  The model uses the <a href=\"AixLib.Fluid.BoilerCHP.BaseClasses.PartialHeatGenerator\">AixLib.Fluid.BoilerCHP.BaseClasses.PartialHeatGenerator</a> in the most simple setup in order either test its functionalities or to use in cases where the controller is modelled outside the heat generator.
