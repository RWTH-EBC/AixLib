...
<p>
  A boiler model consisting of the internal boiler controler and a replaceable outer controler. This controler can be chosen to provide the boiler temperature setpoint based on the chosen conditions such as ambient air temperature, etc.
...
<ul>
  ...
  <li>
    <i>April 20, 2012&#160;</i> by Ana Constanting:<br/>
    Implemented
  </li>
</ul>
