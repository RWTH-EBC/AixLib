...
equation
  ...
  connect(boilerEffciency.y, boilerControlBus.Efficiency) annotation (Line(
        points={{81,22},{86,22},{86,86},{2.05,86},{2.05,100.05}},
        color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
  ...
  connect(boilerControlBus.TColdMea, fromKelvin.Kelvin) annotation (Line(
      points={{2.05,100.05},{2.05,100},{-100,100},{-100,47},{-27.8,47}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(Dim4.y, multiplex4_1.u4[1])
    annotation (Line(points={{-39.1,-62},{22,-62},{22,13}}, color={0,0,127}));
  connect(multiplex4_1.y, boilerEffciency.u)
