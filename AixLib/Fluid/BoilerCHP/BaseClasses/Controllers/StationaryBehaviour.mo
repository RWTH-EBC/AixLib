...
protected
  parameter String Filename= if m_flowVar==false then "modelica://AixLib/Resources/Data/Fluid/BoilerCHP/NotManufacturer/Boiler/TAg_mNom.sdf" else "modelica://AixLib/Resources/Data/Fluid/BoilerCHP/NotManufacturer/Boiler/TAg_mVar.sdf" annotation(Evaluate=true);
equation
