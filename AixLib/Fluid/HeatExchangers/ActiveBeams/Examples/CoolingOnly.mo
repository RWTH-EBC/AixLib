...
<p>
  This example tests the implementation of <a href=\"modelica://AixLib.Fluid.HeatExchangers.ActiveBeams.Cooling\">AixLib.Fluid.HeatExchangers.ActiveBeams.Cooling</a>. An air volume is maintained at a temperature below <i>25ˆ</i>C by a controller that regulates the water flow rate in the active beam.
