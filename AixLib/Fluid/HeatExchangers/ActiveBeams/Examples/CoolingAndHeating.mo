...
model CoolingAndHeating
  ...
  AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating beaCooHea(
    ...
    redeclare
      ...
      AixLib.Fluid.HeatExchangers.ActiveBeams.Data.Trox.DID632A_nozzleH_lenght6ft_heating perHea,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            ...
            -120},{120,120}})),experiment(StopTime=172800),__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingAndHeating.mos"
...
<p>
  This example tests the implementation of <a href=\"modelica://AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating\">AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating</a> for both heating and cooling mode. An air volume is maintained at a temperature between <i>22ˆ</i>C and <i>25ˆ</i>C by two controllers that regulate the water flow rate in the active beam.
</p></html>",revisions="<html>
<ul>
  <li>June 25, 2016, by Michael Wetter:<br/>
    Changed medium start temperature to avoid conflicting start values of the same precedence in Dymola 2016. See <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/485\">issue 485</a>.
  </li>
  <li>June 14, 2016, by Michael Wetter:<br/>
