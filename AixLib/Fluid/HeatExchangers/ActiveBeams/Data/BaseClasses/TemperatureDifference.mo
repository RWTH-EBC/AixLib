...
<p align=\"center\" style=\"font-style:italic;\">
  r<sub>ΔT</sub><sup>i</sup>= ΔT<sup>i</sup> ⁄ ΔT<sub>nominal</sub> = (T<sub>w</sub><sup>i</sup>-T<sub>z</sub>) ⁄ (T<sub>w,nominal</sub>-T<sub>z</sub>),
</p>
<p>
  where <i>T<sub>w</sub><sup>i</sup></i> is the water inlet temperature, <i>T<sub>z</sub></i> is the zone air temperature and <i>T<sub>w,nominal</sub></i> is the nominal water inlet temperature.
</p>
<p>
  The normalized temperature difference <i>r<sub>ΔT</sub></i> must be strictly increasing, i.e., <i>r<sub>ΔT</sub><sup>i</sup> &lt; r<sub>ΔT</sub><sup>i+1</sup></i>. Both vectors, <i>r<sub>ΔT</sub></i> and <i>f</i> must have the same size.
