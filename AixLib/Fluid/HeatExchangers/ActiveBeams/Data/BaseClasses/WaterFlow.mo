...
<p>
  The normamlized volume flow rate <i>r<sub>V</sub></i> must be strictly increasing, i.e., <i>r<sub>V</sub><sup>i</sup> &lt; r<sub>V</sub><sup>i+1</sup></i>. Both vectors, <i>r<sub>V</sub></i> and <i>f</i> must have the same size.
