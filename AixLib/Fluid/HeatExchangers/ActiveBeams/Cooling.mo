...
<p>
  This model operates only in cooling mode. For a model that operates in both heating and cooling mode, use <a href=\"modelica://AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating\">AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating</a>.
</p>
<p>
  For a description of the equations, see the <a href=\"modelica://AixLib.Fluid.HeatExchangers.ActiveBeams.UsersGuide\">User's Guide</a>.
</p>
<p>
  Performance data are available from <a href=\"modelica://AixLib.Fluid.HeatExchangers.ActiveBeams.Data\">AixLib.Fluid.HeatExchangers.ActiveBeams.Data</a>.
</p>
<h4>
  References
</h4>
<ul>
  <li>DOE(2015) EnergyPlus documentation v8.4.0 - Engineering Reference.
  </li>
...
<ul>
  ...
  <li>September 17, 2016, by Michael Wetter:<br/>
    Corrected wrong annotation to avoid an error in the pedantic model check in Dymola 2017 FD01 beta2.<br/>
    This is for <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/557\">issue 557</a>.
  </li>
