...
model NumberOfBeams
  ...
  AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating beaCooHea10(
    ...
    redeclare
      ...
      AixLib.Fluid.HeatExchangers.ActiveBeams.Data.Trox.DID632A_nozzleH_lenght6ft_cooling

      perCoo,

    redeclare

      AixLib.Fluid.HeatExchangers.ActiveBeams.Data.Trox.DID632A_nozzleH_lenght6ft_heating
...
<p>
  This model validates the scaling of the heat tranfer and pressure drop for <code>nBeams &gt; 1</code>.
</p>
<p>
  It uses two instances of <a href=\"modelica://AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating\">AixLib.Fluid.HeatExchangers.ActiveBeams.CoolingAndHeating</a>, one with <code>nBeams = 1</code> and one with <code>nBeams = 10</code>.
