...
<p>
  The heater model has a capacity of <code>Q_flow_max = 1.0e4</code> Watts and the cooler model has a capacitiy of <code>Q_flow_min = -1000</code> Watts. Hence, both only track their set point of the outlet temperature during certain times. There is also a heater and cooler with unlimited capacity.
</p>
<p>
