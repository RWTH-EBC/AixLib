...
model HeaterCooler_T_dynamic
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-100,
    ...
    __Dymola_Commands(file= "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/HeaterCooler_T_dynamic.mos"
...
<p>
  This example is identical to <a href=\"modelica://AixLib.Fluid.HeatExchangers.Validation.HeaterCooler_T\">AixLib.Fluid.HeatExchangers.Validation.HeaterCooler_T</a> except that the heater and cooler models are configured to have a time constant of <i>60</i> seconds at nominal flow rate. At lower flow rate, the time constant increases proportional to the mass flow rate.
