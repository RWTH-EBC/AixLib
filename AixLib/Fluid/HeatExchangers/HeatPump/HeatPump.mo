...
model HeatPump
  ...
  parameter Real linPresLoss_con=0 "Pressure loss: Coefficient for linear term"
  ...
  parameter Real linPresLoss_eva=0 "Pressure loss: Coefficient for linear term"
...
public
  ...
  AixLib.Fluid.HeatExchangers.HeatPump.Characteristics.constantQualityGrade
    constrainedby AixLib.Fluid.HeatExchangers.HeatPump.Characteristics.baseFct
  ...
  AixLib.Fluid.HeatExchangers.HeatPump.DefrostCorrection.noModel
    constrainedby
    AixLib.Fluid.HeatExchangers.HeatPump.DefrostCorrection.baseFct
  ...
  parameter SI.MassFlowRate mFlow_conNominal=0.5
    "Nominal mass flow rate in condenser (only with polynomials, as already given in data tables)"
  ...
  parameter SI.MassFlowRate mFlow_evaNominal=0.5
    "Nominal mass flow rate in evaporator (only for polynomials, as already given in data tables)"
