within AixLib.Fluid.HeatExchangers.HeatPump.Partial;
model Cycle
...
public
  ...
  AixLib.Fluid.HeatExchangers.HeatPump.DefrostCorrection.noModel constrainedby
...
parameter SI.Temperature T_conMax=338.15 "Maximum condenser outlet temperature"
