...
<p>
  where <i>ε</i> is a constant effectiveness and <i>Q<sub>max</sub></i> is the maximum heat that can be transferred.
</p>
<p>
  For a heat and moisture exchanger, use <a href=\"modelica://AixLib.Fluid.MassExchangers.ConstantEffectiveness\">AixLib.Fluid.MassExchangers.ConstantEffectiveness</a> instead of this model.
