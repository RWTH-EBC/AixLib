...
model RadiatorEN442_2 "Test model for radiator"
 ...
 package Medium = AixLib.Media.Water "Medium model";
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort senTemRad1In(
