...
public
  ...
  Real dhInlDesdt(unit="J/(kg.s)") "Total derivative of specific enthalpy at inlet";
  Real dhSCTPdt(unit="J/(kg.s)") "Total derivative of specific enthalpy at boundary between SC and TP";
  Real dhTPSHdt(unit="J/(kg.s)") "Total derivative of specific enthalpy at boundary between TP and SH";
  Real dhOutDesdt(unit="J/(kg.s)") "Total derivative of specific enthalpy at outlet";
