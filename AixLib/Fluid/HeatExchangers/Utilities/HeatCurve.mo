...
equation
 ...
 reference temperature will be the outside air temperature.</p>
 <p>The heating curve is defined so that a given maximum forward temperature of
 the heating system is reached at a given lowest design reference temperature.
 At a reference temperature of 20 &deg;C, the heating curve also reaches
 20 &deg;C for the set-point temperature.</p>
 </html>", revisions = "<html>
 <ul>
 <li><i>09.10.2013&nbsp;</i>
    by Marcus Fuchs:<br/>
