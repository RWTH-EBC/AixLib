...
record SimpleBuildingtesttabs_multiple_zones_tz_1_upperTABS "SimpleBuildingtesttabs_multiple_zones_tz_1_upperTABS"
  extends AixLib.DataBase.Walls.WallBaseDataDefinition(
    ...
    c = {1000.0, 1000.0},
    eps = 0.95);
end SimpleBuildingtesttabs_multiple_zones_tz_1_upperTABS;
