...
record SimpleBuildingtesttabs_multiple_zones_tz_2_upperTABS_int "SimpleBuildingtesttabs_multiple_zones_tz_2_upperTABS_int"
  extends AixLib.DataBase.Walls.WallBaseDataDefinition(
    ...
    c = {1000.0, 840.0},
    eps = 0.95);
end SimpleBuildingtesttabs_multiple_zones_tz_2_upperTABS_int;
