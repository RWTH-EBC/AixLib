...
equation
  ...
  for i in 1:RoomNo loop
    ...
    connect(boundary.ports[1], tABSSystem.port_a) annotation (Line(
          points={{-58,0},{-24,0}},                         color={0,127,255}));
    connect(tABSSystem.port_b, bou.ports[1]) annotation (Line(points={{30,0},{
            74,0}},                               color={0,127,255}));
    connect(tABSSystem.m_flowNominal, boundary.m_flow_in) annotation (Line(points={{-24,-9.6},{-48,-9.6},{-48,-14},{-86,-14},{-86,8},
            {-80,8}},                         color={0,0,127}));
    connect(tABSSystem.T_FlowNominal, boundary.T_in) annotation (
        Line(points={{-24,-14.4},{-42,-14.4},{-42,-22},{-94,-22},{-94,4},{-80,4}},
                   color={0,0,127}));
