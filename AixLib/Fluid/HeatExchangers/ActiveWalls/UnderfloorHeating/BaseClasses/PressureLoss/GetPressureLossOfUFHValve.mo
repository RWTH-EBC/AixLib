...
function GetPressureLossOfUFHValve
  ...
  output Modelica.Units.SI.PressureDifference preDrop "Pressure drop for the given input";
protected
...
algorithm
  ...
  Get the pressure loss of an under floor heating valve. The data is
  calculated based on the log-log-diagram in the following image. Based
  on [1, p. 11].
</p>
<p>
  <img src=
