...
model PanelHeatingMultiple
  ...
  AixLib.Fluid.HeatExchangers.ActiveWalls.PanelHeating panelheating_1D_Dis2(
      redeclare package Medium = Medium, A=panelHeatingArea)
    annotation (Placement(transformation(extent={{56,34},{84,46}})));
  AixLib.Fluid.HeatExchangers.ActiveWalls.PanelHeating panelheating_1D_Dis3(
      redeclare package Medium = Medium, A=panelHeatingArea)
    annotation (Placement(transformation(extent={{56,6},{84,18}})));
  AixLib.Fluid.HeatExchangers.ActiveWalls.PanelHeating panelheating_1D_Dis4(
      redeclare package Medium = Medium, A=panelHeatingArea)
    annotation (Placement(transformation(extent={{56,-22},{84,-10}})));
  AixLib.Fluid.HeatExchangers.ActiveWalls.PanelHeating panelheating_1D_Dis5(
      redeclare package Medium = Medium, A=panelHeatingArea)
    annotation (Placement(transformation(extent={{56,-52},{84,-40}})));
  AixLib.Fluid.HeatExchangers.ActiveWalls.PanelHeating panelheating_1D_Dis6(
      redeclare package Medium = Medium, A=panelHeatingArea)
