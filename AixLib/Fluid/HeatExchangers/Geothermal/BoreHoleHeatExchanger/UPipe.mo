within AixLib.Fluid.HeatExchangers.Geothermal.BoreHoleHeatExchanger;
...
public
  ...
  Modelica.Fluid.Interfaces.FluidPort_b fluidPortOut(redeclare package Medium =
        Medium) annotation (Placement(transformation(extent={{10,70},{30,90}})));
  FixedResistances.HydraulicResistance              deflection(
    redeclare package Medium = Medium,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,extent={{-80,-80},
            {80,80}}), graphics), Icon(coordinateSystem(preserveAspectRatio=true,
