...
outputVector[1] := d_in + (log10(nb)-log10(nb-1))/log10(nb)*lengthLgDiscr;

  for i in 2:nRad loop
      outputVector[i] := outputVector[i-1]+(log10(nb+1-i)-log10(nb-i))/log10(nb)*lengthLgDiscr;
  end for;

  annotation (Documentation(info="<html>
<p><b><font style=\"color: #008000; \">Overview</font></b> </p>
<p>Function gives outer diameters for a logarithmically discretized ground.</p>
