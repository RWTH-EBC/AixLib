...
function getInnerDiameters
  "Returns a vector with the inner diameters of the radial elements of an radially discretized volume"
...
algorithm
  ...
  for i in 1:nRad loop
    outputVector[i] := d_in + ((i-1)*stepWidth);
  end for;

  annotation (Documentation(info="<html>
<h4><span style=\"color:#008000\">Overview</span></h4>
<p>Function returns a vector with the inner diameters of the radial elements of an radially discretized volume.</p>
