...
<p>
  See <a href=\"modelica://AixLib.Fluid.HeatExchangers.Examples.AirHeater_u\">AixLib.Fluid.HeatExchangers.Examples.AirHeater_u</a> for a model that takes the heating power as an input.
...
<ul>
  ...
  <li>November 12, 2014, by Michael Wetter:<br/>
    ...
    __Dymola_Commands(file= "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/AirHeater_T.mos"
