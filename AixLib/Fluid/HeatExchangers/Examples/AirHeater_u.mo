...
<p>
  See <a href=\"modelica://AixLib.Fluid.HeatExchangers.Examples.AirHeater_T\">AixLib.Fluid.HeatExchangers.Examples.AirHeater_T</a> for a model that takes the leaving air temperature as an input.
...
<ul>
  ...
  <li>November 12, 2014, by Michael Wetter:<br/>
    ...
    __Dymola_Commands(file= "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/AirHeater_u.mos"
