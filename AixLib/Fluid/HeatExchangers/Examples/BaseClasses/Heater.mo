...
partial model Heater "Base class for example model for the heater and cooler"
  ...
  AixLib.Fluid.Movers.FlowControlled_m_flow mov(
...
<p>
  This partial model is used to construct the models <a href=\"modelica://AixLib.Fluid.HeatExchangers.Examples.AirHeater_T\">AixLib.Fluid.HeatExchangers.Examples.AirHeater_T</a> and <a href=\"modelica://AixLib.Fluid.HeatExchangers.Examples.AirHeater_u\">AixLib.Fluid.HeatExchangers.Examples.AirHeater_u</a> and the similar models <a href=\"modelica://AixLib.Fluid.HeatExchangers.Examples.WaterHeater_T\">AixLib.Fluid.HeatExchangers.Examples.WaterHeater_T</a> and <a href=\"modelica://AixLib.Fluid.HeatExchangers.Examples.WaterHeater_u\">AixLib.Fluid.HeatExchangers.Examples.WaterHeater_u</a>. It consists of a volume with heat loss to the ambient, a fan, a set point for the temperature of the volume and a PI controller.
</p>
<p>
  The instance <code>bou</code> is required to set a reference pressure for system models in which the fluid is modelled as an incompressible fluid, and it also is required to account for a variation of density of the fluid.
