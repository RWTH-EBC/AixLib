...
protected
  ...
  // See AixLib, issue 282 for a discussion.
...
<ul>
  ...
  Set
  <code>
    prescribedHeatFlowRate=true</code>
    if
    the
    <i>
    only</i>
    ...
    case,
    <code>
    heatPort.Q_flow=0</code>.
  </li>
  <li>
  Set
  <code>
    prescribedHeatFlowRate=false</code>
    if
    there
    is
    heat
...
<ul>
  ...
  Jorissen:<br/>
    ...
    if
    or
    <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/247\">
    issue
    247</a>.
  </li>
  <li>
  ...
  Jorissen:<br/>
    ...
    Set
    <code>
    prescribedHeatFlowRate=prescribedHeatflowRate</code>
    for
    <a href=\"modelica://AixLib.Fluid.Interfaces.StaticTwoPortConservationEquation\">
    AixLib.Fluid.Interfaces.StaticTwoPortConservationEquation</a>.
    This
  ...
  Wetter:<br/>
    ...
    than
    <code>
    Modelica.SIunits.Temperature</code>
    to
    avoid
    an
    error
    ...
    if
    <code>
    Buildings.Fluid.Chillers.Carnot_y</code>
    is
    translated
    using
    pedantic
    ...
    is
    for
    <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">
    #426</a>.
  </li>
  <li>
  June
...
<a href=\"modelica://AixLib.Fluid.Interfaces.StaticTwoPortConservationEquation\">
  ...
  Wetter:<br/>
    ...
    of
    issue
    <a href=\"https://github.com/lbl-srg/modelica-buildings/issues/197\">
    #197</a>.
  </li>
  <li>
  October
  ...
  Wetter:<br/>
    ...
    assignment
    <code>
    preferredMediumStates=true</code>
    to
    <code>
  ...
  Wetter:<br/>
    ...
    See
    also
    <a href=\"https://trac.modelica.org/Modelica/ticket/393\">
