...
<p>
  This model tests <a href=\"modelica://AixLib.Fluid.MixingVolumes.MixingVolumeMoistAir\">AixLib.Fluid.MixingVolumes.MixingVolumeMoistAir</a>. After an initial transient, the temperature and humidity of the volume stabilizes.
</p></html>",revisions="<html>
<ul>
  <li>February 11, 2014 by Michael Wetter:<br/>
    Changed <code>HWat_flow(y=vol1.HWat_flow</code> to <code>QLat_flow(y=vol1.QLat_flow.y)</code> and <code>QWat</code> to <code>QLat</code>.
  </li>
