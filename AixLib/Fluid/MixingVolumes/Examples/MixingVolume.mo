...
model MixingVolume
  ...
  AixLib.Fluid.Sensors.EnthalpyFlowRate entFloRat(redeclare package Medium =
        Medium, m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,50},{60,70}})));
  AixLib.Fluid.Sensors.EnthalpyFlowRate entFloRat1(redeclare package Medium =
        Medium, m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,0},{60,20}})));
  ...
  AixLib.Fluid.Sensors.EnthalpyFlowRate entFloRat2(redeclare package Medium =
        Medium, m_flow_nominal=2) "Enthalpy flow rate"
                                     annotation (Placement(transformation(
          extent={{40,-92},{60,-72}})));
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/MixingVolumes/Examples/MixingVolume.mos"
        "Simulate and plot"),
...
Standard Library with the implementation in the <code>AixLib</code>
