...
model MixingVolumeMFactor
  ...
  extends AixLib.Fluid.MixingVolumes.Examples.MixingVolumeMassFlow(
  sou(X={0.02,0.98},
      T=Medium.T_default),
  vol(mSenFac=10),
    bou(nPorts=3));
...
<p>
See
<a href=\"modelica://AixLib.Fluid.MixingVolumes.Examples.MixingVolumeMassFlow\">
AixLib.Fluid.MixingVolumes.Examples.MixingVolumeMassFlow</a>
...
First implementation.
          ...
          "modelica://AixLib/Resources/Scripts/Dymola/Fluid/MixingVolumes/Examples/MixingVolumeMFactor.mos"
        "Simulate and plot"));
