...
<p>
  This model tests the implementation of the mixing volumes. It compares the results from the mixing volume of the Modelica Standard Library with the implementation in the <code>AixLib</code> library.
</p></html>",revisions="<html>
<ul>
  <li>November 4, 2016, by Michael Wetter:<br/>
    Removed wrong use of <code>each</code> keyword.<br/>
    This is for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/575\">issue 575</a>.
  </li>
  ...
  <li>October 24, 2013, by Michael Wetter:<br/>
    Set <code>vol(h_start=45300.945)</code>. This avoids a cyclic assignment of <code>vol.T_start</code> and <code>vol.h_start</code> in <code>Modelica.Fluid.Vessels.ClosedVolume</code>.
  </li>
