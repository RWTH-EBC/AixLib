...
<ul>
  <li>October 24, 2013 by Michael Wetter:<br/>
    Set <code>flowModel(m_flow_nominal=2)</code> in the pipe models to avoid a cyclic definition of <code>pipe1.flowModel.m_flow_nominal</code> and <code>pipe2.flowModel.m_flow_nominal</code>.
  </li>
