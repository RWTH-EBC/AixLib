...
<p>
  This test checks if the trace substance flow rate is conserved when adding moisture to a mixing volume that is configured to steady state.<br/>
...
<p>
  Note, however, that there is some approximation error because in its default configuration, the conservation balance models simplify the treatment of the water that is added to the fluid. See <a href=\"modelica://AixLib.Fluid.Interfaces.ConservationEquation\">AixLib.Fluid.Interfaces.StaticTwoPortConservationEquation</a> and <a href=\"modelica://AixLib.Fluid.Interfaces.ConservationEquation\">AixLib.Fluid.Interfaces.StaticTwoPortConservationEquation</a> for a discussion.
</p></html>",revisions="<html>
<ul>
  <li>November 3, 2016, by Michael Wetter:<br/>
    Removed wrong assignment for <code>C_nominal</code>.<br/>
    This is for <a href=\"https://github.com/iea-annex60/modelica-annex60/issues/568\">issue 568</a>.
  </li>
  ...
  <li>May 22 2015 by Filip Jorissen:<br/>
