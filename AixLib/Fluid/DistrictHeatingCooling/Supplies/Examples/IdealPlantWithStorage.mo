...
model IdealPlantWithStorage "Example of the IdealPlantWithStorage model"
...
equation
  ...
  connect(bou.ports[2], idealPlantWithStorage.port_a) annotation (Line(points={
          {-138,14},{-116,14},{-116,14},{-92,14}}, color={0,127,255}));
  annotation (
