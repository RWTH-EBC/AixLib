...
equation
  ...
  connect(plugFlowPipe3.ports_b[1], sourceIdeal.port_a) annotation (Line(points=
         {{-20,-48},{-92,-48},{-92,10},{-52,10}}, color={0,127,255}));
  ...
  connect(const.y, sourceIdeal.dpIn) annotation (Line(points={{-69,-12},{-60,-12},
          {-60,3},{-52.6,3}}, color={0,0,127}));
  connect(booleanTable.y, controllerTFlexibilityElectricHeating.electricitySignal)
    annotation (Line(points={{-121,32},{-102,32},{-102,37.2},{-92,37.2}}, color=
         {255,0,255}));
  connect(const1.y, controllerTFlexibilityElectricHeating.T_setNormalOperation)
    annotation (Line(points={{-121,62},{-100,62},{-100,43},{-92,43}}, color={0,0,
          127}));
  annotation (
