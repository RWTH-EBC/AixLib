...
model CoolingTwoSupplies
  ...
  FixedResistances.PlugFlowPipe pipeReturn4(
    ...
    kIns=0.027) "Return pipe" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={110,-260})));
  Supplies.OpenLoop.SourcePower sourcePower(redeclare package Medium = Medium,
      pReturn=200000) annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=180,
        origin={310,-250})));
