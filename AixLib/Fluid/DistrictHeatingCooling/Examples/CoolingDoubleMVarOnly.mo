...
equation
  ...
  connect(pipeReturn3.port_a, pipeReturn4.port_a) annotation (Line(points={{140,
          -130},{140,-264},{88,-264}},  color={0,127,255}));
  connect(pipeReturn4.ports_b[1], pipeReturn1.port_a) annotation (Line(points={{68,-264},
          {-60,-264},{-60,-130}},           color={0,127,255}));
  ...
  connect(sourcePower.port_a, pipeReturn4.port_a) annotation (Line(points={{320,
          -250},{326,-250},{326,-266},{140,-266},{140,-264},{88,-264}},  color={
          0,127,255}));
  ...
  connect(pipeReturn4.heatPort, pipeReturn.heatPort) annotation (Line(points={{
          78,-274},{18,-274},{18,-268},{-112,-268},{-112,-194},{-160,-194},{
          -160,0},{-70,0},{-70,6.10623e-16}}, color={191,0,0}));
  connect(pipeSupply4.heatPort, pipeReturn.heatPort) annotation (Line(points={{
          170,-250},{-104,-250},{-104,-182},{-160,-182},{-160,0},{-70,0},{-70,
