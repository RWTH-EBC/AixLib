...
model CoolingDoubleMVarOnly
  ...
  Supplies.OpenLoop.SourcePower sourceIdeal(
  ...
  Modelica.Blocks.Sources.Sine sine4(
    amplitude=12000,
    freqHz=1/10000,
    offset=48000)  "A sine wave for varying heat demands" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={310,-210})));
...
equation
  ...
  connect(pipeSupply.ports_b[1], varTSupply.port_a)
    annotation (Line(points={{58,-10},{58,-60},{10,-60}}, color={0,127,255}));
  ...
  connect(TGround.port, pipeReturn.heatPort)
    annotation (Line(points={{-160,-200},{-160,0},{-70,0}},
                                                         color={191,0,0}));
  connect(TGround.port, pipeSupply.heatPort) annotation (Line(points={{-160,-200},
          {-160,-20},{80,-20},{80,0},{70,0}},color={191,0,0}));
  ...
  connect(pipeSupply1.ports_b[1], varTSupply1.port_a) annotation (Line(points={{
          58,-130},{58,-182},{10,-182}}, color={0,127,255}));
  connect(varTSupply1.Q_flow_input, sine1.y) annotation (Line(points={{10.8,-190},
          {30,-190},{30,-199}}, color={0,0,127}));
  connect(pipeSupply1.port_a, pipeSupply.ports_b[2])
    annotation (Line(points={{60,-110},{60,-10},{62,-10}}, color={0,127,255}));
  connect(pipeReturn1.ports_b[1], pipeReturn.port_a)
    annotation (Line(points={{-60,-110},{-60,-10}}, color={0,127,255}));
  connect(TGround.port, pipeReturn1.heatPort) annotation (Line(points={{-160,-200},
          {-160,-120},{-70,-120}}, color={191,0,0}));
  connect(TGround.port, pipeSupply1.heatPort) annotation (Line(points={{-160,-200},
          {-160,-140},{80,-140},{80,-120},{70,-120}}, color={191,0,0}));
  connect(pipeReturn3.ports_b[1], pipeReturn2.port_a) annotation (Line(points={{
          140,-110},{140,-78},{140,-78},{140,-50},{140,-50},{140,-10}}, color={0,
          127,255}));
  connect(varTSupply2.port_b, pipeReturn2.port_a) annotation (Line(points={{190,
          -60},{140,-60},{140,-10}}, color={0,127,255}));
  connect(pipeSupply2.ports_b[1], varTSupply2.port_a) annotation (Line(points={{
          258,-10},{258,-60},{210,-60}}, color={0,127,255}));
  connect(pipeSupply3.port_a, pipeSupply2.ports_b[2]) annotation (Line(points={{
          260,-110},{260,-10},{262,-10}}, color={0,127,255}));
  connect(pipeSupply3.ports_b[1], varTSupply3.port_a) annotation (Line(points={{
          258,-130},{258,-182},{210,-182}}, color={0,127,255}));
  connect(varTSupply2.Q_flow_input, sine3.y) annotation (Line(points={{210.8,-68},
          {230,-68},{230,-79}}, color={0,0,127}));
  connect(varTSupply3.Q_flow_input, sine2.y) annotation (Line(points={{210.8,-190},
          {230,-190},{230,-199}}, color={0,0,127}));
  ...
  connect(TGround.port, pipeSupply3.heatPort) annotation (Line(points={{-160,-200},
          {-160,-140},{280,-140},{280,-120},{270,-120}}, color={191,0,0}));
  connect(TGround.port, pipeReturn3.heatPort) annotation (Line(points={{-160,-200},
          {-160,-140},{120,-140},{120,-120},{130,-120}}, color={191,0,0}));
  connect(TGround.port, pipeSupply2.heatPort) annotation (Line(points={{-160,-200},
          {-160,-20},{280,-20},{280,0},{270,0}}, color={191,0,0}));
  connect(TGround.port, pipeReturn2.heatPort) annotation (Line(points={{-160,-200},
          {-160,-20},{120,-20},{120,0},{130,0}}, color={191,0,0}));
  connect(pipeSupply3.ports_b[2], pipeSupply4.port_a) annotation (Line(points={{
          262,-130},{262,-240},{180,-240}}, color={0,127,255}));
  connect(pipeSupply4.ports_b[1], pipeSupply1.ports_b[2]) annotation (Line(
        points={{160,-240},{62,-240},{62,-130}}, color={0,127,255}));
  ...
  connect(sourcePower.port_b, pipeSupply4.port_a) annotation (Line(points={{300,
          -250},{262,-250},{262,-240},{180,-240}}, color={0,127,255}));
  connect(sourcePower.port_a, pipeReturn4.port_a) annotation (Line(points={{320,
          -250},{334,-250},{334,-270},{140,-270},{140,-260},{120,-260}}, color={
          0,127,255}));
  connect(sine4.y, sourcePower.Q_flow_input) annotation (Line(points={{310,-221},
          {310,-232},{310,-242},{309.8,-242}}, color={0,0,127}));
  connect(sourceIdeal.Q_flow_input, sine5.y)
    annotation (Line(points={{0.2,68},{0,68},{0,79}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-180,-280},
            {400,100}})),                                        Diagram(
