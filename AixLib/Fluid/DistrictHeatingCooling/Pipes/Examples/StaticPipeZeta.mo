...
model StaticPipeZeta "Simple example of StaticPipeZeta"
  ...
  AixLib.Fluid.DistrictHeatingCooling.Pipes.StaticPipeZeta
                                             pip(
    redeclare package Medium = Medium,
    nPorts=1,
    dh=0.1,
...
<a href=\"modelica://AixLib.Fluid.DistrictHeatingCooling.Pipes.StaticPipeZeta\">
AixLib.Fluid.DistrictHeatingCooling.Pipes.StaticPipeZeta</a>.
