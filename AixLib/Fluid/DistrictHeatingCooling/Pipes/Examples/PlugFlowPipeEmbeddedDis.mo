...
model PlugFlowPipeEmbeddedDis "Simple example of plug flow pipe embedded with disctretization of soil"
  import AixLib;
  ...
  AixLib.Fluid.DistrictHeatingCooling.Pipes.PlugFlowPipeEmbeddedDis
                                                        pip(
    redeclare package Medium = Medium,
    nPorts=1,
    dh=0.1,
  ...
  AixLib.Fluid.Sensors.TemperatureTwoPort senTemIn(
    redeclare package Medium = Medium,
    m_flow_nominal=1,
    T_start=323.15) "Temperature sensofr"
