...
equation
  ...
  connect(hydraulicResistance.port_b, cor.port_a)
...
<p>This model takes into account transport delay along the pipe length idealized as a plug flow. The model also includes thermal inertia of the pipe wall. This model determines the pressure drop using the sum of zeta values.</p>
<h4>Implementation</h4>
<p>This model is based on <a href=\"modelica://AixLib.Fluid.FixedResistances.BaseClasses.PlugFlowCore\">AixLib.Fluid.FixedResistances.BaseClasses.PlugFlowCore</a>.</p>
