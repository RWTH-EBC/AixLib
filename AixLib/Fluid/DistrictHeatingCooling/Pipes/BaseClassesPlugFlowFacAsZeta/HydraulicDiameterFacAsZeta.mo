within AixLib.Fluid.DistrictHeatingCooling.Pipes.BaseClassesPlugFlowFacAsZeta;
model HydraulicDiameterFacAsZeta
  ...
  extends AixLib.Fluid.FixedResistances.PressureDrop(
    ...
    final dp_nominal=factor*dpStraightPipe_nominal);
  ...
  parameter Real fac(min=0) = 0
    "Factor to take into account resistance of bends etc., fac=Sum of Zeta";
  ...
  final parameter Real factor = 1 + 8*fac*m_flow_nominal*m_flow_nominal/(rho_default*Modelica.Constants.pi*Modelica.Constants.pi*dh*dh*dh*dh*dpStraightPipe_nominal)
...
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/480\">#480</a>.
  ...
  Icon(graphics={Text(
          ...
          textString="dh")}));
end HydraulicDiameterFacAsZeta;
