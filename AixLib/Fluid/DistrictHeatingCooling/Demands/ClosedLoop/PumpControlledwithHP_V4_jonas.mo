...
public
  ...
  Sources.Boundary_pT toHouse(redeclare package Medium = MediumBuilding, nPorts
      =1) annotation (Placement(transformation(extent={{-124,-48},{-104,-28}})));
...
equation
  ...
  connect(senTem.port_b, del1.ports[2]) annotation (Line(points={{62,0},{84,0}},
                              color={0,127,255}));
  connect(senTem4.port_b, heaPum.port_a2) annotation (Line(points={{-28,-18},{
          -20,-18},{-20,-26},{-10,-26}},
                                     color={0,127,255}));
  connect(heaPum.port_b2, senTem.port_a) annotation (Line(points={{10,-26},{28,
  ...
  connect(fromHouse.ports[1], senTem3.port_a)
    annotation (Line(points={{90,-38},{60,-38}},  color={0,127,255}));
  connect(senTem3.port_b, heaPum.port_a1)
    annotation (Line(points={{40,-38},{10,-38}}, color={0,127,255}));
  connect(heaPum.port_b1, senTem1.port_a) annotation (Line(points={{-10,-38},{-64,
          -38}},               color={0,127,255}));
  connect(senTem1.port_b, toHouse.ports[1])
