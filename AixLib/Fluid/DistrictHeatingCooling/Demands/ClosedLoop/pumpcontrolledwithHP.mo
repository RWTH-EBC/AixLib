...
public
  ...
  Modelica.Blocks.Sources.RealExpression realExpression1(y=min(273.15 + 18, (
        senTem1.T - gain.y/m_flow_nominal/4180)))
    annotation (Placement(transformation(extent={{-236,-228},{-216,-208}})));
  ...
  Modelica.Blocks.Logical.Switch switch1
    annotation (Placement(transformation(extent={{-8,-116},{12,-96}})));
  Modelica.Blocks.Sources.RealExpression realExpression4(y=273.15 + 65)
    annotation (Placement(transformation(extent={{-38,-142},{-18,-122}})));
equation
  ...
  connect(realExpression1.y, prescribedTemperature.T)
    annotation (Line(points={{-215,-218},{-204,-218},{-204,-220},{-194,-220}},
                                                       color={0,0,127}));
  ...
  connect(hysteresis.y, switch1.u2)
    annotation (Line(points={{-35,-114},{-20,-114},{-20,-106},{-10,-106}},
                                                     color={255,0,255}));
  connect(switch1.y, heaPum.TSet)
    annotation (Line(points={{13,-106},{14,-106},{14,-88},{10,-88},{10,-71}},
                                                            color={0,0,127}));
  connect(realExpression4.y, switch1.u3) annotation (Line(points={{-17,-132},{
          -17,-114},{-10,-114}},
                             color={0,0,127}));
