...
model ValveControlledwithHE_end2 "Substation with fixed dT and Heat Exchanger"
...
equation
  ...
  connect(Q_flow_input, greaterThreshold.u) annotation (Line(points={{-118,88},
          {-132,88},{-132,86},{-144,86},{-144,-90},{-118,-90}}, color={0,0,127}));
  connect(switch1.y, fan.m_flow_in)
    annotation (Line(points={{-21,-84},{2,-84},{2,-66}}, color={0,0,127}));
  connect(greaterThreshold.y, switch1.u2) annotation (Line(points={{-95,-90},{
          -94,-90},{-94,-86},{-44,-86},{-44,-84}}, color={255,0,255}));
  connect(realExpression.y, switch1.u3) annotation (Line(points={{-61,-98},{-56,
          -98},{-56,-92},{-44,-92}}, color={0,0,127}));
  connect(const.y, switch1.u1) annotation (Line(points={{-63,-68},{-54,-68},{
...
end ValveControlledwithHE_end2;
