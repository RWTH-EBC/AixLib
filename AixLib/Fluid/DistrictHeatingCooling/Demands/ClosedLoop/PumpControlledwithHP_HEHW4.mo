...
model PumpControlledwithHP_HEHW4 "Substation model for  low-temperature networks for buildings with 
...
public
  ...
  Actuators.Valves.MixingValve mixingValve(
  redeclare package Medium = MediumBuilding,
    filteredOpening=true,
    riseTime=50,
    leakageOpening=0) annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=90,
        origin={-168,-106})));
  inner Utilities.Sources.BaseParameters baseParameters
    annotation (Placement(transformation(extent={{-248,94},{-228,114}})));
...
equation
  ...
  connect(senTem1.port_b, mixingValve.port_2) annotation (Line(points={{-170,-82},
          {-170,-96},{-168,-96}}, color={0,127,255}));
  connect(PID.y, mixingValve.opening) annotation (Line(points={{-187,-110},{-182,
          -110},{-182,-114},{-175,-114}}, color={0,0,127}));
  connect(mixingValve.port_1, tan.portHex_a) annotation (Line(points={{-168,-116},
          {-168,-158},{-38.2,-158},{-38.2,-152}}, color={0,127,255}));
  connect(mixingValve.port_3, vol1.ports[1]) annotation (Line(points={{-158,-106},
          {-158,-140},{-158,-174},{-156,-174}}, color={0,127,255}));
  connect(vol1.ports[2], senTem3.port_a) annotation (Line(points={{-152,-174},{-146,
          -174},{-146,-190},{-118,-190},{-118,-186}}, color={0,127,255}));
...
end PumpControlledwithHP_HEHW4;
