...
model PumpControlledwithHP_DC_F "Substation model for  low-temperature networks for buildings with 
...
public
  ...
  Modelica.Blocks.Sources.RealExpression realExpression3(y=senTem7.T +
        realinput.y/(cp_default*m_flow_nominal))
