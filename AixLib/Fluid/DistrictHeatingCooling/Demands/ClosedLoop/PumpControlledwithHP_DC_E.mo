...
model PumpControlledwithHP_DC_E "Substation model for  low-temperature networks for buildings with 
...
public
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature fixedTemperature1(T=293.15)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={162,-108})));
  Modelica.Blocks.Sources.RealExpression T_in(y=senTem7.T + realinput.y/(
  ...
  redeclare package Medium =MediumBuilding,
  nPorts=1)
    annotation (Placement(transformation(extent={{-150,-208},{-130,-188}})));
...
equation
  ...
  connect(opening.y, val.y) annotation (Line(points={{-149,-112},{-132,-112}},
                                   color={0,0,127}));
  connect(senTem4.port_b, vol.ports[1]) annotation (Line(points={{154,-176},{170,
          -176},{170,-146}}, color={0,127,255}));
  ...
  connect(realExpression6.y, prescribedHeatFlow1.Q_flow)
    annotation (Line(points={{-119,58},{-122,58},{-122,46},{-100,46}},
                                                   color={0,0,127}));
  ...
  connect(prescribedHeatFlow1.port, vol2.heatPort) annotation (Line(points={{
          -80,46},{-78,46},{-78,14},{-76,14}}, color={191,0,0}));
  connect(heaPum.QEva_flow, eva_HM.p) annotation (Line(points={{-11,-23},{-11,
          -2.5},{4,-2.5},{4,20.4}}, color={0,0,127}));
  connect(heaPum.P, fuelCounter.fuel_in)
    annotation (Line(points={{-11,-32},{-12,-32},{-12,16}}, color={0,0,127}));
  connect(heaPum.QCon_flow, con_HM.p) annotation (Line(points={{-11,-41},{-26,
          -41},{-26,20.4}}, color={0,0,127}));
  ...
  connect(bou2.ports[1], fan1.port_a) annotation (Line(points={{100,-112},{96,-112},
  ...
  connect(senTem4.port_a, tan.port_b) annotation (Line(points={{134,-176},{124,-176},
          {124,-190},{32,-190},{32,-176},{14,-176}}, color={0,127,255}));
  connect(boundary.ports[1], jun1.port_1)
    annotation (Line(points={{112,-48},{86,-48},{86,-40}}, color={0,127,255}));
  connect(senTem7.port_b, HZ.port_a)
    annotation (Line(points={{-120,-150},{-120,-164}}, color={0,127,255}));
  connect(HZ.port_b, bou3.ports[1]) annotation (Line(points={{-120,-184},{-120,-198},
          {-130,-198}}, color={0,127,255}));
  connect(realExpression.y, boundary.m_flow_in)
    annotation (Line(points={{153,-40},{134,-40}}, color={0,0,127}));
  connect(T_in.y, boundary.T_in) annotation (Line(points={{159,-60},{150,-60},{150,
          -62},{134,-62},{134,-44}}, color={0,0,127}));
