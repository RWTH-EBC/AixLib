...
model SubstationHeatingDirectCooling "Substation model for bidirctional low-temperature networks for buildings with 
  ...
  the return flows are used as supply flows for the other application. "
    ...
    parameter Modelica.SIunits.HeatFlowRate coolingDemand_max "Maximum cooling demand for scaling of chiller";
...
equation
  ...
  connect(heaPum.P, powerDemandHeaPum) annotation (Line(points={{-11,-30},{-20,
          -30},{-20,-20},{226,-20}}, color={0,0,127}));
