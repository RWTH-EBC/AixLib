...
model MassFlowControllerCooling
    ...
    Modelica.Blocks.Interfaces.RealInput T_supplyCoolingSet annotation (
        Placement(transformation(extent={{-138,-200},{-98,-160}}),
...
equation
    connect(division3.u2,const2. y) annotation (Line(points={{118.6,-37.2},{
            107.1,-37.2},{107.1,-38},{-33.4,-38}},
                                         color={0,0,127}));
    connect(lessThreshold.y, switch2.u2) annotation (Line(points={{-9,-82},{144,
            -82},{144,-88},{300,-88}},
                                color={255,0,255}));
  connect(deltaT_CoolingGridSet, const2.u)
    ...
    connect(CoolingDemand, division3.u1) annotation (Line(points={{-120,12},{0,
          12},{0,-28.8},{118.6,-28.8}},
                                    color={0,0,127}));
    connect(division3.y, switch2.u1) annotation (Line(points={{134.7,-33},{
            216.35,-33},{216.35,-80},{300,-80}},
                                   color={0,0,127}));
  connect(deltaT_HE.y, add5.u2) annotation (Line(points={{-77,-204},{-66,-204},{
          -66,-200},{-54,-200}}, color={0,0,127}));
    connect(T_supplyCoolingSet, add5.u1) annotation (Line(points={{-118,-180},{
          -90,-180},{-90,-188},{-54,-188}},   color={0,0,127}));
    ...
    connect(division1.y, switch1.u3) annotation (Line(points={{76.7,71},{155.35,
  ...
  connect(zero1.y, switch3.u1) annotation (Line(points={{268.4,-134},{284,-134},
          {284,-138},{300,-138}}, color={0,0,127}));
  connect(zero2.y, switch1.u1) annotation (Line(points={{158.4,100},{198,100},{198,
          86},{236,86}}, color={0,0,127}));
