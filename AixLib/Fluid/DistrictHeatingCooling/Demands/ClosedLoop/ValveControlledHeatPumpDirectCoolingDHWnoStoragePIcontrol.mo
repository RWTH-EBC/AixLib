...
equation
  ...
  connect(HP_control.direct_cooling, DirectCooling.u2) annotation (Line(points={{
          -294.222,-53.75},{-244,-53.75},{-244,-26},{-162,-26},{-162,70},{-142,
          70}},                                      color={255,0,255}));
  connect(heaPum.is_cooling, HP_control.hp_cooling_mode) annotation (Line(
        points={{-37,-8.2},{-25.5,-8.2},{-25.5,-61.25},{-294.222,-61.25}},
                                                               color={255,0,255}));
  ...
  connect(pControl.y, val.y) annotation (Line(points={{-189,60},{-180,60},{-180,
