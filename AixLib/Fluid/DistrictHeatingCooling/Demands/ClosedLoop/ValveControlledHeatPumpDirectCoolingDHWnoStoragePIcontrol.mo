...
public
  ...
  Utilities.Logical.ValveControlLogic2PI       Val_control
...
equation
  connect(prescribedHeatFlow.port,HX. heatPort)
    annotation (Line(points={{-112,62},{-112,10},{-134,10}},
                                                 color={191,0,0}));
  ...
  connect(HP_Return.ports[1],heaPum. port_a1) annotation (Line(points={{50,-36},
          {42,-36},{42,-12},{-38,-12}},
                                      color={0,127,255}));
  connect(dhw_input,dT_DHW. u1) annotation (Line(points={{-460,20},{-420,20},{
  ...
  connect(heat_input,dT_hot. u1) annotation (Line(points={{-460,60},{-426,60},{
  ...
  connect(DirectCooling.y,prescribedHeatFlow. Q_flow)
    annotation (Line(points={{-123,92},{-112,92},{-112,82}}, color={0,0,127}));
  connect(cold_input,DirectCooling. u1) annotation (Line(points={{-460,100},{
          -146,100}},                                        color={0,0,127}));
  connect(Zero.y,DirectCooling. u3) annotation (Line(points={{-144.9,70},{-152,
          70},{-152,84},{-146,84}},
                               color={0,0,127}));
  ...
  connect(cold_input,HP_control. cold_input) annotation (Line(points={{-460,100},
          {-410,100},{-410,-63.25},{-376.444,-63.25}},
                                             color={0,0,127}));
  connect(heat_input,HP_control. heat_input) annotation (Line(points={{-460,60},
          {-426,60},{-426,-70.75},{-376.444,-70.75}},
                                            color={0,0,127}));
  connect(dhw_input,HP_control. dhw_input) annotation (Line(points={{-460,20},{
          -420,20},{-420,-78.25},{-376.444,-78.25}},
                                           color={0,0,127}));
  ...
  connect(DirectCooling.u2,HP_control. direct_cooling) annotation (Line(points={{-146,92},
          {-162,92},{-162,-55.75},{-327.556,-55.75}},            color={255,0,
          255}));
