...
model PumpControlledwithHP_HE_ze "Substation model for  low-temperature networks for buildings with 
...
public
  ...
  Modelica.Blocks.Sources.TimeTable timeTable1(table=[0,273.15 + 10; 7.0e+06,273.15
         + 10; 7.0e+06,273.15 + 10; 1.2e+07,273.15 + 10; 1.2e+07,273.15 + 11; 2.2e+07,
        273.15 + 11; 2.2e+07,273.15 + 10; 2.7e+07,273.15 + 10; 2.7e+07,273.15 +
  ...
  Modelica.Blocks.Sources.RealExpression realExpression7(y=if cooling.y == 0
  ...
  Modelica.Blocks.Interfaces.RealOutput dP_Out
    annotation (Placement(transformation(extent={{214,90},{234,110}})));
  Modelica.Blocks.Sources.RealExpression realExpression9(y=port_a.p - port_b.p)
    annotation (Placement(transformation(extent={{170,88},{190,108}})));
  ...
  redeclare package Medium = Medium,
    ...
    l2=1e-9,
    l=0.05)
    annotation (Placement(transformation(extent={{-232,-10},{-212,10}})));
equation
  ...
  connect(realExpression6.y, switch2.u1) annotation (Line(points={{-259,70},{-252,
          70},{-252,54},{-246,54}}, color={0,0,127}));
  connect(senTem.T, limiter1.u)
    annotation (Line(points={{54,1},{50,1},{50,82},{42,82}}, color={0,0,127}));
  connect(realExpression9.y, dP_Out) annotation (Line(points={{191,98},{206,98},
          {206,100},{224,100}}, color={0,0,127}));
  connect(port_a, val1.port_a)
    annotation (Line(points={{-260,0},{-232,0}}, color={0,127,255}));
  connect(val1.port_b, senTem2.port_a)
    annotation (Line(points={{-212,0},{-192,0}}, color={0,127,255}));
  connect(switch2.y, val1.y) annotation (Line(points={{-223,46},{-223,29},{-222,
          29},{-222,12}}, color={0,0,127}));
...
end PumpControlledwithHP_HE_ze;
