...
public
  ...
  Modelica.Blocks.Math.Add temperatureReturnBuilding(k2=-1)
    "Temperature returning from building heating system" annotation (Placement(
        ...
        rotation=180,
        origin={40,-74})));
  Modelica.Blocks.Sources.Constant TSupplyHeatingSet(k=T_supplyHeatingSet)
    "Temperature of supply line" annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=180,
        origin={82,-40})));
  Modelica.Blocks.Sources.Constant deltaT_heatingBuildingSite(k=dTBuilding)
...
equation
  ...
  connect(TSupplyHeatingSet.y, temperatureReturnBuilding.u1) annotation (Line(
        points={{71,-40},{60,-40},{60,-68},{52,-68}}, color={0,0,127}));
  ...
  connect(TSupplyHeatingSet.y, heaPum.TSet) annotation (Line(points={{71,-40},{59.5,
          -40},{59.5,-15},{10,-15}}, color={0,0,127}));
