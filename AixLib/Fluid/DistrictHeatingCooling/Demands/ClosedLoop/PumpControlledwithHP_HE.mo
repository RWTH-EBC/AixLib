...
model PumpControlledwithHP_HE "Substation model for  low-temperature networks for buildings with 
...
public
  ...
  Modelica.Blocks.Sources.TimeTable timeTable1(table=[0,273.15 + 10; 7.0e+06,
        273.15 + 10; 7.0e+06,273.15 + 10; 1.2e+07,273.15 + 10; 1.2e+07,273.15
         + 11; 2.2e+07,273.15 + 11; 2.2e+07,273.15 + 10; 2.7e+07,273.15 + 10;
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=273.15 + 15, uMin=273.15 +
        10.5) annotation (Placement(transformation(extent={{40,72},{20,92}})));
...
equation
  ...
  connect(realExpression6.y, switch2.u1) annotation (Line(points={{-259,70},{
          -252,70},{-252,54},{-246,54}}, color={0,0,127}));
