...
model ValveControlledwithHEwithT_Table3
...
public
  ...
  Modelica.Blocks.Math.Add T_return_sec(k2=-1) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-4,-70})));
equation
  ...
  connect(Q_flow_input, gain.u) annotation (Line(points={{-86,84},{-54,84},{-54,
          96},{112,96},{112,-78},{90,-78}}, color={0,0,127}));
  connect(gain.y, division.u1) annotation (Line(points={{90,-101},{62,-101},{62,
          -94},{30,-94}}, color={0,0,127}));
  connect(senT_vor_sec.T, T_return_sec.u1) annotation (Line(points={{-16,5},{
          -22,5},{-22,-82},{-10,-82}}, color={0,0,127}));
  annotation (
...
end ValveControlledwithHEwithT_Table3;
