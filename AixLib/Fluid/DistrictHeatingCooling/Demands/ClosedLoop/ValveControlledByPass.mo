...
model ValveControlledByPass "Substation with variable dT"
...
equation
  ...
  connect(gain.y, heat2massFlow.u2)
    annotation (Line(points={{-11,40},{-4,40},{-4,36}}, color={0,0,127}));
  connect(Q_flow_input, heat2massFlow.u1)
    annotation (Line(points={{-108,80},{8,80},{8,36}}, color={0,0,127}));
  ...
  connect(gain1.u, smoothMax.y) annotation (Line(points={{2.22045e-15,-18},{4,
          -18},{4,-15},{12,-15}}, color={0,0,127}));
  connect(heat2massFlow.y, smoothMax.u2)
    annotation (Line(points={{2,13},{2,8},{6,8}}, color={0,0,127}));
  connect(m_flo_min.y, smoothMax.u1) annotation (Line(points={{79,36},{18,36},{18,
          8}},            color={0,0,127}));
