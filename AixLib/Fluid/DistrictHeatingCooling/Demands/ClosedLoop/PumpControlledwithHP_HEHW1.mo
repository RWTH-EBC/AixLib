...
model PumpControlledwithHP_HEHW1 "Substation model for  low-temperature networks for buildings with 
...
public
  ...
  MixingVolumes.MixingVolume vol1(redeclare package Medium = Medium,
  ...
  Sensors.TemperatureTwoPort senTem1(redeclare package Medium = Medium,tau=0,
    m_flow_nominal=m_flow_nominal,
    T_start=308.15)
  ...
  FixedResistances.Junction jun1(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={62,-102})));
  MixingVolumes.MixingVolume vol(redeclare package Medium = Medium,
    V=0.15,
    nPorts=2,
    T_start=303.15,
  ...
  Modelica.Blocks.Sources.Trapezoid trapezoid(
    ...
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=90,
        origin={130,-42})));
  Movers.FlowControlled_m_flow fan2(redeclare package Medium = Medium,
    allowFlowReversal=false,
    ...
    annotation (Placement(transformation(extent={{-10,10},{10,-10}},
        rotation=-90,
        origin={-76,-118})));
  Sensors.TemperatureTwoPort senTem4(redeclare package Medium = Medium,                     tau=0,
    allowFlowReversal=false,
    m_flow_nominal=m_flow_nominal,
    T_start=308.15)
    annotation (Placement(transformation(extent={{26,-164},{46,-144}})));
  Sensors.TemperatureTwoPort senTem5(redeclare package Medium = Medium,                     tau=0,
    allowFlowReversal=false,
    m_flow_nominal=m_flow_nominal,
    T_start=303.15)
  ...
  Sources.FixedBoundary bou2(redeclare package Medium = Medium,nPorts=1)
...
equation
  ...
  connect(jun.port_3, senTem1.port_a) annotation (Line(points={{-88,-82},{-118,
          -82},{-118,-68},{-148,-68}},
                                  color={0,127,255}));
  connect(const1.y, PID.u_s) annotation (Line(points={{-229,-98},{-214,-98},{
          -214,-102},{-212,-102}},
                              color={0,0,127}));
  connect(senTem1.T, PID.u_m) annotation (Line(points={{-159,-78},{-172,-78},{
          -172,-92},{-200,-92},{-200,-90}},
                                        color={0,0,127}));
  connect(prescribedTemperature.port, vol1.heatPort)
    annotation (Line(points={{-194,-188},{-156,-188}}, color={191,0,0}));
  connect(senTem3.port_b, jun1.port_1) annotation (Line(points={{-48,-178},{62,
          -178},{62,-112}},
                      color={0,127,255}));
  connect(tan.heaPorSid, fixedTemperature.port) annotation (Line(points={{0.96,
          -154},{0,-154},{0,-178},{4.44089e-16,-178}},
                                                   color={191,0,0}));
  connect(senTem4.port_b, vol.ports[2]) annotation (Line(points={{46,-154},{196,
          -154},{196,-126},{204,-126}}, color={0,127,255}));
  connect(tan.port_b, senTem4.port_a) annotation (Line(points={{8,-154},{26,
          -154}},                color={0,127,255}));
  connect(jun.port_2, fan2.port_a) annotation (Line(points={{-78,-92},{-76,-92},
          {-76,-108}},            color={0,127,255}));
  connect(fan2.port_b, tan.port_a) annotation (Line(points={{-76,-128},{-76,
          -142},{-24,-142},{-24,-154}},
                                  color={0,127,255}));
  connect(realExpression.y, fan2.m_flow_in) annotation (Line(points={{-101,-120},
          {-94,-120},{-94,-118},{-88,-118}}, color={0,0,127}));
  connect(senTem1.port_b, fan3.port_a) annotation (Line(points={{-148,-88},{
          -148,-98},{-146,-98}},
                              color={0,127,255}));
  connect(fan3.port_b, vol1.ports[1]) annotation (Line(points={{-146,-118},{
          -148,-118},{-148,-178}},        color={0,127,255}));
  connect(vol1.ports[2], senTem3.port_a) annotation (Line(points={{-144,-178},{
          -68,-178}},                    color={0,127,255}));
  connect(PID.y, fan3.m_flow_in)
    annotation (Line(points={{-189,-102},{-170,-102},{-170,-108},{-158,-108}},
                                                       color={0,0,127}));
  connect(bou.ports[1], fan3.port_a) annotation (Line(points={{-198,-66},{-174,
          -66},{-174,-98},{-146,-98}}, color={0,127,255}));
  connect(prescribedTemperature1.port, vol.heatPort) annotation (Line(points={{
          198,-86},{214,-86},{214,-114}}, color={191,0,0}));
  connect(realExpression5.y, prescribedTemperature1.T) annotation (Line(points=
          {{179,-50},{174,-50},{174,-86},{176,-86}}, color={0,0,127}));
  connect(pulse.y, heaPum.TSet) annotation (Line(points={{15,-104},{18,-104},{
          18,-71},{10,-71}}, color={0,0,127}));
...
end PumpControlledwithHP_HEHW1;
