...
model PumpControlledwithHP_HEHW5 "Substation model for  low-temperature networks for buildings with 
...
equation
  ...
  connect(realExpression3.y, switch1.u1) annotation (Line(points={{-27,-80},{-20,
          -80},{-20,-96},{-12,-96}}, color={0,0,127}));
  connect(realExpression4.y, switch1.u3) annotation (Line(points={{-23,-128},{-23,
          -112},{-12,-112}}, color={0,0,127}));
...
end PumpControlledwithHP_HEHW5;
