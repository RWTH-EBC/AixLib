...
model IdealSinkHeat
  "Demand node as an ideal sink without return flow, using table input"
  extends
  ...
  Modelica.Blocks.Sources.CombiTimeTable Q_flow_set(
    tableOnFile=true,
    tableName="Demand",
    extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
    "Table input for prescribed heat demand"        annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-70,80})));
