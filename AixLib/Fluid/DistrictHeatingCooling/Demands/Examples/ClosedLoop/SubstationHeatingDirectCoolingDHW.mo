...
model SubstationHeatingDirectCoolingDHW
  import AixLib;
  ...
  AixLib.Fluid.DistrictHeatingCooling.Demands.ClosedLoop.SubstationDirectHeatingCoolingDHW
    substationDirectHeatingCoolingDHW(
    heatDemand_max=4000,
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    experiment(
      ...
      Interval=60,
      Tolerance=1e-007));
end SubstationHeatingDirectCoolingDHW;
