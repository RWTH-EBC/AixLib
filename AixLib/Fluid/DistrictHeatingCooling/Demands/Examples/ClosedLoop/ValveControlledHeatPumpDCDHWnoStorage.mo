...
model ValveControlledHeatPumpDCDHWnoStorage
  "Example of Substation from MA Jonas Grossmann"
  import AixLib;
  ...
  AixLib.Fluid.DistrictHeatingCooling.Demands.ClosedLoop.ValveControlledHeatPumpDirectCoolingDHWnoStorage
    House_EquationBased(
...
equation
  connect(pipeSupply.ports_b[1], House_EquationBased.port_a) annotation (Line(
        points={{50,20},{50,-28.2105},{38,-28.2105}}, color={0,127,255}));
  connect(House_EquationBased.port_b, pipeReturn.port_a) annotation (Line(
        points={{-0.131034,-28.2105},{-32,-28.2105},{-32,-4}}, color={0,127,255}));
  ...
  connect(House_EquationBased.dpOut, pControl.u_m) annotation (Line(points={{
          -0.655172,-24.1053},{-10,-24.1053},{-10,28}}, color={0,0,127}));
  connect(heat_demand.y, House_EquationBased.heat_input) annotation (Line(
        points={{77,50},{66,50},{66,-20},{39.3103,-20}}, color={0,0,127}));
  connect(dhw_demand.y, House_EquationBased.dhw_input) annotation (Line(points=
          {{77,10},{68,10},{68,-25.8842},{39.3103,-25.8842}}, color={0,0,127}));
  connect(cold_demand.y, House_EquationBased.cold_input) annotation (Line(
        points={{77,-30},{72,-30},{72,-22.7368},{39.3103,-22.7368}}, color={0,0,
          127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,
    ...
    experiment(
      ...
      Interval=60,
      Tolerance=1e-007));
end ValveControlledHeatPumpDCDHWnoStorage;
