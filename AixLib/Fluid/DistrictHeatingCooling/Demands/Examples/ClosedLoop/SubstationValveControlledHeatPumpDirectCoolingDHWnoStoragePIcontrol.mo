...
model SubstationValveControlledHeatPumpDirectCoolingDHWnoStoragePIcontrol
  "Example for valve controlled substation with a reversible heatpump and direct cooling. No DHW storage is implemented. The valve is controlled with two PI controllers."
  import AixLib;
  ...
  AixLib.Fluid.DistrictHeatingCooling.Demands.ClosedLoop.ValveControlledHeatPumpDirectCoolingDHWnoStoragePIcontrol
    House_PIcontrolled(
...
equation
  ...
  connect(dhw_demand.y, House_PIcontrolled.dhw_input) annotation (Line(points={{77,10},
          {68,10},{68,-25.2632},{33.1852,-25.2632}},         color={0,0,127}));
...
end SubstationValveControlledHeatPumpDirectCoolingDHWnoStoragePIcontrol;
