...
model OpenLoopVarTSupplyDp
  ...
  package Medium = AixLibLatest.Media.Specialized.Water.ConstantProperties_pT (
      T_nominal=273.15 + 60,
      p_nominal=600000.0,
      T_default=273.15 + 60);
  ...
  AixLib.Fluid.DistrictHeatingCooling.Demands.OpenLoop.VarTSupplyDp demand(
    ...
    dTDesign=15,
    TReturn=333.15) "Simple demand model" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={-2,-60})));
...
equation
  ...
  connect(demand.port_a, pipeSupply.ports_b[1])
    annotation (Line(points={{8,-60},{60,-60},{60,-10}}, color={0,127,255}));
