...
<table cellspacing=\"0\" cellpadding=\"2\" border=\"1\" width=\"50%\">
  <caption>
    ...
    <p>
      ...
      given in ft**3/s and have been converted to mass flow rates in
      kg/s using the density of 995.586 kg/m**3:
    </p>
    <table cellspacing=\"0\" cellpadding=\"2\" border=\"1\" width=\"50%\">
      <caption>
        \"Discharges\"&gt;
        ...
        <p>
          For the pipes, Larock et al. [2000] give an exponential
          equation to calculate the pressure losses as a function of
          the mass flow rate. This model implementation uses the
          reference results' mass flow rates and pressure losses as
          nominal values in the Pressure Drop model:
        </p>
        <table cellspacing=\"0\" cellpadding=\"2\" border=\"1\" width=\"50%\">
          <caption>
            \"Nominal values\"&gt;
            ...
            <p>
              The outputs compare the relative deviations between the
              calculated pressures at the demand nodes B1, B2, and B3
              with the reference results given in Larock et al. [2000].
              The results show deviations below 0.3 percent.
            </p>
            <h4>
              References
            </h4>
            <ul>
              <li>
                ...
                Larock, Bruce E., Roland W. Jeppson, and Gary Z.
                Watters. <i>Hydraulics of pipeline systems</i>. Boca
                Raton, FL: CRC Press, 2000.</a>
              </li>
