within AixLib.Fluid.SolarCollectors.BaseClasses.Examples;
 model ASHRAESolarGain "Example showing the use of ASHRAESolarGain"
   ...
   parameter AixLib.Fluid.SolarCollectors.Data.GenericASHRAE93 per=
     AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_ThermaLiteHS20()
     "Performance data"
     annotation (choicesAllMatching=true);
   AixLib.Fluid.SolarCollectors.BaseClasses.ASHRAESolarGain solGai(
     nSeg=3,
 ...
 <a href=\"modelica://AixLib.Fluid.SolarCollectors.BaseClasses.ASHRAESolarGain\">
 AixLib.Fluid.SolarCollectors.BaseClasses.ASHRAESolarGain</a>.
 </p>
 </html>",
 revisions="<html>
 <ul>
 ...
 First implementation.
     ...
     __Dymola_Commands(file=
           "modelica://AixLib/Resources/Scripts/Dymola/Fluid/SolarCollectors/BaseClasses/Examples/ASHRAESolarGain.mos"
         "Simulate and plot"),
