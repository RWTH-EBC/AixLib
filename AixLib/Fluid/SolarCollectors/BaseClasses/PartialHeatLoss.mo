within AixLib.Fluid.SolarCollectors.BaseClasses;
 block PartialHeatLoss
   ...
   Modelica.Blocks.Interfaces.RealOutput QLos_flow[nSeg](
     ...
     each displayUnit="W") = {QLos_internal[i]*smooth(1, if TFlu[i] > TMedMin2
      then 1 else AixLib.Utilities.Math.Functions.smoothHeaviside(TFlu[i] -
 ...
 AixLib.Fluid.SolarCollectors.BaseClasses.ASHRAEHeatLoss</a> and
 <a href=\"modelica://AixLib.Fluid.SolarCollectors.BaseClasses.EN12975HeatLoss\">
 AixLib.Fluid.SolarCollectors.BaseClasses.EN12975HeatLoss</a>. It contains the
