within AixLib.Fluid.SolarCollectors.Controls;
model CollectorPump
  ...
  AixLib.BoundaryConditions.WeatherData.Bus weaBus "Weather data input"
    annotation (Placement(transformation(extent={{-110,40},{-90,60}})));

  AixLib.Fluid.SolarCollectors.Controls.BaseClasses.GCritCalc criSol(
...
Moved old model to <code>AixLib.Obsolete</code> package.<br/>
This is for
