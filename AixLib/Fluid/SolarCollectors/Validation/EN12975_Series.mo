...
model EN12975_Series
  ...
  model Collector
    ...
    final show_T = true,
    final per=AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_VerificationModel(),
    final shaCoe=0,
    final azi=0,
    final energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    final rho=0.2,
    final nColType=AixLib.Fluid.SolarCollectors.Types.NumberSelection.Number,
    nPanels=1,
    final til=0.78539816339745,
    final use_shaCoe_in=false,
    final sysConfig=AixLib.Fluid.SolarCollectors.Types.SystemConfiguration.Series);
