...
model FlatPlate "Validation model for FlatPlate"
  ...
  AixLib.Fluid.SolarCollectors.ASHRAE93
   solCol(
    ...
    shaCoe=0,
    azi=0,
    per=AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_TRNSYSValidation(),
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
       "modelica://AixLib/Resources/Data/Fluid/SolarCollectors/Validation/FlatPlate/TRNSYSAnnualData.txt"),
...
AixLib.Fluid.SolarCollectors.ASHRAE93</a> solar collector model
against TRNSYS data. Data files are used to ensure that the
<a href=\"modelica://AixLib.Fluid.SolarCollectors.ASHRAE93\">
AixLib.Fluid.SolarCollectors.ASHRAE93</a> solar collector model and
the TRNSYS model use the same inlet and weather conditions. The
solar collector model must reference the
<a href=\"modelica://AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_TRNSYSValidation\">
AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_TRNSYSValidation</a>
...
First implementation.
  ...
  __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/FlatPlate.mos"
    "Simulate and plot"),
