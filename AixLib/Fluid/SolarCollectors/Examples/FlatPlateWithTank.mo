within AixLib.Fluid.SolarCollectors.Examples;
 model FlatPlateWithTank
   ...
   replaceable package Medium_2 = AixLib.Media.Water "Fluid flowing through the collector";
   ...
   AixLib.Fluid.SolarCollectors.ASHRAE93 solCol(
     ...
     per=AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_SolahartKf(),
     nSeg=9,
     final azi=azi,
     final til=til,
   ...
   AixLib.Fluid.Sensors.TemperatureTwoPort TOut(
     T_start(displayUnit="K"),
     m_flow_nominal=m_flow_nominal,
     redeclare package Medium = Medium_2) "Temperature sensor"
     annotation (Placement(transformation(extent={{30,46},{50,66}})));
   AixLib.Fluid.Sensors.TemperatureTwoPort TIn(m_flow_nominal=m_flow_nominal,
     redeclare package Medium = Medium_2) "Temperature sensor"
   ...
   AixLib.Fluid.Storage.StratifiedEnhancedInternalHex
    tan(
     ...
     annotation (Placement(transformation(
       extent={{-20,-20},{20,20}},
       origin={100,-20})));
   AixLib.Fluid.SolarCollectors.Controls.CollectorPump pumCon(
     per=AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_ThermaLiteHS20(),
     final azi=azi,
     final til=til,
     final rho=rho)
     "Pump controller"
   ...
   AixLib.Fluid.Movers.FlowControlled_m_flow pum(
     ...
     "Pump forcing circulation through the system" annotation (Placement(
         ...
         rotation=90,
         origin={-50,0})));
   AixLib.Fluid.Storage.ExpansionVessel exp(
   ...
   AixLib.Controls.OBC.CDL.Conversions.BooleanToReal booToRea(realTrue=
         m_flow_nominal)
 ...
 AixLib.Fluid.Storage.StratifiedEnhancedInternalHex</a> (tan) model is
 ...
 AixLib.Fluid.Movers.FlowControlled_m_flow</a>, pum), 
 passes the water through an expansion tank
 (<a href=\"modelica://AixLib.Fluid.Storage.ExpansionVessel\">
 AixLib.Fluid.Storage.ExpansionVessel</a>, exp),
 a temperature sensor
 (<a href=\"modelica://AixLib.Fluid.Sensors.TemperatureTwoPort\">
 AixLib.Fluid.Sensors.TemperatureTwoPort</a>, TIn),
 the solar collector
 (<a href=\"modelica://AixLib.Fluid.SolarCollectors.ASHRAE93\">
 AixLib.Fluid.SolarCollectors.ASHRAE93,</a> solCol),
 and a second temperature sensor
 (<a href=\"modelica://AixLib.Fluid.Sensors.TemperatureTwoPort\">
 AixLib.Fluid.Sensors.TemperatureTwoPort</a>, TOut)
 ...
 AixLib.BoundaryConditions.WeatherData.ReaderTMY3</a>, weaDat) which passes
 ...
 (<a href=\"modelica://AixLib.Fluid.SolarCollectors.Controls.CollectorPump\">
 AixLib.Fluid.SolarCollectors.Controls.CollectorPump</a>, pumCon)
 and a gain model.
 ...
 <p>
 bou1 (<a href=\"modelica://AixLib.Fluid.Sources.MassFlowSource_T\">
 AixLib.Fluid.Sources.MassFlowSource_T)</a> provides a constant mass flow
