within AixLib.Fluid.SolarCollectors.Data.GlazedFlatPlate;
record FP_GuangdongFSPTY95 =
    AixLib.Fluid.SolarCollectors.Data.GenericASHRAE93 (
    final A=2,
    final mDry=35,
    final CTyp=AixLib.Fluid.SolarCollectors.Types.HeatCapacity.DryMass,
    final C=0,
    final V=1.7/1000,
