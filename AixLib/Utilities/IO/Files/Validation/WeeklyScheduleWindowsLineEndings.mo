within AixLib.Utilities.IO.Files.Validation;
...
wed                12  1   4  -" "Contents of schedule.txt";
  AixLib.Utilities.IO.Files.WeeklySchedule weeSchLin(
    columns={2,3,4,5},
    tableOnFile=true,
    fileName=Modelica.Utilities.Files.loadResource("modelica://AixLib/Resources/Data/schedule.txt"),
    t_offset=1e6) "Weekly schedule example using file data source"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));

  AixLib.Utilities.IO.Files.WeeklySchedule weeSchWin(
    columns={2,3,4,5},
    tableOnFile=true,
    fileName=Modelica.Utilities.Files.loadResource("modelica://AixLib/Resources/Data/scheduleWindows.txt"),
