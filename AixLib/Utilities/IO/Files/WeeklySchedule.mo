...
protected
  AixLib.Utilities.IO.Files.BaseClasses.WeeklyScheduleObject cal=
      AixLib.Utilities.IO.Files.BaseClasses.WeeklyScheduleObject(tableOnFile, sourceName, t_offset, data)
    "Schedule object";
  ...
  pure function getCalendarValue
    ...
    input AixLib.Utilities.IO.Files.BaseClasses.WeeklyScheduleObject ID "Pointer to file writer object";
...
<p>
See <a href=\"modelica://AixLib/Resources/Data/schedule.txt\">AixLib/Resources/Data/schedule.txt</a>
