...
<p>
  Adapted from <a href=\"modelica://Modelica.Blocks.Logical.Switch\">Modelica.Blocks.Logical.Switch</a>.
</p>
<p>
...
<p>
  If u2 is <b>true</b>, the output signal y is set equal to u1, else it is set equal to u3.
