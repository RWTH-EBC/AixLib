...
<p>
  <code>SocketSend()</code> sends the data contained in sendbuffer to the server via the current socket. It is necessary to specify the current length of the message.
</p>
<h4>
  Usage of Function
</h4>
<p>
  This code snippet will create a local socket and connect to server with IP 0.11.11.11 on port 1234 and send the message \"I am a message!\" with the length of 15 characters to the server every 1 second.
</p>
<pre>
...
<h4>
  C Source Code of <code>SocketSend()</code>
</h4>
<p>
  Source code of <code>SocketSend()</code>.
</p>
<pre>
