...
<ul>
  <li>
    <i>Feburary 6, 2017</i> by Philipp Mehrfeld:<br/>
    Revised documentation.
  </li>
  <li>
    <i>December 14, 2016</i> by Fabian Wuellhorst:<br/>
    Implemented.
  </li>
</ul></html>",revisions="<html>
<p>
  <b><span style=\"color:">Overview</span></b>
</p>
<p>
  The model <b>NcDataReader</b> reads data from netCDF files (based on HDF) to Modelica. You can read attributes of type integer or double/float/Real as well as one dimensional vectors. Therefore, the NcDataReader represents an alternative for the <a href=\"Modelica.Blocks.Sources.CombiTimeTable\">CombiTimeTable</a>.
</p>
<p>
  You have to select the <code>*.nc file</code> your data is stored in and define the variable's names (<code>varName</code>). With the checkboxes, you can select what type of data/attributes should be read in by the model and define afterwards the names of the variables/attributes.
</p>
<p>
  <b><span style=\"font-size:" color:="">IMPORTANT:</span></b> This model needs the external library <a href=\"https://github.com/tbeu/netCDF-DataReader\">NcDataReader2</a>. Clone or download the repository and load the Modelica library package (<code>netCDF-DataReader/NcDataReader2/package.mo</code>).
</p>
<p>
  <b><span style=\"color:">Further external information</span></b>
</p>
<p>
  For further information please consider <a href=\"https://github.com/tbeu/netCDF-DataReader\">netCDF-DataReader GitHub repository</a>.
</p>
<p>
  Have a look directly at the <a href=\"https://github.com/tbeu/netCDF-DataReader/blob/master/NcDataReader2/Resources/doc/ncDataReader2_Manual.pdf\">documentation</a> on how to create netCDF-files (<code>*.nc files</code>) and the different interpolation and extrapolation types.
</p>
<p>
  More information can be found <a href=\"https://www.j-raedler.de/projects/ncdatareader2/\">here</a>.
</p>
<p>
  <b><span style=\"color:">Outlook</span></b>
</p>
<p>
  If the function NcEasyGetScattered2D works in the future, an implementation to this model should follow. It would substitute <a href=\"Modelica.Blocks.Tables.CombiTable2D\">CombiTable2D</a>. Please have a look at the documentation on how to create netCDF-files and the different interpolation types. More information on that you find here.
</p>
<h4>
  <span style=\"color:">Example Function</span>
</h4>
<p>
  <a href=\"AixLib.Utilities.Examples.NcDataReader\">AixLib.Utilities.Examples.NcDataReader</a>
