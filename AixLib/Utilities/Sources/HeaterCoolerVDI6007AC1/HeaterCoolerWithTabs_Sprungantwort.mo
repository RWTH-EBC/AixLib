...
model HeaterCoolerWithTabs_Sprungantwort
...
// Heating, Cooling & Control Struktur übernommen aus PartialHeaterCoolerPI
 ...
 // Anteile der Wärmeströme
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    tableOnFile=true,
    tableName="TABSpower",
    fileName=ModelicaServices.ExternalReferences.loadResource("modelica://Sprungantwort_6/MFHtabs1990heavy1000/TABS_power_MFHtabs1990heavy1000.txt"),
    columns=2:4,
...
// übernommen aus HeaterCoolerPI und nicht sicher was es macht
  ...
  connect(combiTimeTable.y[3], sumHeating.u[1]) annotation (Line(points={{-39,36},
          {40,36},{40,30},{118.8,30}}, color={0,0,127}));
  connect(const.y, sumCooling.u[1]) annotation (Line(points={{-41,-74},{38,-74},
          {38,-30},{118.8,-30}}, color={0,0,127}));
  ...
  connect(const.y, gainCTabsExt.u) annotation (Line(points={{-41,-74},{-30,-74},
          {-30,-37.2},{-20,-37.2}}, color={0,0,127}));
  connect(const.y, gainCTabsInt.u) annotation (Line(points={{-41,-74},{-20,-74},
          {-20,-37.2},{0,-37.2}}, color={0,0,127}));

  connect(combiTimeTable.y[1], gainHTabsExt.u) annotation (Line(points={{-39,36},
          {-30,36},{-30,39.2},{-20,39.2}}, color={0,0,127}));
  connect(combiTimeTable.y[2], gainHTabsInt.u) annotation (Line(points={{-39,36},
          {-18,36},{-18,39.2},{-4.44089e-16,39.2}}, color={0,0,127}));
...
<li>March, 2021, by Christian Wenzel:<br>First implementation.</li>
        ...
        Rectangle(
          ...
          pattern=LinePattern.None)}), Diagram(coordinateSystem(extent={{-160,-100},
            {160,100}})));
end HeaterCoolerWithTabs_Sprungantwort;
