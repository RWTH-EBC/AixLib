...
model tabsPlusAirController
  ...
  Modelica.Blocks.Interfaces.BooleanInput remCoolerActiveInput
  ...
  Modelica.Blocks.Interfaces.BooleanOutput remCoolerActiveOutput
    annotation (Placement(transformation(extent={{100,40},{120,60}})));
  Modelica.Blocks.Interfaces.BooleanInput remHeaterActiveInput
  ...
  Modelica.Blocks.Interfaces.BooleanOutput remHeaterActiveOutput
...
equation
  ...
  connect(remCoolerActiveInput, and1.u2) annotation (Line(points={{-100,30},{
          -28,30},{-28,42},{18,42}}, color={255,0,255}));
  connect(not1.y, and1.u1) annotation (Line(points={{1,70},{6,70},{6,50},{18,50}},
        color={255,0,255}));
  connect(and1.y, remCoolerActiveOutput)
  ...
  connect(remHeaterActiveInput, and2.u2) annotation (Line(points={{-100,-70},{
          -38,-70},{-38,-58},{18,-58}}, color={255,0,255}));
  connect(and2.y, remHeaterActiveOutput)
    annotation (Line(points={{41,-50},{110,-50}}, color={255,0,255}));
