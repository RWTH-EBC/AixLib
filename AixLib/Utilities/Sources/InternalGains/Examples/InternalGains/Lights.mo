...
model Lights "Simulation to check the light models"
  ...
  AixLib.Utilities.Sources.InternalGains.Lights.LightsRelToMaxValue lights_sensibleHeat_Avar(maxHeatFlowAbsolute=100) annotation (Placement(transformation(extent={{-10,-62},{10,-42}})));
