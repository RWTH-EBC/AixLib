...
equation
  ...
  connect(pITempHeat.y, gainRad.u)
    annotation (Line(points={{-1,20},{8,20},{8,50},{18,50}}, color={0,0,127}));
  connect(pITempHeat.y, gainCon.u)
    annotation (Line(points={{-1,20},{8,20},{8,80},{18,80}}, color={0,0,127}));
  connect(pITempCool.y, gainCooCon.u) annotation (Line(points={{-1,-20},{6,-20},
          {6,-54},{0,-54},{0,-62},{18,-62}}, color={0,0,127}));
  connect(pITempCool.y, gainCooRad.u) annotation (Line(points={{-1,-20},{6,-20},
          {6,-54},{0,-54},{0,-92},{18,-92}}, color={0,0,127}));
  annotation (Documentation(info="<html>
<p><b><span style=\"color: #008000;\">Overview</span> </b></p>
<p>This is just a simple heater and/or cooler with a PI-controller. It can be used as an quasi-ideal source for heating and cooling applications. </p>
<ul>
