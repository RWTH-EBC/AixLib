...
partial model IdealHeaterCoolerBase_seperate_parameters
  ...
  parameter Modelica.SIunits.HeatFlowRate Q_flow_heat = 1 "Heat flow rate of the heater" annotation(Dialog(tab = "Heater"));
  parameter Real weightfactor_heater = 1 "weightfactor of the heater" annotation(Dialog(tab = "Heater"));
  parameter Modelica.SIunits.HeatFlowRate Q_flow_cooler = 1 "Heat flow rate of the cooler" annotation(Dialog(tab = "Cooler"));
  parameter Real weightfactor_cooler = 1 "weightfactor of the cooler" annotation(Dialog(tab = "Cooler"));
  parameter Real h_heater = 100000 "upper limit controller output of the heater" annotation(Dialog(tab = "Heater", group = "Controller"));
  ...
  parameter Modelica.SIunits.Time TN_heater = 1 "Time constant of the heating controller" annotation(Dialog(tab = "Heater", group = "Controller"));
  parameter Real h_cooler = 0 "upper limit controller output of the cooler" annotation(Dialog(tab = "Cooler", group = "Controller"));
  parameter Real l_cooler = -100000 "lower limit controller output of the cooler" annotation(Dialog(tab = "Cooler", group = "Controller"));
  parameter Real KR_cooler = 10000 "Gain of the cooling controller" annotation(Dialog(tab = "Cooler", group = "Controller"));
  parameter Modelica.SIunits.Time TN_cooler = 1 "Time constant of the cooling controller" annotation(Dialog(tab = "Cooler", group = "Controller"));
