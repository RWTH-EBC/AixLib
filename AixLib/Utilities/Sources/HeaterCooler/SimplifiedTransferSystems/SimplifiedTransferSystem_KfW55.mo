...
record SimplifiedTransferSystem_KfW55
  extends Modelica.Icons.Record;
  parameter Real k_Rad(unit="1")=1 "Gain for radiator";
  parameter Real k_UfhGroFlo(unit="1")=0.9574 "Gain for underfloorheating of ground floor";
  ...
  parameter Modelica.Units.SI.Time T_UfhGroFlo(start=1)=1.7710 * 3600 "Time Constant for underfloorheating of ground floor";
  ...
  parameter Real fraHeaRadUfh=0.6353 "Fraction of heating to radiation for underfloorheating";
...
end SimplifiedTransferSystem_KfW55;
