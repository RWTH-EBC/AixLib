...
record SimplifiedTransferSystem_KfW40
  extends Modelica.Icons.Record;
  parameter Real k_Rad(unit="1")=1 "Gain for radiator";
  parameter Real k_UfhGroFlo(unit="1")=0.9675 "Gain for underfloorheating of ground floor";
  ...
  parameter Modelica.Units.SI.Time T_UfhGroFlo(start=1)=1.7792 * 3600 "Time Constant for underfloorheating of ground floor";
  ...
  parameter Real fraHeaRadUfh=0.6345 "Fraction of heating to radiation for underfloorheating";
...
end SimplifiedTransferSystem_KfW40;
