...
record SimplifiedTransferSystem_IWU_Heavy
  extends Modelica.Icons.Record;
  parameter Real k_Rad(unit="1")=1 "Gain for radiator";
  parameter Real k_UfhGroFlo(unit="1")=0.9122 "Gain for underfloorheating of ground floor";
  ...
  parameter Modelica.Units.SI.Time T_UfhGroFlo(start=1)=1.9069 * 3600 "Time Constant for underfloorheating of ground floor";
  ...
  parameter Real fraHeaRadUfh=0.6424 "Fraction of heating to radiation for underfloorheating";
...
end SimplifiedTransferSystem_IWU_Heavy;
