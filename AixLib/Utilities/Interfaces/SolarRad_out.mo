...
<p>
  The <b>SolarRad_out</b> connector is used for the total radiation output and its main components. Is explicitly defined as an output.
</p>
<p>
...
<ul>
  ...
  <li>radiation reflected from the ground (as part of the total radiation)
  </li>
