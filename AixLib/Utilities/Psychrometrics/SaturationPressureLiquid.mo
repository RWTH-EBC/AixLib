...
equation
  ...
  pSat = AixLib.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TSat);
...
<p>
  Saturation pressure of water above the triple point temperature computed from temperature according to Wagner <i>et al.</i> (1993). The range of validity is between <i>273.16</i> and <i>373.16</i> Kelvin.
</p>
<h4>
  References
</h4>
