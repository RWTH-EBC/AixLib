...
equation
  ...
  pSat = AixLib.Utilities.Psychrometrics.Functions.sublimationPressureIce(TSat);
...
<p>
  Sublimation pressure of water below the triple point temperature, computed from temperature, according to Wagner <i>et al.</i> (1993). The range of validity is between <i>190</i> and <i>273.16</i> Kelvin.
</p>
<h4>
  References
</h4>
