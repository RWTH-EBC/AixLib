...
model MassFraction_pTphi "Unit test for dew point temperature calculation"
  extends Modelica.Icons.Example;
   ...
   package Medium2 = AixLib.Media.GasesPTDecoupled.MoistAir "Medium model";
    Modelica.Blocks.Sources.Ramp Phi(
    offset=0,
    duration=0.5,
    height=1) "Relative humidity"
                 annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));
  AixLib.Utilities.Psychrometrics.X_pTphi masFra1 "Mass fraction computation"
  ...
  AixLib.Utilities.Psychrometrics.X_pTphi masFra2(use_p_in=false)
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/MassFraction_pTphi.mos"
        "Simulate and plot"));
