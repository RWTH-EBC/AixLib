...
model WetBul_pTX "Model to test the wet bulb temperature computation"
 ...
 package Medium = AixLib.Media.Air "Medium model"
  ...
  Modelica.Blocks.Sources.Constant TDryBul(k=293.15) "Dry bulb temperature"
            ...
            {-60,80}})));
  AixLib.Utilities.Psychrometrics.WetBul_pTX wetBul_TDryBulX
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/WetBul_pTX.mos"
        "Simulate and plot"),
