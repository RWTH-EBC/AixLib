...
model HumidityRatioPressure "Unit test for humidity ratio model"
 ...
 package Medium = AixLib.Media.Air "Medium model"
  ...
  AixLib.Utilities.Psychrometrics.pW_X vapPre(
  ...
  Modelica.Blocks.Sources.Constant p(k=101325) "Pressure"
            ...
            {-60,40}})));
  AixLib.Utilities.Psychrometrics.X_pW humRat(
                            use_p_in=true)
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/HumidityRatioPressure.mos"
        "Simulate and plot"));
