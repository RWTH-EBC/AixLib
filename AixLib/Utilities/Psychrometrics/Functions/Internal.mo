...
<ul>
  <li>August 10, 2011, by Michael Wetter:<br/>
    Changed function to extend from <code>Modelica.Media.Common.OneNonLinearEquation</code> instead of <code>AixLib.Utilities.Math.BaseClasses.OneNonLinearEquation</code>.
  </li>
