...
<p>
  The correlation used in this model is valid for dew point temperatures between <i>0</i>°C and <i>200</i>°C. It is the correlation from 2005 ASHRAE Handbook, p. 6.2. In an earlier version of this model, the equation from Peppers has been used, but this equation yielded about <i>15</i> Kelvin lower dew point temperatures.
</p></html>",revisions="<html>
<ul>
  <li>April 29, 2014 by Michael Wetter:<br/>
    Added dummy argument to <code>Internal.solve</code> to avoid a warning in Dymola 2015.
  </li>
  ...
  <li>February 6, 2010 by Michael Wetter:<br/>
