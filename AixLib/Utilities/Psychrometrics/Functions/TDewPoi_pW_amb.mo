...
<p>
  Dew point temperature calculation for moist air between <i>0</i>°C and <i>30</i>°C with partial pressure of water vapor as an input.
</p>
<p>
...
<ul>
  <li>October 4, 2014, by Michael Wetter:<br/>
    Removed <code>extends AixLib.Utilities.Psychrometrics.Functions.BaseClasses.pW_TDewPoi_amb</code> as this gives a compile time error in OpenModelica as the input argument <code>T</code> cannot be found.
  </li>
  <li>March 9, 2012 by Michael Wetter:<br/>
    Added <code>smoothOrder=99</code> and <code>displayUnit</code> for pressure.
  </li>
  <li>May 21, 2010 by Michael Wetter:<br/>
