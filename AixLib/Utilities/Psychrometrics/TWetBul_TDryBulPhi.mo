...
equation
  if approximateWetBulb then
    ...
    TWetBul = (TDryBul * ((1-XiDryBul) *
               AixLib.Utilities.Psychrometrics.Constants.cpAir + XiDryBul *
               AixLib.Utilities.Psychrometrics.Constants.cpSte) + (XiDryBul-XiSat) *
               AixLib.Utilities.Psychrometrics.Constants.h_fg)/
            ( (1-XiSat)*AixLib.Utilities.Psychrometrics.Constants.cpAir + XiSat *
