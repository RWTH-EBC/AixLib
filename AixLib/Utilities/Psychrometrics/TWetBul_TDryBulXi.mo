...
equation
  if approximateWetBulb then
    ...
    TWetBul = (TDryBul *
                ...
                (Xi[iWat]-XiSat) * AixLib.Utilities.Psychrometrics.Constants.h_fg)/
            ( (1-XiSat)*AixLib.Utilities.Psychrometrics.Constants.cpAir +
            XiSat * AixLib.Utilities.Psychrometrics.Constants.cpSte);
    TDryBul_degC = 0;
    rh_per       = 0;
  end if;
...
<a href=\"modelica://AixLib.Fluid.Sensors.WetBulbTemperature\">AixLib.Fluid.Sensors.WetBulbTemperature</a>
</p>
<h4>References</h4>
<p>
Stull, Roland.
