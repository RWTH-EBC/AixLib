within AixLib.Utilities.Clustering.Validation;
...
initial equation
  (centroids, labels, cluster_size) = AixLib.Utilities.Clustering.KMeans(
...
__Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Utilities/Clustering/Validation/KMeans_2d.mos"
        "Simulate and plot"),
