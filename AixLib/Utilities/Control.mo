...
package Control "Controls that are not defined in MSL or Annex60-Library"
        extends Modelica.Icons.Package;

  model PITemp "PI Controler that can switch the output range of the controler"

    Modelica.Blocks.Interfaces.RealInput soll
    ...
    Modelica.Blocks.Interfaces.BooleanInput onOff
      ...
      annotation (Placement(transformation(extent={{-120,-80},{-80,-40}},
            rotation=0), iconTransformation(extent={{-100,-60},{-80,-40}})));
    ...
    Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temperatureSensor
      annotation (Placement(transformation(
          ...
          rotation=90)));
  equation
    connect(onOff, switch1.u2) annotation (Line(points={{-100,-60},{-80,-60},{
            -80,-4},{-42,-4}}, color={255,0,255}));
    connect(switch2.y, y) annotation (Line(points={{77,-8},{79.5,-8},{79.5,0},{
            90,0}},  color={0,0,127}));
    connect(onOff, switch2.u2) annotation (Line(points={{-100,-60},{-80,-60},{
            -80,-30},{-16,-30},{-16,-12},{30,-12},{30,-8},{54,-8}}, color={255,
            0,255}));
    connect(onOff, triggeredTrapezoid.u) annotation (Line(points={{-100,-60},{
            -80,-60},{-80,-30},{-50,-30},{-50,-50},{-42,-50}}, color={255,0,255}));
    ...
    connect(soll, switch1.u3) annotation (Line(points={{-80,90},{-80,6},{-42,6},
            {-42,4}}, color={0,0,127}));
    connect(temperatureSensor.port, Therm1) annotation (Line(
        points={{-60,-80},{-60,-90}},
        color={191,0,0},
        smooth=Smooth.None));
    connect(temperatureSensor.T, switch1.u1) annotation (Line(
        points={{-60,-60},{-60,-12},{-42,-12}},
        color={0,0,127},
        smooth=Smooth.None));
