...
<p>
  Type for choosing how to set the reference time in <a href=\"modelica://AixLib.Utilities.Time.CalendarTime\">AixLib.Utilities.Time.CalendarTime</a>.
</p>
<p>
  For example, <code>AixLib.Utilities.Time.Types.TimeReference.NY2016</code> means that if the Modelica built-in variable <code>time=0</code>, it is January 1, 2016, 0:00:00 local time.
</p></html>",revisions="<html>
<ul>
  <li>September 10, 2016, by Michael Wetter:<br/>
    Revised implementation and moved to new package <a href=\"modelica://AixLib.Utilities.Time.CalendarTime.Types\">AixLib.Utilities.Time.CalendarTime.Types</a>.
  </li>
