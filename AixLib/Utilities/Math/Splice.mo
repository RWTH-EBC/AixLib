...
<p>
  This block implements <a href=\"modelica://AixLib.Utilities.Math.Functions.spliceFunction\">AixLib.Utilities.Math.Functions.spliceFunction</a>, which provides a continuously differentiable transition between two arguments.
</p></html>",revisions="<html>
<ul>
  <li>August 31, 2012, by Michael Wetter:<br/>
    Revised documentation.
  </li>
  <li>July 30, 2012, by Kaustubh Phalak:<br/>
