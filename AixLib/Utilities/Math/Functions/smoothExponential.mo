...
<p>
  Function to provide a once continuously differentiable approximation to <i>exp(- |x| )</i> in the interval <i>|x| &lt; δ</i> for some positive <i>δ</i>
</p></html>",revisions="<html>
<ul>
  <li>October 30, 2008, by Michael Wetter:<br/>
    First implementation. Implemented to reduce chattering in <a href=\"modelica://AixLib.Fluid.Storage.BaseClasses.Stratifier\">AixLib.Fluid.Storage.BaseClasses.Stratifier</a>.
  </li>
