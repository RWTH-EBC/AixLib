...
<p>
  This function replicates the integer input signal to an array of <code>nout</code> identical output signals.
</p></html>",revisions="<html>
<ul>
  <li>November 28, 2013, by Marcus Fuchs:<br/>
    Implementation based on Kaustubh Phalak's block <a href=\"modelica://AixLib.Utilities.Math.IntegerReplicator\">AixLib.Utilities.Math.IntegerReplicator</a>.
  </li>
