...
<p>
  Once Lipschitz continuously differentiable approximation to the <code>Heaviside(.,.)</code> function. See Example <a href=\"modelica://AixLib.Utilities.Math.Examples.SmoothHeaviside\">AixLib.Utilities.Math.Examples.SmoothHeaviside</a>.
...
<ul>
  ...
  <li>July 17, 2015, by Marcus Fuchs:<br/>
    Add link to example.
  </li>
