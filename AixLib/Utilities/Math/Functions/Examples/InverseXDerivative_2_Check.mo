...
<p>
  This model validates the implementation of <a href=\"modelica://AixLib.Utilities.Math.Functions.inverseXRegularized\">AixLib.Utilities.Math.Functions.inverseXRegularized</a> and its second order derivative <a href=\"modelica://AixLib.Utilities.Math.Functions.BaseClasses.der_2_smoothTransition\">AixLib.Utilities.Math.Functions.BaseClasses.der_2_smoothTransition</a>. If the derivative implementation is wrong, the simulation will stop with an error.
