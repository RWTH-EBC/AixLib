...
equation
   dp=ramp.y;
   m_flow = AixLib.Utilities.Math.Functions.interpolate(u=dp, xd=xd, yd=yd, d=d);

  annotation (
experiment(
      StopTime=500,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://AixLib/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/Interpolate.mos"
        "Simulate and plot"), Documentation(info="<html>
<p>
This example demonstrates the function
<a href=\"modelica://AixLib.Utilities.Math.Functions.interpolate\">
AixLib.Utilities.Math.Functions.interpolate</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
Moved to
<a href=\"modelica://AixLib.Utilities.Math.Functions.Examples\">
AixLib.Utilities.Math.Functions</a>
from
<a href=\"modelica://AixLib.Airflow.Multizone.BaseClasses.Examples\">
AixLib.Airflow.Multizone.BaseClasses</a>.<br/>
This is for
