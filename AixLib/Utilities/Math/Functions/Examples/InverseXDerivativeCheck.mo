...
<p>
  This model validates the implementation of <a href=\"modelica://AixLib.Utilities.Math.Functions.inverseXRegularized\">AixLib.Utilities.Math.Functions.inverseXRegularized</a> and its first order derivative <a href=\"modelica://AixLib.Utilities.Math.Functions.BaseClasses.der_smoothTransition\">AixLib.Utilities.Math.Functions.BaseClasses.der_smoothTransition</a>. If the derivative implementation is wrong, the simulation will stop with an error.
</p></html>",revisions="<html>
<ul>
  <li>June 22, 2016, by Filip Jorissen:<br/>
    Changed example such that it explicitly uses <a href=\"modelica://AixLib.Utilities.Math.Functions.BaseClasses.der_inverseXRegularized\">AixLib.Utilities.Math.Functions.BaseClasses.der_inverseXRegularized</a>.
  </li>
