...
info="<html>
<p>
  Implementation of the first derivative of the function <a href=\"modelica://AixLib.Utilities.Math.Functions.inverseXRegularized\">AixLib.Utilities.Math.Functions.inverseXRegularized</a>.
