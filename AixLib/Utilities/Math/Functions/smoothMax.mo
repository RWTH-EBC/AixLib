...
<p>
  Note that the maximum need not be respected, such as illustrated in <a href=\"modelica://AixLib.Utilities.Math.Examples.SmoothMin\">AixLib.Utilities.Math.Examples.SmoothMin</a>.
