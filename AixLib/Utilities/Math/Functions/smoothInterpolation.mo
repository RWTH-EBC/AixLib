...
algorithm
  if n > 2 then
    ...
    dy_dx :=AixLib.Utilities.Math.Functions.splineDerivatives(
      x=xSup,
      y=ySup,
...
<a href=\"modelica://AixLib.Utilities.Math.Functions.splineDerivatives\">
AixLib.Utilities.Math.Functions.splineDerivatives</a>
to find the derivatives, and then call
<a href=\"modelica://AixLib.Utilities.Math.Functions.interpolate\">
AixLib.Utilities.Math.Functions.interpolate</a> to perform the interpolation.
...
<a href=\"modelica://AixLib.Utilities.Math.Functions.Examples.Interpolate\">
AixLib.Utilities.Math.Functions.Examples.Interpolate</a>.
</p>
<p>
...
<a href=\"modelica://AixLib.Utilities.Math.Functions.Examples.SmoothInterpolation\">
AixLib.Utilities.Math.Functions.Examples.SmoothInterpolation</a>.
</p>
</html>",
revisions="<html>
<ul>
