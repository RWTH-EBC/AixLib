...
<p>
  Once Lipschitz continuously differentiable approximation to the <i>Heaviside(.,.)</i> function. See Example <a href=\"modelica://AixLib.Utilities.Math.Examples.SmoothHeaviside\">AixLib.Utilities.Math.Examples.SmoothHeaviside</a>.
