...
model StoredExergyMeter
  ...
  Modelica.Fluid.Sensors.SpecificEnthalpy specificEnthalpyRef[n](redeclare package
              Medium = Medium) "Specific enthalpy of the reference environment"
    annotation (Placement(transformation(extent={{-10,60},{-30,40}})));
  Modelica.Fluid.Sensors.SpecificEntropy specificEntropyRef[n](redeclare package
              Medium = Medium) "Specific enthalpy of the reference environment"
    annotation (Placement(transformation(extent={{10,60},{30,40}})));
