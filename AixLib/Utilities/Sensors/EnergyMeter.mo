...
model EnergyMeter
  ...
  Modelica.Blocks.Interfaces.RealInput p(unit="W") annotation(Placement(transformation(origin = {-86, 0}, extent = {{-14, -14}, {14, 14}}, rotation = 180)));
...
equation
  ...
  annotation (preferredView = "info", Icon(graphics={  Rectangle(extent = {{-40, 66}, {46, -62}}, lineColor = {0, 0, 255}, fillColor = {95, 95, 95},
