...
model EnergyKpis "Test of different energy KPIs"
  ...
  Modelica.Blocks.Sources.Pulse P_pul(
    amplitude=2,
    period=2,
...
equation
  connect(Q_flow_pul.y, thmMtr.Q_flow) annotation (Line(points={{-79,50},{-40,50},
          {-40,70},{-2,70}}, color={0,0,127}));
  connect(Q_flow_pul.y, thmMtrTim.Q_flow) annotation (Line(points={{-79,50},{-40,
          50},{-40,30},{-2,30}}, color={0,0,127}));
  connect(P_pul.y, eleMtr.P) annotation (Line(points={{-79,-50},{-40,-50},{-40,-30},
          {-2,-30}}, color={0,0,127}));
  connect(P_pul.y, eleMtrTim.P) annotation (Line(points={{-79,-50},{-40,-50},{-40,
