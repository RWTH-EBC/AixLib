...
model IntegralErrorDualBounds
  ...
  AixLib.Utilities.KPIs.IntegralErrorSingleReference.IntegralErrorBySign
    intErrPos(use_reset=resInBou) "Intergral of positive errors"
    annotation (Placement(transformation(extent={{-60,50},{-40,70}})));
  AixLib.Utilities.KPIs.IntegralErrorSingleReference.IntegralErrorBySign
    intErrNeg(use_reset=resInBou, posItg=false) "Intergral of negative errors"
...
equation
  ...
  connect(u, intErrPos.u) annotation (Line(points={{-120,0},{-90,0},{-90,60},{
          -62,60}},
                color={0,0,127}));
  connect(u, intErrNeg.u) annotation (Line(points={{-120,0},{-90,0},{-90,-60},{
          -62,-60}},
                 color={0,0,127}));
  ...
  connect(intErrNeg.y, add.u2) annotation (Line(points={{-39,-60},{50,-60},{50,-6},
          {58,-6}}, color={0,0,127}));
  connect(intErrPos.isItgAct, or1.u1) annotation (Line(points={{-39,66},{10,66},
          {10,20},{18,20}}, color={255,0,255}));
  connect(intErrNeg.isItgAct, or1.u2) annotation (Line(points={{-39,-54},{10,-54},
          {10,12},{18,12}}, color={255,0,255}));
  ...
  connect(intErrPos.isItgAct, yOutUppBou) annotation (Line(points={{-39,66},{60,
          66},{60,80},{110,80}}, color={255,0,255}));
  connect(intErrNeg.isItgAct, yOutLowBou) annotation (Line(points={{-39,-54},{
          60,-54},{60,-40},{110,-40}}, color={255,0,255}));
  connect(or1.y, yOutBou) annotation (Line(points={{41,20},{110,20}},
        color={255,0,255}));
  connect(intErrPos.isItgAct, notUpp.u) annotation (Line(points={{-39,66},{10,
          66},{10,30},{-18,30}}, color={255,0,255}));
  connect(intErrNeg.isItgAct, notLow.u) annotation (Line(points={{-39,-54},{10,
          -54},{10,-90},{-18,-90}}, color={255,0,255}));
