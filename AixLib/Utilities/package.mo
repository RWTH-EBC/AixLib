...
annotation (preferedView="diagram",
            conversion(from(version="0.2",script="modelica://BaseLib/Conversions/ConvertFromBaseLib_0.2_To_1.2.mos"),
            from(version="1.1",script="modelica://BaseLib/Conversions/ConvertFromBaseLib_1.1_To_1.2.mos"),
            noneFromVersion="1.2.1",
            from(version="2.0",script="modelica://BaseLib/Conversions/ConvertFromBaseLib_2.0_To_2.1.mos"),
            from(version="2.1",script="modelica://BaseLib/Conversions/ConvertFromBaseLib_2.1_To_2.2.mos")),
            uses(
