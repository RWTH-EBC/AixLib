...
<p>
  The <b>HeatTransfer_outside</b> is a model for the convective heat transfer at outside walls
</p>
<p>
  <img src=\"modelica://AixLib/Resources/Images/Stars/stars3.png\" alt=\"stars:" out="" of="">
</p>
<p>
  <b><span style=\"color:">Concept</span></b>
</p>
<p>
  It allows the choice between three different models:
</p>
<ul>
  <li>after DIN 6946: <img src=\"modelica://AixLib/Resources/Images/Utilities/HeatTransfer/HeatConv_outside/equation-vd3eY3hw.png\" alt=\"alpha"> , where <img src=\"modelica://AixLib/Resources/Images/Utilities/HeatTransfer/HeatConv_outside/equation-MU6LPHRs.png\" alt=\"alpha\"> (<b>alpha)</b> is the heat transfer coefficent and <b>v</b> is the wind speed
  </li>
  <li>after the ASHRAE Fundamentals Handbook from 1989, the way it is presented in EnergyPlus Engineering reference from 2011: <img src=\"modelica://AixLib/Resources/Images/Utilities/HeatTransfer/HeatConv_outside/equation-A5RXdOdd.png\" alt=\"alpha" d="">, where <img src=\"modelica://AixLib/Resources/Images/Utilities/HeatTransfer/HeatConv_outside/equation-LDgZSLyY.png\" alt=\"alpha\"> (<b>alpha</b>) and <b>v</b> are as above and the coefficients <b>D, E, F</b> depend on the surface of the outer wall.<br/>
    <b><span style=\"color:">Attention:</span></b> This is a combined coefficient for convective and radiative heat exchange.
  </li>
  <li>with a custom constant <img src=\"modelica://AixLib/Resources/Images/Utilities/HeatTransfer/HeatConv_outside/equation-BjHulWj5.png\" alt=\"alpha"> (<b>alpha)</b> value
  </li>
</ul>
<p>
...
<ul>
  ...
  <li>ASHRAEHandbook1989, as cited in EnergyPlus Engineering Reference. : EnergyPlus Engineering Reference, 2011 p.56
  </li>
</ul>
<p>
  <b><span style=\"color:">Example Results</span></b>
</p>
<p>
  <a href=\"AixLib.Utilities.Examples.HeatTransfer_test\">AixLib.Utilities.Examples.HeatTransfer_test</a>
</p>
<p>
  <a href=\"AixLib.Utilities.Examples.HeatConv_outside\">AixLib.Utilities.Examples.HeatConv_outside</a>
</p></html>",revisions="<html>
<ul>
  <li>
    <i>November 16, 2016&#160;</i> by Ana Constantin:<br/>
    Conditioned input WindSpeedPort and introduced protected input WindSpeed_internal
  </li>
</ul>
<ul>
  <li>
