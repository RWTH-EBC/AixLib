...
<li>after the ASHRAE Fundamentals Handbook from 1989, the way it is presented in EnergyPlus Engineering reference from 2011: <img src=\"modelica://BaseLib/Images/equations/equation-zygE8L9u.png\"/>, where<b> alfa</b> and <b>v</b> are as above and the coefficients <b>D, E, F</b> depend on the surface of the outer wall. <b><font style=\"color: #ff0000; \">Attention:</font></b> This is a combined coeeficient for convective and radiative heat exchange.</li>
