...
model CylindricHeatTransfer_halfpipeisolated
  "Model for cylindric heat transfer of a pipe that is isolated on the half of its radius"
...
end CylindricHeatTransfer_halfpipeisolated;
