...
protected
  Modelica.SIunits.TemperatureDifference posDiff=abs(port_b.T - port_a.T)
...
<ul>
<li>Bernd Gl&uuml;ck:<i> Heizen und K&uuml;hlen mit Niedrigexergie - Innovative W&auml;rme&uuml;bertragung und W&auml;rmespeicherung (LowEx) 2008</i>. </li>
...
<p><a href=\"AixLib.Utilities.Examples.HeatTransfer_test\">AixLib.Utilities.Examples.HeatTransfer_test </a></p>
 ...
 <ul>
<li><i>March 26, 2015&nbsp;</i> by Ana Constantin:<br/>Changed ecuations for differnet surface orientations according to newer work from Glück</li>
