...
model ModularBoiler_FlowTemperatureControlAdmixModule
  ...
  Modelica.Blocks.Interfaces.RealInput Tset[k]
    ...
    annotation (Placement(transformation(
        extent={{-16,-16},{16,16}},
        rotation=-90,
        origin={34,100}), iconTransformation(extent={{2,72},{34,104}})));
...
end ModularBoiler_FlowTemperatureControlAdmixModule;
