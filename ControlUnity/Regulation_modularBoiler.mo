...
equation
  ...
  connect(PLRMea, lessThreshold1.u) annotation (Line(points={{-100,-66},{-72,
          -66},{-72,-67},{-45.4,-67}}, color={0,0,127}));
  connect(lessThreshold1.y, switch1.u2) annotation (Line(points={{-29.3,-67},{
          28,-67},{28,-10},{42,-10}}, color={255,0,255}));
