...
equation
  ...
  connect(heatingCurve.TSet, switch1.u1) annotation (Line(points={{-47,0},{-36,0},
          {-36,-66},{22,-66},{22,-60}}, color={0,0,127}));
  connect(PID.y, lessEqualThreshold.u) annotation (Line(points={{-1,0},{12,0},{12,
          54},{-126,54},{-126,-86},{-8,-86}}, color={0,0,127}));
  connect(lessEqualThreshold.y, switch1.u2)
    annotation (Line(points={{15,-86},{30,-86},{30,-60}}, color={255,0,255}));
  connect(TMea, switch1.u3) annotation (Line(points={{66,-100},{66,-72},{38,-72},
          {38,-60}}, color={0,0,127}));
