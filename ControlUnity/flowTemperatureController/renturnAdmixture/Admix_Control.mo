...
model Admix_Control "Test for admix circuit"
  ...
  AixLib.Fluid.Sources.Boundary_pT boundary[2](
    T=343.15,
    redeclare package Medium = Medium,
    nPorts=2) annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-8,-50})));
  AixLib.Fluid.Sources.Boundary_pT boundary1[2](
    T=323.15,
    redeclare package Medium = Medium,
    nPorts=2) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
...
equation
  ...
  connect(boundary1.ports, Admix.port_b2)
    annotation (Line(points={{28,-40},{28,-20}}, color={0,127,255}));
  connect(boundary.ports, Admix.port_a1)
    annotation (Line(points={{-8,-40},{-8,-20},{-8,-20}}, color={0,127,255}));
  connect(Admix.port_a2, hydRes.port_b) annotation (Line(points={{28,40},{26,40},
          {26,60},{20,60}}, color={0,127,255}));
