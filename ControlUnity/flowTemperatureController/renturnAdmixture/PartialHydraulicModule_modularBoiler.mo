...
partial model PartialHydraulicModule_modularBoiler
  ...
  parameter AixLib.DataBase.Pipes.PipeBaseDataDefinition parameterPipe=
    ...
    annotation (choicesAllMatching=true, Dialog(group="Pipes"));
  ...
  BoilerControlBus_admixture boilerControlBus_admixture annotation (Placement(
...
equation
  ...
  connect(VFSen_out.V_flow, boilerControlBus_admixture.VFlowInMea) annotation (
      Line(
      ...
      index=1,
      extent={{6,3},{6,3}}));
  connect(VFSen_in.V_flow, boilerControlBus_admixture.VFlowOutMea) annotation (
      Line(
  ...
  connect(senT_b1.T, PT1_b1.u) annotation (Line(points={{94,26.6},{86,26.6},{86,
          58},{70,58}}, color={0,0,127}));
  connect(PT1_b1.y, boilerControlBus_admixture.TFwrdOutMea) annotation (Line(
        points={{70,81},{70,100.1},{0.1,100.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(PT1_a1.y, boilerControlBus_admixture.TFwrdInMea) annotation (Line(
        points={{-70,81},{-70,100},{0.1,100},{0.1,100.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(PT1_b2.y, boilerControlBus_admixture.TRtrnOutMea) annotation (Line(
        points={{-121,-30},{-122,-30},{-122,100},{0.1,100},{0.1,100.1}}, color={
          0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  ...
  connect(PT1_a2.y, boilerControlBus_admixture.TRtrnInMea) annotation (Line(
        points={{121,-30},{130,-30},{130,100},{116,100},{116,100.1},{0.1,100.1}},
        color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
...
end PartialHydraulicModule_modularBoiler;
