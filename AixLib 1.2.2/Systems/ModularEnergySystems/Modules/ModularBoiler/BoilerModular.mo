...
equation
  ...
  connect(val_DrinkingWater.port_3, tWWAdd_on.port_a_feedback)
    ...
    annotation (Line(points={{-10,-70},{-72,-70},{-72,0},{-66,0}},
                                                           color={0,127,255},
        pattern=LinePattern.Dash));
  ...
  connect(port_b_DW, tWWAdd_on.port_b_DW)
    ...
    connect(senTIn.T, boilerControlBus.TBoilerIn) annotation (Line(points={{-60,8.8},
          {-60,86},{0,86},{0,100}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  ...
  connect(senTIn1.port_b, senTIn.port_a)
    annotation (Line(points={{-80,0},{-66,0}}, color={0,127,255}));
