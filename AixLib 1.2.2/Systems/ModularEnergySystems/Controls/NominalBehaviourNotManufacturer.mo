...
model NominalBehaviourNotManufacturer
  ...
  SDF.NDTable SDFRatioCoolingWater(
    ...
    readFromFile=true,
    filename=ModelicaServices.ExternalReferences.loadResource(
        "modelica://AixLib/Resources/Data/Fluid/BoilerCHP/NotManufacturer/CHP/RatioCoolingWater.sdf"),
...
equation
  ...
  connect(pelNom.y, multiplex2_1.u1[1])
    annotation (Line(points={{-83.2,24},{-62,24}}, color={0,0,127}));
  ...
  connect(multiplex2_1.y, SDFRatioCoolingWater.u) annotation (Line(points={{-39,
          30},{-30,30},{-30,-58},{-22,-58}}, color={0,0,127}));
  ...
  connect(product.y, division2.u1) annotation (Line(points={{64.7,-53},{76.6,-53},
          {76.6,-52.8}}, color={0,0,127}));
  connect(TempDiffCC.y, division2.u2) annotation (Line(points={{67,-80},{68,-80},
          {68,-78},{72,-78},{72,-62},{76.6,-62},{76.6,-61.2}}, color={0,0,127}));
  connect(division2.y, mWaterCC) annotation (Line(points={{92.7,-57},{96,-57},{96,
          -60},{110,-60}}, color={0,0,127}));
  connect(division4.y, dTCCNom) annotation (Line(points={{92.7,1},{96.35,1},{96.35,
  ...
  connect(division2.y, product1.u2) annotation (Line(points={{92.7,-57},{100,-57},
          {100,-38},{68,-38},{68,-29.2},{74.6,-29.2}}, color={0,0,127}));
